...
public:
	...
	unsigned char                                      UnknownData01[0x108];                                     // 0x0238(0x0108) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnSelectedChanged;                                        // 0x0210(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonClicked;                                          // 0x0220(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonDoubleClicked;                                    // 0x0230(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonHovered;                                          // 0x0240(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonUnhovered;                                        // 0x0250(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	int                                                MinWidth;                                                 // 0x0260(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                MinHeight;                                                // 0x0264(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UClass*                                      Style;                                                    // 0x0268(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FSlateSound                                 PressedSlateSoundOverride;                                // 0x0270(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FSlateSound                                 HoveredSlateSoundOverride;                                // 0x0288(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bApplyAlphaOnDisable : 1;                                 // 0x02A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bSelectable : 1;                                          // 0x02A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bShouldSelectUponReceivingFocus : 1;                      // 0x02A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bInteractableWhenSelected : 1;                            // 0x02A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bToggleable : 1;                                          // 0x02A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bDisplayInputActionWhenNotInteractable : 1;               // 0x02A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bHideInputActionWithKeyboard : 1;                         // 0x02A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bShouldUseFallbackDefaultInputAction : 1;                 // 0x02A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData00[0x1];                                       // 0x02A1(0x0001) MISSED OFFSET
	TEnumAsByte<EButtonClickMethod>                    ClickMethod;                                              // 0x02A2(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x02A3(0x0001) MISSED OFFSET
	int                                                InputPriority;                                            // 0x02A4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FDataTableRowHandle                         TriggeringInputAction;                                    // 0x02A8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0x40];                                      // 0x02B8(0x0040) MISSED OFFSET
	class UCommonActionWidget*                         InputActionWidget;                                        // 0x02F8(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UMaterialInstanceDynamic*                    SingleMaterialStyleMID;                                   // 0x0300(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FButtonStyle                                NormalStyle;                                              // 0x0308(0x0238)
	struct FButtonStyle                                SelectedStyle;                                            // 0x0540(0x0238)
...
public:
	...
	float                                              ItemHeight;                                               // 0x0160(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	struct FMargin                                     DesiredItemPadding;                                       // 0x0164(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnTemplate)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0174(0x0004) MISSED OFFSET
	class UClass*                                      ListItemClass;                                            // 0x0178(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	TEnumAsByte<ESelectionMode>                        SelectionMode;                                            // 0x0180(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	EConsumeMouseWheel                                 ConsumeMouseWheel;                                        // 0x0181(0x0001) (Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	bool                                               bClearSelectionOnClick;                                   // 0x0182(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0183(0x0001) MISSED OFFSET
	int                                                NumPreAllocatedEntries;                                   // 0x0184(0x0004) (Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	bool                                               bSimulateDoubleClickOnSelectedItemClick;                  // 0x0188(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	unsigned char                                      UnknownData02[0x167];                                     // 0x0189(0x0167) MISSED OFFSET
	class UCommonListViewNullItem*                     NullItem;                                                 // 0x02F0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	TWeakObjectPtr<class UMenuAnchor>                  OwningMenuAnchor;                                         // 0x03C0(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UObject>                      ContextProvidingObject;                                   // 0x03C8(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnAnalogCapture;                                          // 0x0398(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FSlateBrush                                 ProgressMaterialBrush;                                    // 0x0120(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FName                                       ProgressMaterialParam;                                    // 0x0198(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FSlateBrush                                 IconRimBrush;                                             // 0x01A0(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly)
	class UMaterialInstanceDynamic*                    ProgressDynamicMaterial;                                  // 0x0218(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	struct FSlateBrush                                 Background;                                               // 0x0028(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
...
{
public:
	class UClass*                                      Style;                                                    // 0x0250(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bReducePaddingBySafezone;                                 // 0x0258(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0259(0x0003) MISSED OFFSET
	struct FMargin                                     MinimumPadding;                                           // 0x025C(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
...
public:
	...
	struct FSlateBrush                                 SingleMaterialBrush;                                      // 0x0030(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FSlateBrush                                 NormalBase;                                               // 0x00A8(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FSlateBrush                                 NormalHovered;                                            // 0x0120(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FSlateBrush                                 NormalPressed;                                            // 0x0198(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FSlateBrush                                 SelectedBase;                                             // 0x0210(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FSlateBrush                                 SelectedHovered;                                          // 0x0288(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FSlateBrush                                 SelectedPressed;                                          // 0x0300(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FSlateBrush                                 Disabled;                                                 // 0x0378(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FMargin                                     ButtonPadding;                                            // 0x03F0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FMargin                                     CustomPadding;                                            // 0x0400(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	int                                                MinWidth;                                                 // 0x0410(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                MinHeight;                                                // 0x0414(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      NormalTextStyle;                                          // 0x0418(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      NormalHoveredTextStyle;                                   // 0x0420(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      SelectedTextStyle;                                        // 0x0428(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      SelectedHoveredTextStyle;                                 // 0x0430(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      DisabledTextStyle;                                        // 0x0438(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FSlateSound                                 PressedSlateSound;                                        // 0x0440(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FSlateSound                                 HoveredSlateSound;                                        // 0x0458(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
...
{
public:
	struct FScriptMulticastDelegate                    OnDoubleClicked;                                          // 0x03E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x40];                                      // 0x03F0(0x0040) MISSED OFFSET
	int                                                MinWidth;                                                 // 0x0430(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MinHeight;                                                // 0x0434(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bButtonEnabled;                                           // 0x0438(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bInteractionEnabled;                                      // 0x0439(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x26];                                      // 0x043A(0x0026) MISSED OFFSET
...
{
public:
	struct FScriptDelegate                             OnNavigationEvent;                                        // 0x0250(0x0010) (Edit, ZeroConstructor, InstancedReference)
...
{
public:
	struct FScriptMulticastDelegate                    OnLoadingStateChanged;                                    // 0x01C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x30];                                      // 0x01D8(0x0030) MISSED OFFSET
	class UCommonLoadGuard*                            LoadGuard;                                                // 0x0208(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FMargin                                     ThrobberPadding;                                          // 0x012C(0x0010) (Edit)
...
public:
	...
	struct FScriptMulticastDelegate                    OnRotated;                                                // 0x07C0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UCommonButton*                               ButtonLeft;                                               // 0x07D0(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UCommonButton*                               ButtonRight;                                              // 0x07D8(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UCommonTextBlock*                            MyText;                                                   // 0x07E0(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FMargin                                     Margin;                                                   // 0x00AC(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
...
public:
	...
	bool                                               bAllowInvisibleItemSelection;                             // 0x0308(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
...
{
public:
	bool                                               bShowForGamepad;                                          // 0x0270(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowForMouseAndKeyboard;                                 // 0x0271(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowForTouch;                                            // 0x0272(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowForPC;                                               // 0x0273(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowForMac;                                              // 0x0274(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowForPS4;                                              // 0x0275(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowForXBox;                                             // 0x0276(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowForIOS;                                              // 0x0277(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowForAndroid;                                          // 0x0278(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ESlateVisibility                                   VisibleType;                                              // 0x0279(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ESlateVisibility                                   HiddenType;                                               // 0x027A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FWidgetCarouselNavigationBarStyle           NavigationStyle;                                          // 0x0130(0x0728)
	unsigned char                                      UnknownData01[0x38];                                      // 0x0858(0x0038) MISSED OFFSET
...
public:
	...
	ECommonSwitcherTransition                          TransitionType;                                           // 0x0150(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ETransitionCurve                                   TransitionCurveType;                                      // 0x0151(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0152(0x0002) MISSED OFFSET
	float                                              TransitionDuration;                                       // 0x0154(0x0004) (Edit, ZeroConstructor, IsPlainOldData)

...
struct FTransform ATrap_Floor_Player_Jump_Pad_C::GetFireLocationAndRotation()
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Jump_Pad.Trap_Floor_Player_Jump_Pad_C.GetFireLocationAndRotation");

	ATrap_Floor_Player_Jump_Pad_C_GetFireLocationAndRotation_Params params;

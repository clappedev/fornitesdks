...
{
	bool                                               Show_Button;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function LegacyButtonIconText.LegacyButtonIconText_C.Set Alignment
struct ULegacyButtonIconText_C_Set_Alignment_Params
{
	TEnumAsByte<ETextJustify>                          Align;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct ULegacyButtonIconText_C_Set_Icon_Params
{
	...
	bool                                               RefreshPadding;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

...
// 0x21F0 (0x2220 - 0x0030)
class USocialListStyleDataAsset : public UDataAsset
{
public:
	struct FSocialListStyle                            Style;                                                    // 0x0030(0x21F0) (Edit)
...
public:
	...
	unsigned char                                      UnknownData00[0x5D60];                                    // 0x00C0(0x5D60) MISSED OFFSET

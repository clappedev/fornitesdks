...
public:
	...
	unsigned char                                      UnknownData04[0x40];                                      // 0x0160(0x0040) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x10];                                      // 0x01D8(0x0010) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x3];                                       // 0x0225(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0xF];                                       // 0x0239(0x000F) MISSED OFFSET
	bool                                               bSendProfileCommandRevisions;                             // 0x0248(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x47];                                      // 0x0249(0x0047) MISSED OFFSET

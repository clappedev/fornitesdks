...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemManagementItemTileButton.ItemManagementItemTileButton_C.OnClicked");

	UItemManagementItemTileButton_C_OnClicked_Params params;

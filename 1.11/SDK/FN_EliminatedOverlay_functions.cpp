...
{
	static auto fn = UObject::FindObject<UFunction>("Function EliminatedOverlay.EliminatedOverlay_C.AnySquadMembersStillAlive");

	UEliminatedOverlay_C_AnySquadMembersStillAlive_Params params;

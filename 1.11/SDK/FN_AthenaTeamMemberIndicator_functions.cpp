...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaTeamMemberIndicator.AthenaTeamMemberIndicator_C.On Team Player Names Changed");

	UAthenaTeamMemberIndicator_C_On_Team_Player_Names_Changed_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaTeamMemberIndicator.AthenaTeamMemberIndicator_C.CapturePlayerName");

	UAthenaTeamMemberIndicator_C_CapturePlayerName_Params params;

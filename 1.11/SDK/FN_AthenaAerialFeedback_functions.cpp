...
void UAthenaAerialFeedback_C::CustomEvent_2()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAerialFeedback.AthenaAerialFeedback_C.CustomEvent_2");

	UAthenaAerialFeedback_C_CustomEvent_2_Params params;
...
// Function AthenaAerialFeedback.AthenaAerialFeedback_C.CustomEvent_3
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EAthenaGamePhaseStep           GamePhaseStep                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UAthenaAerialFeedback_C::CustomEvent_3(EAthenaGamePhaseStep GamePhaseStep)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaAerialFeedback.AthenaAerialFeedback_C.CustomEvent_3");

	UAthenaAerialFeedback_C_CustomEvent_3_Params params;

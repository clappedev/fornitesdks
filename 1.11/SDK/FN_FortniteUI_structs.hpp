...
enum class EFortFrontEndFeatureStateReason : uint8_t
{
	...
	UnexpectedFeature              = 4,
	Invalid                        = 5,
	EFortFrontEndFeatureStateReason_MAX = 6
};
...
enum class EFortUIFeatureStateReason : uint8_t
{
	...
	UnexpectedFeature              = 5,
	Invalid                        = 6,
	EFortUIFeatureStateReason_MAX  = 7
};
...
{
	class UFortItemDefinition*                         ItemDef;                                                  // 0x0090(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
};
...
struct FFortHealthyGamingData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0040(0x0010) UNKNOWN PROPERTY: ArrayProperty FortniteUI.FortHealthyGamingData.RatingIcons
};

...
public:
	...
	unsigned char                                      UnknownData04[0x4A8];                                     // 0x0598(0x04A8) MISSED OFFSET
	TArray<class AGameplayAbilityTargetActor*>         SpawnedTargetActors;                                      // 0x0A40(0x0010) (ZeroConstructor)
	struct FGameplayAbilityRepAnimMontage              RepAnimMontageInfo;                                       // 0x0A50(0x0030) (Net)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0A80(0x0008) MISSED OFFSET
	struct FGameplayAbilityLocalAnimMontage            LocalAnimMontageInfo;                                     // 0x0A88(0x0030)
	unsigned char                                      UnknownData06[0x118];                                     // 0x0AB8(0x0118) MISSED OFFSET
	class AActor*                                      OwnerActor;                                               // 0x0BD0(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      AvatarActor;                                              // 0x0BD8(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x20];                                      // 0x0BE0(0x0020) MISSED OFFSET
	struct FActiveGameplayEffectsContainer             ActiveGameplayEffects;                                    // 0x0C00(0x04F0) (Net)
	struct FActiveGameplayCueContainer                 ActiveGameplayCues;                                       // 0x10F0(0x00D0) (Net)
	struct FActiveGameplayCueContainer                 MinimalReplicationGameplayCues;                           // 0x11C0(0x00D0) (Net)
	unsigned char                                      UnknownData08[0x180];                                     // 0x1290(0x0180) MISSED OFFSET
	TArray<unsigned char>                              BlockedAbilityBindings;                                   // 0x1410(0x0010) (Net, ZeroConstructor, Transient)
	unsigned char                                      UnknownData09[0x180];                                     // 0x1420(0x0180) MISSED OFFSET
	struct FMinimalReplicationTagCountMap              MinimalReplicationTags;                                   // 0x15A0(0x0060) (Net)
	unsigned char                                      UnknownData10[0x10];                                      // 0x1600(0x0010) MISSED OFFSET
	struct FReplicatedPredictionKeyMap                 ReplicatedPredictionKeyMap;                               // 0x1610(0x00C0) (Net)
...
public:
	...
	struct FSoftObjectPath                             GlobalCurveTableName;                                     // 0x0168(0x0018) (Config)
	struct FSoftObjectPath                             GlobalAttributeMetaDataTableName;                         // 0x0180(0x0018) (Config)
	struct FSoftObjectPath                             GlobalAttributeSetDefaultsTableName;                      // 0x0198(0x0018) (Config)
	TArray<struct FSoftObjectPath>                     GlobalAttributeSetDefaultsTableNames;                     // 0x01B0(0x0010) (ZeroConstructor, Config)
	struct FSoftObjectPath                             GlobalGameplayCueManagerClass;                            // 0x01C0(0x0018) (Config)
	struct FSoftObjectPath                             GlobalGameplayCueManagerName;                             // 0x01D8(0x0018) (Config)
	TArray<struct FString>                             GameplayCueNotifyPaths;                                   // 0x01F0(0x0010) (ZeroConstructor, Config)
	struct FSoftObjectPath                             GameplayTagResponseTableName;                             // 0x0200(0x0018) (Config)
	class UGameplayTagReponseTable*                    GameplayTagResponseTable;                                 // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               PredictTargetGameplayEffects;                             // 0x0220(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0221(0x0007) MISSED OFFSET
	class UCurveTable*                                 GlobalCurveTable;                                         // 0x0228(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UCurveTable*>                         GlobalAttributeDefaultsTables;                            // 0x0230(0x0010) (ZeroConstructor)
	class UDataTable*                                  GlobalAttributeMetaDataTable;                             // 0x0240(0x0008) (ZeroConstructor, IsPlainOldData)
	class UGameplayCueManager*                         GlobalGameplayCueManager;                                 // 0x0248(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0xF0];                                      // 0x0250(0x00F0) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData07[0xF];                                       // 0x05F1(0x000F) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x1B0];                                     // 0x01B0(0x01B0) MISSED OFFSET
	TArray<class UClass*>                              LoadedGameplayCueNotifyClasses;                           // 0x0360(0x0010) (ZeroConstructor, Transient)
	TArray<class UClass*>                              GameplayCueClassesForPreallocation;                       // 0x0370(0x0010) (ZeroConstructor, Transient)
	...
	unsigned char                                      UnknownData02[0x78];                                      // 0x03A8(0x0078) MISSED OFFSET
...
{
public:
	bool                                               bAutoDestroyOnRemove;                                     // 0x0368(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0369(0x0003) MISSED OFFSET
	float                                              AutoDestroyDelay;                                         // 0x036C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfTimelineIsStillRunning;                             // 0x0370(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfLatentActionIsStillRunning;                         // 0x0371(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x0372(0x0006) MISSED OFFSET
	struct FGameplayTag                                GameplayCueTag;                                           // 0x0378(0x0008) (Edit, DisableEditOnInstance)
	struct FGameplayTagReferenceHelper                 ReferenceHelper;                                          // 0x0380(0x0040) (Edit)
	struct FName                                       GameplayCueName;                                          // 0x03C0(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bAutoAttachToOwner;                                       // 0x03C8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsOverride;                                               // 0x03C9(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerInstigator;                             // 0x03CA(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerSourceObject;                           // 0x03CB(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleOnActiveEvents;                             // 0x03CC(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleWhileActiveEvents;                          // 0x03CD(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x03CE(0x0002) MISSED OFFSET
	int                                                NumPreallocatedInstances;                                 // 0x03D0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3C];                                      // 0x03D4(0x003C) MISSED OFFSET
...
public:
	...
	class UAbilitySystemComponent*                     AbilitySystemComponent;                                   // 0x0408(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	bool                                               ShouldProduceTargetDataOnServer;                          // 0x0368(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0369(0x0007) MISSED OFFSET
	struct FGameplayAbilityTargetingLocationInfo       StartLocation;                                            // 0x0370(0x0070) (BlueprintVisible, BlueprintReadOnly, Net)
	...
	class UGameplayAbility*                            OwningAbility;                                            // 0x04C8(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bDestroyOnConfirmation;                                   // 0x04D0(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x04D1(0x0007) MISSED OFFSET
	class AActor*                                      SourceActor;                                              // 0x04D8(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	struct FWorldReticleParameters                     ReticleParams;                                            // 0x04E0(0x000C) (BlueprintVisible)
	unsigned char                                      UnknownData03[0x4];                                       // 0x04EC(0x0004) MISSED OFFSET
	class UClass*                                      ReticleClass;                                             // 0x04F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGameplayTargetDataFilterHandle             Filter;                                                   // 0x04F8(0x0010) (BlueprintVisible, Net)
	bool                                               bDebug;                                                   // 0x0508(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x17];                                      // 0x0509(0x0017) MISSED OFFSET
	class UAbilitySystemComponent*                     GenericDelegateBoundASC;                                  // 0x0520(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FCollisionProfileName                       TraceProfile;                                             // 0x0530(0x0008) (Edit, BlueprintVisible, Config)
	bool                                               bTraceAffectsAimPitch;                                    // 0x0538(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x0539(0x0017) MISSED OFFSET
...
{
public:
	class UMaterialInterface*                          PlacedActorMaterial;                                      // 0x0570(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FWorldReticleParameters                     Parameters;                                               // 0x0368(0x000C) (Edit, BlueprintVisible, DisableEditOnTemplate)
	bool                                               bFaceOwnerFlat;                                           // 0x0374(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSnapToTargetedActor;                                     // 0x0375(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetValid;                                           // 0x0376(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetAnActor;                                         // 0x0377(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class APlayerController*                           MasterPC;                                                 // 0x0378(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AActor*                                      TargetingActor;                                           // 0x0380(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCapsuleComponent*                           CollisionComponent;                                       // 0x0388(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<class UActorComponent*>                     VisualizationComponents;                                  // 0x0390(0x0010) (ExportObject, ZeroConstructor)

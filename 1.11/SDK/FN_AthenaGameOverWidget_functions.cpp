...
void UAthenaGameOverWidget_C::AddTeamMemberIndicator(class AFortPlayerStateAthena* Player_State, int Team_Member_Index)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaGameOverWidget.AthenaGameOverWidget_C.AddTeamMemberIndicator");

	UAthenaGameOverWidget_C_AddTeamMemberIndicator_Params params;

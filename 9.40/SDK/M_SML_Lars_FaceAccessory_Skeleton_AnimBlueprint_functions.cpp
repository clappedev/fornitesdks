...
{
	static auto Func = Class->GetFunction("M_SML_Lars_FaceAccessory_Skeleton_AnimBlueprint_C", "AnimGraph");
...
{
	static auto Func = Class->GetFunction("M_SML_Lars_FaceAccessory_Skeleton_AnimBlueprint_C", "ExecuteUbergraph_M_SML_Lars_FaceAccessory_Skeleton_AnimBlueprint");

...
void AB_Prj_Athena_StickyGrenade_C::HandleHitVehicle(class UObject* Object, class UPrimitiveComponent* Component, class ABuildingWall* LocalWall, UInterfaceProperty_ K2Node_DynamicCast_AsFort_Vehicle_Interface, bool K2Node_DynamicCast_bSuccess)
{
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_StickyGrenade_C", "PlayerDiedEvent");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_StickyGrenade_C", "AIDiedEvent");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_StickyGrenade_C", "BindToPlayerOrAIDeath");

	Params::AB_Prj_Athena_StickyGrenade_C_BindToPlayerOrAIDeath_Params Parms;

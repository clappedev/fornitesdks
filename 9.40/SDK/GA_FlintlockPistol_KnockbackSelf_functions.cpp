...
{
	static auto Func = Class->GetFunction("GA_FlintlockPistol_KnockbackSelf_C", "K2_ActivateAbility");

	Params::UGA_FlintlockPistol_KnockbackSelf_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_FlintlockPistol_KnockbackSelf_C", "CheckVel");

	Params::UGA_FlintlockPistol_KnockbackSelf_C_CheckVel_Params Parms;
...
void UGA_FlintlockPistol_KnockbackSelf_C::ExecuteUbergraph_GA_FlintlockPistol_KnockbackSelf(int32 EntryPoint, class AActor* CallFunc_GetAvatarActorFromActorInfo_ReturnValue, class AFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, const struct FVector& CallFunc_GetVelocity_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, float CallFunc_Abs_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue)
{
	static auto Func = Class->GetFunction("GA_FlintlockPistol_KnockbackSelf_C", "ExecuteUbergraph_GA_FlintlockPistol_KnockbackSelf");

	Params::UGA_FlintlockPistol_KnockbackSelf_C_ExecuteUbergraph_GA_FlintlockPistol_KnockbackSelf_Params Parms;

...
{
	static auto Func = Class->GetFunction("BP_Fortnite_CommanderLights_C", "SetVisiblityofDetailSpecificMeshes");
...
{
	static auto Func = Class->GetFunction("BP_Fortnite_CommanderLights_C", "SetVisiblityofSceneLighting");
...
{
	static auto Func = Class->GetFunction("BP_Fortnite_CommanderLights_C", "UserConstructionScript");

	Params::ABP_Fortnite_CommanderLights_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Fortnite_CommanderLights_C", "DisableLobbySetLighting");

	Params::ABP_Fortnite_CommanderLights_C_DisableLobbySetLighting_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Fortnite_CommanderLights_C", "UpdateSettings");

	Params::ABP_Fortnite_CommanderLights_C_UpdateSettings_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Fortnite_CommanderLights_C", "EnableLobbySetLighting");

	Params::ABP_Fortnite_CommanderLights_C_EnableLobbySetLighting_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Fortnite_CommanderLights_C", "ReceiveBeginPlay");

	Params::ABP_Fortnite_CommanderLights_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Fortnite_CommanderLights_C", "ExecuteUbergraph_BP_Fortnite_CommanderLights");

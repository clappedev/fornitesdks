...
void UFortnite_M_Avg_Player_MenusScreen_AnimBP_C::AnimGraph(struct FPoseLink* AnimGraph)
{
	static auto Func = Class->GetFunction("Fortnite_M_Avg_Player_MenusScreen_AnimBP_C", "AnimGraph");

	Params::UFortnite_M_Avg_Player_MenusScreen_AnimBP_C_AnimGraph_Params Parms;

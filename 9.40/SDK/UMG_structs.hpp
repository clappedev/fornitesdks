...
{
public:
	uint8                                        Pad_10A2[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10A3[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_10A6[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_10A7[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_10A8[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Shear;                                             // 0x368(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_10A9[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_10AD[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

...
{
	static auto Func = Class->GetFunction("UIManager_C", "Deprecated_RemoveModalPanel");
...
{
	static auto Func = Class->GetFunction("UIManager_C", "Deprecated_PopModalPanel");
...
{
	static auto Func = Class->GetFunction("UIManager_C", "Deprecated_ShowNextModalWidget");
...
{
	static auto Func = Class->GetFunction("UIManager_C", "Deprecated_QueueModalPanel");
...
{
	static auto Func = Class->GetFunction("UIManager_C", "Deprecated_PopCurrentModal");

	Params::UUIManager_C_Deprecated_PopCurrentModal_Params Parms;
...
{
	static auto Func = Class->GetFunction("UIManager_C", "OnModalQueueEmptied");

	Params::UUIManager_C_OnModalQueueEmptied_Params Parms;

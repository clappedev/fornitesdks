...
struct ABP_CreativeDeimosRift_C_BP_Cosmetic_RampUp_Params
{
public:
};
...
struct ABP_CreativeDeimosRift_C_BP_Cosmetic_Intro_Params
{
public:
};
...
struct ABP_CreativeDeimosRift_C_BP_Cosmetic_Idle_Params
{
public:
};
...
struct ABP_CreativeDeimosRift_C_ReceiveBeginPlay_Params
{
public:
};
...
struct ABP_CreativeDeimosRift_C_BP_Cosmetic_ShouldDie_Params
{
public:
};
...
struct ABP_CreativeDeimosRift_C_OnBuildingRiftSpawnedAI_Bind_Params
{
public:
};
...
struct ABP_CreativeDeimosRift_C_TestDynamicRiftSpawn_Params
{
public:
};
...
struct ABP_CreativeDeimosRift_C_SpawnEffects_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_4D07[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext_1;                      // 0x370(0x18)()

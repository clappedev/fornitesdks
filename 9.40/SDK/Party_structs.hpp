...
public:
	...
	uint8                                        Pad_143A[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_143B[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class USocialChatChannel*>            ListenChannels;                                    // 0x18(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_143C[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_143E[0x35];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_143F[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

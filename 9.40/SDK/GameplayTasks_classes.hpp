...
{
public:
	uint8                                        Pad_15B7[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        : 1;                                               // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        bIsNetDirty : 1;                                   // Mask : 0x2 0xE4(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_15B9[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15BB[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_15BC[0x25];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15C3[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]

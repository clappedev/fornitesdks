...
{
	static auto Func = Class->GetFunction("LandscapeBlueprintCustomBrush", "RequestLandscapeUpdate");

	Params::ALandscapeBlueprintCustomBrush_RequestLandscapeUpdate_Params Parms;

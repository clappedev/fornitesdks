...
{
	static auto Func = Class->GetFunction("SK_ChillBronco_AnimBP_C", "AnimGraph");
...
{
	static auto Func = Class->GetFunction("SK_ChillBronco_AnimBP_C", "ExecuteUbergraph_SK_ChillBronco_AnimBP");

...
{
	static auto Func = Class->GetFunction("GC_Husk_Slow_C", "OnRemove");
...
{
	static auto Func = Class->GetFunction("GC_Husk_Slow_C", "StopCuffLock");

	Params::AGC_Husk_Slow_C_StopCuffLock_Params Parms;

...
public:
	...
	uint8                                        Pad_3220[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3223[0x24];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3231[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3232[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3236[0x1F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3237[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3238[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]

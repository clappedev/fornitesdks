...
{
	static auto Func = Class->GetFunction("GA_Athena_TNT_WithTrajectory_C", "InitTrajectoryVariables");

	Params::UGA_Athena_TNT_WithTrajectory_C_InitTrajectoryVariables_Params Parms;

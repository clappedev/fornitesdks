...
public:
	...
	uint8                                        Pad_4C87[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEffectSpecHandle             CallFunc_SetupGE_Effect_Out;                       // 0x1C0(0x10)()
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x248(0x28)()

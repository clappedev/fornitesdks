...
{
	static auto Func = Class->GetFunction("AthenaDirectAcquisitionOfferUndoOverlay_C", "OnInitialized");

	Params::UAthenaDirectAcquisitionOfferUndoOverlay_C_OnInitialized_Params Parms;

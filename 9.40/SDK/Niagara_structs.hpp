...
public:
	...
	uint8                                        Pad_11B6[0x1E0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_11C6[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11D2[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UObject*>                       RootObjects;                                       // 0x8(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_11D3[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11D4[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11D8[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

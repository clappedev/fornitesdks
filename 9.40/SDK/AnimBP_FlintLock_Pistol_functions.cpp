...
void UAnimBP_FlintLock_Pistol_C::AnimGraph(struct FPoseLink* AnimGraph)
{
	static auto Func = Class->GetFunction("AnimBP_FlintLock_Pistol_C", "AnimGraph");

	Params::UAnimBP_FlintLock_Pistol_C_AnimGraph_Params Parms;

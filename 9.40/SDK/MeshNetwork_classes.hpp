...
public:
	...
	uint8                                        Pad_D44[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D4A[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D4B[0x54];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D4C[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]

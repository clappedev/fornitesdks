...
public:
	...
	struct FPlaylistFrontEndData                 RepresentedPlaylist;                               // 0xD48(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	int32                                        NumTilesInRow;                                     // 0xD70(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4EA6[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTimerHandle                          CountdownTimer;                                    // 0xD78(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

...
public:
	...
	uint8                                        Pad_4926[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FAnimNode_Root                        AnimGraphNode_Root_3C1BB7DE4FD6FF67836FAE9ACCF37460; // 0x878(0x30)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_C7700CCB48C6B72B53BABDB1A8E11F3F; // 0x8A8(0x108)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_2E06B5DB4589D39F49B61FB14C0B1BFB; // 0x9B0(0x108)()
	struct FRotator                              SocketUpVector;                                    // 0xAB8(0xC)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4927[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ACharacter*                            Character;                                         // 0xAC8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AFortPlayerPawnAthena*                 Player_pawn;                                       // 0xAD0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        Pawn_speed_alpha;                                  // 0xAD8(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               backpack_position;                                 // 0xADC(0xC)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABGA_Athena_Balloons_C*                BGA_Athena_Balloons;                               // 0xAE8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              backpack_rotation;                                 // 0xAF0(0xC)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)

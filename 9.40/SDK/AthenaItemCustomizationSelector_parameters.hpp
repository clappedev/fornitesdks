...
public:
	...
	uint8                                        Pad_5A12[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5A1A[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetVariantUnlockRequirement_ReturnValue;  // 0xF8(0x18)()
	...
	uint8                                        Pad_5A23[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]

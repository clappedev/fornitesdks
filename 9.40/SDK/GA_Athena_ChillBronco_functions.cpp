...
{
	static auto Func = Class->GetFunction("GA_Athena_ChillBronco_C", "SpawnThrownProjectile");
...
{
	static auto Func = Class->GetFunction("GA_Athena_ChillBronco_C", "OnProjectileSpawned");
...
{
	static auto Func = Class->GetFunction("GA_Athena_ChillBronco_C", "ExecuteUbergraph_GA_Athena_ChillBronco");

...
public:
	...
	class FText                                  K2Node_Select_Default_1;                           // 0x2E0(0x18)()
	class FText                                  CallFunc_TextToUpper_ReturnValue_1;                // 0x2F8(0x18)()
	...
	class FText                                  CallFunc_Format_ReturnValue_1;                     // 0x420(0x18)()
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array_2;                          // 0x438(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue_2;                     // 0x448(0x18)()
};

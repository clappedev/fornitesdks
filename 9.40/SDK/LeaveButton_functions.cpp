...
{
	static auto Func = Class->GetFunction("LeaveButton_C", "PerformLeave");

	Params::ULeaveButton_C_PerformLeave_Params Parms;
...
{
	static auto Func = Class->GetFunction("LeaveButton_C", "LeaveDialogCancelled__DelegateSignature");

	Params::ULeaveButton_C_LeaveDialogCancelled__DelegateSignature_Params Parms;

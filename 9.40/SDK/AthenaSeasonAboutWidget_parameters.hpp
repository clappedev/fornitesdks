...
public:
	...
	uint8                                        Pad_5F0C[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_1;            // 0xA4(0x10)(ZeroConstructor, NoDestructor)
	...
	class UFortGlobalUIContext*                  CallFunc_GetContext_ReturnValue_1;                 // 0xE8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_HandlePageRight_bPassThrough;             // 0xF0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_HandlePageLeft_bPassThrough;              // 0xF1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5F12[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_IsUsingTouch_ReturnValue;                 // 0x100(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)

...
public:
	...
	struct FGameplayTag                          SnowmanCue;                                        // 0x9F8(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

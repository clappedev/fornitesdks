...
public:
	...
	struct FSolarisPrototype                     K2Node_MakeStruct_SolarisPrototype;                // 0x30(0x58)()
};
...
public:
	...
	uint8                                        Pad_4CE0[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4CEA[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AFortMinigame*                         CallFunc_GetCurrentMinigame_Minigame;              // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	uint8                                        Pad_4CED[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4CF0[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]

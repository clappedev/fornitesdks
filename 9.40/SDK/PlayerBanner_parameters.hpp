...
public:
	...
	struct FFortAthenaLoadout                    CallFunc_GetLoadoutForPlayer_ReturnValue;          // 0x18(0xF0)()
	...
	class FName                                  CallFunc_Conv_StringToName_ReturnValue_1;          // 0x114(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1[0x4];                                        // Fixing Size After Last Property  [ Dumper-7 ]
	struct FFortHomeBaseInfo                     CallFunc_GetHomeBaseInfoForPlayer_Result;          // 0x120(0x40)()
	bool                                         CallFunc_SetBannerImage_Success;                   // 0x160(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	uint8                                        Pad_9[0x3];                                        // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B[0x5];                                        // Fixing Size After Last Property  [ Dumper-7 ]

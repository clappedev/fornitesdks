...
// UInterfaceProperty_                CallFunc_SetBrushFromAtlasInterface_AtlasRegion5_CastInput       (ZeroConstructor, IsPlainOldData, NoDestructor)

void UTouchLookStick_C::SetBrushForStatus(bool InBuild_or_Edit_Mode, bool Is_RC_Pawn, bool* Found_Context, bool CallFunc_CheckForTag_HasTag, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion_CastInput, class UFortAbilitySystemContext* CallFunc_GetContext_ReturnValue, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion1_CastInput, bool CallFunc_HasMatchingGameplayTag_ReturnValue, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion2_CastInput, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion3_CastInput, bool CallFunc_CheckForTag_HasTag1, bool CallFunc_CheckForTag_HasTag2, bool CallFunc_BooleanOR_ReturnValue, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion4_CastInput, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion5_CastInput)
{
	...
	Parms.CallFunc_SetBrushFromAtlasInterface_AtlasRegion5_CastInput = CallFunc_SetBrushFromAtlasInterface_AtlasRegion5_CastInput;

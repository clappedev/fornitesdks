...
public:
	...
	enum class EFortShowdownMatchType            Temp_byte_Variable;                                // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class EFortShowdownEventState           Temp_byte_Variable1;                               // 0xD0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class EFortShowdownMatchType            CallFunc_GetTournamentMatchType_ReturnValue;       // 0x168(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3457[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class FString>                        CallFunc_ParseIntoArray_ReturnValue;               // 0x170(0x10)(ZeroConstructor, ReferenceParm)
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue;            // 0x1C0(0x18)()
	class FText                                  CallFunc_Conv_StringToText_ReturnValue1;           // 0x1D8(0x18)()
	class FText                                  CallFunc_TextToUpper_ReturnValue1;                 // 0x1F0(0x18)()
	class FText                                  CallFunc_TextToUpper_ReturnValue2;                 // 0x208(0x18)()
	...
	struct FTimespan                             CallFunc_GetTournamentTimeLeft_ReturnValue;        // 0x228(0x8)(NoDestructor, HasGetValueTypeHash)
	enum class EFortShowdownEventState           CallFunc_GetTournamentState_ReturnValue;           // 0x230(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3459[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_BreakTimespan_Days;                       // 0x234(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_BreakTimespan_Hours;                      // 0x238(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_BreakTimespan_Minutes;                    // 0x23C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_BreakTimespan_Seconds;                    // 0x240(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_BreakTimespan_Milliseconds;               // 0x244(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array;                            // 0x290(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  K2Node_Select1_Default;                            // 0x2A0(0x18)()
	class FText                                  K2Node_Select2_Default;                            // 0x2B8(0x18)()
	class FText                                  K2Node_Select3_Default;                            // 0x2D0(0x18)()
	class FText                                  CallFunc_Format_ReturnValue;                       // 0x2E8(0x18)()
	class FString                                CallFunc_GetTournamentId_ReturnValue;              // 0x300(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_TextToUpper_ReturnValue3;                 // 0x310(0x18)()
};

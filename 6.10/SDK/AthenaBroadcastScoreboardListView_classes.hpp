...
public:
	...
	void ResetFocus(class UAthenaSpectatorScoreboardRowData* RowToSelect, class UCommonInputSubsystem* CallFunc_GetContext_ReturnValue, int32 CallFunc_GetIndexForItem_ReturnValue, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, int32 CallFunc_SelectInt_ReturnValue);

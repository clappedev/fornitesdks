...
public:
	...
	class FString                                CallFunc_PopNextPendingFeatureUnlock_ReturnValue;  // 0x28(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class UFeatureUnlockScreen_C*                K2Node_DynamicCast_AsFeature_Unlock_Screen;        // 0x38(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x40(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsInViewport_ReturnValue;                 // 0x41(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

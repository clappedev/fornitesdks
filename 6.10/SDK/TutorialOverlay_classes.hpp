...
public:
	...
	class UAnnouncement_Tutorial_C*              Announcement_Tutorial;                             // 0x310(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

...
public:
	...
	float                                        Animate_Ninja_ShadowStance_Dissolve_Inverse_Translucent_Shader_Opacity_E17701694932393A7CEF57869B1CE50B; // 0x428(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        Animate_Ninja_ShadowStance_Dissolve_NinjaDissolve_E17701694932393A7CEF57869B1CE50B; // 0x42C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETimelineDirection                Animate_Ninja_ShadowStance_Dissolve__Direction_E17701694932393A7CEF57869B1CE50B; // 0x430(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GC_Perk_Ninja_ShadowStance_Active_C");
		return Clss;
	}

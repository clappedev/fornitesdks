...
public:
	...
	class UCommonTextBlock*                      Notification;                                      // 0x230(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	float                                        TimeToDisplay;                                     // 0x238(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        FadeInterpSpeed;                                   // 0x23C(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         IsFading;                                          // 0x240(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3D9A[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        RemainingTime;                                     // 0x244(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  FullyVisible;                                      // 0x248(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  FullyHidden;                                       // 0x260(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  GameOnly;                                          // 0x278(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  ReplayOnly;                                        // 0x290(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	enum class ESlateVisibility                  PendingVisibility;                                 // 0x2A8(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
{
public:
	uint8                                        Pad_14C3[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14C7[0x29B];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14C9[0x2F0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14CA[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14CB[0x34];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14CC[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]

...
public:
	...
	uint8                                        Pad_2D28[0x64];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2D30[0x51];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D33[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2D36[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2D37[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D39[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D3B[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UPhysicalMaterial*>             CookedPhysicalMaterials;                           // 0x5F0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_2D3C[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D3D[0x54];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TSet<class ALandscapeStreamingProxy*>        Proxies;                                           // 0xC0(0x50)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_2D3E[0xF0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2D3F[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D42[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	//struct FGuid                               LandscapeGuid;                                     // 0x5F8(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_2D47[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D4D[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FExpressionInput                      LayerNotUsed;                                      // 0x58(0x10)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_2D4E[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        PreviewUsed : 1;                                   // Mask : 0x1 0x78(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2D50[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]

...
public:
	...
	uint8                                        Pad_1474[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1475[0x338];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	//class UReplicationGraphNode_GridSpatialization2D* GridNode;                                          // 0x3E8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UReplicationGraphNode_ActorList*       AlwaysRelevantNode;                                // 0x3F0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FConnectionAlwaysRelevantNodePair> AlwaysRelevantForConnectionList;                   // 0x3F8(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class AActor*>                        ActorsWithoutNetConnection;                        // 0x408(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_1477[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1478[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1479[0xE8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_147A[0x98];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_147B[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_147C[0x58];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_147D[0x1E0];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1480[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1481[0x140];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1483[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]

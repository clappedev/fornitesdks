...
public:
	...
	enum class EFortShowdownEventState           Temp_byte_Variable;                                // 0x98(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        Temp_int_Variable4;                                // 0xAC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        Temp_int_Variable7;                                // 0xB8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EFortShowdownEventState           CallFunc_GetEventState_ReturnValue;                // 0xBC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  Temp_text_Variable6;                               // 0x170(0x18)()
	...
	class FText                                  Temp_text_Variable7;                               // 0x1C8(0x18)()
	enum class EFortShowdownEventState           Temp_byte_Variable1;                               // 0x1E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4CB1[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_Select1_Default;                            // 0x1E8(0x18)()
	class FText                                  CallFunc_TextToUpper_ReturnValue1;                 // 0x200(0x18)()
};

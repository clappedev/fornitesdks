...
// Parameters:
// class UItemManagementModeDetailsPanel_C*K2Node_DynamicCast_AsItem_Management_Mode_Details_Panel          (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_EqualEqual_ByteByte_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor)

void UItemManagementScreen_C::HandleDifferentModeSet(class UItemManagementModeDetailsPanel_C* K2Node_DynamicCast_AsItem_Management_Mode_Details_Panel, bool K2Node_DynamicCast_bSuccess, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static auto Func = Class->GetFunction("ItemManagementScreen_C", "HandleDifferentModeSet");

	Params::UItemManagementScreen_C_HandleDifferentModeSet_Params Parms;
	Parms.K2Node_DynamicCast_AsItem_Management_Mode_Details_Panel = K2Node_DynamicCast_AsItem_Management_Mode_Details_Panel;

...
public:
	...
	struct FAnimNode_Root                        AnimGraphNode_Root_1205956746F4C2F910A7F697B79629BF; // 0x458(0x40)()
	struct FAnimNode_CopyPoseFromMesh            AnimGraphNode_CopyPoseFromMesh_1F1787404E7008182EF87F809FB4795C; // 0x498(0xF0)(ContainsInstancedReference)
	class USkeletalMeshComponent*                MeshToCopy;                                        // 0x588(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

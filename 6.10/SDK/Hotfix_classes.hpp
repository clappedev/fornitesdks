...
{
public:
	uint8                                        Pad_D0A[0x1C8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D0B[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D0E[0x2E];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D10[0x17];                                     // Fixing Size After Last Property  [ Dumper-7 ]

...
{
	static auto Func = Class->GetFunction("GA_SpookyMist_Travel_C", "CheckIfTraveling");

	Params::UGA_SpookyMist_Travel_C_CheckIfTraveling_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_SpookyMist_Travel_C", "DestroyIfOverlapping");

	Params::UGA_SpookyMist_Travel_C_DestroyIfOverlapping_Params Parms;

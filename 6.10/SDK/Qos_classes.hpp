...
{
public:
	uint8                                        Pad_121C[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_121E[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1220[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1223[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]

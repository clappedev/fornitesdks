...
{
	static auto Func = Class->GetFunction("AthenaEventMatchInfoScreen_C", "ToggleScoreboardGroupByTeam");

	Params::UAthenaEventMatchInfoScreen_C_ToggleScoreboardGroupByTeam_Params Parms;

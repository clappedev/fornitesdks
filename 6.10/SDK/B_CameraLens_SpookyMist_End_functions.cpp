...
{
	static auto Func = Class->GetFunction("B_CameraLens_SpookyMist_End_C", "UserConstructionScript");

	Params::AB_CameraLens_SpookyMist_End_C_UserConstructionScript_Params Parms;

...
public:
	...
	class UItemWindow_C*                         Recycle_Info_Window;                               // 0x358(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void SetScrollFocus(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue);

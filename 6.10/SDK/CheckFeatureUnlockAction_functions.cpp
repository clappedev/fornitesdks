...
{
	static auto Func = Class->GetFunction("CheckFeatureUnlockAction_C", "UserConstructionScript");

	Params::ACheckFeatureUnlockAction_C_UserConstructionScript_Params Parms;

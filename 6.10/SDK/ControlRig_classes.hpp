...
{
public:
	uint8                                        Pad_C[0x14];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E[0x40];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_10[0xF];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12[0x8];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13[0x6];                                       // Fixing Size After Last Property  [ Dumper-7 ]

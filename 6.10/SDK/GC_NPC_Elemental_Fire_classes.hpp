...
public:
	...
	class UParticleSystemComponent*              P_FireElemental_Ambient_AuxillaryObjs;             // 0x3A0(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UParticleSystemComponent*              Fire_Elemental_HeadFire;                           // 0x3A8(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UParticleSystemComponent*              Fire_Elemental_FX;                                 // 0x3B0(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	TMap<class FName, struct FLinearColor>       MiniBoss_Vectors;                                  // 0x3E0(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)

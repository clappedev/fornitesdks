...
void UPickupMessageItem_C::Setup(class UFortItem* Picked_Up_Item, class FText CallFunc_GetDisplayName_ReturnValue, TSoftObjectPtr<class UTexture2D> CallFunc_GetSmallPreviewImage_ReturnValue)
{

...
public:
	...
	struct FTextBlockStyle                       MarkupTextStyle;                                   // 0x278(0x1E0)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                           MarkupBackground;                                  // 0x458(0x88)(Edit, NativeAccessSpecifierPublic)
	struct FSlateColor                           ButtonColor;                                       // 0x4E0(0x28)(Edit, NativeAccessSpecifierPublic)
	struct FSlateColor                           ButtonHoverColor;                                  // 0x508(0x28)(Edit, NativeAccessSpecifierPublic)
	struct FSlateColor                           TipColor;                                          // 0x530(0x28)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                           SeperatorBrush;                                    // 0x558(0x88)(Edit, NativeAccessSpecifierPublic)
	float                                        SeperatorThickness;                                // 0x5E0(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMargin                               MarkupPadding;                                     // 0x5E4(0x10)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                               ButtonPadding;                                     // 0x5F4(0x10)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FMargin                               ChatEntryPadding;                                  // 0x1290(0x10)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FMargin                               FriendActionPadding;                               // 0x1330(0x10)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                               FriendActionHeaderPadding;                         // 0x1340(0x10)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                               FriendActionStatusMargin;                          // 0x1350(0x10)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FLinearColor                          DefaultFontColor;                                  // 0x1E0(0x10)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                          InvertedFontColor;                                 // 0x1F0(0x10)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                          DefaultDullFontColor;                              // 0x200(0x10)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_2F27[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FChatMarkupStyle                      ChatMarkupStyle;                                   // 0x6080(0x608)(Edit, NativeAccessSpecifierPublic)
	struct FSocialSoundSchema                    SoundSchema;                                       // 0x6688(0x48)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};

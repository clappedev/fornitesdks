...
// Function ItemManagementMulchModeBox.ItemManagementMulchModeBox_C.SetScrollFocus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UFortUINavigationManager*    CallFunc_GetUINavigationManager_ReturnValue                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UItemManagementMulchModeBox_C::SetScrollFocus(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
	static auto Func = Class->GetFunction("ItemManagementMulchModeBox_C", "SetScrollFocus");

	Params::UItemManagementMulchModeBox_C_SetScrollFocus_Params Parms;

...
public:
	...
	uint8                                        Pad_5369[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector2D                             MinMaxValue;                                       // 0x29C(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_536A[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  ValuePrefixText;                                   // 0x2A8(0x18)(Edit, BlueprintVisible)
	class FText                                  ValueSuffixText;                                   // 0x2C0(0x18)(Edit, BlueprintVisible)
	bool                                         MouseDragUpdates;                                  // 0x2D8(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_536B[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class USoundBase*                            SliderSound;                                       // 0x2E0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

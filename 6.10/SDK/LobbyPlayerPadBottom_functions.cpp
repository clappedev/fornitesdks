...
int32 ULobbyPlayerPadBottom_C::GetBonusXPValue(class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class UFortSeasonalEventManager* CallFunc_GetSeasonalEventManager_ReturnValue, int32 CallFunc_GetBRXPBonusPoints_ReturnValue)
{

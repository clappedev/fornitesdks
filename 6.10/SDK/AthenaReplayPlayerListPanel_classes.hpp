...
public:
	...
	class UAthenaReplayPlayerListListView_C*     FortReplayPlayerListListView;                      // 0x348(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FDataTableRowHandle                   ShowPlayerProfileInput;                            // 0x350(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

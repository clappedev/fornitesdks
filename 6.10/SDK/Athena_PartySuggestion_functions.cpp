...
void UAthena_PartySuggestion_C::OnRadialPickerStatusChanged(bool Opened)
{
	static auto Func = Class->GetFunction("Athena_PartySuggestion_C", "OnRadialPickerStatusChanged");

	Params::UAthena_PartySuggestion_C_OnRadialPickerStatusChanged_Params Parms;
	Parms.Opened = Opened;

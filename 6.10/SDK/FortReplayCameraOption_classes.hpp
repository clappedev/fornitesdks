...
public:
	...
	enum class ESpectatorCameraType              CameraType;                                        // 0xC18(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)

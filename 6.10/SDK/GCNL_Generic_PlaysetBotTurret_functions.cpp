...
{
	static auto Func = Class->GetFunction("GCNL_Generic_PlaysetBotTurret_C", "OnActive");
...
{
	static auto Func = Class->GetFunction("GCNL_Generic_PlaysetBotTurret_C", "OnRemove");
...
{
	static auto Func = Class->GetFunction("GCNL_Generic_PlaysetBotTurret_C", "UserConstructionScript");

	Params::AGCNL_Generic_PlaysetBotTurret_C_UserConstructionScript_Params Parms;

...
{
	static auto Func = Class->GetFunction("GCL_TNT_Fuse_Cook_C", "UserConstructionScript");

	Params::AGCL_TNT_Fuse_Cook_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_TNT_Fuse_Cook_C", "ReceiveBeginPlay");

	Params::AGCL_TNT_Fuse_Cook_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_TNT_Fuse_Cook_C", "ModulateFuseSound");

	Params::AGCL_TNT_Fuse_Cook_C_ModulateFuseSound_Params Parms;

...
// class UCommonUISubsystem*          CallFunc_GetContext_ReturnValue8                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UNews_C*                     CallFunc_Create_ReturnValue4                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class ESlateVisibility        K2Node_Select3_Default                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UPermissionsRoot_C*          CallFunc_Create_ReturnValue5                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ULegalInfo_C*                CallFunc_Create_ReturnValue6                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UOptionsMenu_C*              CallFunc_Create_ReturnValue7                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UMessageCenterWidget_C*      CallFunc_Create_ReturnValue8                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UMainMenu_C::InitializeMainMenu(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, int32 Temp_int_Array_Index_Variable, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UAthenaChallengesTab_C* CallFunc_Create_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue1, enum class ESlateVisibility Temp_byte_Variable2, bool CallFunc_AllowLogout_ReturnValue, bool CallFunc_IsInAthena_ReturnValue, enum class ESlateVisibility Temp_byte_Variable3, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, class UTeamSelectWidget_C* CallFunc_Create_ReturnValue1, enum class ESlateVisibility Temp_byte_Variable4, bool Temp_bool_Variable1, enum class ESlateVisibility K2Node_Select1_Default, TArray<class UIconTextButton_C*>& K2Node_MakeArray_Array, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, class UIconTextButton_C* CallFunc_Array_Get_Item, class UPrivacyWidget_C* CallFunc_Create_ReturnValue2, int32 CallFunc_Array_Length_ReturnValue, bool Temp_bool_Variable2, int32 Temp_int_Loop_Counter_Variable, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue3, class UShowFriendCodesSelection_C* CallFunc_Create_ReturnValue3, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_IsOutpostOwner_OutpostOwner, bool CallFunc_IsInZone_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue, class UFortUIDataConfigurationContext* CallFunc_GetContext_ReturnValue3, bool CallFunc_ArePartyFeaturesEnabled_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue4, bool CallFunc_AllowQuit_ReturnValue, bool CallFunc_IsInZone_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable5, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, enum class ESlateVisibility Temp_byte_Variable6, bool Temp_bool_Variable3, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue5, bool CallFunc_IsInZone_ReturnValue3, enum class ESlateVisibility K2Node_Select2_Default, bool CallFunc_BooleanAND_ReturnValue1, enum class ESlateVisibility Temp_byte_Variable7, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue4, class UNews_C* CallFunc_Create_ReturnValue4, enum class ESlateVisibility K2Node_Select3_Default, class UPermissionsRoot_C* CallFunc_Create_ReturnValue5, class ULegalInfo_C* CallFunc_Create_ReturnValue6, class UOptionsMenu_C* CallFunc_Create_ReturnValue7, class UMessageCenterWidget_C* CallFunc_Create_ReturnValue8)
{
...
// class UCommonInputSubsystem*       CallFunc_GetContext_ReturnValue10                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Greater_IntInt_ReturnValue                              (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// class UCommonUISubsystem*          CallFunc_GetContext_ReturnValue17                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
public:
	...
	uint8                                        Pad_E93[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E97[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Rotation;                                          // 0x2C8(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_E98[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Scale;                                             // 0x4A8(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_E99[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E9B[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EA9[0x1E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]

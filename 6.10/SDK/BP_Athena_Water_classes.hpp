...
public:
	...
	uint8                                        Pad_37BB[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	int32                                        BounceLake;                                        // 0x398(0x4)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash)

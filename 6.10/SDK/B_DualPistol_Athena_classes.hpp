...
public:
	...
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0xFE8(0x8)(Transient, DuplicateTransient)
	class USoundCue*                             FireSoundOverride;                                 // 0xFF0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

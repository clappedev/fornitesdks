...
// Function PerkWidgetNew.PerkWidgetNew_C.SetDescriptionWrapTextAt
...
void UPerkWidgetNew_C::SetDescriptionWrapTextAt(float WrapTextAt, bool Temp_bool_Variable, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, float Temp_float_Variable, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue1, float K2Node_Select_Default, int32 CallFunc_FTrunc_ReturnValue)
{
	static auto Func = Class->GetFunction("PerkWidgetNew_C", "SetDescriptionWrapTextAt");

	Params::UPerkWidgetNew_C_SetDescriptionWrapTextAt_Params Parms;
...
void UPerkWidgetNew_C::InitializeSettings(bool bIncludeName, bool bIncludeDescription, enum class EFortBrushSize IconSize, bool bUseLargeFormatName, const struct FFortUIPerk& Perk, bool ShowMouseTooltips, float WrapTextAt)
{

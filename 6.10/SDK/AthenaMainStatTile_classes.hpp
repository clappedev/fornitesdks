...
public:
	...
	class UCommonTextBlock*                      NameTextBlock;                                     // 0x230(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      ValueTextBlock;                                    // 0x238(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class FText                                  StatName;                                          // 0x240(0x18)(Edit, BlueprintVisible)
	class FString                                BaseTagName;                                       // 0x258(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)

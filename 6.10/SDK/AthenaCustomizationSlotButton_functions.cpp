...
// Parameters:
// enum class EFortItemCardSize       NewParam                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaCustomizationSlotButton_C::SetCardSize(enum class EFortItemCardSize NewParam)
{
	static auto Func = Class->GetFunction("AthenaCustomizationSlotButton_C", "SetCardSize");

	Params::UAthenaCustomizationSlotButton_C_SetCardSize_Params Parms;

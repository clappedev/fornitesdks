...
public:
	...
	uint8                                        Pad_1266[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1267[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1268[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1269[0x17F];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_126B[0x58];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_126E[0x108];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_126F[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1270[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]

...
{
	static auto Func = Class->GetFunction("B_CameraLens_SpookyMist_Dive_C", "UserConstructionScript");

	Params::AB_CameraLens_SpookyMist_Dive_C_UserConstructionScript_Params Parms;

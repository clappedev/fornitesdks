...
public:
	...
	class UScrollBox*                            ScrollBox_151;                                     // 0x220(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FButtonStyle                          ButtonStyle;                                       // 0x228(0x278)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<class UButton*, class AFortPlayerState*> ButtonToPlayerStateMap;                            // 0x4A0(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FButtonStyle                          FollowedButtonStyle;                               // 0x4F0(0x278)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<class AFortPlayerState*, class UButton*> PlayerStateToButtonMap;                            // 0x768(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance)
	class UButton*                               FollowedPlayerButton;                              // 0x7B8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

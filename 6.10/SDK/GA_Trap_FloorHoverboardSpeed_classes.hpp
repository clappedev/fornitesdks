...
public:
	...
	float                                        HoverboardBoostVelocityShift;                      // 0x928(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_34EA[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ATrap_Floor_Hoverboard_Speed_C*        HoverboardSpeedTrap;                               // 0x930(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

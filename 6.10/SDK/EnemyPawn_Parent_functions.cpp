...
void AEnemyPawn_Parent_C::RegisterBuildingHitStaticMesh(class UStaticMeshComponent* Mesh, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_Array_Add_ReturnValue)
{
	static auto Func = Class->GetFunction("EnemyPawn_Parent_C", "RegisterBuildingHitStaticMesh");

	Params::AEnemyPawn_Parent_C_RegisterBuildingHitStaticMesh_Params Parms;
	Parms.Mesh = Mesh;
...
void AEnemyPawn_Parent_C::RegisterBuildingHitSkeletalMesh(class USkeletalMeshComponent* Mesh, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_Array_Add_ReturnValue)
{
	static auto Func = Class->GetFunction("EnemyPawn_Parent_C", "RegisterBuildingHitSkeletalMesh");

	Params::AEnemyPawn_Parent_C_RegisterBuildingHitSkeletalMesh_Params Parms;
	Parms.Mesh = Mesh;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
	Parms.CallFunc_Array_Add_ReturnValue = CallFunc_Array_Add_ReturnValue;
...
// Parameters:
// class UStaticMeshComponent*        Mesh                                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UStaticMeshComponent*        EffectMesh                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AEnemyPawn_Parent_C::ApplyBuildingHitEffectToStaticMesh(class UStaticMeshComponent* Mesh, class UStaticMeshComponent* EffectMesh, class UMaterialInstanceDynamic* Effect_MID, bool CallFunc_K2_AttachToComponent_ReturnValue, bool CallFunc_IsValid_ReturnValue, TArray<class UMaterialInterface*>& CallFunc_GetMaterials_ReturnValue, int32 CallFunc_GetNumMaterials_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue1, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_GetGameTimeInSeconds_ReturnValue, int32 Temp_int_Variable, float CallFunc_Add_FloatFloat_ReturnValue, class UMaterialInterface* CallFunc_Array_Get_Item, class UMaterialInstanceDynamic* K2Node_DynamicCast_AsMaterial_Instance_Dynamic, bool K2Node_DynamicCast_bSuccess, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class UTexture* CallFunc_K2_GetTextureParameterValue_ReturnValue, bool CallFunc_IsValid_ReturnValue2, class UTexture* CallFunc_K2_GetTextureParameterValue_ReturnValue1, bool CallFunc_IsValid_ReturnValue3, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, float CallFunc_GetGameTimeInSeconds_ReturnValue1, const struct FTransform& Temp_struct_Variable, class UStaticMeshComponent* CallFunc_AddComponent_ReturnValue, bool CallFunc_SetStaticMesh_ReturnValue)
{
...
// Parameters:
// class USkeletalMeshComponent*      Mesh                                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class USkeletalMeshComponent*      EffectMesh                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AEnemyPawn_Parent_C::ApplyBuildingHitEffectToSkeletalMesh(class USkeletalMeshComponent* Mesh, class USkeletalMeshComponent* EffectMesh, class UMaterialInstanceDynamic* EffectMID, bool CallFunc_K2_AttachToComponent_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_GetNumMaterials_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue1, const struct FTransform& Temp_struct_Variable, class USkeletalMeshComponent* CallFunc_AddComponent_ReturnValue, float CallFunc_GetGameTimeInSeconds_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, int32 Temp_int_Variable, float CallFunc_GetGameTimeInSeconds_ReturnValue1, class UMaterialInstanceDynamic* CallFunc_GetMIDForSkeletalMeshComponent_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class UTexture* CallFunc_K2_GetTextureParameterValue_ReturnValue, bool CallFunc_IsValid_ReturnValue2, class UTexture* CallFunc_K2_GetTextureParameterValue_ReturnValue1, bool CallFunc_IsValid_ReturnValue3, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue)
{
...
// bool                               CallFunc_ShouldShowBuildingHitEffect_ReturnValue                 (ZeroConstructor, IsPlainOldData, NoDestructor)

void AEnemyPawn_Parent_C::ExecuteUbergraph_EnemyPawn_Parent(int32 EntryPoint, int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32 Temp_int_Variable1, int32 CallFunc_Add_IntInt_ReturnValue1, bool Temp_bool_Variable, const struct FTransform& Temp_struct_Variable, class UParticleSystemComponent* CallFunc_AddComponent_ReturnValue, bool Temp_bool_Variable1, bool CallFunc_IsDedicatedServer_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue1, int32 Temp_int_Variable2, int32 CallFunc_Add_IntInt_ReturnValue2, float CallFunc_BreakVector_X1, float CallFunc_BreakVector_Y1, float CallFunc_BreakVector_Z1, float CallFunc_RandomFloatInRange_ReturnValue, float CallFunc_RandomFloatInRange_ReturnValue1, float CallFunc_RandomFloatInRange_ReturnValue2, const struct FLinearColor& Temp_struct_Variable1, const struct FVector& CallFunc_MakeVector_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue, const struct FVector& CallFunc_GetSocketLocation_ReturnValue, float K2Node_Event_Damage2, const struct FGameplayTagContainer& K2Node_Event_DamageTags2, const struct FVector& K2Node_Event_Momentum2, const struct FHitResult& K2Node_Event_HitInfo2, class AFortPawn* K2Node_Event_InstigatedBy1, class AActor* K2Node_Event_DamageCauser1, const struct FGameplayEffectContextHandle& K2Node_Event_EffectContext2, enum class EFortDamageZone CallFunc_GetDamageZone_ReturnValue, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, bool K2Node_SwitchEnum1_CmpSuccess, bool CallFunc_EnemyDeathVisuals_HQ, const struct FVector& K2Node_CustomEvent_RiftLocationWS2, bool CallFunc_IsValid_ReturnValue1, const struct FVector& K2Node_CustomEvent_RiftLocationWS1, bool CallFunc_IsDedicatedServer_ReturnValue1, bool CallFunc_IsValid_ReturnValue2, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue1, bool CallFunc_IsValid_ReturnValue3, int32 Temp_int_Variable3, int32 CallFunc_Add_IntInt_ReturnValue3, const struct FVector& K2Node_CustomEvent_RiftLocationWS, bool CallFunc_IsDedicatedServer_ReturnValue2, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, const struct FLinearColor& Temp_struct_Variable2, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue1, int32 Temp_int_Variable4, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue4, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue, class ABuildingRift* K2Node_DynamicCast_AsBuilding_Rift, bool K2Node_DynamicCast_bSuccess, bool CallFunc_EqualEqual_VectorVector_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue1, const struct FTransform& CallFunc_MakeTransform_ReturnValue, bool CallFunc_IsValid_ReturnValue4, TArray<class AActor*>& Temp_object_Variable, float CallFunc_RandomFloatFromStream_ReturnValue, const struct FLinearColor& CallFunc_PickColorFromAnArrayOfColors_Color, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue2, const struct FLinearColor& CallFunc_PickColorFromAnArrayOfColors_Color1, const struct FLinearColor& CallFunc_PickColorFromAnArrayOfColors_Color2, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue3, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue4, const struct FLinearColor& CallFunc_PickColorFromAnArrayOfColors_Color3, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue5, float CallFunc_Multiply_FloatFloat_ReturnValue2, float CallFunc_RandomFloatInRange_ReturnValue3, float CallFunc_GetFloatValue_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, bool CallFunc_IsValid_ReturnValue5, float CallFunc_Multiply_FloatFloat_ReturnValue3, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, int32 CallFunc_GetBoneIndex_ReturnValue, const struct FVector& CallFunc_MakeVector_ReturnValue1, const struct FVector& CallFunc_GetRefPosePosition_ReturnValue, float Temp_float_Variable, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue6, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue7, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue8, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue9, bool CallFunc_IsValid_ReturnValue6, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue1, bool CallFunc_IsDedicatedServer_ReturnValue3, class APlayerCameraManager* CallFunc_GetPlayerCameraManager_ReturnValue, bool CallFunc_IsValid_ReturnValue7, const struct FVector& CallFunc_GetCameraLocation_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue1, const struct FTransform& Temp_struct_Variable3, bool CallFunc_BooleanAND_ReturnValue, class USkeletalMeshComponent* CallFunc_AddComponent_ReturnValue1, float K2Node_Event_Damage1, const struct FGameplayTagContainer& K2Node_Event_DamageTags1, const struct FVector& K2Node_Event_Momentum1, const struct FHitResult& K2Node_Event_HitInfo1, class AFortPawn* K2Node_Event_InstigatedBy, class AActor* K2Node_Event_DamageCauser, const struct FGameplayEffectContextHandle& K2Node_Event_EffectContext1, class AFortProjectileBase* K2Node_DynamicCast_AsFort_Projectile_Base, bool K2Node_DynamicCast_bSuccess1, class AFortWeapon* K2Node_DynamicCast_AsFort_Weapon, bool K2Node_DynamicCast_bSuccess2, enum class EFortDamageZone CallFunc_GetDamageZone_ReturnValue1, bool K2Node_SwitchEnum2_CmpSuccess, UInterfaceProperty_ K2Node_DynamicCast_AsGameplay_Tag_Asset_Interface, bool K2Node_DynamicCast_bSuccess3, bool CallFunc_HasAnyMatchingGameplayTags_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue1, bool CallFunc_IsValid_ReturnValue8, bool CallFunc_Not_PreBool_ReturnValue2, bool Temp_bool_Variable2, bool CallFunc_K2_AttachToComponent_ReturnValue, const struct FVector& CallFunc_GetSocketLocation_ReturnValue1, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue1, float CallFunc_RandomFloatInRange_ReturnValue4, const struct FVector& CallFunc_GetSocketLocation_ReturnValue2, const struct FRotator& CallFunc_K2_GetComponentRotation_ReturnValue, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue2, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue1, const struct FVector& CallFunc_GetSocketLocation_ReturnValue3, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue2, const struct FHitResult& CallFunc_LineTraceSingle_OutHit, bool CallFunc_LineTraceSingle_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue3, bool Temp_bool_Has_Been_Initd_Variable, bool CallFunc_LessEqual_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue1, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue2, float CallFunc_Add_FloatFloat_ReturnValue1, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, float CallFunc_VSize_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue1, float CallFunc_GetGameTimeInSeconds_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue2, float CallFunc_GetGameTimeInSeconds_ReturnValue1, bool Temp_bool_IsClosed_Variable, bool Temp_bool_Option_B___If_false__use_Option_A_Variable, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FVector& K2Node_Select_Default, class UMaterialInstanceDynamic* CallFunc_GetMIDForSkeletalMeshComponent_ReturnValue, class UTexture* CallFunc_K2_GetTextureParameterValue_ReturnValue, int32 CallFunc_GetNumMaterials_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue9, class UTexture* CallFunc_K2_GetTextureParameterValue_ReturnValue1, bool CallFunc_IsValid_ReturnValue10, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue2, bool CallFunc_K2_AttachToComponent_ReturnValue1, const struct FLinearColor& K2Node_Select1_Default, float K2Node_CustomEvent_Delay_Amount, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue10, bool K2Node_Event_bShouldUseSpecialEventGE, class UStaticMeshComponent* CallFunc_Array_Get_Item, class UStaticMeshComponent* CallFunc_Array_Get_Item1, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue1, bool CallFunc_IsDedicatedServer_ReturnValue4, bool CallFunc_LessEqual_IntInt_ReturnValue1, class UStaticMeshComponent* CallFunc_Array_Get_Item2, bool CallFunc_IsValid_ReturnValue11, int32 CallFunc_Array_Length_ReturnValue1, int32 CallFunc_Subtract_IntInt_ReturnValue2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, bool CallFunc_LessEqual_IntInt_ReturnValue2, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, bool CallFunc_IsValid_ReturnValue12, class USkeletalMeshComponent* CallFunc_Array_Get_Item3, bool CallFunc_IsValid_ReturnValue13, int32 CallFunc_Array_Length_ReturnValue2, int32 CallFunc_Subtract_IntInt_ReturnValue3, bool CallFunc_LessEqual_IntInt_ReturnValue3, bool CallFunc_IsValid_ReturnValue14, class USkeletalMeshComponent* CallFunc_Array_Get_Item4, class USkeletalMeshComponent* CallFunc_Array_Get_Item5, int32 CallFunc_Array_Length_ReturnValue3, int32 CallFunc_Subtract_IntInt_ReturnValue4, bool CallFunc_LessEqual_IntInt_ReturnValue4, float CallFunc_Add_FloatFloat_ReturnValue3, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue1, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue3, float K2Node_Event_Damage, const struct FGameplayTagContainer& K2Node_Event_DamageTags, const struct FVector& K2Node_Event_Momentum, const struct FHitResult& K2Node_Event_HitInfo, const struct FGameplayEffectContextHandle& K2Node_Event_EffectContext, bool K2Node_Event_bPlayerPlaced, bool CallFunc_ShouldShowBuildingHitEffect_ReturnValue)
{
	...
	Parms.CallFunc_ShouldShowBuildingHitEffect_ReturnValue = CallFunc_ShouldShowBuildingHitEffect_ReturnValue;

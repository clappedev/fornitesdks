...
{
public:
	uint8                                        Pad_2541[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2544[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2545[0x29B];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2547[0x2F0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2548[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2549[0x34];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_254A[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]

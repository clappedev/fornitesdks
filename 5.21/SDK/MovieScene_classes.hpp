...
public:
	...
	uint8                                        Pad_2BF[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2C4[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2CA[0x348];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2CC[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]

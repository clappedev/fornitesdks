...
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x768(0x8)(Transient, DuplicateTransient)
	struct FFortGameplayCueParticleInfo          LandParticle;                                      // 0x770(0x58)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FFortBurstEffectData                  LandBurst;                                         // 0x7C8(0xB8)(Edit, BlueprintVisible, DisableEditOnInstance)

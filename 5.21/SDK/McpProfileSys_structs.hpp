...
public:
	...
	uint8                                        Pad_1325[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1327[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1328[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]

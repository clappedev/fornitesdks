...
void UMissionVotingDetailsPanel_C::ExecuteUbergraph_MissionVotingDetailsPanel(int32 EntryPoint, bool Temp_bool_Variable, bool CallFunc_IsValid_ReturnValue, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button2, class UCommonButton* K2Node_ComponentBoundEvent_Button1, bool K2Node_CustomEvent_Success, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, bool CallFunc_IsVoteRequired_VoteRequired, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue1, enum class EFortVoteType K2Node_Event_VoteType1, bool K2Node_Event_bIsVoteActive, int32 K2Node_Event_VoteResult, bool CallFunc_EqualEqual_IntInt_ReturnValue, bool K2Node_Event_bIsMultiplayer, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue1, enum class EFortVoteType K2Node_Event_VoteType, class UMaterialInterface* Temp_object_Variable, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue1, class UMaterialInterface* Temp_object_Variable1, bool Temp_bool_Variable1, class FText Temp_text_Variable, class UMaterialInterface* K2Node_Select_Default, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate4, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate5, class FText Temp_text_Variable1, enum class EFortVoteArbitratorType CallFunc_GetArbitratorType_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, class UCommonButton* K2Node_ComponentBoundEvent_Button, const struct FGeometry& K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, class USoundBase* K2Node_Select1_Default, bool CallFunc_CanRequestVote_ReturnValue, bool Temp_bool_Variable2, class FText K2Node_Select2_Default, class FText CallFunc_TextToUpper_ReturnValue)
{

...
void UVoteResultNotificationWidget_C::Initialize(enum class EFortVoteType VoteType, enum class EFortVoteArbitratorType ArbitratorType, bool VoteSucceeded, class FText Temp_text_Variable, class FText Temp_text_Variable1, bool Temp_bool_Variable, bool Temp_bool_Variable1, class UMaterialInterface* Temp_object_Variable, class UMaterialInterface* Temp_object_Variable1, bool Temp_bool_Variable2, const struct FLinearColor& Temp_struct_Variable, const struct FLinearColor& Temp_struct_Variable1, enum class EFortVoteType Temp_byte_Variable, class UMaterialInterface* Temp_object_Variable2, class UMaterialInterface* Temp_object_Variable3, class UMaterialInterface* Temp_object_Variable4, bool Temp_bool_Variable3, class UTexture2D* Temp_object_Variable5, class UTexture2D* Temp_object_Variable6, bool Temp_bool_Variable4, class FText Temp_text_Variable2, class FText Temp_text_Variable3, enum class EFortVoteType Temp_byte_Variable1, class FText Temp_text_Variable4, class FText Temp_text_Variable5, class FText Temp_text_Variable6, class FText Temp_text_Variable7, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UMaterialInterface* K2Node_Select_Default, class FText K2Node_Select1_Default, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, const struct FLinearColor& K2Node_Select2_Default, class UTexture2D* K2Node_Select3_Default, enum class EFortVoteType Temp_byte_Variable2, class FText K2Node_Select4_Default, class UMaterialInterface* K2Node_Select5_Default, class FText K2Node_Select6_Default, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData1, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue, class FText K2Node_Select7_Default)
{

...
{
public:
	uint8                                        Pad_2[0x14];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4[0x40];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6[0xF];                                        // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9[0x6];                                        // Fixing Size After Last Property  [ Dumper-7 ]

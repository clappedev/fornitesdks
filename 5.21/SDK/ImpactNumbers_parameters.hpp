...
public:
	...
	uint8                                        Pad_4A99[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4A9B[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	struct FFortDamageNumberInfo                 NewDamageHitInfoStruct;                            // 0x0(0x68)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	uint8                                        Pad_4AA7[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4AA8[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4AB0[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]

...
{
public:
	uint8                                        Pad_DDB[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DDC[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DDD[0x17F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DDF[0x58];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DE0[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DE2[0x108];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DE3[0xC8];                                     // Fixing Size Of Struct [ Dumper-7 ]

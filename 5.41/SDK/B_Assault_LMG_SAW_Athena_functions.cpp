...
{
	static auto Func = Class->GetFunction("B_Assault_LMG_SAW_Athena_C", "UserConstructionScript");

	Params::AB_Assault_LMG_SAW_Athena_C_UserConstructionScript_Params Parms;

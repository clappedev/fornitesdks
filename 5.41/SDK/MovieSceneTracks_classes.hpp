...
public:
	...
	uint8                                        Pad_E87[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E8B[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Rotation;                                          // 0x2C8(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_E8C[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Scale;                                             // 0x4A8(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_E8D[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E92[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E9D[0x1E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]

...
public:
	...
	uint8                                        Pad_27AB[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27AC[0x80];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FGameplayTagSource>            TagSources;                                        // 0xA8(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_27AD[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]

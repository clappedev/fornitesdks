...
public:
	...
	uint8                                        Pad_EA0[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EA4[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_EA5[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EA7[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               RotationCurve;                                     // 0x1E0(0xA0)(NativeAccessSpecifierPublic)
	uint8                                        Pad_EA8[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               ScaleCurve;                                        // 0x3C0(0xA0)(NativeAccessSpecifierPublic)
	uint8                                        Pad_EA9[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EAD[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EB6[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EB7[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EB8[0x1E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EBB[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EC0[0x1E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EC1[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EC2[0x67];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EC7[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

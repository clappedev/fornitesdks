...
public:
	...
	uint8                                        Pad_3D[0x30];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_44[0x38];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_46[0x58];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_47[0x20];                                      // Fixing Size Of Struct [ Dumper-7 ]

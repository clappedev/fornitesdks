...
public:
	...
	uint8                                        Pad_13EC[0xA7];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13ED[0x1D];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13EF[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13F0[0xC0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13F3[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13F6[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13F7[0x26];                                    // Fixing Size Of Struct [ Dumper-7 ]

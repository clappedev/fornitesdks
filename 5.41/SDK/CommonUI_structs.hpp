...
public:
	...
	uint8                                        Pad_E5C[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E5E[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E5F[0x110];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E61[0x150];                                    // Fixing Size After Last Property  [ Dumper-7 ]

...
{
public:
	uint8                                        Pad_3[0x14];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5[0x40];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_7[0xF];                                        // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9[0x8];                                        // Fixing Size Of Struct [ Dumper-7 ]

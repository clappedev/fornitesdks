...
{
	static auto Func = Class->GetFunction("GCN_Loop_DeimosColdBreath_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_DeimosColdBreath_C", "OnRemoval");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_DeimosColdBreath_C", "Begin Overlap");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_DeimosColdBreath_C", "End Overlap");

...
{
	static auto Func = Class->GetFunction("GCN_Carmine_Beam_C", "ExecuteUbergraph_GCN_Carmine_Beam");

	Params::UGCN_Carmine_Beam_C_ExecuteUbergraph_GCN_Carmine_Beam_Params Parms;

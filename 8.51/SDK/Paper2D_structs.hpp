...
public:
	...
	uint8                                        Pad_2D1D[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2D22[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

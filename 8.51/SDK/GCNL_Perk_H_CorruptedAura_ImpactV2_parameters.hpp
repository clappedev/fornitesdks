...
struct AGCNL_Perk_H_CorruptedAura_ImpactV2_C_OnRemoval_Params
{
public:
...
struct AGCNL_Perk_H_CorruptedAura_ImpactV2_C_OnLoopingStart_Params
{
public:
	//class AActor*                              MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	//struct FGameplayCueParameters              Parameters;                                        // 0x8(0xB8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGCNL_Perk_H_CorruptedAura_ImpactV2_C_ExecuteUbergraph_GCNL_Perk_H_CorruptedAura_ImpactV2_Params
{
public:
	...
	struct FVector                               CallFunc_GetSocketLocation_ReturnValue;            // 0x1E4(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
public:
	...
	class UFortItem*                                   ItemToRepresent_Current;                                  // 0x0528(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              LastUpdateCallTime;                                       // 0x0530(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void NeedToUpdateBasedOnItemToRepresentDefinitionChange(bool* Changed);

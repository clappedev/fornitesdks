...
struct UGCN_Carmine_ApplyStone_C_OnBurst_Params
{
public:
	...
	struct FLinearColor                          CallFunc_Map_Find_Value;                           // 0x1B8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

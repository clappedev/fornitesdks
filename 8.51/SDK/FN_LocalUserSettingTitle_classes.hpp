...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass LocalUserSettingTitle.LocalUserSettingTitle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_LocalUserSettingTitle(int EntryPoint);
};

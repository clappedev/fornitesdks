...
struct UGCN_Athena_Booty_DestroyItem_C_OnBurst_Params
{
public:
	...
	struct FVector                               CallFunc_GetActorForwardVector_ReturnValue;        // 0xF4(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                              CallFunc_MakeRotator_ReturnValue;                  // 0x134(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FHitResult                            CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x14C(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	float                                        CallFunc_Add_FloatFloat_ReturnValue_2;             // 0x1E8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_MakeVector_ReturnValue;                   // 0x1EC(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x1F8(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};

...
// Parameters:
// bool                           IsChoicePack                   (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void AStoreCardReveal_BP_C::IsCurrentCardChoicePack(bool* IsChoicePack)
{
	static auto fn = UObject::FindObject<UFunction>("Function StoreCardReveal_BP.StoreCardReveal_BP_C.IsCurrentCardChoicePack");

	AStoreCardReveal_BP_C_IsCurrentCardChoicePack_Params params;
	...
	if (IsChoicePack != nullptr)
		*IsChoicePack = params.IsChoicePack;
}
...
// Parameters:
// int                            ChoiceIndex                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UMaterialInstanceDynamic* MID_Choice_Sticker             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void AStoreCardReveal_BP_C::SetRarityColor_CC(int ChoiceIndex, class UMaterialInstanceDynamic* MID_Choice_Sticker)
{
	static auto fn = UObject::FindObject<UFunction>("Function StoreCardReveal_BP.StoreCardReveal_BP_C.SetRarityColor_CC");

	AStoreCardReveal_BP_C_SetRarityColor_CC_Params params;
	params.ChoiceIndex = ChoiceIndex;
	params.MID_Choice_Sticker = MID_Choice_Sticker;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function StoreCardReveal_BP.StoreCardReveal_BP_C.ResetForTransition");

	AStoreCardReveal_BP_C_ResetForTransition_Params params;

...
public:
	...
	class UParticleSystemComponent*                    P_Husk_Elemental_Electric_AuxObjs;                        // 0x02B8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UParticleSystemComponent*                    Lightning_Elemental_FX;                                   // 0x02C0(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)

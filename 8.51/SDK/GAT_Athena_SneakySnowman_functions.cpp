...
{
	static auto Func = Class->GetFunction("GAT_Athena_SneakySnowman_C", "Remove Snowman");
...
{
	static auto Func = Class->GetFunction("GAT_Athena_SneakySnowman_C", "K2_ActivateAbility");

	Params::UGAT_Athena_SneakySnowman_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GAT_Athena_SneakySnowman_C", "ExecuteUbergraph_GAT_Athena_SneakySnowman");

...
{
// 0x18 (0x7A8 - 0x790)
// BlueprintGeneratedClass GCNL_Goose_Status_VR.GCNL_Goose_Status_VR_C
class AGCNL_Goose_Status_VR_C : public AFortGameplayCueNotify_Loop
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x790(0x8)(ZeroConstructor, Transient, DuplicateTransient)
	struct FLinearColor                          Color;                                             // 0x798(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("GCNL_Goose_Status_VR_C");
		return Clss;
	}

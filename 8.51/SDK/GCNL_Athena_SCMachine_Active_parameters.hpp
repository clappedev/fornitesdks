...
struct AGCNL_Athena_SCMachine_Active_C_OnLoopingStart_Params
{
public:
...
struct AGCNL_Athena_SCMachine_Active_C_OnRemoval_Params
{
public:
	//class AActor*                              MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	//struct FGameplayCueParameters              Parameters;                                        // 0x8(0xB8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGCNL_Athena_SCMachine_Active_C_ExecuteUbergraph_GCNL_Athena_SCMachine_Active_Params
{
public:
	...
	class UParticleSystemComponent*              CallFunc_Array_Get_Item_1;                         // 0x1E0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABGA_Athena_SCMachine_C*               K2Node_DynamicCast_AsBGA_Athena_SCMachine;         // 0x1E8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABGA_Athena_SCMachine_C*               K2Node_DynamicCast_AsBGA_Athena_SCMachine_1;       // 0x1F8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_K2_GetComponentLocation_ReturnValue;      // 0x204(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult_1;     // 0x2A4(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};

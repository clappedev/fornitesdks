...
struct USquadMemberTile_C_BP_OnUnhovered_Params
{
public:
};
...
struct USquadMemberTile_C_BP_OnHovered_Params
{
public:
};
...
struct USquadMemberTile_C_OnSquadAssigned_Params
{
public:
};
...
struct USquadMemberTile_C_Construct_Params
{
public:
};
...
struct USquadMemberTile_C_BP_OnSelected_Params
{
public:
};
...
struct USquadMemberTile_C_BP_OnDeselected_Params
{
public:
};
...
struct USquadMemberTile_C_OnTeamMemberEstablished_Params
{
public:
...
public:
	...
	struct FAthenaTeamDisplayInfo                CallFunc_GetSquadDisplayInfo_ReturnValue;          // 0x38(0x88)()
	bool                                         CallFunc_IsCurrentMemberLocal_ReturnValue;         // 0xC0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         K2Node_Event_IsDesignTime;                         // 0xC1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EGameReadiness                    K2Node_Event_ReadyStatus;                          // 0xC2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5AD1[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         K2Node_Event_bHasValidMember;                      // 0x100(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	enum class EGameReadiness                    Temp_byte_Variable;                                // 0x110(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5AD4[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue_2;              // 0x118(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInterface*                    K2Node_Select_Default;                             // 0x120(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

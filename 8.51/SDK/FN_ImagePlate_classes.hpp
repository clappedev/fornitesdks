...
{
public:
	class UImagePlateComponent*                        ImagePlate;                                               // 0x0240(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FImagePlateParameters                       Plate;                                                    // 0x03F0(0x0038) (Edit)

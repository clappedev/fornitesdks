...
{
public:
	uint8                                        Pad_FD3[0x1B8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FD4[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FD5[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FD7[0x2E];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FD9[0x17];                                     // Fixing Size After Last Property  [ Dumper-7 ]

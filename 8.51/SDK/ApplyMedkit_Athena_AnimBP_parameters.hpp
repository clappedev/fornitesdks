...
struct UApplyMedkit_Athena_AnimBP_C_BlueprintUpdateAnimation_Params
{
public:
...
public:
	...
	class AB_ConsumableSmall_Medkit_Athena_C*    K2Node_DynamicCast_AsB_Consumable_Small_Medkit_Athena; // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

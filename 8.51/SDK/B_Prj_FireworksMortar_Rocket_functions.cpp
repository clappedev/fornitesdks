...
{
	static auto Func = Class->GetFunction("B_Prj_FireworksMortar_Rocket_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("B_Prj_FireworksMortar_Rocket_C", "OnBounce");
...
{
	static auto Func = Class->GetFunction("B_Prj_FireworksMortar_Rocket_C", "OnExploded");
...
{
	static auto Func = Class->GetFunction("B_Prj_FireworksMortar_Rocket_C", "ReceiveBeginPlay");

	Params::AB_Prj_FireworksMortar_Rocket_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_FireworksMortar_Rocket_C", "ExecuteUbergraph_B_Prj_FireworksMortar_Rocket");

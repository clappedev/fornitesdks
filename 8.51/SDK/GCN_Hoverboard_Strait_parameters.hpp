...
public:
	...
	class ATrap_Floor_Hoverboard_Speed_C*        K2Node_DynamicCast_AsTrap_Floor_Hoverboard_Speed;  // 0x180(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APlayerPawn_Generic_C*                 K2Node_DynamicCast_AsPlayer_Pawn_Generic;          // 0x190(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

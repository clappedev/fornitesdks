...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GCNL_Vent_White_Exit.GCNL_Vent_White_Exit_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GCNL_Vent_White_Exit(int EntryPoint);
};

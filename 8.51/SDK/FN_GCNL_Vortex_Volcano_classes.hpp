...
public:
	...
	float                                              FadePPVol_LERP_B67C7D5648A7EEE393AA48A725F62F0E;          // 0x07A0(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    FadePPVol__Direction_B67C7D5648A7EEE393AA48A725F62F0E;    // 0x07A4(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GCNL_Vortex_Volcano.GCNL_Vortex_Volcano_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GCNL_Vortex_Volcano(int EntryPoint);
};

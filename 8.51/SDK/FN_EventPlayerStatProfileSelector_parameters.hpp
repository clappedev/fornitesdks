...
struct UEventPlayerStatProfileSelector_C_BndEvt__CloseMainPanel_K2Node_ComponentBoundEvent_Params
{
	class UCommonButton*                               Button;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};

// Function EventPlayerStatProfileSelector.EventPlayerStatProfileSelector_C.OnActivated
struct UEventPlayerStatProfileSelector_C_OnActivated_Params
{
};

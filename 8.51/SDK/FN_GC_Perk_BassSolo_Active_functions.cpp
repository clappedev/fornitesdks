...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Perk_BassSolo_Active.GC_Perk_BassSolo_Active_C.ReceiveDestroyed");

	AGC_Perk_BassSolo_Active_C_ReceiveDestroyed_Params params;

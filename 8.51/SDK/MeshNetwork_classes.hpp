...
{
public:
	uint8                                        Pad_2C54[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2C55[0x17];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C57[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2C5B[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2C5C[0x55];                                    // Fixing Size Of Struct [ Dumper-7 ]

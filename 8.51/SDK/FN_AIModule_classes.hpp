...
{
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x02B8(0x0038) MISSED OFFSET
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x02F0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x02F0(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x02F0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x02F0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x02F0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x02F0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x7];                                       // 0x02F1(0x0007) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x02F8(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x0300(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x0308(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x0310(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x0318(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x0320(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x0328(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0330(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.AIController.ReceiveMoveCompleted
...
{
public:
	TArray<class UAISenseConfig*>                      SensesConfig;                                             // 0x00D8(0x0010) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance)
	class UClass*                                      DominantSense;                                            // 0x00E8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x80];                                      // 0x0108(0x0080) MISSED OFFSET
	unsigned char                                      UnknownData02[0x10];                                      // 0x0108(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.AIPerceptionComponent.OnPerceptionUpdated
	unsigned char                                      UnknownData03[0x10];                                      // 0x0198(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.AIPerceptionComponent.OnTargetPerceptionUpdated
...
public:
	...
	TArray<class UBTNode*>                             NodeInstances;                                            // 0x0158(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x120];                                     // 0x0168(0x0120) MISSED OFFSET
...
public:
	...
	class UNavMovementComponent*                       MovementComp;                                             // 0x0110(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0118(0x0008) MISSED OFFSET
	class ANavigationData*                             MyNavData;                                                // 0x0120(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x158];                                     // 0x0128(0x0158) MISSED OFFSET
...
public:
	...
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x0288(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x0290(0x000C) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x24];                                      // 0x029C(0x0024) MISSED OFFSET
...
public:
	...
	TArray<struct FNavigationLink>                     PointLinks;                                               // 0x0250(0x0010) (Edit, ZeroConstructor)
	TArray<struct FNavigationSegmentLink>              SegmentLinks;                                             // 0x0260(0x0010) (ZeroConstructor)
	class UNavLinkCustomComponent*                     SmartLinkComp;                                            // 0x0270(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	bool                                               bSmartLinkIsRelevant;                                     // 0x0278(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0279(0x0007) MISSED OFFSET
	unsigned char                                      UnknownData02[0x10];                                      // 0x0279(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.NavLinkProxy.OnSmartLinkReached
...
{
public:
	unsigned char                                      bAutoRegisterAsSource : 1;                                // 0x00D8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, Config)
	unsigned char                                      UnknownData00[0x7];                                       // 0x00D9(0x0007) MISSED OFFSET
	TArray<class UClass*>                              RegisterAsSourceForSenses;                                // 0x00E0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	TArray<class UBlackboardKeyType*>                  KeyInstances;                                             // 0x0108(0x0010) (ZeroConstructor, Transient)
...
public:
	...
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x0668(0x0010) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0678(0x0010) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x0688(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x068C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x0690(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0691(0x0003) MISSED OFFSET
	unsigned char                                      bDrawLabels : 1;                                          // 0x0694(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x0694(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x0694(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x0694(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x0694(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0695(0x0003) MISSED OFFSET
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x0698(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0699(0x0007) MISSED OFFSET
	struct FNavAgentProperties                         NavAgentProperties;                                       // 0x06A0(0x0030) (Edit)
	unsigned char                                      UnknownData03[0x20];                                      // 0x06D0(0x0020) MISSED OFFSET
...
{
public:
	class UNavLocalGridManager*                        GridManager;                                              // 0x0280(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x00ED(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.PawnSensingComponent.OnSeePawn
	unsigned char                                      UnknownData02[0x10];                                      // 0x0108(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.PawnSensingComponent.OnHearNoise
	float                                              PeripheralVisionAngle;                                    // 0x0118(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              PeripheralVisionCosine;                                   // 0x011C(0x0004) (ZeroConstructor, IsPlainOldData)

...
{
	static auto Func = Class->GetFunction("GCL_Athena_Carrot_C", "Timeline_0__FinishedFunc");

	Params::AGCL_Athena_Carrot_C_Timeline_0__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Athena_Carrot_C", "Timeline_0__UpdateFunc");

	Params::AGCL_Athena_Carrot_C_Timeline_0__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Athena_Carrot_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCL_Athena_Carrot_C", "OnRemoval");

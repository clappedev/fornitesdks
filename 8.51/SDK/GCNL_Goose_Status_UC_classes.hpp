...
{
// 0x18 (0x7A8 - 0x790)
// BlueprintGeneratedClass GCNL_Goose_Status_UC.GCNL_Goose_Status_UC_C
class AGCNL_Goose_Status_UC_C : public AFortGameplayCueNotify_Loop
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GCNL_Goose_Status_UC_C");
		return Clss;
	}

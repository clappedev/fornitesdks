...
{
public:
	struct FCameraLookatTrackingSettings               LookatTrackingSettings;                                   // 0x0750(0x0050) (Edit, BlueprintVisible)
...
public:
	...
	struct FCameraFocusSettings                        FocusSettings;                                            // 0x07B8(0x0058) (Edit, BlueprintVisible)
	float                                              CurrentFocalLength;                                       // 0x0810(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CurrentAperture;                                          // 0x0814(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CurrentFocusDistance;                                     // 0x0818(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x081C(0x000C) MISSED OFFSET

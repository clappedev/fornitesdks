...
void APartyDisplayManagerBP_C::NeedToUpdateBasedOnItemToRepresentDefinitionChange(bool* Changed)
{
	static auto fn = UObject::FindObject<UFunction>("Function PartyDisplayManagerBP.PartyDisplayManagerBP_C.NeedToUpdateBasedOnItemToRepresentDefinitionChange");

	APartyDisplayManagerBP_C_NeedToUpdateBasedOnItemToRepresentDefinitionChange_Params params;

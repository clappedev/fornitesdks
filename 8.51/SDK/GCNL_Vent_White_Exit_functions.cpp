...
{
	static auto Func = Class->GetFunction("GCNL_Vent_White_Exit_C", "FadePPVol__FinishedFunc");

	Params::AGCNL_Vent_White_Exit_C_FadePPVol__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Vent_White_Exit_C", "FadePPVol__UpdateFunc");

	Params::AGCNL_Vent_White_Exit_C_FadePPVol__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Vent_White_Exit_C", "OnLoopingStart");

	Params::AGCNL_Vent_White_Exit_C_OnLoopingStart_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Vent_White_Exit_C", "OnRemoval");

	Params::AGCNL_Vent_White_Exit_C_OnRemoval_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;

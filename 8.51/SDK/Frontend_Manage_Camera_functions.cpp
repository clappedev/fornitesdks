...
{
	static auto Func = Class->GetFunction("Frontend_Manage_Camera_C", "CameraSelected");
...
{
	static auto Func = Class->GetFunction("Frontend_Manage_Camera_C", "CameraDeselected");

	Params::AFrontend_Manage_Camera_C_CameraDeselected_Params Parms;
...
{
	static auto Func = Class->GetFunction("Frontend_Manage_Camera_C", "CameraHasBeenDeselected__DelegateSignature");

	Params::AFrontend_Manage_Camera_C_CameraHasBeenDeselected__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("Frontend_Manage_Camera_C", "CameraHasBeenSelected__DelegateSignature");

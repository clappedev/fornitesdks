...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Summon_GroundEffect_C", "Timeline_0__FinishedFunc");

	Params::AGC_DUDEBRO_Summon_GroundEffect_C_Timeline_0__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Summon_GroundEffect_C", "Timeline_0__UpdateFunc");

	Params::AGC_DUDEBRO_Summon_GroundEffect_C_Timeline_0__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Summon_GroundEffect_C", "K2_HandleGameplayCue");
...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Summon_GroundEffect_C", "ExecuteUbergraph_GC_DUDEBRO_Summon_GroundEffect");

...
{
	static auto Func = Class->GetFunction("GA_Athena_PushCannon_Fired_C", "EventReceived_754FCB724B0719D064732A99C8CBBF35");

	Params::UGA_Athena_PushCannon_Fired_C_EventReceived_754FCB724B0719D064732A99C8CBBF35_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Athena_PushCannon_Fired_C", "K2_OnEndAbility");

	Params::UGA_Athena_PushCannon_Fired_C_K2_OnEndAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Athena_PushCannon_Fired_C", "K2_ActivateAbility");

	Params::UGA_Athena_PushCannon_Fired_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Athena_PushCannon_Fired_C", "ExecuteUbergraph_GA_Athena_PushCannon_Fired");

	Params::UGA_Athena_PushCannon_Fired_C_ExecuteUbergraph_GA_Athena_PushCannon_Fired_Params Parms;

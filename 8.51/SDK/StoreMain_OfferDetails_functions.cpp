...
{
	static auto Func = Class->GetFunction("StoreMain_OfferDetails_C", "BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");

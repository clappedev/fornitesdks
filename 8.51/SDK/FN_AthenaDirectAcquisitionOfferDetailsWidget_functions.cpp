...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.ShopVariantPreviewInfoUpdated");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_ShopVariantPreviewInfoUpdated_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::CreateAndAddRewardItem(struct FFortItemQuantityPair ItemQuantity, int ItemIndex, bool PreviewPlaceholder, TArray<struct FFortItemQuantityPair>* SortedItemQuantities)
{
	...
	params.PreviewPlaceholder = PreviewPlaceholder;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;

...
{
	static auto Func = Class->GetFunction("BGA_Athena_SCMachine_Pickup_C", "OnRep_bResumeSimulation");

	Params::ABGA_Athena_SCMachine_Pickup_C_OnRep_bResumeSimulation_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_Athena_SCMachine_Pickup_C", "BaseDied");

	Params::ABGA_Athena_SCMachine_Pickup_C_BaseDied_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_Athena_SCMachine_Pickup_C", "BaseDestroyed");

	Params::ABGA_Athena_SCMachine_Pickup_C_BaseDestroyed_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_Athena_SCMachine_Pickup_C", "HandleBinding");

	Params::ABGA_Athena_SCMachine_Pickup_C_HandleBinding_Params Parms;
	Parms.Actor = Actor;
...
void ABGA_Athena_SCMachine_Pickup_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("BGA_Athena_SCMachine_Pickup_C", "ReceiveHit");

	Params::ABGA_Athena_SCMachine_Pickup_C_ReceiveHit_Params Parms;
	Parms.MyComp = MyComp;
	Parms.Other = Other;
...
{
	static auto Func = Class->GetFunction("BGA_Athena_SCMachine_Pickup_C", "StopSim");

	Params::ABGA_Athena_SCMachine_Pickup_C_StopSim_Params Parms;
	Parms.Hit = Hit;

...
class AGCN_Loop_Snow_Debris_C : public AFortGameplayCueNotify_Loop
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GCN_Loop_Snow_Debris.GCN_Loop_Snow_Debris_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GCN_Loop_Snow_Debris(int EntryPoint);
};

...
class AGCNL_Goose_Status_SR_C : public AFortGameplayCueNotify_Loop
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GCNL_Goose_Status_SR_C");
		return Clss;
	}

...
public:
	...
	unsigned char                                      UnknownData01[0x3D8];                                     // 0x00B8(0x03D8) MISSED OFFSET
...
{
public:
	class UReplicationGraphNode_ActorList*             AlwaysRelevantNode;                                       // 0x0490(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FConnectionAlwaysRelevantNodePair>   AlwaysRelevantForConnectionList;                          // 0x0498(0x0010) (ZeroConstructor)
	TArray<class AActor*>                              ActorsWithoutNetConnection;                               // 0x04A8(0x0010) (ZeroConstructor)
...
{
public:
	class UReplicationGraph*                           ReplicationGraph;                                         // 0x0240(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetReplicationGraphConnection*              ConnectionManager;                                        // 0x0248(0x0008) (ZeroConstructor, IsPlainOldData)

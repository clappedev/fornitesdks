...
{
	static auto Func = Class->GetFunction("GCNL_Creative_BarrelExplosion_Player_C", "PPTL__FinishedFunc");

	Params::AGCNL_Creative_BarrelExplosion_Player_C_PPTL__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Creative_BarrelExplosion_Player_C", "PPTL__UpdateFunc");

	Params::AGCNL_Creative_BarrelExplosion_Player_C_PPTL__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Creative_BarrelExplosion_Player_C", "OnApplication");
...
{
	static auto Func = Class->GetFunction("GCNL_Creative_BarrelExplosion_Player_C", "ExecuteUbergraph_GCNL_Creative_BarrelExplosion_Player");

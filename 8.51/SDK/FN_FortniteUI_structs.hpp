...
{
	EFortReplayEventType                               EventType;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	float                                              EventTime;                                                // 0x0004(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FString                                     InstigatorName;                                           // 0x0008(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     VictimName;                                               // 0x0018(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
};
...
struct FFortPlayerSurveyCMSDataConditionGroup
{
	...
	struct FJsonObjectWrapper                          C;                                                        // 0x0008(0x0020)
};
...
{
	struct FText                                       T;                                                        // 0x0000(0x0018)
	TArray<struct FFortPlayerSurveyCMSDataQuestionChoice> C;                                                        // 0x0018(0x0010) (ZeroConstructor)
};

...
public:
	...
	TArray<struct FAttributeDefaults>                  DefaultStartingData;                                      // 0x0158(0x0010) (Edit, ZeroConstructor)
	TArray<class UAttributeSet*>                       SpawnedAttributes;                                        // 0x0168(0x0010) (ExportObject, Net, ZeroConstructor)
	unsigned char                                      UnknownData01[0x1C0];                                     // 0x0178(0x01C0) MISSED OFFSET
	float                                              OutgoingDuration;                                         // 0x0338(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              IncomingDuration;                                         // 0x033C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x20];                                      // 0x0340(0x0020) MISSED OFFSET
	TArray<struct FString>                             ClientDebugStrings;                                       // 0x0360(0x0010) (Net, ZeroConstructor)
	TArray<struct FString>                             ServerDebugStrings;                                       // 0x0370(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData03[0x60];                                      // 0x0380(0x0060) MISSED OFFSET
	bool                                               UserAbilityActivationInhibited;                           // 0x03E0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               ReplicationProxyEnabled;                                  // 0x03E1(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bSuppressGrantAbility;                                    // 0x03E2(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bSuppressGameplayCues;                                    // 0x03E3(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x03E4(0x0004) MISSED OFFSET
	TArray<class AGameplayAbilityTargetActor*>         SpawnedTargetActors;                                      // 0x03E8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x28];                                      // 0x03F8(0x0028) MISSED OFFSET
	class AActor*                                      OwnerActor;                                               // 0x0420(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      AvatarActor;                                              // 0x0428(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x10];                                      // 0x0430(0x0010) MISSED OFFSET
	struct FGameplayAbilitySpecContainer               ActivatableAbilities;                                     // 0x0440(0x0120) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData07[0x30];                                      // 0x0560(0x0030) MISSED OFFSET
	TArray<class UGameplayAbility*>                    AllReplicatedInstancedAbilities;                          // 0x0590(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x1D0];                                     // 0x05A0(0x01D0) MISSED OFFSET
	struct FGameplayAbilityRepAnimMontage              RepAnimMontageInfo;                                       // 0x0770(0x0030) (Net)
	bool                                               bCachedIsNetSimulated;                                    // 0x07A0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingMontageRep;                                       // 0x07A1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x6];                                       // 0x07A2(0x0006) MISSED OFFSET
	struct FGameplayAbilityLocalAnimMontage            LocalAnimMontageInfo;                                     // 0x07A8(0x0030)
	unsigned char                                      UnknownData10[0xA0];                                      // 0x07D8(0x00A0) MISSED OFFSET
	struct FActiveGameplayEffectsContainer             ActiveGameplayEffects;                                    // 0x0878(0x0480) (Net)
	struct FActiveGameplayCueContainer                 ActiveGameplayCues;                                       // 0x0CF8(0x0128) (Net)
	struct FActiveGameplayCueContainer                 MinimalReplicationGameplayCues;                           // 0x0E20(0x0128) (Net)
	unsigned char                                      UnknownData11[0x128];                                     // 0x0F48(0x0128) MISSED OFFSET
	TArray<unsigned char>                              BlockedAbilityBindings;                                   // 0x1070(0x0010) (Net, ZeroConstructor, Transient)
	unsigned char                                      UnknownData12[0x128];                                     // 0x1080(0x0128) MISSED OFFSET
	struct FMinimalReplicationTagCountMap              MinimalReplicationTags;                                   // 0x11A8(0x0060) (Net)
	unsigned char                                      UnknownData13[0x10];                                      // 0x1208(0x0010) MISSED OFFSET
	struct FReplicatedPredictionKeyMap                 ReplicatedPredictionKeyMap;                               // 0x1218(0x0118) (Net)
...
public:
	...
	class UAbilitySystemComponent*                     AbilitySystemComponent;                                   // 0x02E0(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
public:
	...
	bool                                               bIsActive;                                                // 0x03E0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsCancelable;                                            // 0x03E1(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsBlockingOtherAbilities;                                // 0x03E2(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x15];                                      // 0x03E3(0x0015) MISSED OFFSET
	bool                                               bMarkPendingKillOnAbilityEnd;                             // 0x03F8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	bool                                               ShouldProduceTargetDataOnServer;                          // 0x0240(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0241(0x000F) MISSED OFFSET
	struct FGameplayAbilityTargetingLocationInfo       StartLocation;                                            // 0x0250(0x0070) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData01[0x30];                                      // 0x02C0(0x0030) MISSED OFFSET
	class APlayerController*                           MasterPC;                                                 // 0x02F0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UGameplayAbility*                            OwningAbility;                                            // 0x02F8(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bDestroyOnConfirmation;                                   // 0x0300(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0301(0x0007) MISSED OFFSET
	class AActor*                                      SourceActor;                                              // 0x0308(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	struct FWorldReticleParameters                     ReticleParams;                                            // 0x0310(0x000C) (BlueprintVisible)
	unsigned char                                      UnknownData03[0x4];                                       // 0x031C(0x0004) MISSED OFFSET
	class UClass*                                      ReticleClass;                                             // 0x0320(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGameplayTargetDataFilterHandle             Filter;                                                   // 0x0328(0x0010) (BlueprintVisible, Net)
	bool                                               bDebug;                                                   // 0x0338(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x17];                                      // 0x0339(0x0017) MISSED OFFSET
	class UAbilitySystemComponent*                     GenericDelegateBoundASC;                                  // 0x0350(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	bool                                               bTraceAffectsAimPitch;                                    // 0x0364(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xB];                                       // 0x0365(0x000B) MISSED OFFSET
...
{
public:
	float                                              CollisionRadius;                                          // 0x0370(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CollisionHeight;                                          // 0x0374(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UClass*                                      PlacedActorClass;                                         // 0x0390(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          PlacedActorMaterial;                                      // 0x0398(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FWorldReticleParameters                     Parameters;                                               // 0x0240(0x000C) (Edit, BlueprintVisible, DisableEditOnTemplate)
	bool                                               bFaceOwnerFlat;                                           // 0x024C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSnapToTargetedActor;                                     // 0x024D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetValid;                                           // 0x024E(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetAnActor;                                         // 0x024F(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class APlayerController*                           MasterPC;                                                 // 0x0250(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AActor*                                      TargetingActor;                                           // 0x0258(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCapsuleComponent*                           CollisionComponent;                                       // 0x0260(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<class UActorComponent*>                     VisualizationComponents;                                  // 0x0268(0x0010) (ExportObject, ZeroConstructor)
...
{
public:
	bool                                               bAutoDestroyOnRemove;                                     // 0x0240(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0241(0x0003) MISSED OFFSET
	float                                              AutoDestroyDelay;                                         // 0x0244(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfTimelineIsStillRunning;                             // 0x0248(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfLatentActionIsStillRunning;                         // 0x0249(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x024A(0x0002) MISSED OFFSET
	struct FGameplayTag                                GameplayCueTag;                                           // 0x024C(0x0008) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0254(0x0004) MISSED OFFSET
	struct FGameplayTagReferenceHelper                 ReferenceHelper;                                          // 0x0258(0x0010) (Edit)
	struct FName                                       GameplayCueName;                                          // 0x0268(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bAutoAttachToOwner;                                       // 0x0270(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsOverride;                                               // 0x0271(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerInstigator;                             // 0x0272(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerSourceObject;                           // 0x0273(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleOnActiveEvents;                             // 0x0274(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleWhileActiveEvents;                          // 0x0275(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0276(0x0002) MISSED OFFSET
	int                                                NumPreallocatedInstances;                                 // 0x0278(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x34];                                      // 0x027C(0x0034) MISSED OFFSET

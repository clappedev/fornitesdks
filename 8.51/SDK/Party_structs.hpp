...
{
public:
	uint8                                        Pad_F81[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F84[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                PlatformSessionId;                                 // 0xB8(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_F85[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F86[0x37];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F88[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F8A[0x35];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F8B[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

...
public:
	...
	uint8                                        Pad_4EE2[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class AB_Beam_C*                             CallFunc_FinishSpawningActor_ReturnValue;          // 0x228(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

...
{
public:
	uint8                                        Pad_DE3[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DE4[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DE6[0xA8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DE8[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DEA[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DEB[0x40];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DEC[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TSubclassOf<class USocialInteractionMenu>    ActionMenuClass;                                   // 0x3A8(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USocialInteractionMenu*                ActionMenu;                                        // 0x3B0(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_DF0[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]

...
{
	static auto Func = Class->GetFunction("GCN_Athena_Item_Ashton_Turbo_LeapAttack_Impact_C", "OnBurst");

	Params::UGCN_Athena_Item_Ashton_Turbo_LeapAttack_Impact_C_OnBurst_Params Parms;

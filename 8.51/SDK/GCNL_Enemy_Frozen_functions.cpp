...
{
	static auto Func = Class->GetFunction("GCNL_Enemy_Frozen_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCNL_Enemy_Frozen_C", "OnRemoval");
...
{
	static auto Func = Class->GetFunction("GCNL_Enemy_Frozen_C", "ExecuteUbergraph_GCNL_Enemy_Frozen");

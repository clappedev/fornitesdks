...
{
	static auto Func = Class->GetFunction("GCNL_Perk_H_CorruptedAura_ImpactV2_C", "OnRemoval");

	Params::AGCNL_Perk_H_CorruptedAura_ImpactV2_C_OnRemoval_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Perk_H_CorruptedAura_ImpactV2_C", "OnLoopingStart");

	Params::AGCNL_Perk_H_CorruptedAura_ImpactV2_C_OnLoopingStart_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;

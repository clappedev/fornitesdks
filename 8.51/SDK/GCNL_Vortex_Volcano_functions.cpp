...
{
	static auto Func = Class->GetFunction("GCNL_Vortex_Volcano_C", "FadePPVol__FinishedFunc");

	Params::AGCNL_Vortex_Volcano_C_FadePPVol__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Vortex_Volcano_C", "FadePPVol__UpdateFunc");

	Params::AGCNL_Vortex_Volcano_C_FadePPVol__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Vortex_Volcano_C", "OnLoopingStart");

	Params::AGCNL_Vortex_Volcano_C_OnLoopingStart_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Vortex_Volcano_C", "OnRemoval");

	Params::AGCNL_Vortex_Volcano_C_OnRemoval_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;

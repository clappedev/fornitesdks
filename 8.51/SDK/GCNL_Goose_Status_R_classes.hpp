...
{
// 0x18 (0x7A8 - 0x790)
// BlueprintGeneratedClass GCNL_Goose_Status_R.GCNL_Goose_Status_R_C
class AGCNL_Goose_Status_R_C : public AFortGameplayCueNotify_Loop
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GCNL_Goose_Status_R_C");
		return Clss;
	}

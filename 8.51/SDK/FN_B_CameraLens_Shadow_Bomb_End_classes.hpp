...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_CameraLens_Shadow_Bomb_End.B_CameraLens_Shadow_Bomb_End_C");
		return ptr;
	}


	void ReceiveBeginPlay();
	void ExecuteUbergraph_B_CameraLens_Shadow_Bomb_End(int EntryPoint);
};

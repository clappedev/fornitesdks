...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0600(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Foliage.FoliageInstancedStaticMeshComponent.OnInstanceTakePointDamage
	unsigned char                                      UnknownData01[0x10];                                      // 0x0610(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Foliage.FoliageInstancedStaticMeshComponent.OnInstanceTakeRadialDamage

...
{
public:
	class UCommonTextBlock*                      TextHave;                                          // 0x238(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class FText                                  DisplayText;                                       // 0x240(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)

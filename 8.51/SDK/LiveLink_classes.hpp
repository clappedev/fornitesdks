...
public:
	...
	uint8                                        Pad_F05[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F07[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F08[0xA8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F09[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]

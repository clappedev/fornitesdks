...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Goose_Status_VR.GCNL_Goose_Status_VR_C.OnLoopingStart");

	AGCNL_Goose_Status_VR_C_OnLoopingStart_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Goose_Status_VR.GCNL_Goose_Status_VR_C.OnRemoval");

	AGCNL_Goose_Status_VR_C_OnRemoval_Params params;
	params.MyTarget = MyTarget;
	params.Parameters = Parameters;
	params.ParticleComponents = ParticleComponents;
	params.AudioComponents = AudioComponents;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Goose_Status_VR.GCNL_Goose_Status_VR_C.OnApplication");

	AGCNL_Goose_Status_VR_C_OnApplication_Params params;
	params.MyTarget = MyTarget;
	params.Parameters = Parameters;
	params.ParticleComponents = ParticleComponents;
	params.AudioComponents = AudioComponents;
...
void AGCNL_Goose_Status_VR_C::ExecuteUbergraph_GCNL_Goose_Status_VR(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Goose_Status_VR.GCNL_Goose_Status_VR_C.ExecuteUbergraph_GCNL_Goose_Status_VR");

	AGCNL_Goose_Status_VR_C_ExecuteUbergraph_GCNL_Goose_Status_VR_Params params;

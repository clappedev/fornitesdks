...
{
	static auto Func = Class->GetFunction("GCNL_Goose_Status_VR_C", "OnLoopingStart");

	Params::AGCNL_Goose_Status_VR_C_OnLoopingStart_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Goose_Status_VR_C", "OnRemoval");

	Params::AGCNL_Goose_Status_VR_C_OnRemoval_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;
...
{
	static auto Func = Class->GetFunction("GCNL_Goose_Status_VR_C", "OnApplication");

	Params::AGCNL_Goose_Status_VR_C_OnApplication_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;
...
{
	static auto Func = Class->GetFunction("GCNL_Goose_Status_VR_C", "ExecuteUbergraph_GCNL_Goose_Status_VR");

	Params::AGCNL_Goose_Status_VR_C_ExecuteUbergraph_GCNL_Goose_Status_VR_Params Parms;

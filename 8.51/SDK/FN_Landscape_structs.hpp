...
struct FProceduralLayer
{
	...
	TArray<struct FLandscapeProceduralLayerBrush>      Brushes;                                                  // 0x0028(0x0010) (ZeroConstructor)
	TArray<int8_t>                                     HeightmapBrushOrderIndices;                               // 0x0038(0x0010) (ZeroConstructor)
	TArray<int8_t>                                     WeightmapBrushOrderIndices;                               // 0x0048(0x0010) (ZeroConstructor)
	TMap<class ULandscapeLayerInfoObject*, bool>       WeightmapLayerAllocationBlend;                            // 0x0058(0x0050) (ZeroConstructor)
};
...
{
	TArray<class UTexture2D*>                          Weightmaps;                                               // 0x0000(0x0010) (ZeroConstructor)
	TArray<struct FWeightmapLayerAllocationInfo>       WeightmapLayerAllocations;                                // 0x0010(0x0010) (ZeroConstructor)
...
struct FProceduralLayerData
{
	...
	TMap<class ULandscapeComponent*, struct FWeightmapLayerData> WeightmapData;                                            // 0x0050(0x0050) (ZeroConstructor)
};

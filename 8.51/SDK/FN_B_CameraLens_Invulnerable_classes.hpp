...
class AB_CameraLens_Invulnerable_C : public AEmitterCameraLensEffectBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_CameraLens_Invulnerable.B_CameraLens_Invulnerable_C");
		return ptr;
	}


	void ReceiveBeginPlay();
	void ExecuteUbergraph_B_CameraLens_Invulnerable(int EntryPoint);
};

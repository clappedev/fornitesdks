...
class UGA_Athena_PushCannon_Fired_C : public UFortGameplayAbility
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GA_Athena_PushCannon_Fired.GA_Athena_PushCannon_Fired_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GA_Athena_PushCannon_Fired(int EntryPoint);
};

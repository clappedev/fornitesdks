...
{
public:
	uint8                                        Pad_F0D[0x140];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_F0F[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_F10[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F12[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

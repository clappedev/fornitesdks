...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCN_Ashton_Chicago_ShieldToss.GCN_Ashton_Chicago_ShieldToss_C.OnBurst");

	UGCN_Ashton_Chicago_ShieldToss_C_OnBurst_Params params;

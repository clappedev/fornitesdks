...
{
public:
	uint8                                        Pad_2E16[0x80];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2E1A[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2E1B[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2E1D[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

...
{
	static auto Func = Class->GetFunction("GCNL_Taker_Vlad_Berzerker_Phase3_C", "OnRemove");
...
bool AGCNL_Taker_Vlad_Berzerker_Phase3_C::OnActive(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, class AEnemyPawn_Parent_C* K2Node_DynamicCast_AsEnemy_Pawn_Parent, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static auto Func = Class->GetFunction("GCNL_Taker_Vlad_Berzerker_Phase3_C", "OnActive");

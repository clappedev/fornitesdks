...
public:
	...
	enum class ESlateVisibility                  K2Node_Select_Default_1;                           // 0xD1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_bVisible;                             // 0xD2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

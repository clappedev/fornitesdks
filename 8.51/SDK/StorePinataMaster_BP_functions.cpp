...
{
	static auto Func = Class->GetFunction("StorePinataMaster_BP_C", "TransitionFromOpeningPacks");

	Params::AStorePinataMaster_BP_C_TransitionFromOpeningPacks_Params Parms;
...
{
	static auto Func = Class->GetFunction("StorePinataMaster_BP_C", "HideAllOpeningPacksMeshes");

	Params::AStorePinataMaster_BP_C_HideAllOpeningPacksMeshes_Params Parms;
...
{
	static auto Func = Class->GetFunction("StorePinataMaster_BP_C", "StartChoiceCardFlip");

	Params::AStorePinataMaster_BP_C_StartChoiceCardFlip_Params Parms;

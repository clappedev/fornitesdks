...
{
	static auto fn = UObject::FindObject<UFunction>("Function FrontEndRewards_ChoiceRewards.FrontEndRewards_ChoiceRewards_C.OnInitialized");

	UFrontEndRewards_ChoiceRewards_C_OnInitialized_Params params;

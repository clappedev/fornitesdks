...
{
	static auto Func = Class->GetFunction("GCNL_Goose_Status_UC_C", "OnLoopingStart");

	Params::AGCNL_Goose_Status_UC_C_OnLoopingStart_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Goose_Status_UC_C", "OnRemoval");

	Params::AGCNL_Goose_Status_UC_C_OnRemoval_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;
...
{
	static auto Func = Class->GetFunction("GCNL_Goose_Status_UC_C", "OnApplication");

	Params::AGCNL_Goose_Status_UC_C_OnApplication_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;

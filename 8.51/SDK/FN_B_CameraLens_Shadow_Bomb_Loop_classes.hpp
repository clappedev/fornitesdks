...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_CameraLens_Shadow_Bomb_Loop.B_CameraLens_Shadow_Bomb_Loop_C");
		return ptr;
	}


	void ReceiveBeginPlay();
	void ExecuteUbergraph_B_CameraLens_Shadow_Bomb_Loop(int EntryPoint);
};

...
void UFullPartyMember_C::SetupParticipatingState()
{
	static auto fn = UObject::FindObject<UFunction>("Function FullPartyMember.FullPartyMember_C.SetupParticipatingState");

	UFullPartyMember_C_SetupParticipatingState_Params params;
...
// Parameters:
// struct FUniqueNetIdRepl        UniqueId                       (Parm, OutParm)

void UFullPartyMember_C::GetMemberUniqueId(struct FUniqueNetIdRepl* UniqueId)
{
	static auto fn = UObject::FindObject<UFunction>("Function FullPartyMember.FullPartyMember_C.GetMemberUniqueId");

	UFullPartyMember_C_GetMemberUniqueId_Params params;

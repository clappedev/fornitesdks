...
void UFortMediaSubtitlesPlayer::Stop()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SubtitlesWidgets.FortMediaSubtitlesPlayer.Stop");
...
void UFortMediaSubtitlesPlayer::SetSubtitles(class UOverlays* Subtitles)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SubtitlesWidgets.FortMediaSubtitlesPlayer.SetSubtitles");
...
void UFortMediaSubtitlesPlayer::Play()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SubtitlesWidgets.FortMediaSubtitlesPlayer.Play");
...
void UFortMediaSubtitlesPlayer::BindToMediaPlayer(class UMediaPlayer* InMediaPlayer)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SubtitlesWidgets.FortMediaSubtitlesPlayer.BindToMediaPlayer");
...
bool USubtitleDisplay::HasSubtitles()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SubtitlesWidgets.SubtitleDisplay.HasSubtitles");

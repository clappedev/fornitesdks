...
void UErrorLlama_C::HandleInputTypeChanged(ECommonInputType NewInputType)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ErrorLlama.ErrorLlama_C.HandleInputTypeChanged");
...
void UErrorLlama_C::Construct()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ErrorLlama.ErrorLlama_C.Construct");
...
void UErrorLlama_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ErrorLlama.ErrorLlama_C.Tick");
...
void UErrorLlama_C::RandomizeColor()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ErrorLlama.ErrorLlama_C.RandomizeColor");
...
void UErrorLlama_C::HandleNormalizedInputDirection(const struct FVector2D& _2DInputVec)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ErrorLlama.ErrorLlama_C.HandleNormalizedInputDirection");
...
void UErrorLlama_C::ExecuteUbergraph_ErrorLlama(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ErrorLlama.ErrorLlama_C.ExecuteUbergraph_ErrorLlama");

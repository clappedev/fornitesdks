...
class UGCN_Athena_PetrolPickup_HitWorld_C : public UFortGameplayCueNotify_Burst
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GCN_Athena_PetrolPickup_HitWorld.GCN_Athena_PetrolPickup_HitWorld_C");

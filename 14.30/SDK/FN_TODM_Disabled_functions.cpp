...
void ATODM_Disabled_C::UserConstructionScript()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function TODM_Disabled.TODM_Disabled_C.UserConstructionScript");
...
void ATODM_Disabled_C::DisableLightAndFog(bool Enable)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function TODM_Disabled.TODM_Disabled_C.DisableLightAndFog");
...
void ATODM_Disabled_C::ReceiveBeginPlay()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function TODM_Disabled.TODM_Disabled_C.ReceiveBeginPlay");
...
void ATODM_Disabled_C::ExecuteUbergraph_TODM_Disabled(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function TODM_Disabled.TODM_Disabled_C.ExecuteUbergraph_TODM_Disabled");

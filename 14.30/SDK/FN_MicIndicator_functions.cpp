...
void UMicIndicator_C::OnPlayerTalkingChanged(bool bIsTalking)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function MicIndicator.MicIndicator_C.OnPlayerTalkingChanged");
...
void UMicIndicator_C::OnPlayerMuted(bool bIsMuted)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function MicIndicator.MicIndicator_C.OnPlayerMuted");
...
void UMicIndicator_C::ExecuteUbergraph_MicIndicator(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function MicIndicator.MicIndicator_C.ExecuteUbergraph_MicIndicator");

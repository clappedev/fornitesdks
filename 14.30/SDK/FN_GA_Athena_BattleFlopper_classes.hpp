...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GA_Athena_BattleFlopper.GA_Athena_BattleFlopper_C");
	...
	void ExecuteUbergraph_GA_Athena_BattleFlopper(int EntryPoint);
};

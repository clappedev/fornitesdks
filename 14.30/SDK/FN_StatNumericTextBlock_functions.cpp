...
void UStatNumericTextBlock_C::SetComparisonState(EFortBuffState Buff_State)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StatNumericTextBlock.StatNumericTextBlock_C.SetComparisonState");
...
void UStatNumericTextBlock_C::UpdateComparison()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StatNumericTextBlock.StatNumericTextBlock_C.UpdateComparison");
...
void UStatNumericTextBlock_C::Construct()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StatNumericTextBlock.StatNumericTextBlock_C.Construct");
...
void UStatNumericTextBlock_C::PreConstruct(bool IsDesignTime)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StatNumericTextBlock.StatNumericTextBlock_C.PreConstruct");
...
void UStatNumericTextBlock_C::ExecuteUbergraph_StatNumericTextBlock(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StatNumericTextBlock.StatNumericTextBlock_C.ExecuteUbergraph_StatNumericTextBlock");

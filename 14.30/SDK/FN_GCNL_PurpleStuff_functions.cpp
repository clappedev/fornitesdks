...
bool AGCNL_PurpleStuff_C::OnRemove(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCNL_PurpleStuff.GCNL_PurpleStuff_C.OnRemove");
...
bool AGCNL_PurpleStuff_C::OnActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCNL_PurpleStuff.GCNL_PurpleStuff_C.OnActive");
...
void AGCNL_PurpleStuff_C::ReceiveBeginPlay()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCNL_PurpleStuff.GCNL_PurpleStuff_C.ReceiveBeginPlay");
...
void AGCNL_PurpleStuff_C::ReceiveTick(float DeltaSeconds)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCNL_PurpleStuff.GCNL_PurpleStuff_C.ReceiveTick");
...
void AGCNL_PurpleStuff_C::ExecuteUbergraph_GCNL_PurpleStuff(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCNL_PurpleStuff.GCNL_PurpleStuff_C.ExecuteUbergraph_GCNL_PurpleStuff");

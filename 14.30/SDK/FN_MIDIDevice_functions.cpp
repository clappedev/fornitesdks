...
void UMIDIDeviceManager::STATIC_GetMIDIOutputDeviceIDByName(const struct FString& DeviceName, int* DeviceID)
{
...
void UMIDIDeviceManager::STATIC_GetMIDIInputDeviceIDByName(const struct FString& DeviceName, int* DeviceID)
{
	static UFunction* fn = NULL;
	if(!fn)
...
void UMIDIDeviceManager::STATIC_GetDefaultIMIDIOutputDeviceID(int* DeviceID)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function MIDIDevice.MIDIDeviceManager.GetDefaultIMIDIOutputDeviceID");
...
void UMIDIDeviceManager::STATIC_GetDefaultIMIDIInputDeviceID(int* DeviceID)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function MIDIDevice.MIDIDeviceManager.GetDefaultIMIDIInputDeviceID");

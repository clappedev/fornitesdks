...
void UCinematic_TeamMics_C::Update(const struct FFortTeamMemberInfo& UpdatedMemberInfo)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic-TeamMics.Cinematic-TeamMics_C.Update");
...
void UCinematic_TeamMics_C::Construct()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic-TeamMics.Cinematic-TeamMics_C.Construct");
...
void UCinematic_TeamMics_C::ExecuteUbergraph_Cinematic_TeamMics(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic-TeamMics.Cinematic-TeamMics_C.ExecuteUbergraph_Cinematic-TeamMics");

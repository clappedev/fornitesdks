...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass StyleLibrary.StyleLibrary_C");
		
		return ptr;
	}


	void STATIC_Get_Conning_Color_From_Homebase_Rating(int HomeBaseRating, int DifficultyLevel, class UObject* __WorldContext, struct FLinearColor* DifficultyColor);
	...
	void STATIC_ResizeBrush(TEnumAsByte<EFortBrushSize> BrushSize, const struct FSlateBrush& BaseBrush, class UObject* __WorldContext, struct FSlateBrush* ResizedBrush);

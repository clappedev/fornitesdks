...
void ADA_Glider_Item_C::IsOnGround(bool* bOnGround)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function DA_Glider_Item.DA_Glider_Item_C.IsOnGround");
...
void ADA_Glider_Item_C::RaiseUsageError(const struct FGameplayTagContainer& FailedReason)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function DA_Glider_Item.DA_Glider_Item_C.RaiseUsageError");
...
void ADA_Glider_Item_C::BPPressTrigger(class AFortDecoHelper* FortDecoHelper)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function DA_Glider_Item.DA_Glider_Item_C.BPPressTrigger");
...
void ADA_Glider_Item_C::ExecuteUbergraph_DA_Glider_Item(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function DA_Glider_Item.DA_Glider_Item_C.ExecuteUbergraph_DA_Glider_Item");

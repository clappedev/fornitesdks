...
void UPistol_Revolver_SideAction_AnimBP_C::AnimGraph(struct FPoseLink* AnimGraph)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Pistol_Revolver_SideAction_AnimBP.Pistol_Revolver_SideAction_AnimBP_C.AnimGraph");

	UPistol_Revolver_SideAction_AnimBP_C_AnimGraph_Params params;
...
void UPistol_Revolver_SideAction_AnimBP_C::ExecuteUbergraph_Pistol_Revolver_SideAction_AnimBP(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Pistol_Revolver_SideAction_AnimBP.Pistol_Revolver_SideAction_AnimBP_C.ExecuteUbergraph_Pistol_Revolver_SideAction_AnimBP");

...
void UGAT_CommandoActiveAbility_C::K2_ActivateAbility()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GAT_CommandoActiveAbility.GAT_CommandoActiveAbility_C.K2_ActivateAbility");
...
void UGAT_CommandoActiveAbility_C::ExecuteUbergraph_GAT_CommandoActiveAbility(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GAT_CommandoActiveAbility.GAT_CommandoActiveAbility_C.ExecuteUbergraph_GAT_CommandoActiveAbility");

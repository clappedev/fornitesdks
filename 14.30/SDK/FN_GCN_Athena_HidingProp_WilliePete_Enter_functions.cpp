...
void UGCN_Athena_HidingProp_WilliePete_Enter_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_HidingProp_WilliePete_Enter.GCN_Athena_HidingProp_WilliePete_Enter_C.OnBurst");

	UGCN_Athena_HidingProp_WilliePete_Enter_C_OnBurst_Params params;

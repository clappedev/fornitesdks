...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("AnimBlueprintGeneratedClass BP_StormTrackerSniper.BP_StormTrackerSniper_C");
	...
	void ExecuteUbergraph_BP_StormTrackerSniper(int EntryPoint);
};

...
struct FMovieSceneSectionParameters
{
	...
	int                                                HierarchicalBias;                                         // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneEvaluationFieldEntityMetaData
{
	...
	unsigned char                                      bEvaluateInSequencePreRoll : 1;                           // 0x0009(0x0001)
	unsigned char                                      bEvaluateInSequencePostRoll : 1;                          // 0x0009(0x0001)

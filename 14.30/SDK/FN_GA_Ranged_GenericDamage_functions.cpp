...
void UGA_Ranged_GenericDamage_C::GetEventData(const struct FGameplayTag& EventTag, struct FGameplayEventData* GameplayEventData)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GA_Ranged_GenericDamage.GA_Ranged_GenericDamage_C.GetEventData");
...
void UGA_Ranged_GenericDamage_C::K2_CommitExecute()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GA_Ranged_GenericDamage.GA_Ranged_GenericDamage_C.K2_CommitExecute");

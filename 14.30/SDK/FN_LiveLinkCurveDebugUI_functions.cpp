...
void ULiveLinkDebuggerBlueprintLibrary::STATIC_HideLiveLinkDebugger()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LiveLinkCurveDebugUI.LiveLinkDebuggerBlueprintLibrary.HideLiveLinkDebugger");
...
void ULiveLinkDebuggerBlueprintLibrary::STATIC_DisplayLiveLinkDebugger(const struct FString& SubjectName)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LiveLinkCurveDebugUI.LiveLinkDebuggerBlueprintLibrary.DisplayLiveLinkDebugger");
...
float ULiveLinkDebuggerSettings::GetDPIScaleBasedOnSize(const struct FIntPoint& Size)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LiveLinkCurveDebugUI.LiveLinkDebuggerSettings.GetDPIScaleBasedOnSize");
...
struct FSlateColor ULiveLinkDebuggerSettings::GetBarColorForCurveValue(float CurveValue)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LiveLinkCurveDebugUI.LiveLinkDebuggerSettings.GetBarColorForCurveValue");

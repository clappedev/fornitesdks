...
void Uwindowchromebuttons_C::OnMouseEnter(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function windowchromebuttons.windowchromebuttons_C.OnMouseEnter");
...
void Uwindowchromebuttons_C::OnMouseLeave(const struct FPointerEvent& MouseEvent)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function windowchromebuttons.windowchromebuttons_C.OnMouseLeave");
...
void Uwindowchromebuttons_C::ExecuteUbergraph_windowchromebuttons(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function windowchromebuttons.windowchromebuttons_C.ExecuteUbergraph_windowchromebuttons");

...
void UGCN_Athena_GenericHeldObject_Throw_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_GenericHeldObject_Throw.GCN_Athena_GenericHeldObject_Throw_C.OnBurst");

	UGCN_Athena_GenericHeldObject_Throw_C_OnBurst_Params params;

...
void UGC_Athena_Feedback_ExplosionSmall_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GC_Athena_Feedback_ExplosionSmall.GC_Athena_Feedback_ExplosionSmall_C.OnBurst");

	UGC_Athena_Feedback_ExplosionSmall_C_OnBurst_Params params;

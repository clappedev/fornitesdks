...
struct FSlateBrush UTooltip_Custom_S_C::Get_Icon_Brush()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Tooltip-Custom-S.Tooltip-Custom-S_C.Get Icon Brush");
...
struct FText UTooltip_Custom_S_C::Get_Header_Text()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Tooltip-Custom-S.Tooltip-Custom-S_C.Get Header Text");
...
struct FText UTooltip_Custom_S_C::Get_Body_Text()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Tooltip-Custom-S.Tooltip-Custom-S_C.Get Body Text");
...
void UTooltip_Custom_S_C::Construct()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Tooltip-Custom-S.Tooltip-Custom-S_C.Construct");
...
void UTooltip_Custom_S_C::ExecuteUbergraph_Tooltip_Custom_S(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Tooltip-Custom-S.Tooltip-Custom-S_C.ExecuteUbergraph_Tooltip-Custom-S");

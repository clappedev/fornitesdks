...
void UGCN_Athena_GenericHeldObject_EnterWater_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_GenericHeldObject_EnterWater.GCN_Athena_GenericHeldObject_EnterWater_C.OnBurst");

	UGCN_Athena_GenericHeldObject_EnterWater_C_OnBurst_Params params;

...
class AB_Apple_Weap_Athena_C : public AB_UtilityItem_Generic_Athena_C
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass B_Apple_Weap_Athena.B_Apple_Weap_Athena_C");

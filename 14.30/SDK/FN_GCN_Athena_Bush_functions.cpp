...
void AGCN_Athena_Bush_C::OpacityFade__FinishedFunc()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_Bush.GCN_Athena_Bush_C.OpacityFade__FinishedFunc");
...
void AGCN_Athena_Bush_C::OpacityFade__UpdateFunc()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_Bush.GCN_Athena_Bush_C.OpacityFade__UpdateFunc");
...
void AGCN_Athena_Bush_C::ReceiveTick(float DeltaSeconds)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_Bush.GCN_Athena_Bush_C.ReceiveTick");
...
void AGCN_Athena_Bush_C::On_Player_Step()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_Bush.GCN_Athena_Bush_C.On Player Step");
...
void AGCN_Athena_Bush_C::OnLoopingStart(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_Bush.GCN_Athena_Bush_C.OnLoopingStart");
...
void AGCN_Athena_Bush_C::OnRemoval(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_Bush.GCN_Athena_Bush_C.OnRemoval");
...
void AGCN_Athena_Bush_C::ExecuteUbergraph_GCN_Athena_Bush(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_Bush.GCN_Athena_Bush_C.ExecuteUbergraph_GCN_Athena_Bush");

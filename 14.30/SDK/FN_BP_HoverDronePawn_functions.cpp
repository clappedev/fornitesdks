...
void ABP_HoverDronePawn_C::GetWindVolumeFromAltitude(float Altitude, float* Volume)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_HoverDronePawn.BP_HoverDronePawn_C.GetWindVolumeFromAltitude");
...
void ABP_HoverDronePawn_C::SetWindAudioEnabled(bool Enabled)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_HoverDronePawn.BP_HoverDronePawn_C.SetWindAudioEnabled");
...
void ABP_HoverDronePawn_C::ReceiveTick(float DeltaSeconds)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_HoverDronePawn.BP_HoverDronePawn_C.ReceiveTick");
...
void ABP_HoverDronePawn_C::Update_Wind_Audio()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_HoverDronePawn.BP_HoverDronePawn_C.Update Wind Audio");
...
void ABP_HoverDronePawn_C::ReceiveBeginPlay()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_HoverDronePawn.BP_HoverDronePawn_C.ReceiveBeginPlay");
...
void ABP_HoverDronePawn_C::ReceivePossessed(class AController* NewController)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_HoverDronePawn.BP_HoverDronePawn_C.ReceivePossessed");
...
void ABP_HoverDronePawn_C::ReceiveUnpossessed(class AController* OldController)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_HoverDronePawn.BP_HoverDronePawn_C.ReceiveUnpossessed");
...
void ABP_HoverDronePawn_C::ExecuteUbergraph_BP_HoverDronePawn(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_HoverDronePawn.BP_HoverDronePawn_C.ExecuteUbergraph_BP_HoverDronePawn");

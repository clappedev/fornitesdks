...
void UGCN_Player_InWater_HandSplash_Sprint_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Player_InWater_HandSplash_Sprint.GCN_Player_InWater_HandSplash_Sprint_C.OnBurst");

	UGCN_Player_InWater_HandSplash_Sprint_C_OnBurst_Params params;

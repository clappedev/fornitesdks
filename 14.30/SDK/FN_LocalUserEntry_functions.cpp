...
void ULocalUserEntry_C::HandleOnlineIndicatorView(ELocalUserOnlineStatus InLocalUserOnlineStatus)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LocalUserEntry.LocalUserEntry_C.HandleOnlineIndicatorView");
...
void ULocalUserEntry_C::BP_OnHovered()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LocalUserEntry.LocalUserEntry_C.BP_OnHovered");
...
void ULocalUserEntry_C::BP_OnUnhovered()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LocalUserEntry.LocalUserEntry_C.BP_OnUnhovered");
...
void ULocalUserEntry_C::OnOnlineStatusChanged(ELocalUserOnlineStatus OnlineStatus)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LocalUserEntry.LocalUserEntry_C.OnOnlineStatusChanged");
...
void ULocalUserEntry_C::ExecuteUbergraph_LocalUserEntry(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function LocalUserEntry.LocalUserEntry_C.ExecuteUbergraph_LocalUserEntry");

...
void USocialPanelTab_C::BP_OnHovered()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialPanelTab.SocialPanelTab_C.BP_OnHovered");
...
void USocialPanelTab_C::BP_OnUnhovered()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialPanelTab.SocialPanelTab_C.BP_OnUnhovered");
...
void USocialPanelTab_C::BP_OnSelected()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialPanelTab.SocialPanelTab_C.BP_OnSelected");
...
void USocialPanelTab_C::BP_OnDeselected()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialPanelTab.SocialPanelTab_C.BP_OnDeselected");
...
void USocialPanelTab_C::ExecuteUbergraph_SocialPanelTab(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialPanelTab.SocialPanelTab_C.ExecuteUbergraph_SocialPanelTab");

...
void UAlterationWidget_C::GetValidLazyTexture()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.GetValidLazyTexture");
...
void UAlterationWidget_C::HasValidTexture(bool* ValidBrush)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.HasValidTexture");
...
void UAlterationWidget_C::IsGamplaySlot(class UFortAlterationItemDefinition* Alteration, bool* Result)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.IsGamplaySlot");
...
void UAlterationWidget_C::TriggerTextAnimation()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.TriggerTextAnimation");
...
void UAlterationWidget_C::SetWidgetSettings(bool bInIncludeName, bool bInIncludeShortDescription, bool bInIncludeDescription, TEnumAsByte<EFortBrushSize> InIconSize, bool bInUseLargeFormatName, bool InShouldShowRarity)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.SetWidgetSettings");
...
void UAlterationWidget_C::InitLockedLayout()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.InitLockedLayout");
...
void UAlterationWidget_C::SetEvolutionDetails()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.SetEvolutionDetails");
...
void UAlterationWidget_C::UpdatePips()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.UpdatePips");
...
void UAlterationWidget_C::InitDescriptiveText()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.InitDescriptiveText");
...
void UAlterationWidget_C::InitIcon()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.InitIcon");
...
bool UAlterationWidget_C::ShouldFadeAlteration()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.ShouldFadeAlteration");
...
struct FLinearColor UAlterationWidget_C::GetHighlightColor()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.GetHighlightColor");
...
void UAlterationWidget_C::OnSetup()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.OnSetup");
...
void UAlterationWidget_C::ExecuteUbergraph_AlterationWidget(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function AlterationWidget.AlterationWidget_C.ExecuteUbergraph_AlterationWidget");

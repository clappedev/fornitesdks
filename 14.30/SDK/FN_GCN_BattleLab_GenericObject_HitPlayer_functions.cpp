...
void UGCN_BattleLab_GenericObject_HitPlayer_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_BattleLab_GenericObject_HitPlayer.GCN_BattleLab_GenericObject_HitPlayer_C.OnBurst");

	UGCN_BattleLab_GenericObject_HitPlayer_C_OnBurst_Params params;

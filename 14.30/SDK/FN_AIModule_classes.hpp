...
public:
	...
	unsigned char                                      bStartAILogicOnPossess : 1;                               // 0x02D0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x02D0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x02D0(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x02D0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x02D0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x02D0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x02D0(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0310(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.AIController.ReceiveMoveCompleted
...
public:
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x0180(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.AIPerceptionComponent.OnTargetPerceptionInfoUpdated
...
public:
	...
	TEnumAsByte<ECollisionChannel>                     DefaultSightCollisionChannel;                             // 0x009B(0x0001) (Edit, ZeroConstructor, Config, DisableEditOnInstance, GlobalConfig, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0259(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty AIModule.NavLinkProxy.OnSmartLinkReached
...
public:
	...
	bool STATIC_RegisterPerceptionStimuliSource(class UObject* WorldContextObject, class UAISense* Sense, class AActor* Target);
	void OnPerceptionStimuliSourceEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);
	class UAISense* STATIC_GetSenseClassForStimulus(class UObject* WorldContextObject, const struct FAIStimulus& Stimulus);
};
...
public:
	...
	unsigned char                                      bDefineArc : 1;                                           // 0x0208(0x0001) (Edit)
...
public:
	...
	class APawn* STATIC_SpawnAIFromClass(class UObject* WorldContextObject, class APawn* PawnClass, class UBehaviorTree* BehaviorTree, const struct FVector& Location, const struct FRotator& Rotation, bool bNoCollisionFail, class AActor* Owner);
...
public:
	...
	void SetValueAsClass(const struct FName& KeyName, class UObject* ClassValue);
	...
	class UObject* GetValueAsClass(const struct FName& KeyName);
...
public:
	...
	void STATIC_SetBlackboardValueAsClass(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, class UObject* Value);
	...
	class UObject* STATIC_GetBlackboardValueAsClass(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key);
...
public:
	...
	unsigned char                                      bIncludeContextLocation : 1;                              // 0x0168(0x0001) (Edit)
...
public:
	...
	unsigned char                                      bDefineArc : 1;                                           // 0x01C8(0x0001) (Edit)
...
public:
	...
	class UEnvQueryInstanceBlueprintWrapper* STATIC_RunEQSQuery(class UObject* WorldContextObject, class UEnvQuery* QueryTemplate, class UObject* Querier, TEnumAsByte<EEnvQueryRunMode> RunMode, class UEnvQueryInstanceBlueprintWrapper* WrapperClass);
};
...
public:
	...
	unsigned char                                      bDrawLabels : 1;                                          // 0x04F4(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x04F4(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x04F4(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x04F4(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x04F4(0x0001) (Edit)
...
public:
	...
	class UPawnAction* STATIC_CreateActionInstance(class UObject* WorldContextObject, class UPawnAction* ActionClass);
};

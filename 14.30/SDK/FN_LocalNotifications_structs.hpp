...
struct FLocalNotificationData
{
	...
	ELocalNotificationType                             Type;                                                     // 0x0001(0x0001) (ZeroConstructor, IsPlainOldData)
	ELocalNotificationEventType                        EventType;                                                // 0x0002(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5];                                       // 0x0003(0x0005) MISSED OFFSET
	TMap<ELocalNotificationParams, struct FString>     ParamsByName;                                             // 0x0008(0x0050)
	bool                                               LocalTime;                                                // 0x0058(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0059(0x0007) MISSED OFFSET
	struct FString                                     TitleKey;                                                 // 0x0060(0x0010) (ZeroConstructor)
	struct FString                                     BodyKey;                                                  // 0x0070(0x0010) (ZeroConstructor)
	struct FString                                     ActivationEvent;                                          // 0x0080(0x0010) (ZeroConstructor)
};

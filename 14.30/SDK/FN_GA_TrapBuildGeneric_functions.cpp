...
void UGA_TrapBuildGeneric_C::K2_ActivateAbility()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GA_TrapBuildGeneric.GA_TrapBuildGeneric_C.K2_ActivateAbility");
...
void UGA_TrapBuildGeneric_C::ExecuteUbergraph_GA_TrapBuildGeneric(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GA_TrapBuildGeneric.GA_TrapBuildGeneric_C.ExecuteUbergraph_GA_TrapBuildGeneric");

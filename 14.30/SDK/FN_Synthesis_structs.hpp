...
{
	struct FSoundModulationDestinationSettings         SampleRateModulation;                                     // 0x0000(0x0010) (Edit, BlueprintVisible)
	struct FSoundModulationDestinationSettings         BitModulation;                                            // 0x0010(0x0010) (Edit, BlueprintVisible)
};
...
struct FSourceEffectChorusSettings
{
	...
	struct FSoundModulationDestinationSettings         DepthModulation;                                          // 0x0008(0x0010) (Edit, BlueprintVisible)
	float                                              Frequency;                                                // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	struct FSoundModulationDestinationSettings         FrequencyModulation;                                      // 0x0020(0x0010) (Edit, BlueprintVisible)
	float                                              Feedback;                                                 // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	struct FSoundModulationDestinationSettings         FeedbackModulation;                                       // 0x0038(0x0010) (Edit, BlueprintVisible)
	float                                              WetLevel;                                                 // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x004C(0x0004) MISSED OFFSET
	struct FSoundModulationDestinationSettings         WetModulation;                                            // 0x0050(0x0010) (Edit, BlueprintVisible)
	float                                              DryLevel;                                                 // 0x0060(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0064(0x0004) MISSED OFFSET
	struct FSoundModulationDestinationSettings         DryModulation;                                            // 0x0068(0x0010) (Edit, BlueprintVisible)
	float                                              Spread;                                                   // 0x0078(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x007C(0x0004) MISSED OFFSET
	struct FSoundModulationDestinationSettings         SpreadModulation;                                         // 0x0080(0x0010) (Edit, BlueprintVisible)
};
...
struct FSourceEffectFilterAudioBusModulationSettings
{
	...
	ESourceEffectFilterParam                           FilterParam;                                              // 0x0014(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FSourceEffectMidSideSpreaderSettings
{
	...
	EStereoChannelMode                                 InputMode;                                                // 0x0004(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EStereoChannelMode                                 OutputMode;                                               // 0x0005(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FSourceEffectStereoDelaySettings
{
	...
	EStereoDelayFiltertype                             FilterType;                                               // 0x0019(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FSubmixEffectConvolutionReverbSettings
{
	...
	float                                              SurroundRearChannelBleedDb;                               // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bInvertRearChannelBleedPhase;                             // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSurroundRearChannelFlip;                                 // 0x0009(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x000A(0x0002) MISSED OFFSET
	float                                              SurroundRearChannelBleedAmount;                           // 0x000C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UAudioImpulseResponse*                       ImpulseResponse;                                          // 0x0010(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               AllowHArdwareAcceleration;                                // 0x0018(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
struct FSubmixEffectMultibandCompressorSettings
{
	...
	unsigned char                                      UnknownData00[0x2];                                       // 0x0002(0x0002) MISSED OFFSET
	float                                              LookAheadMsec;                                            // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bLinkChannels;                                            // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAnalogMode;                                              // 0x0009(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFourPole;                                                // 0x000A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x5];                                       // 0x000B(0x0005) MISSED OFFSET
	TArray<struct FDynamicsBandSettings>               Bands;                                                    // 0x0010(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
};

...
void UItemDetailsHeader_C::SetStyles()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ItemDetailsHeader.ItemDetailsHeader_C.SetStyles");
...
void UItemDetailsHeader_C::UpdateItemsForWidgets()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ItemDetailsHeader.ItemDetailsHeader_C.UpdateItemsForWidgets");
...
void UItemDetailsHeader_C::Construct()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ItemDetailsHeader.ItemDetailsHeader_C.Construct");
...
void UItemDetailsHeader_C::HandleDifferentItemToDetailSet()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ItemDetailsHeader.ItemDetailsHeader_C.HandleDifferentItemToDetailSet");
...
void UItemDetailsHeader_C::HandleDifferentItemToCompareSet()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ItemDetailsHeader.ItemDetailsHeader_C.HandleDifferentItemToCompareSet");
...
void UItemDetailsHeader_C::PreConstruct(bool IsDesignTime)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ItemDetailsHeader.ItemDetailsHeader_C.PreConstruct");
...
void UItemDetailsHeader_C::ExecuteUbergraph_ItemDetailsHeader(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ItemDetailsHeader.ItemDetailsHeader_C.ExecuteUbergraph_ItemDetailsHeader");

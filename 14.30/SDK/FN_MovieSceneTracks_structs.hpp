...
{
	class UCameraShake*                                ShakeClass;                                               // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	class UCameraShake*                                ShakeClass;                                               // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PlayScale;                                                // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECameraAnimPlaySpace>                  Playspace;                                                // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
...
struct FMovieSceneEventPtrs
{
	...
	unsigned char                                      UnknownData00[0x20];                                      // 0x0008(0x0020) UNKNOWN PROPERTY: FieldPathProperty MovieSceneTracks.MovieSceneEventPtrs.BoundObjectProperty
};
...
struct FMovieSceneEventSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      bFireEventsWhenForwards : 1;                              // 0x00A8(0x0001)
	unsigned char                                      bFireEventsWhenBackwards : 1;                             // 0x00A8(0x0001)

...
void UPowerRatingWidget_C::UpdateWidgetState()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PowerRatingWidget.PowerRatingWidget_C.UpdateWidgetState");
...
void UPowerRatingWidget_C::Construct()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PowerRatingWidget.PowerRatingWidget_C.Construct");
...
void UPowerRatingWidget_C::OnBasePowerRatingUpdated(int BasePowerRating)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PowerRatingWidget.PowerRatingWidget_C.OnBasePowerRatingUpdated");
...
void UPowerRatingWidget_C::OnTeamPowerRatingUpdated(int TeamPowerRating)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PowerRatingWidget.PowerRatingWidget_C.OnTeamPowerRatingUpdated");
...
void UPowerRatingWidget_C::OnPowerRatingProgressUpdated(float BaseRatingProgress, float TeamRatingProgress)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PowerRatingWidget.PowerRatingWidget_C.OnPowerRatingProgressUpdated");
...
void UPowerRatingWidget_C::PreConstruct(bool IsDesignTime)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PowerRatingWidget.PowerRatingWidget_C.PreConstruct");
...
void UPowerRatingWidget_C::OnTeamMembershipChanged()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PowerRatingWidget.PowerRatingWidget_C.OnTeamMembershipChanged");
...
void UPowerRatingWidget_C::ExecuteUbergraph_PowerRatingWidget(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PowerRatingWidget.PowerRatingWidget_C.ExecuteUbergraph_PowerRatingWidget");

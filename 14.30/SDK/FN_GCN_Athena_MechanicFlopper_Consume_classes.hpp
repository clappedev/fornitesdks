...
class UGCN_Athena_MechanicFlopper_Consume_C : public UFortGameplayCueNotify_Burst
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GCN_Athena_MechanicFlopper_Consume.GCN_Athena_MechanicFlopper_Consume_C");
	...
	void ExecuteUbergraph_GCN_Athena_MechanicFlopper_Consume(int EntryPoint);
};

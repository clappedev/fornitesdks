...
void AB_CameraLens_SpookyMist_Loop_C::ReceiveBeginPlay()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function B_CameraLens_SpookyMist_Loop.B_CameraLens_SpookyMist_Loop_C.ReceiveBeginPlay");
...
void AB_CameraLens_SpookyMist_Loop_C::ExecuteUbergraph_B_CameraLens_SpookyMist_Loop(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function B_CameraLens_SpookyMist_Loop.B_CameraLens_SpookyMist_Loop_C.ExecuteUbergraph_B_CameraLens_SpookyMist_Loop");

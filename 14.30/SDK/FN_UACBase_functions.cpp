...
void UUACNetworkComponent::SendPacketToServer(unsigned char Type, TArray<unsigned char> Packet)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function UACBase.UACNetworkComponent.SendPacketToServer");
...
void UUACNetworkComponent::SendPacketToClient(unsigned char Type, TArray<unsigned char> Packet)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function UACBase.UACNetworkComponent.SendPacketToClient");
...
void UUACNetworkComponent::SendClientHello(uint32_t SessionKey)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function UACBase.UACNetworkComponent.SendClientHello");

...
void UGCN_BattleLab_GenericObject_EnterWater_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_BattleLab_GenericObject_EnterWater.GCN_BattleLab_GenericObject_EnterWater_C.OnBurst");

	UGCN_BattleLab_GenericObject_EnterWater_C_OnBurst_Params params;

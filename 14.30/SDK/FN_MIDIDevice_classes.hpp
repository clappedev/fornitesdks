...
public:
	...
	void STATIC_GetMIDIOutputDeviceIDByName(const struct FString& DeviceName, int* DeviceID);
	void STATIC_GetMIDIInputDeviceIDByName(const struct FString& DeviceName, int* DeviceID);
	void STATIC_GetDefaultIMIDIOutputDeviceID(int* DeviceID);
	void STATIC_GetDefaultIMIDIInputDeviceID(int* DeviceID);
	void STATIC_FindMIDIDevices(TArray<struct FFoundMIDIDevice>* OutMIDIDevices);
	void STATIC_FindAllMIDIDeviceInfo(TArray<struct FMIDIDeviceInfo>* OutMIDIInputDevices, TArray<struct FMIDIDeviceInfo>* OutMIDIOutputDevices);
	class UMIDIDeviceOutputController* STATIC_CreateMIDIDeviceOutputController(int DeviceID);
	class UMIDIDeviceInputController* STATIC_CreateMIDIDeviceInputController(int DeviceID, int MIDIBufferSize);

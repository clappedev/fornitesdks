...
struct UCommonButton_SetPressedSoundOverride_Params
{
...
struct UCommonButton_SetIsFocusable_Params
{
...
struct UCommonButton_SetHoveredSoundOverride_Params
{
	class USoundBase*                                  Sound;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UCommonButton_GetIsFocusable_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UCommonVisibilitySwitcher_OnActiveWidgetChangedLegacy__DelegateSignature_Params
{

...
public:
	...
	float                                              Timeline_0_LerpWhiteWash_7F6EEB5A42EA09E354D8B4A32C35C459;// 0x07C8(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_7F6EEB5A42EA09E354D8B4A32C35C459;   // 0x07CC(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GCNL_Athena_HidingProp_Teleporting_WilliePete.GCNL_Athena_HidingProp_Teleporting_WilliePete_C");
	...
	void ExecuteUbergraph_GCNL_Athena_HidingProp_Teleporting_WilliePete(int EntryPoint);
};

...
struct UGA_FuelEquipped_C_K2_ActivateAbility_Params
{
};

// Function GA_FuelEquipped.GA_FuelEquipped_C.K2_OnEndAbility
struct UGA_FuelEquipped_C_K2_OnEndAbility_Params
{
	bool                                               bWasCancelled;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function GA_FuelEquipped.GA_FuelEquipped_C.ExecuteUbergraph_GA_FuelEquipped
struct UGA_FuelEquipped_C_ExecuteUbergraph_GA_FuelEquipped_Params
{

...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GA_Athena_Flopper_Effective.GA_Athena_Flopper_Effective_C");
	...
	void ExecuteUbergraph_GA_Athena_Flopper_Effective(int EntryPoint);
};

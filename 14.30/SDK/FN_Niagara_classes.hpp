...
{
public:
	class UNiagaraSystem*                              Asset;                                                    // 0x0440(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraTickBehavior                               TickBehavior;                                             // 0x0448(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0449(0x0007) MISSED OFFSET
	struct FNiagaraUserRedirectionParameterStore       OverrideParameters;                                       // 0x0450(0x00C8)
	unsigned char                                      bForceSolo : 1;                                           // 0x0518(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x2B];                                      // 0x0519(0x002B) MISSED OFFSET
	unsigned char                                      bAutoDestroy : 1;                                         // 0x0544(0x0001)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x0544(0x0001)
	unsigned char                                      bAutoManageAttachment : 1;                                // 0x0544(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bAutoAttachWeldSimulatedBodies : 1;                       // 0x0544(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0545(0x0003) MISSED OFFSET
	float                                              MaxTimeBeforeForceUpdateTransform;                        // 0x0548(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x054C(0x0004) MISSED OFFSET
	TArray<struct FNiagaraMaterialOverride>            EmitterMaterials;                                         // 0x0550(0x0010) (ZeroConstructor, Transient, DuplicateTransient)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0560(0x0008) MISSED OFFSET
	unsigned char                                      UnknownData05[0x10];                                      // 0x0560(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Niagara.NiagaraComponent.OnSystemFinished
	TWeakObjectPtr<class USceneComponent>              AutoAttachParent;                                         // 0x0578(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData)
	struct FName                                       AutoAttachSocketName;                                     // 0x0580(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachLocationRule;                                   // 0x0588(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachRotationRule;                                   // 0x0589(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachScaleRule;                                      // 0x058A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FNiagaraPlatformSet                         Platforms;                                                // 0x0028(0x0020) (Edit)
	int                                                SortOrderHint;                                            // 0x0048(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsEnabled;                                               // 0x004C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bMotionBlurEnabled;                                       // 0x004D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x22];                                      // 0x004E(0x0022) MISSED OFFSET
...
{
public:
	class USceneComponent*                             ComponentType;                                            // 0x0070(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           ComponentCountLimit;                                      // 0x0078(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x007C(0x0004) MISSED OFFSET
	struct FNiagaraVariableAttributeBinding            EnabledBinding;                                           // 0x0080(0x0058) (Edit)
	bool                                               bAssignComponentsOnParticleID;                            // 0x00D8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOnlyCreateComponentsOnParticleSpawn;                     // 0x00D9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x00DA(0x0006) MISSED OFFSET
	class USceneComponent*                             TemplateComponent;                                        // 0x00E0(0x0008) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<struct FNiagaraComponentPropertyBinding>    PropertyBindings;                                         // 0x00E8(0x0010) (ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0x50];                                      // 0x0028(0x0050) UNKNOWN PROPERTY: SetProperty Niagara.NiagaraComponentSettings.SuppressActivationList
	unsigned char                                      UnknownData01[0x50];                                      // 0x0078(0x0050) UNKNOWN PROPERTY: SetProperty Niagara.NiagaraComponentSettings.ForceAutoPooolingList
	unsigned char                                      UnknownData02[0x50];                                      // 0x00C8(0x0050) UNKNOWN PROPERTY: SetProperty Niagara.NiagaraComponentSettings.SuppressEmitterList
...
public:
	...
	unsigned char                                      bUseLUT : 1;                                              // 0x0058(0x0001) (Edit)
	unsigned char                                      bExposeCurve : 1;                                         // 0x0058(0x0001) (Edit)
...
public:
	...
	unsigned char                                      bCreateRenderTarget : 1;                                  // 0x0118(0x0001) (Edit)
	ENiagaraGpuBufferFormat                            BufferFormat;                                             // 0x0119(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x56];                                      // 0x011A(0x0056) MISSED OFFSET
	TMap<uint64_t, class UTextureRenderTarget2D*>      ManagedRenderTargets;                                     // 0x0170(0x0050) (Transient)
...
{
public:
	struct FString                                     EmitterName;                                              // 0x00F8(0x0010) (Edit, ZeroConstructor)
	struct FString                                     DIName;                                                   // 0x0108(0x0010) (Edit, ZeroConstructor)
...
public:
	...
	TMap<uint64_t, class UTextureRenderTarget2D*>      ManagedRenderTargets;                                     // 0x0040(0x0050) (Transient)
...
public:
	...
	struct FNiagaraPlatformSet                         Platforms;                                                // 0x00C8(0x0020) (Edit)
	struct FNiagaraEmitterScalabilityOverrides         ScalabilityOverrides;                                     // 0x00E8(0x0010) (Edit)
	unsigned char                                      bInterpolatedSpawning : 1;                                // 0x00F8(0x0001) (Edit)
	unsigned char                                      bFixedBounds : 1;                                         // 0x00F8(0x0001) (Edit)
	unsigned char                                      bUseMinDetailLevel : 1;                                   // 0x00F8(0x0001) (Deprecated)
	unsigned char                                      bUseMaxDetailLevel : 1;                                   // 0x00F8(0x0001) (Deprecated)
	unsigned char                                      bOverrideGlobalSpawnCountScale : 1;                       // 0x00F8(0x0001) (Deprecated)
	unsigned char                                      bRequiresPersistentIDs : 1;                               // 0x00F8(0x0001) (Edit)
	unsigned char                                      bCombineEventSpawn : 1;                                   // 0x00F8(0x0001) (Edit)
	...
	uint32_t                                           DefaultShaderStageIndex;                                  // 0x0100(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           MaxUpdateIterations;                                      // 0x0104(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x50];                                      // 0x0108(0x0050) UNKNOWN PROPERTY: SetProperty Niagara.NiagaraEmitter.SpawnStages
	unsigned char                                      bSimulationStagesEnabled : 1;                             // 0x0158(0x0001) (Edit)
	unsigned char                                      bDeprecatedShaderStagesEnabled : 1;                       // 0x0158(0x0001) (Edit)
	unsigned char                                      bLimitDeltaTime : 1;                                      // 0x0158(0x0001) (Edit)
	unsigned char                                      UnknownData06[0x7];                                       // 0x0159(0x0007) MISSED OFFSET
	struct FString                                     UniqueEmitterName;                                        // 0x0160(0x0010) (ZeroConstructor)
	TArray<class UNiagaraRendererProperties*>          RendererProperties;                                       // 0x0170(0x0010) (ZeroConstructor)
	TArray<struct FNiagaraEventScriptProperties>       EventHandlerScriptProps;                                  // 0x0180(0x0010) (Edit, ZeroConstructor)
	TArray<class UNiagaraSimulationStageBase*>         SimulationStages;                                         // 0x0190(0x0010) (ZeroConstructor)
	class UNiagaraScript*                              GPUComputeScript;                                         // 0x01A0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FName>                               SharedEventGeneratorIds;                                  // 0x01A8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData07[0xC8];                                      // 0x01B8(0x00C8) MISSED OFFSET
...
{
public:
	unsigned char                                      bUseInverseSquaredFalloff : 1;                            // 0x0070(0x0001) (Edit)
	unsigned char                                      bAffectsTranslucency : 1;                                 // 0x0070(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0071(0x0003) MISSED OFFSET
	float                                              RadiusScale;                                              // 0x0074(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector                                     ColorAdd;                                                 // 0x0078(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0084(0x0004) MISSED OFFSET
	struct FNiagaraVariableAttributeBinding            LightRenderingEnabledBinding;                             // 0x0088(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            LightExponentBinding;                                     // 0x00E0(0x0058) (Edit)
	...
	struct FNiagaraVariableAttributeBinding            RadiusBinding;                                            // 0x01E8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            VolumetricScatteringBinding;                              // 0x0240(0x0058) (Edit)
	unsigned char                                      UnknownData02[0x30];                                      // 0x0298(0x0030) MISSED OFFSET
...
// 0x05E8 (0x0658 - 0x0070)
class UNiagaraMeshRendererProperties : public UNiagaraRendererProperties
{
public:
	class UStaticMesh*                                 ParticleMesh;                                             // 0x0070(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraSortMode                                   SortMode;                                                 // 0x0078(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0079(0x0003) MISSED OFFSET
	unsigned char                                      bOverrideMaterials : 1;                                   // 0x007C(0x0001) (Edit)
	unsigned char                                      bSortOnlyWhenTranslucent : 1;                             // 0x007C(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x007D(0x0003) MISSED OFFSET
	TArray<struct FNiagaraMeshMaterialOverride>        OverrideMaterials;                                        // 0x0080(0x0010) (Edit, ZeroConstructor)
	...
	ENiagaraMeshFacingMode                             FacingMode;                                               // 0x009C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x009D(0x0003) MISSED OFFSET
	unsigned char                                      bLockedAxisEnable : 1;                                    // 0x00A0(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x3];                                       // 0x00A1(0x0003) MISSED OFFSET
	struct FVector                                     LockedAxis;                                               // 0x00A4(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraMeshLockedAxisSpace                        LockedAxisSpace;                                          // 0x00B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x00B1(0x0003) MISSED OFFSET
	unsigned char                                      bEnableFrustumCulling : 1;                                // 0x00B4(0x0001) (Edit)
	unsigned char                                      bEnableCameraDistanceCulling : 1;                         // 0x00B4(0x0001) (Edit)
	unsigned char                                      UnknownData06[0x3];                                       // 0x00B5(0x0003) MISSED OFFSET
	float                                              MinCameraDistance;                                        // 0x00B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxCameraDistance;                                        // 0x00BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           RendererVisibility;                                       // 0x00C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x00C4(0x0004) MISSED OFFSET
	struct FNiagaraVariableAttributeBinding            PositionBinding;                                          // 0x00C8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            ColorBinding;                                             // 0x0120(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            VelocityBinding;                                          // 0x0178(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            MeshOrientationBinding;                                   // 0x01D0(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            ScaleBinding;                                             // 0x0228(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            SubImageIndexBinding;                                     // 0x0280(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterialBinding;                                   // 0x02D8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial1Binding;                                  // 0x0330(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial2Binding;                                  // 0x0388(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial3Binding;                                  // 0x03E0(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            MaterialRandomBinding;                                    // 0x0438(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            CustomSortingBinding;                                     // 0x0490(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            NormalizedAgeBinding;                                     // 0x04E8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            CameraOffsetBinding;                                      // 0x0540(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            RendererVisibilityTagBinding;                             // 0x0598(0x0058) (Edit)
	unsigned char                                      UnknownData08[0x68];                                      // 0x05F0(0x0068) MISSED OFFSET
...
// 0x0758 (0x07C8 - 0x0070)
class UNiagaraRibbonRendererProperties : public UNiagaraRendererProperties
{
public:
	class UMaterialInterface*                          Material;                                                 // 0x0070(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FNiagaraUserParameterBinding                MaterialUserParamBinding;                                 // 0x0078(0x0020) (Edit)
	ENiagaraRibbonFacingMode                           FacingMode;                                               // 0x0098(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0099(0x0003) MISSED OFFSET
	struct FNiagaraRibbonUVSettings                    UV0Settings;                                              // 0x009C(0x0024) (Edit)
	struct FNiagaraRibbonUVSettings                    UV1Settings;                                              // 0x00C0(0x0024) (Edit)
	ENiagaraRibbonDrawDirection                        DrawDirection;                                            // 0x00E4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00E5(0x0003) MISSED OFFSET
	float                                              CurveTension;                                             // 0x00E8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraRibbonTessellationMode                     TessellationMode;                                         // 0x00EC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00ED(0x0003) MISSED OFFSET
	int                                                TessellationFactor;                                       // 0x00F0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseConstantFactor;                                       // 0x00F4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x00F5(0x0003) MISSED OFFSET
	float                                              TessellationAngle;                                        // 0x00F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bScreenSpaceTessellation;                                 // 0x00FC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x00FD(0x0003) MISSED OFFSET
	struct FNiagaraVariableAttributeBinding            PositionBinding;                                          // 0x0100(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            ColorBinding;                                             // 0x0158(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            VelocityBinding;                                          // 0x01B0(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            NormalizedAgeBinding;                                     // 0x0208(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            RibbonTwistBinding;                                       // 0x0260(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            RibbonWidthBinding;                                       // 0x02B8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            RibbonFacingBinding;                                      // 0x0310(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            RibbonIdBinding;                                          // 0x0368(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            RibbonLinkOrderBinding;                                   // 0x03C0(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            MaterialRandomBinding;                                    // 0x0418(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterialBinding;                                   // 0x0470(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial1Binding;                                  // 0x04C8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial2Binding;                                  // 0x0520(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial3Binding;                                  // 0x0578(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            U0OverrideBinding;                                        // 0x05D0(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            V0RangeOverrideBinding;                                   // 0x0628(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            U1OverrideBinding;                                        // 0x0680(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            V1RangeOverrideBinding;                                   // 0x06D8(0x0058) (Edit)
	unsigned char                                      UnknownData05[0x98];                                      // 0x0730(0x0098) MISSED OFFSET
...
public:
	...
	struct FNiagaraVMExecutableData                    CachedScriptVM;                                           // 0x01B8(0x00D8)
	TArray<class UNiagaraParameterCollection*>         CachedParameterCollectionReferences;                      // 0x0290(0x0010) (ZeroConstructor)
	TArray<struct FNiagaraScriptDataInterfaceInfo>     CachedDefaultDataInterfaces;                              // 0x02A0(0x0010) (ZeroConstructor)
...
public:
	...
	TMap<struct FString, struct FText>                 ComponentRendererWarningsPerClass;                        // 0x0060(0x0050) (Edit, Config)
	class UNiagaraEffectType*                          DefaultEffectTypePtr;                                     // 0x00B0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      bSpawnOnly : 1;                                           // 0x0048(0x0001) (Edit)
	unsigned char                                      bDisablePartialParticleUpdate : 1;                        // 0x0048(0x0001) (Edit)
...
// 0x06B8 (0x0728 - 0x0070)
class UNiagaraSpriteRendererProperties : public UNiagaraRendererProperties
{
public:
	class UMaterialInterface*                          Material;                                                 // 0x0070(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraRendererSourceDataMode                     SourceMode;                                               // 0x0078(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0079(0x0007) MISSED OFFSET
	struct FNiagaraUserParameterBinding                MaterialUserParamBinding;                                 // 0x0080(0x0020) (Edit)
	ENiagaraSpriteAlignment                            Alignment;                                                // 0x00A0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraSpriteFacingMode                           FacingMode;                                               // 0x00A1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x00A2(0x0002) MISSED OFFSET
	struct FVector2D                                   PivotInUVSpace;                                           // 0x00A4(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraSortMode                                   SortMode;                                                 // 0x00AC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00AD(0x0003) MISSED OFFSET
	struct FVector2D                                   SubImageSize;                                             // 0x00B0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSubImageBlend : 1;                                       // 0x00B8(0x0001) (Edit)
	unsigned char                                      bRemoveHMDRollInVR : 1;                                   // 0x00B8(0x0001) (Edit)
	unsigned char                                      bSortOnlyWhenTranslucent : 1;                             // 0x00B8(0x0001) (Edit)
	unsigned char                                      bGpuLowLatencyTranslucency : 1;                           // 0x00B8(0x0001) (Edit)
	unsigned char                                      UnknownData03[0x3];                                       // 0x00B9(0x0003) MISSED OFFSET
	float                                              MinFacingCameraBlendDistance;                             // 0x00BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxFacingCameraBlendDistance;                             // 0x00C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x00C4(0x0004) MISSED OFFSET
	struct FNiagaraVariableAttributeBinding            PositionBinding;                                          // 0x00C8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            ColorBinding;                                             // 0x0120(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            VelocityBinding;                                          // 0x0178(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            SpriteRotationBinding;                                    // 0x01D0(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            SpriteSizeBinding;                                        // 0x0228(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            SpriteFacingBinding;                                      // 0x0280(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            SpriteAlignmentBinding;                                   // 0x02D8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            SubImageIndexBinding;                                     // 0x0330(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterialBinding;                                   // 0x0388(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial1Binding;                                  // 0x03E0(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial2Binding;                                  // 0x0438(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            DynamicMaterial3Binding;                                  // 0x0490(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            CameraOffsetBinding;                                      // 0x04E8(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            UVScaleBinding;                                           // 0x0540(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            MaterialRandomBinding;                                    // 0x0598(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            CustomSortingBinding;                                     // 0x05F0(0x0058) (Edit)
	struct FNiagaraVariableAttributeBinding            NormalizedAgeBinding;                                     // 0x0648(0x0058) (Edit)
	TArray<struct FNiagaraMaterialAttributeBinding>    MaterialParameterBindings;                                // 0x06A0(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData05[0x78];                                      // 0x06B0(0x0078) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData06[0xA8];                                      // 0x03C8(0x00A8) MISSED OFFSET

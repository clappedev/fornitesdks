...
struct FText UXpBarToolTip_C::GetBodyText()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function XpBarToolTip.XpBarToolTip_C.GetBodyText");
...
struct FText UXpBarToolTip_C::GetRestedXPText()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function XpBarToolTip.XpBarToolTip_C.GetRestedXPText");
...
struct FText UXpBarToolTip_C::GetBoostXPText()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function XpBarToolTip.XpBarToolTip_C.GetBoostXPText");
...
struct FText UXpBarToolTip_C::GetCommanderXPText()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function XpBarToolTip.XpBarToolTip_C.GetCommanderXPText");
...
struct FText UXpBarToolTip_C::GetHeaderText()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function XpBarToolTip.XpBarToolTip_C.GetHeaderText");

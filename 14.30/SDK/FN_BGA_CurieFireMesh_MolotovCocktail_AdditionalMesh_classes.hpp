...
class ABGA_CurieFireMesh_MolotovCocktail_AdditionalMesh_C : public ABGA_GenericCurieFuel_Parent_C
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BGA_CurieFireMesh_MolotovCocktail_AdditionalMesh.BGA_CurieFireMesh_MolotovCocktail_AdditionalMesh_C");

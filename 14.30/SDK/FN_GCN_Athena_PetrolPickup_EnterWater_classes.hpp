...
class UGCN_Athena_PetrolPickup_EnterWater_C : public UFortGameplayCueNotify_Burst
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GCN_Athena_PetrolPickup_EnterWater.GCN_Athena_PetrolPickup_EnterWater_C");

...
void UGC_Athena_Feedback_ExplosionSmall_SmallRadius_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GC_Athena_Feedback_ExplosionSmall_SmallRadius.GC_Athena_Feedback_ExplosionSmall_SmallRadius_C.OnBurst");

	UGC_Athena_Feedback_ExplosionSmall_SmallRadius_C_OnBurst_Params params;

...
public:
	...
	TArray<struct FString>                             ActorGuidStrings;                                         // 0x0218(0x0010) (ZeroConstructor, Deprecated)
...
public:
	...
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0308(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0318(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty MovieSceneTracks.MovieSceneAudioSection.OnAudioFinished
	unsigned char                                      UnknownData03[0x10];                                      // 0x0328(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty MovieSceneTracks.MovieSceneAudioSection.OnAudioPlaybackPercent
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x00E8(0x0008) MISSED OFFSET
	struct FGuid                                       CameraGuid;                                               // 0x00F0(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FMovieSceneObjectBindingID                  CameraBindingID;                                          // 0x0100(0x0018) (Edit)
...
public:
	...
	class UCameraShake*                                ShakeClass;                                               // 0x0108(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	struct FString                                     ShotDisplayName;                                          // 0x0160(0x0010) (ZeroConstructor)
	struct FText                                       DisplayName;                                              // 0x0170(0x0018) (Deprecated)

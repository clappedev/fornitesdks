...
bool UToyOptionsComponent_C::BlueprintOnLocalInteract(class AFortPlayerPawn* InteractingPawn)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ToyOptionsComponent.ToyOptionsComponent_C.BlueprintOnLocalInteract");
...
void UToyOptionsComponent_C::OnLoaded_E8F4D2FB4AB5542DE83E50B51A402D27(class UObject* Loaded)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ToyOptionsComponent.ToyOptionsComponent_C.OnLoaded_E8F4D2FB4AB5542DE83E50B51A402D27");
...
void UToyOptionsComponent_C::DisplayOptions(class APlayerController* InteractingPlayer)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ToyOptionsComponent.ToyOptionsComponent_C.DisplayOptions");
...
void UToyOptionsComponent_C::ExecuteUbergraph_ToyOptionsComponent(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ToyOptionsComponent.ToyOptionsComponent_C.ExecuteUbergraph_ToyOptionsComponent");

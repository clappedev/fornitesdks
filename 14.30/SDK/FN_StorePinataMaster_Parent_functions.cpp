...
void AStorePinataMaster_Parent_C::InitiatePinata()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StorePinataMaster_Parent.StorePinataMaster_Parent_C.InitiatePinata");
...
void AStorePinataMaster_Parent_C::CameraResetComplete()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StorePinataMaster_Parent.StorePinataMaster_Parent_C.CameraResetComplete");
...
void AStorePinataMaster_Parent_C::CameraTransitionComplete()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StorePinataMaster_Parent.StorePinataMaster_Parent_C.CameraTransitionComplete");
...
void AStorePinataMaster_Parent_C::ExecuteUbergraph_StorePinataMaster_Parent(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function StorePinataMaster_Parent.StorePinataMaster_Parent_C.ExecuteUbergraph_StorePinataMaster_Parent");

...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass TooltipLibrary.TooltipLibrary_C");
	...
	void STATIC_Create_Basic_Tooltip(class APlayerController* Owning_Player, const struct FText& Body_Text, const struct FText& Header_Text, class USlateBrushAsset* Icon_Brush, class UCommonTextStyle* Header_Style, class UCommonTextStyle* Body_Style, class UObject* __WorldContext, class UUserWidget** Output);
};

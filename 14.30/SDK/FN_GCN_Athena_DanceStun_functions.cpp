...
bool AGCN_Athena_DanceStun_C::OnRemove(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_DanceStun.GCN_Athena_DanceStun_C.OnRemove");
...
bool AGCN_Athena_DanceStun_C::OnActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_DanceStun.GCN_Athena_DanceStun_C.OnActive");
...
void AGCN_Athena_DanceStun_C::ReceiveTick(float DeltaSeconds)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_DanceStun.GCN_Athena_DanceStun_C.ReceiveTick");
...
void AGCN_Athena_DanceStun_C::ExecuteUbergraph_GCN_Athena_DanceStun(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_DanceStun.GCN_Athena_DanceStun_C.ExecuteUbergraph_GCN_Athena_DanceStun");

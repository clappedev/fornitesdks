...
// (Final, Native, Public, HasOutParms, BlueprintCallable)
// Parameters:
// struct FSoundModulationDestinationSettings InModulatorSettings            (ConstParm, Parm, OutParm, ReferenceParm)
...
void USourceEffectBitCrusherPreset::SetSampleRateModulator(const struct FSoundModulationDestinationSettings& InModulatorSettings)
{
	...
	params.InModulatorSettings = InModulatorSettings;
...
void USynthComponentMoto::SetSettings(const struct FMotoSynthRuntimeSettings& InSettings)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Synthesis.SynthComponentMoto.SetSettings");
...
void USynthComponentMoto::SetRPM(float InRPM, float InTimeSec)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Synthesis.SynthComponentMoto.SetRPM");
...
bool USynthComponentMoto::IsEnabled()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Synthesis.SynthComponentMoto.IsEnabled");
...
void USynthComponentMoto::GetRPMRange(float* OutMinRPM, float* OutMaxRPM)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Synthesis.SynthComponentMoto.GetRPMRange");

...
void UGA_Trap_BouncePad_Athena_C::K2_ActivateAbility()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GA_Trap_BouncePad_Athena.GA_Trap_BouncePad_Athena_C.K2_ActivateAbility");
...
void UGA_Trap_BouncePad_Athena_C::ExecuteUbergraph_GA_Trap_BouncePad_Athena(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GA_Trap_BouncePad_Athena.GA_Trap_BouncePad_Athena_C.ExecuteUbergraph_GA_Trap_BouncePad_Athena");

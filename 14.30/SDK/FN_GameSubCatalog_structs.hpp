...
struct FCatalogItemPrice
{
	...
	EAppStore                                          AppStoreId;                                               // 0x0048(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	int                                                DiscountedBasePrice;                                      // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                RegularBasePrice;                                         // 0x0004(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                FloorPrice;                                               // 0x0008(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<EStoreCurrencyType>                    CurrencyType;                                             // 0x000C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	struct FString                                     CurrencySubType;                                          // 0x0010(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	TEnumAsByte<ECatalogSaleType>                      DisplayType;                                              // 0x0020(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0021(0x0007) MISSED OFFSET
	TArray<struct FCatalogDynamicBundleItem>           BundleItems;                                              // 0x0028(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
};
...
struct FCatalogOffer
{
	...
	struct FCatalogDynamicBundle                       DynamicBundleInfo;                                        // 0x0048(0x0038) (Edit)
	int                                                DailyLimit;                                               // 0x0080(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                WeeklyLimit;                                              // 0x0084(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MonthlyLimit;                                             // 0x0088(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	TArray<struct FString>                             Categories;                                               // 0x0090(0x0010) (Edit, ZeroConstructor)
	struct FString                                     CatalogGroup;                                             // 0x00A0(0x0010) (Edit, ZeroConstructor)
	int                                                CatalogGroupPriority;                                     // 0x00B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SortPriority;                                             // 0x00B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FText                                       Title;                                                    // 0x00B8(0x0018) (Edit)
	struct FText                                       ShortDescription;                                         // 0x00D0(0x0018) (Edit)
	struct FText                                       Description;                                              // 0x00E8(0x0018) (Edit)
	struct FString                                     AppStoreId[0xB];                                          // 0x0100(0x0010) (Edit, ZeroConstructor)
	struct FCatalogMetaAssetInfo                       MetaAssetInfo;                                            // 0x01B0(0x0030)
	struct FString                                     DisplayAssetPath;                                         // 0x01E0(0x0010) (ZeroConstructor)
	TArray<struct FItemQuantity>                       ItemGrants;                                               // 0x01F0(0x0010) (ZeroConstructor)
	TArray<struct FCatalogOfferRequirement>            Requirements;                                             // 0x0200(0x0010) (ZeroConstructor)
	struct FCatalogGiftInfo                            GiftInfo;                                                 // 0x0210(0x0028)
	bool                                               Refundable;                                               // 0x0238(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0239(0x0007) MISSED OFFSET
	TArray<struct FString>                             DenyItemTemplateIds;                                      // 0x0240(0x0010) (ZeroConstructor, Deprecated)
};
...
{
	EAppStore                                          AppStore;                                                 // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET

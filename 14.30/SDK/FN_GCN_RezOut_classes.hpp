...
public:
	...
	float                                              TFX_ResOutCharacterMesh_LightIntensity_E9C2D3554642468472CCCFA609A39FBC;// 0x0468(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              TFX_ResOutCharacterMesh_ZHeightParam_E9C2D3554642468472CCCFA609A39FBC;// 0x046C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              TFX_ResOutCharacterMesh_TransitionParam_E9C2D3554642468472CCCFA609A39FBC;// 0x0470(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    TFX_ResOutCharacterMesh__Direction_E9C2D3554642468472CCCFA609A39FBC;// 0x0474(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	float                                              TFX_GlowCharacterMesh_EmissiveWarp_39A37BC9407CF090A09ABDA5A488F776;// 0x0480(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    TFX_GlowCharacterMesh__Direction_39A37BC9407CF090A09ABDA5A488F776;// 0x0484(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x50];                                      // 0x04F0(0x0050) UNKNOWN PROPERTY: SetProperty GCN_RezOut.GCN_RezOut_C.Dissolve
	...
	class UNiagaraComponent*                           Spawned_Death_VFX;                                        // 0x0588(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	class UNiagaraSystem*                              Dissolve_Visual_Effect;                                   // 0x0590(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       Dissolve_VFX_Spawn_Point_Name;                            // 0x0598(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAnimMontage*                                Base_Elimination_Montage;                                 // 0x05A0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAnimMontage*                                DBNO_Elimination_Montage;                                 // 0x05A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAnimMontage*                                Skydiving_Elimination_Montage;                            // 0x05B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAnimMontage*                                Swimming_Elimination_Montage;                             // 0x05B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAnimMontage*                                DBNO_Swimming_Elimination_Montage;                        // 0x05C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               Spawn_VFX_Attached;                                       // 0x05C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x05C9(0x0003) MISSED OFFSET
	float                                              Dissolve_Timeline_Playrate;                               // 0x05CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Glow_Timeline_Playrate;                                   // 0x05D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               DEBUG_REMOVESPAWNVFX;                                     // 0x05D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               DEBUG_REMOVESPAWNEDPOINTLIGHT;                            // 0x05D5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData08[0x2];                                       // 0x05D6(0x0002) MISSED OFFSET
	class UNiagaraSystem*                              Drone_Visual_Effect;                                      // 0x05D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       Drone_VFX_Attach_Point;                                   // 0x05E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GCN_RezOut.GCN_RezOut_C");
	...
	void ExecuteUbergraph_GCN_RezOut(int EntryPoint);
};

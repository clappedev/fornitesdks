...
void AWeakSpot_C::UserConstructionScript()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function WeakSpot.WeakSpot_C.UserConstructionScript");
...
void AWeakSpot_C::ScaleDownParticleTL__FinishedFunc()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function WeakSpot.WeakSpot_C.ScaleDownParticleTL__FinishedFunc");
...
void AWeakSpot_C::ScaleDownParticleTL__UpdateFunc()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function WeakSpot.WeakSpot_C.ScaleDownParticleTL__UpdateFunc");
...
void AWeakSpot_C::OnHit()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function WeakSpot.WeakSpot_C.OnHit");
...
void AWeakSpot_C::HideMesh()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function WeakSpot.WeakSpot_C.HideMesh");
...
void AWeakSpot_C::OnFadeOut()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function WeakSpot.WeakSpot_C.OnFadeOut");
...
void AWeakSpot_C::OnStartDirectionEffect()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function WeakSpot.WeakSpot_C.OnStartDirectionEffect");
...
void AWeakSpot_C::ExecuteUbergraph_WeakSpot(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function WeakSpot.WeakSpot_C.ExecuteUbergraph_WeakSpot");

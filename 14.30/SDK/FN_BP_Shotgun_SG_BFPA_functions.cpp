...
void UBP_Shotgun_SG_BFPA_C::AnimGraph(struct FPoseLink* AnimGraph)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_Shotgun_SG_BFPA.BP_Shotgun_SG_BFPA_C.AnimGraph");

	UBP_Shotgun_SG_BFPA_C_AnimGraph_Params params;
...
void UBP_Shotgun_SG_BFPA_C::ExecuteUbergraph_BP_Shotgun_SG_BFPA(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function BP_Shotgun_SG_BFPA.BP_Shotgun_SG_BFPA_C.ExecuteUbergraph_BP_Shotgun_SG_BFPA");

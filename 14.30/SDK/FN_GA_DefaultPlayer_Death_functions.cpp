...
void UGA_DefaultPlayer_Death_C::PickDeathMontageSection()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GA_DefaultPlayer_Death.GA_DefaultPlayer_Death_C.PickDeathMontageSection");
...
void UGA_DefaultPlayer_Death_C::ExecuteUbergraph_GA_DefaultPlayer_Death(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GA_DefaultPlayer_Death.GA_DefaultPlayer_Death_C.ExecuteUbergraph_GA_DefaultPlayer_Death");

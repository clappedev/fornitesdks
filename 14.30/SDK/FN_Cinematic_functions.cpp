...
void UCinematic_C::GetAudioTrackIndex(int* AudioTrack)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.GetAudioTrackIndex");
...
void UCinematic_C::StopAndClearSubtitles()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.StopAndClearSubtitles");
...
void UCinematic_C::ClearOldSubtitlesIfNecessary(bool NewSubtitlesExist, class UFortMediaSubtitlesPlayer* NewSubtitles)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.ClearOldSubtitlesIfNecessary");
...
void UCinematic_C::SetMoviePlaying(bool MoviePlaying)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.SetMoviePlaying");
...
void UCinematic_C::ClearMovieWidget(class UFortMovieWidget** MovieWidgetToClear)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.ClearMovieWidget");
...
void UCinematic_C::ClearMovieSlot(class UPanelWidget** MovieSlotToClear)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.ClearMovieSlot");
...
class UWidget* UCinematic_C::PopContentWidgetInternal(const struct FContentPushState& State)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.PopContentWidgetInternal");
...
void UCinematic_C::SkipMovie()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.SkipMovie");
...
void UCinematic_C::ClearMovie()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.ClearMovie");
...
// (Public, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UMediaPlayer*            MediaPlayer                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
// class ULegacy_MovieWidget_C*   MovieWidget                    (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, InstancedReference, ReferenceParm, IsPlainOldData)

void UCinematic_C::ShowMovie(class UMediaPlayer* MediaPlayer, class UMediaSource* MediaSource, class UNamedSlot** MovieSlot, class ULegacy_MovieWidget_C** MovieWidget)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.ShowMovie");
...
void UCinematic_C::Construct()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.Construct");
...
void UCinematic_C::HandleClientEvent_QueueCinematic(class UObject* EventSource, class UObject* EventFocus, const struct FFortClientEvent& ClientEvent)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.HandleClientEvent_QueueCinematic");
...
void UCinematic_C::Destruct()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.Destruct");
...
void UCinematic_C::HandleEndReached()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.HandleEndReached");
...
void UCinematic_C::HandleClientEvent_SkipCinematic(class UObject* EventSource, class UObject* EventFocus, const struct FFortClientEvent& ClientEvent)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.HandleClientEvent_SkipCinematic");
...
void UCinematic_C::PushContentWidgetInternal(class UWidget* Widget, const struct FContentPushState& State)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.PushContentWidgetInternal");
...
void UCinematic_C::OnEnterState(EFortUIState PreviousUIState)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.OnEnterState");
...
void UCinematic_C::OnExitState(EFortUIState NextUIState)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function Cinematic.Cinematic_C.OnExitState");

...
class UGA_Athena_TowerGrenade_Secondary_C : public UGA_Athena_Grenade_ThrowWithTrajectory_Secondary_Parent_C
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GA_Athena_TowerGrenade_Secondary.GA_Athena_TowerGrenade_Secondary_C");
	...
	void ExecuteUbergraph_GA_Athena_TowerGrenade_Secondary(int EntryPoint);
};

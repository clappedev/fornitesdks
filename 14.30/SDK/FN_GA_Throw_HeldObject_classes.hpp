...
public:
	...
	class AB_HeldObject_Parent_C*                      HeldObject;                                               // 0x0C50(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GA_Throw_HeldObject.GA_Throw_HeldObject_C");
	...
	void ExecuteUbergraph_GA_Throw_HeldObject(int EntryPoint);
};

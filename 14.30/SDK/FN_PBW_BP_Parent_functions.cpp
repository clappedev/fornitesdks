...
void APBW_BP_Parent_C::OnRep_Random_Chance()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PBW_BP_Parent.PBW_BP_Parent_C.OnRep_Random Chance");
...
void APBW_BP_Parent_C::ReceiveBeginPlay()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PBW_BP_Parent.PBW_BP_Parent_C.ReceiveBeginPlay");
...
void APBW_BP_Parent_C::ExecuteUbergraph_PBW_BP_Parent(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function PBW_BP_Parent.PBW_BP_Parent_C.ExecuteUbergraph_PBW_BP_Parent");

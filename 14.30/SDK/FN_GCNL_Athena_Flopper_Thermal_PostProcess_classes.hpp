...
class AGCNL_Athena_Flopper_Thermal_PostProcess_C : public AFortGameplayCueNotify_Loop
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x07C0(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	float                                              Timeline_0_ThermalRamp_EE3FE13847FA77F12191C58A147565E6;  // 0x07C8(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_EE3FE13847FA77F12191C58A147565E6;   // 0x07CC(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GCNL_Athena_Flopper_Thermal_PostProcess.GCNL_Athena_Flopper_Thermal_PostProcess_C");
	...
	void ExecuteUbergraph_GCNL_Athena_Flopper_Thermal_PostProcess(int EntryPoint);
};

...
struct FKairosAvatarDisplayInfo
{
	...
	struct FFortAthenaLoadout                          Loadout;                                                  // 0x0108(0x00F0) (BlueprintVisible, BlueprintReadOnly)
	class UAnimSequenceBase*                           AnimToPlay;                                               // 0x01F8(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FString                                     SnippetPathToPlay;                                        // 0x0200(0x0010) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0210(0x0010) MISSED OFFSET
	class UFortHero*                                   HeroItem;                                                 // 0x0220(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0228(0x0008) MISSED OFFSET
	struct FKairosCaptureParams                        CaptureParams;                                            // 0x0230(0x0100) (BlueprintVisible, BlueprintReadOnly)
	TArray<struct FLinearColor>                        BackgroundColors;                                         // 0x0330(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	class AKairosHeroBase*                             KairosHero;                                               // 0x0340(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AFortPlayerPawn*                             Pawn;                                                     // 0x0348(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsCurrentUser;                                           // 0x0350(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x0351(0x0007) MISSED OFFSET
	struct FString                                     DisplayName;                                              // 0x0358(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0368(0x0008) MISSED OFFSET
	struct FTransform                                  HeadBoneTransform;                                        // 0x0370(0x0030) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	bool                                               bSpawnTransformIsAbsolute;                                // 0x03A0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsNewCharacter;                                          // 0x03A1(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x6];                                       // 0x03A2(0x0006) MISSED OFFSET
	class AFortPlayerPawn*                             HeroPawnClass;                                            // 0x03A8(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bUseDefaultFrontendAnimClass;                             // 0x03B0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)

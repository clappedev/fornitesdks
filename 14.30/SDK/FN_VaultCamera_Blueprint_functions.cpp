...
void AVaultCamera_Blueprint_C::OnActivated(class AFortPlayerController* PlayerController)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function VaultCamera_Blueprint.VaultCamera_Blueprint_C.OnActivated");
...
void AVaultCamera_Blueprint_C::OnDeactivated(class AFortPlayerController* PlayerController)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function VaultCamera_Blueprint.VaultCamera_Blueprint_C.OnDeactivated");
...
void AVaultCamera_Blueprint_C::ExecuteUbergraph_VaultCamera_Blueprint(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function VaultCamera_Blueprint.VaultCamera_Blueprint_C.ExecuteUbergraph_VaultCamera_Blueprint");

...
void UEmergencyNoticeWidget_C::Show_Notice()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function EmergencyNoticeWidget.EmergencyNoticeWidget_C.Show Notice");
...
void UEmergencyNoticeWidget_C::ShowNotice(const struct FText& Title, const struct FText& Body)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function EmergencyNoticeWidget.EmergencyNoticeWidget_C.ShowNotice");
...
void UEmergencyNoticeWidget_C::HideNotice()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function EmergencyNoticeWidget.EmergencyNoticeWidget_C.HideNotice");
...
void UEmergencyNoticeWidget_C::ExecuteUbergraph_EmergencyNoticeWidget(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function EmergencyNoticeWidget.EmergencyNoticeWidget_C.ExecuteUbergraph_EmergencyNoticeWidget");

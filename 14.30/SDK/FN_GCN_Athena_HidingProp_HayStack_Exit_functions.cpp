...
void UGCN_Athena_HidingProp_HayStack_Exit_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*> ParticleComponents, TArray<class UAudioComponent*> AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GCN_Athena_HidingProp_HayStack_Exit.GCN_Athena_HidingProp_HayStack_Exit_C.OnBurst");

	UGCN_Athena_HidingProp_HayStack_Exit_C_OnBurst_Params params;

...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GA_Athena_Flopper_HopFlopper.GA_Athena_Flopper_HopFlopper_C");
	...
	void ExecuteUbergraph_GA_Athena_Flopper_HopFlopper(int EntryPoint);
};

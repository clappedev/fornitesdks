...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GA_Athena_Flopper_Thermal.GA_Athena_Flopper_Thermal_C");
	...
	void ExecuteUbergraph_GA_Athena_Flopper_Thermal(int EntryPoint);
};

...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GA_Athena_FlopperSmall.GA_Athena_FlopperSmall_C");
	...
	void ExecuteUbergraph_GA_Athena_FlopperSmall(int EntryPoint);
};

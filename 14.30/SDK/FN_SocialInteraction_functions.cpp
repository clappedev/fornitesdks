...
void USocialInteraction_C::BP_OnHovered()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialInteraction.SocialInteraction_C.BP_OnHovered");
...
void USocialInteraction_C::BP_OnUnhovered()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialInteraction.SocialInteraction_C.BP_OnUnhovered");
...
void USocialInteraction_C::OnInteractionSet()
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialInteraction.SocialInteraction_C.OnInteractionSet");
...
void USocialInteraction_C::ExecuteUbergraph_SocialInteraction(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function SocialInteraction.SocialInteraction_C.ExecuteUbergraph_SocialInteraction");

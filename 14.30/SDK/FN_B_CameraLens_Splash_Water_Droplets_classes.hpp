...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass B_CameraLens_Splash_Water_Droplets.B_CameraLens_Splash_Water_Droplets_C");
	...
	void ExecuteUbergraph_B_CameraLens_Splash_Water_Droplets(int EntryPoint);
};

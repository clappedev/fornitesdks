...
class UGCN_Athena_PetrolPickup_Refuel_C : public UFortGameplayCueNotify_Burst
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GCN_Athena_PetrolPickup_Refuel.GCN_Athena_PetrolPickup_Refuel_C");

...
{
	static auto Func = Class->GetFunction("GCN_Loop_Ice_Wheels_Environmental_C", "UserConstructionScript");

	Params::AGCN_Loop_Ice_Wheels_Environmental_C_UserConstructionScript_Params Parms;

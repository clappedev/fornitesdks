...
{
	static auto Func = Class->GetFunction("Trap_Floor_MountedTurret_C", "UserConstructionScript");

	Params::ATrap_Floor_MountedTurret_C_UserConstructionScript_Params Parms;

...
{
	static auto Func = Class->GetFunction("GCNL_GM_OnDeath_AllieDmgBuff_C", "UserConstructionScript");

	Params::AGCNL_GM_OnDeath_AllieDmgBuff_C_UserConstructionScript_Params Parms;

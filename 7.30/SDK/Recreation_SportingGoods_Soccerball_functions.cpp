...
{
	static auto Func = Class->GetFunction("Recreation_SportingGoods_Soccerball_C", "UserConstructionScript");

	Params::ARecreation_SportingGoods_Soccerball_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("Recreation_SportingGoods_Soccerball_C", "Reset Ball Hit Sound");

	Params::ARecreation_SportingGoods_Soccerball_C_Reset_Ball_Hit_Sound_Params Parms;
...
{
	static auto Func = Class->GetFunction("Recreation_SportingGoods_Soccerball_C", "BndEvt__SphereCollision_K2Node_ComponentBoundEvent_4_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("Recreation_SportingGoods_Soccerball_C", "ExecuteUbergraph_Recreation_SportingGoods_Soccerball");

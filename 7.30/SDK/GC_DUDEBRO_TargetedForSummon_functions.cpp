...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_TargetedForSummon_C", "UserConstructionScript");

	Params::AGC_DUDEBRO_TargetedForSummon_C_UserConstructionScript_Params Parms;

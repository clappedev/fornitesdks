...
{
	static auto Func = Class->GetFunction("GC_Melee_Edged_Sword_BlinkStrike_Launch_C", "UserConstructionScript");

	Params::AGC_Melee_Edged_Sword_BlinkStrike_Launch_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_Melee_Edged_Sword_BlinkStrike_Launch_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GC_Melee_Edged_Sword_BlinkStrike_Launch_C", "OnRemoval");
...
{
	static auto Func = Class->GetFunction("GC_Melee_Edged_Sword_BlinkStrike_Launch_C", "ExecuteUbergraph_GC_Melee_Edged_Sword_BlinkStrike_Launch");

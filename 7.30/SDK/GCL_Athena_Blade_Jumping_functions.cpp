...
{
	static auto Func = Class->GetFunction("GCL_Athena_Blade_Jumping_C", "UserConstructionScript");

	Params::AGCL_Athena_Blade_Jumping_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Athena_Blade_Jumping_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCL_Athena_Blade_Jumping_C", "ExecuteUbergraph_GCL_Athena_Blade_Jumping");

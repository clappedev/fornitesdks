...
{
	static auto Func = Class->GetFunction("B_ProjectileTrajectory_Athena_FireworksMortar_C", "UserConstructionScript");

	Params::AB_ProjectileTrajectory_Athena_FireworksMortar_C_UserConstructionScript_Params Parms;

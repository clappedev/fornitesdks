...
public:
	...
	uint8                                        Pad_D3[0x3];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_D6[0xF];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_E0[0x8];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_E1[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};

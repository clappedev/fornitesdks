...
{
	static auto Func = Class->GetFunction("GCNL_Taker_Vlad_Berzerker_Phase3_C", "UserConstructionScript");

	Params::AGCNL_Taker_Vlad_Berzerker_Phase3_C_UserConstructionScript_Params Parms;

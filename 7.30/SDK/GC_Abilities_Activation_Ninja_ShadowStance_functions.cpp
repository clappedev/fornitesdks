...
{
	static auto Func = Class->GetFunction("GC_Abilities_Activation_Ninja_ShadowStance_C", "Restore Material on Weapon Mesh");
...
{
	static auto Func = Class->GetFunction("GC_Abilities_Activation_Ninja_ShadowStance_C", "Override Material and Copy Parameters on Weapon Mesh");
...
{
	static auto Func = Class->GetFunction("GC_Abilities_Activation_Ninja_ShadowStance_C", "Restore OG Materials");
...
{
	static auto Func = Class->GetFunction("GC_Abilities_Activation_Ninja_ShadowStance_C", "Destroy Duplicate Mesh");
...
{
	static auto Func = Class->GetFunction("GC_Abilities_Activation_Ninja_ShadowStance_C", "Create Duplicate Mesh");
...
{
	static auto Func = Class->GetFunction("GC_Abilities_Activation_Ninja_ShadowStance_C", "Override Material to Dissolve Material");
...
{
	static auto Func = Class->GetFunction("GC_Abilities_Activation_Ninja_ShadowStance_C", "Save Material");
...
{
	static auto Func = Class->GetFunction("GC_Abilities_Activation_Ninja_ShadowStance_C", "OnWeaponEquipped");

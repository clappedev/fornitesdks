...
{
public:
	uint8                                        Pad_ECC[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_ECE[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_ECF[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]

...
{
	static auto Func = Class->GetFunction("Announce_BuildingDamaged_C", "UserConstructionScript");

	Params::AAnnounce_BuildingDamaged_C_UserConstructionScript_Params Parms;

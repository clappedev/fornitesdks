...
{
	static auto Func = Class->GetFunction("Athena_Enemy_Player_SneakySnowman_C", "UserConstructionScript");

	Params::AAthena_Enemy_Player_SneakySnowman_C_UserConstructionScript_Params Parms;

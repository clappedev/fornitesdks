...
public:
	...
	uint8                                        Pad_2800[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_280F[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

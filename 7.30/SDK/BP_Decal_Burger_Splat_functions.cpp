...
{
	static auto Func = Class->GetFunction("BP_Decal_Burger_Splat_C", "UserConstructionScript");

	Params::ABP_Decal_Burger_Splat_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Decal_Burger_Splat_C", "ReceiveBeginPlay");

	Params::ABP_Decal_Burger_Splat_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Decal_Burger_Splat_C", "ExecuteUbergraph_BP_Decal_Burger_Splat");

...
{
	static auto Func = Class->GetFunction("B_Prj_ThrownConsumable_Parent_C", "UserConstructionScript");

	Params::AB_Prj_ThrownConsumable_Parent_C_UserConstructionScript_Params Parms;

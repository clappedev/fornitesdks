...
public:
	...
	uint8                                        Pad_F03[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F09[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F0D[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F13[0x348];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F16[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F17[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F18[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]

...
{
	static auto Func = Class->GetFunction("GAT_Athena_IceTrap_C", "K2_ActivateAbility");

	Params::UGAT_Athena_IceTrap_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GAT_Athena_IceTrap_C", "ExecuteUbergraph_GAT_Athena_IceTrap");

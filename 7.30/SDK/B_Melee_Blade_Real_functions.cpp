...
{
	static auto Func = Class->GetFunction("B_Melee_Blade_Real_C", "UserConstructionScript");

	Params::AB_Melee_Blade_Real_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Melee_Blade_Real_C", "OnPlayImpactFX");
...
{
	static auto Func = Class->GetFunction("B_Melee_Blade_Real_C", "ExecuteUbergraph_B_Melee_Blade_Real");

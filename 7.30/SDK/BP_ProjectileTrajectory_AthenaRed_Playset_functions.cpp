...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_AthenaRed_Playset_C", "UserConstructionScript");

	Params::ABP_ProjectileTrajectory_AthenaRed_Playset_C_UserConstructionScript_Params Parms;

...
public:
	...
	uint8                                        Pad_56D1[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetEventDateAsText_ReturnValue;           // 0x2B8(0x18)()
	struct FDateTime                             CallFunc_GetEventBeginTime_ReturnValue1;           // 0x2D0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_GetEventTimeAsText_ReturnValue1;          // 0x2D8(0x18)()

...
{
	static auto Func = Class->GetFunction("JackalVehicle_Athena_C", "ReceiveTick");
...
{
	static auto Func = Class->GetFunction("JackalVehicle_Athena_C", "HapticsOnTick");

	Params::AJackalVehicle_Athena_C_HapticsOnTick_Params Parms;
...
{
	static auto Func = Class->GetFunction("JackalVehicle_Athena_C", "StopDriverRumble");

	Params::AJackalVehicle_Athena_C_StopDriverRumble_Params Parms;
...
{
	static auto Func = Class->GetFunction("JackalVehicle_Athena_C", "StartDriverRumble");

	Params::AJackalVehicle_Athena_C_StartDriverRumble_Params Parms;
...
{
	static auto Func = Class->GetFunction("JackalVehicle_Athena_C", "ReloadIfOnGamepad");

	Params::AJackalVehicle_Athena_C_ReloadIfOnGamepad_Params Parms;
...
{
	static auto Func = Class->GetFunction("JackalVehicle_Athena_C", "CheckWater");

	Params::AJackalVehicle_Athena_C_CheckWater_Params Parms;

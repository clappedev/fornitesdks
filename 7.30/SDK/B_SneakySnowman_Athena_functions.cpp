...
{
	static auto Func = Class->GetFunction("B_SneakySnowman_Athena_C", "UserConstructionScript");

	Params::AB_SneakySnowman_Athena_C_UserConstructionScript_Params Parms;

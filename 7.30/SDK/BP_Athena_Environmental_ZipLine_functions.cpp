...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_C", "BndEvt__OverlapCapsule_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_C", "BndEvt__OverlapCapsule_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature");

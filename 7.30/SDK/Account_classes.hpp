...
{
public:
	uint8                                        Pad_FBA[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FBE[0x29B];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FC0[0x2F0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FC1[0x37];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FC2[0x34];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FC3[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]

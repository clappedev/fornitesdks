...
public:
	...
	uint8                                        Pad_10F6[0x3E];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_10F8[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_10FA[0x3D];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_10FB[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

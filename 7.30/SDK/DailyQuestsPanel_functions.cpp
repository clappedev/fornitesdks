...
{
	static auto Func = Class->GetFunction("DailyQuestsPanel_C", "WidgetAnimationEvt_ClaimReward_K2Node_WidgetAnimationEvent_0");

	Params::UDailyQuestsPanel_C_WidgetAnimationEvt_ClaimReward_K2Node_WidgetAnimationEvent_0_Params Parms;

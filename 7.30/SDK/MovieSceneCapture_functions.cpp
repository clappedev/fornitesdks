...
{
	static auto Func = Class->GetFunction("UserDefinedCaptureProtocol", "PushBufferToStream");
...
{
	static auto Func = Class->GetFunction("UserDefinedCaptureProtocol", "BindToStream");

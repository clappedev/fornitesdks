...
{
	static auto Func = Class->GetFunction("GCN_Loop_FestivusAudio_C", "UserConstructionScript");

	Params::AGCN_Loop_FestivusAudio_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCN_Loop_FestivusAudio_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_FestivusAudio_C", "OnRemoval");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_FestivusAudio_C", "ExecuteUbergraph_GCN_Loop_FestivusAudio");

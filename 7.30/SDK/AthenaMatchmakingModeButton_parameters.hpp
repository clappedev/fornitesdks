...
public:
	...
	uint8                                        Pad_54FD[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  K2Node_Select3_Default;                            // 0x178(0x18)()
	class FText                                  CallFunc_TextToUpper_ReturnValue1;                 // 0x190(0x18)()
};

...
public:
	...
	uint8                                        Pad_1305[0xE];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1307[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1308[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1309[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]

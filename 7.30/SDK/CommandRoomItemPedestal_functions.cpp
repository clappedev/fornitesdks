...
{
	static auto Func = Class->GetFunction("CommandRoomItemPedestal_C", "UserConstructionScript");

	Params::ACommandRoomItemPedestal_C_UserConstructionScript_Params Parms;

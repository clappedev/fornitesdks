...
public:
	...
	uint8                                        Pad_130A[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_130C[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_130D[0x140];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_130F[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1310[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1311[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1312[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

...
{
	static auto Func = Class->GetFunction("B_CameraLens_Blinkstrike_C", "UserConstructionScript");

	Params::AB_CameraLens_Blinkstrike_C_UserConstructionScript_Params Parms;

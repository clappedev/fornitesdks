...
{
	static auto Func = Class->GetFunction("RubberDuckStatic_C", "UserConstructionScript");

	Params::ARubberDuckStatic_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("RubberDuckStatic_C", "OnDeathServer");
...
{
	static auto Func = Class->GetFunction("RubberDuckStatic_C", "ReceiveBeginPlay");

	Params::ARubberDuckStatic_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("RubberDuckStatic_C", "ExecuteUbergraph_RubberDuckStatic");

...
{
	static auto Func = Class->GetFunction("GCNL_Creative_SpeedAdjust_Vehicle_C", "UserConstructionScript");

	Params::AGCNL_Creative_SpeedAdjust_Vehicle_C_UserConstructionScript_Params Parms;

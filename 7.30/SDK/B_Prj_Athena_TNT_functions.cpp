...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_TNT_C", "OnRep_RemainingFuseTime");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_TNT_C", "UserConstructionScript");

	Params::AB_Prj_Athena_TNT_C_UserConstructionScript_Params Parms;

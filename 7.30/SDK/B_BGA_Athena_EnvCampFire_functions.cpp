...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_EnvCampFire_C", "UserConstructionScript");

	Params::AB_BGA_Athena_EnvCampFire_C_UserConstructionScript_Params Parms;

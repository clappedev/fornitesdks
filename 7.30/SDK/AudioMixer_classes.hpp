...
public:
	...
	uint8                                        Pad_10C0[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10C7[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10C9[0x5C];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10CA[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]

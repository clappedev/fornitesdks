...
public:
	...
	uint8                                        Pad_14B9[0xA7];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14BA[0x1D];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14BC[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14BD[0xC0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14C0[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14C4[0x27];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14C5[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]

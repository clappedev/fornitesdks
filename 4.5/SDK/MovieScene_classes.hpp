...
public:
	...
	uint8                                        Pad_13C3[0x15];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13C5[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13C7[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13CE[0x348];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13D0[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13D1[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneSequencePlaybackSettings   PlaybackSettings;                                  // 0x3F8(0x40)(Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_13D2[0x3A8];                                   // Fixing Size Of Struct [ Dumper-7 ]

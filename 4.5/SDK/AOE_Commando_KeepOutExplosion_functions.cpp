...
{
	static auto Func = Class->GetFunction("AOE_Commando_KeepOutExplosion_C", "UserConstructionScript");

	Params::AAOE_Commando_KeepOutExplosion_C_UserConstructionScript_Params Parms;

...
void UGamepadMappingInfo_C::GetLineImage(TSoftObjectPtr<class UTexture2D>* Texture, int32 CallFunc_Conv_ByteToInt_ReturnValue, TSoftObjectPtr<class UTexture2D> CallFunc_Array_Get_Item)
{
...
void UGamepadMappingInfo_C::GetControllerImage(TSoftObjectPtr<class UTexture2D>* Texture, int32 CallFunc_Conv_ByteToInt_ReturnValue, TSoftObjectPtr<class UTexture2D> CallFunc_Array_Get_Item)
{

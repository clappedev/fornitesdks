...
void UFrontEnd_C::PlayTrailerMovie(class UActivatableMovieWidget_C* CallFunc_Create_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsErebus_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class UUIManager_C* K2Node_DynamicCast_AsUIManager, bool K2Node_DynamicCast_bSuccess, enum class ESubGame CallFunc_GetSubGame_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsMobileApp_ReturnValue, bool CallFunc_BooleanOR_ReturnValue)
{
...
void UFrontEnd_C::InitForSubGame(bool CallFunc_PlayEventMovieIfNecessary_PlayingEventMovie, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class UAthenaTabsScreen_C* CallFunc_Create_ReturnValue, enum class ESubGame CallFunc_GetSubGame_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, class UFortPartyContext* CallFunc_GetContext_ReturnValue1, class UFortPartyContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_ShouldMcpPartyInvitesBeEnabled_ReturnValue, bool CallFunc_ShouldMcpPartyInvitesBeEnabled_ReturnValue1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue3, class UMainTabsScreen_C* CallFunc_Create_ReturnValue1, enum class EFortUIFeatureState CallFunc_GetFeatureState_OutFeatureState, enum class EFortUIFeatureStateReason CallFunc_GetFeatureState_OutReason, bool K2Node_SwitchEnum1_CmpSuccess)
{
...
void UFrontEnd_C::OnBlockingModalClosedRetryPlayMovie(class UCommonActivatablePanel* Panel)
{
	static auto Func = Class->GetFunction("FrontEnd_C", "OnBlockingModalClosedRetryPlayMovie");

	Params::UFrontEnd_C_OnBlockingModalClosedRetryPlayMovie_Params Parms;
	Parms.Panel = Panel;
...
void UFrontEnd_C::ExecuteUbergraph_FrontEnd(int32 EntryPoint, enum class EPTTState Temp_byte_Variable, enum class EPTTState Temp_byte_Variable1, enum class EPTTState Temp_byte_Variable2, enum class EPTTState Temp_byte_Variable3, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue1, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, enum class EPTTState CallFunc_GetPTTState_ReturnValue, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue3, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue4, enum class EPTTState CallFunc_GetPTTState_ReturnValue1, class UFortSocialImportPanel* CallFunc_ShowSocialImport_ReturnValue, bool CallFunc_ShouldShowSocialImport_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue5, enum class ESubGame CallFunc_GetSubGame_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, enum class EFortUIState K2Node_Event_NextUIState, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue6, enum class EPTTState CallFunc_GetPTTState_ReturnValue2, class UObject* K2Node_HandleClientEvent_EventSource2, class UObject* K2Node_HandleClientEvent_EventFocus2, const struct FFortClientEvent& K2Node_HandleClientEvent_ClientEvent2, enum class EPTTState K2Node_Select_Default, class UClass* Temp_class_Variable, bool K2Node_Event_bHideHeader, bool K2Node_Event_bHideFooter, bool K2Node_Event_bHideChatWidget, class UObject* K2Node_HandleClientEvent_EventSource1, class UObject* K2Node_HandleClientEvent_EventFocus1, const struct FFortClientEvent& K2Node_HandleClientEvent_ClientEvent1, class UObject* K2Node_HandleClientEvent_EventSource, class UObject* K2Node_HandleClientEvent_EventFocus, const struct FFortClientEvent& K2Node_HandleClientEvent_ClientEvent, class UClass* Temp_class_Variable1, bool K2Node_CustomEvent_IsVisible, class UCommonButton* K2Node_ComponentBoundEvent_Button2, enum class EFortUIState K2Node_Event_PreviousUIState, class UCommonButton* K2Node_ComponentBoundEvent_Button1, bool K2Node_ComponentBoundEvent_Selected, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable4, class UClass* K2Node_Select1_Default, class UCommonButton* K2Node_ComponentBoundEvent_Button, enum class ESlateVisibility Temp_byte_Variable5, class UWidget* K2Node_Event_Widget, const struct FContentPushState& K2Node_Event_State, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, bool Temp_bool_Variable1, enum class ESlateVisibility K2Node_Select2_Default, bool CallFunc_NeedSeeTrailerMovie_ReturnValue, bool CallFunc_CheckForGifts_ReturnValue, bool CallFunc_CheckForGifts_ReturnValue1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue7, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue8, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, bool CallFunc_IsCurrentlyShowingLoadingScreen_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue9, enum class ESubGame CallFunc_GetSubGame_ReturnValue1, bool K2Node_SwitchEnum_CmpSuccess, TArray<class UFortQuestItem*>& K2Node_CustomEvent_Quests1, class UCommonActivatablePanel* K2Node_CustomEvent_Panel, class UFortMcpContext* CallFunc_GetContext_ReturnValue10, TArray<class UFortQuestItem*>& K2Node_CustomEvent_Quests, int32 CallFunc_IsDailyRewardAvailable_OutMinutesUntilNextReward, bool CallFunc_IsDailyRewardAvailable_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate4)
{

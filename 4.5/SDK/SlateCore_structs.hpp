...
public:
	...
	uint8                                        Pad_49[0x17];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4B[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4E[0x58];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_50[0x20];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_55[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_56[0x4];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_61[0x4];                                       // Fixing Size Of Struct [ Dumper-7 ]
};

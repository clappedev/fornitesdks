...
public:
	...
	uint8                                        Pad_FDD[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FDE[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FDF[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FE0[0x17F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FE2[0x58];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FE3[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FE5[0x108];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FE6[0xC8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FE7[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]

...
public:
	...
	class FText                                  CallFunc_BreakParams_InteractTEXT;                 // 0x190(0x18)()
	...
	struct FSlateBrush                           CallFunc_GetObjectiveBulletIcon_BulletIcon;        // 0x1C8(0x88)()
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_ObjectiveHandle1;        // 0x280(0x20)()
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_GameplayTags1;           // 0x2E8(0x20)()

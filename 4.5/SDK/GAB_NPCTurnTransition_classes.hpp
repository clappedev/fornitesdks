...
public:
	...
	class UClass*                                GE_AIBaseMeleeFrustration_Build;                   // 0x960(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

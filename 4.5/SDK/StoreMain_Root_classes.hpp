...
public:
	...
	uint8                                        Pad_4A6A[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]

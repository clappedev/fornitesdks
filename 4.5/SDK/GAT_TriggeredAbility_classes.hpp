...
public:
	...
	struct FGameplayTag                          TC_AbilitiesGenericTriggeredAbilityActivate;       // 0x918(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

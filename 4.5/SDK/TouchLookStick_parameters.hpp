...
public:
	...
	uint8                                        Pad_41E5[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_41E9[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FFortHUDState                         CallFunc_GetCurrentHUDState_ReturnValue;           // 0x11(0x13)(ConstParm, NoDestructor)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0x24(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         K2Node_Event_IsFiring;                             // 0x25(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FFortHUDState                         K2Node_Event_NewState;                             // 0x38(0x13)(ConstParm, NoDestructor)

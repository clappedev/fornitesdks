...
public:
	...
	uint8                                        Pad_14C7[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_14C9[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_14CA[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]

...
{
public:
	uint8                                        Pad_143[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FMovieSceneFloatChannel               Translation;                                       // 0x48(0x90)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_146[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Rotation;                                          // 0x168(0x90)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               Scale;                                             // 0x1F8(0x90)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_147[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Shear;                                             // 0x318(0x90)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_148[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	enum class EMovieSceneBlendType              BlendType;                                         // 0x438(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	struct FMovieSceneFloatChannel               TopCurve;                                          // 0x48(0x90)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               LeftCurve;                                         // 0xD8(0x90)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               RightCurve;                                        // 0x168(0x90)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               BottomCurve;                                       // 0x1F8(0x90)(NativeAccessSpecifierPrivate)
	enum class EMovieSceneBlendType              BlendType;                                         // 0x288(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)

...
public:
	...
	uint8                                        Pad_4657[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FSlateBrush                           CallFunc_GetItemSmallPreviewImageBrush_ReturnValue; // 0x160(0x88)()
	...
	struct FGameplayTagContainer                 K2Node_CustomEvent_FailedReason;                   // 0x3A8(0x20)()
	class FText                                  K2Node_CustomEvent_FailureText;                    // 0x3C8(0x18)()

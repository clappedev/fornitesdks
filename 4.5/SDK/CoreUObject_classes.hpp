...
public:
	...
	{
		return GetVFunction<void(*)(const UObject*, class UFunction*, void*)>(this, 0x40 /*0x158FB20*/)(this, Function, Parms);
	}
...
{
public:
	uint8                                        Pad_5[0x38];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6[0x28];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_7[0x44];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_A[0x30];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	enum class EClassCastFlags                   CastFlags;                                         // (0xB8[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_B[0x38];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	class UObject*                               DefaultObject;                                     // (0xF8[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_C[0xF8];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D[0x28];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_11[0x14];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_16[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17[0xC8];                                      // Fixing Size Of Struct [ Dumper-7 ]

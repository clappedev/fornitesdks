...
{
	static auto Func = Class->GetFunction("ToastDisplayArea_C", "BndEvt__VoteResultNotificationWidget_K2Node_ComponentBoundEvent_0_OnToastFinished__DelegateSignature");

	Params::UToastDisplayArea_C_BndEvt__VoteResultNotificationWidget_K2Node_ComponentBoundEvent_0_OnToastFinished__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("ToastDisplayArea_C", "BndEvt__VoteUpdateNotificationWidget_K2Node_ComponentBoundEvent_1_OnToastFinished__DelegateSignature");

	Params::UToastDisplayArea_C_BndEvt__VoteUpdateNotificationWidget_K2Node_ComponentBoundEvent_1_OnToastFinished__DelegateSignature_Params Parms;

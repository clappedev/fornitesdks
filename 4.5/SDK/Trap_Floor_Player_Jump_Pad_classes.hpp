...
public:
	...
	class UParticleSystemComponent*              JumpParticleEffect;                                // 0xCA8(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

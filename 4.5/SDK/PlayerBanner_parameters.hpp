...
public:
	...
	struct FFortAthenaLoadout                    CallFunc_GetLoadoutForPlayer_ReturnValue;          // 0x18(0xA0)()
	enum class ESubGame                          CallFunc_GetSubGame_ReturnValue;                   // 0xB8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                  CallFunc_Conv_StringToName_ReturnValue1;           // 0xC8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortHomeBaseInfo                     CallFunc_GetHomeBaseInfoForPlayer_Result;          // 0xD0(0x40)()
	bool                                         CallFunc_SetBannerImage_Success;                   // 0x110(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

...
{
	static auto Func = Class->GetFunction("GCNL_Athena_Ostrich_Jump_Charging_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCNL_Athena_Ostrich_Jump_Charging_C", "OnApplication");
...
{
	static auto Func = Class->GetFunction("GCNL_Athena_Ostrich_Jump_Charging_C", "OnRemoval");
...
{
	static auto Func = Class->GetFunction("GCNL_Athena_Ostrich_Jump_Charging_C", "ExecuteUbergraph_GCNL_Athena_Ostrich_Jump_Charging");

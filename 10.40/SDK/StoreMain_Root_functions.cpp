...
// class FText                        SplitCurrencyMessage                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void UStoreMain_Root_C::UpdateSpliCurrencyMessage(bool HasCurrencyOnOtherPlatforms, class FText& SplitCurrencyMessage, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, bool CallFunc_GetEnableSplitWalletTextNotice_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static auto Func = Class->GetFunction("StoreMain_Root_C", "UpdateSpliCurrencyMessage");

	Params::UStoreMain_Root_C_UpdateSpliCurrencyMessage_Params Parms;
	Parms.HasCurrencyOnOtherPlatforms = HasCurrencyOnOtherPlatforms;
	Parms.SplitCurrencyMessage = SplitCurrencyMessage;
...
// class UStoreMain_MTXOffer_C_C*     StoreOfferWidget                                                 (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UStoreMain_MTXOffer_C_C*     CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UStoreMain_Root_C::HandleGenerateOffer(class UFortStoreFrontOfferInfo* OfferInfo, class UStoreMain_MTXOffer_C_C* StoreOfferWidget, class FName CallFunc_GetStorefrontName_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue, int32 CallFunc_GetChildrenCount_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 CallFunc_GetChildrenCount_ReturnValue_1, int32 CallFunc_Subtract_IntInt_ReturnValue_1, class UGridSlot* CallFunc_AddChildToGrid_ReturnValue, class UGridSlot* CallFunc_AddChildToGrid_ReturnValue_1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UStoreMain_MTXOffer_C_C* CallFunc_Create_ReturnValue)
{

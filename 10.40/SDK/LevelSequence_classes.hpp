...
{
public:
	uint8                                        Pad_1363[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        bAutoPlay : 1;                                     // Mask : 0x1 0x280(0x1)(Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bOverrideInstanceData : 1;                         // Mask : 0x2 0x280(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bReplicatePlayback : 1;                            // Mask : 0x4 0x280(0x1)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_1367[0x130];                                   // Fixing Size Of Struct [ Dumper-7 ]

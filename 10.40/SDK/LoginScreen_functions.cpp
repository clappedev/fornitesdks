...
// class FText                        CallFunc_GetPlatformDisplayName_ReturnValue_1                    ()
...
void ULoginScreen_C::ExecuteUbergraph_LoginScreen(int32 EntryPoint, class FText CallFunc_GetPlatformDisplayName_ReturnValue, int32 Temp_int_Array_Index_Variable, TArray<class AFort_Entry_Music_Controller_BP_C*>& CallFunc_GetAllActorsOfClass_OutActors, int32 Temp_int_Loop_Counter_Variable, class AFort_Entry_Music_Controller_BP_C* CallFunc_Array_Get_Item, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, enum class EFortUIState K2Node_Event_PreviousUIState, bool CallFunc_Less_IntInt_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue_1, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, const class FString& CallFunc_GetGameVersion_ReturnValue, class FText CallFunc_GetPlatformDisplayName_ReturnValue_1, class FText CallFunc_Conv_StringToText_ReturnValue, class UWidget* K2Node_ComponentBoundEvent_ActiveWidget, int32 K2Node_ComponentBoundEvent_ActiveWidgetIndex)
{
	...
	Parms.CallFunc_GetPlatformDisplayName_ReturnValue_1 = CallFunc_GetPlatformDisplayName_ReturnValue_1;

...
// Parameters:
// UInterfaceProperty_                SafeZoneInterface                                                (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor)
...
void UBP_AmbientAudioController_C::On_Game_Phase_Step_Change(UInterfaceProperty_& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep)
{
...
// UInterfaceProperty_                K2Node_CustomEvent_SafeZoneInterface                             (ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)

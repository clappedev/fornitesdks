...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_GasGrenade_C", "Update Gas Duration");

	Params::AB_Prj_Athena_GasGrenade_C_Update_Gas_Duration_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_GasGrenade_C", "Update Tick Rate");

	Params::AB_Prj_Athena_GasGrenade_C_Update_Tick_Rate_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_GasGrenade_C", "Update PostProcess Scale");

	Params::AB_Prj_Athena_GasGrenade_C_Update_PostProcess_Scale_Params Parms;

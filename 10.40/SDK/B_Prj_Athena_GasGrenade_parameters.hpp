...
struct AB_Prj_Athena_GasGrenade_C_Update_Gas_Duration_Params
{
public:
};
...
struct AB_Prj_Athena_GasGrenade_C_Update_Tick_Rate_Params
{
public:
};
...
struct AB_Prj_Athena_GasGrenade_C_Update_PostProcess_Scale_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_562B[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	float                                        CallFunc_FMax_ReturnValue_1;                       // 0x13C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_GetGameTimeInSeconds_ReturnValue;         // 0x150(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTimerHandle                          CallFunc_K2_SetTimer_ReturnValue_2;                // 0x170(0x8)(NoDestructor, HasGetValueTypeHash)
	...
	enum class EEvaluateCurveTableResult         CallFunc_EvaluateCurveTableRow_OutResult;          // 0x180(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5630[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_EvaluateCurveTableRow_OutXY;              // 0x184(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_SwitchEnum_CmpSuccess;                      // 0x188(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EEvaluateCurveTableResult         CallFunc_EvaluateCurveTableRow_OutResult_1;        // 0x189(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5631[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_EvaluateCurveTableRow_OutXY_1;            // 0x18C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_K2_GetComponentScale_ReturnValue;         // 0x194(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
// Parameters:
// struct FVector                     HitWave_Loc                                                      (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              HitWave_SizeMultiplierOuterRing                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              HitWave_SizeMultiplierInnerRing                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              HitWave_DurationNew                                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AB_BGA_Athena_SilverBlazer_V2_C::Set_RippleFX_Param(const struct FVector& HitWave_Loc, float HitWave_SizeMultiplierOuterRing, float HitWave_SizeMultiplierInnerRing, float HitWave_DurationNew, float HitGridBrightness, float CallFunc_GetGameTimeInSeconds_ReturnValue)
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "Set_RippleFX_Param");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_Set_RippleFX_Param_Params Parms;
	Parms.HitWave_Loc = HitWave_Loc;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "Set_FX_Pos");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "GetResistenceInformation");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "ScaleSafeZone__FinishedFunc");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_ScaleSafeZone__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "ScaleSafeZone__UpdateFunc");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_ScaleSafeZone__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "TimeLine_Death__FinishedFunc");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_TimeLine_Death__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "TimeLine_Death__UpdateFunc");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_TimeLine_Death__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "TimeLine_Death__TriggerDeathFX__EventFunc");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_TimeLine_Death__TriggerDeathFX__EventFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "Timeline_Warning__FinishedFunc");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_Timeline_Warning__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "Timeline_Warning__UpdateFunc");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_Timeline_Warning__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "Timeline_Warning__Audio Pulse__EventFunc");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_Timeline_Warning__Audio_Pulse__EventFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "ReceiveBeginPlay");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "DeathCosmetics");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_DeathCosmetics_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "End");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_End_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "ReceiveHit");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "EventScaleSafeZone");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_EventScaleSafeZone_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "OnDamagePlayEffects");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "HitByRocket");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "HitByShotgun");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "PlayWarningEffectBeforeShieldGoAway");

	Params::AB_BGA_Athena_SilverBlazer_V2_C_PlayWarningEffectBeforeShieldGoAway_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "BndEvt__Sphere_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "BndEvt__Sphere_K2Node_ComponentBoundEvent_3_ComponentEndOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "RunIn");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "RunOut");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_SilverBlazer_V2_C", "ExecuteUbergraph_B_BGA_Athena_SilverBlazer_V2");

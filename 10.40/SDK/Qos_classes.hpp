...
{
public:
	uint8                                        Pad_13B5[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13B7[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13B9[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13BC[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]

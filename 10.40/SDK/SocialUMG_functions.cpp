...
{
	static auto Func = Class->GetFunction("SocialNameTextBlock", "SetNickNameColor");

	Params::USocialNameTextBlock_SetNickNameColor_Params Parms;
...
void USocialListEntry_SocialUser::OnUserPresenceChanged(enum class EOnlineStatus OnlineStatus)
{
	static auto Func = Class->GetFunction("SocialListEntry_SocialUser", "OnUserPresenceChanged");

	Params::USocialListEntry_SocialUser_OnUserPresenceChanged_Params Parms;

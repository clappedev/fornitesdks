...
{
public:
	uint8                                        Pad_11B8[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_11BC[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_11BD[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_11BE[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Shear;                                             // 0x368(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_11BF[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11C6[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

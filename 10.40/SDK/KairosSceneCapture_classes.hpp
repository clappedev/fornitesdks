...
public:
	...
	uint8                                        Pad_E6C[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E6F[0x1F];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FKairosSceneInfo                      ActiveSceneInfo;                                   // 0x2D0(0x20)(Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_E70[0xB0];                                     // Fixing Size Of Struct [ Dumper-7 ]

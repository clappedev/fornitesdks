...
{
public:
	struct FVector                               HitWave_Loc;                                       // 0x0(0xC)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        HitWave_SizeMultiplierOuterRing;                   // 0xC(0x4)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        HitWave_SizeMultiplierInnerRing;                   // 0x10(0x4)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        HitWave_DurationNew;                               // 0x14(0x4)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct AB_BGA_Athena_SilverBlazer_V2_C_ScaleSafeZone__FinishedFunc_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_ScaleSafeZone__UpdateFunc_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_TimeLine_Death__FinishedFunc_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_TimeLine_Death__UpdateFunc_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_TimeLine_Death__TriggerDeathFX__EventFunc_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_Timeline_Warning__FinishedFunc_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_Timeline_Warning__UpdateFunc_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_Timeline_Warning__Audio_Pulse__EventFunc_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_ReceiveBeginPlay_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_DeathCosmetics_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_End_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_EventScaleSafeZone_Params
{
public:
};
...
struct AB_BGA_Athena_SilverBlazer_V2_C_PlayWarningEffectBeforeShieldGoAway_Params
{
public:
};
...
public:
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x268(0x18)()
	...
	uint8                                        Pad_4481[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]

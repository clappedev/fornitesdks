...
{
	static auto Func = Class->GetFunction("AthenaSupplyDrop_C", "TimerCheckPlayerDistance");

	Params::AAthenaSupplyDrop_C_TimerCheckPlayerDistance_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaSupplyDrop_C", "DestroyGroundComponents");

	Params::AAthenaSupplyDrop_C_DestroyGroundComponents_Params Parms;

...
// TArray<struct FPurchasedItemInfo>  Purchases                                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)

void UAthenaDirectAcquisitionMTXDetails_C::HandleRealMoneyPurchaseComplete(bool bSuccess, TArray<struct FPurchasedItemInfo>& Purchases)
{
...
// TArray<struct FPurchasedItemInfo>  K2Node_CustomEvent_Purchases                                     (ConstParm, ZeroConstructor, ReferenceParm)
...
void UAthenaDirectAcquisitionMTXDetails_C::ExecuteUbergraph_AthenaDirectAcquisitionMTXDetails(int32 EntryPoint, class UFortMcpContext* CallFunc_GetContext_ReturnValue, class UAthenaAccountContext* CallFunc_GetContext_ReturnValue_1, class FText CallFunc_GetCurrentSeasonName_ReturnValue, class FText CallFunc_GetCurrentSeasonNumberAsText_ReturnValue, bool K2Node_CustomEvent_bSuccess_1, TArray<struct FPurchasedItemInfo>& K2Node_CustomEvent_PurchasedItems, const class FString& K2Node_CustomEvent_OfferId, class UFortMcpContext* CallFunc_GetContext_ReturnValue_2, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, const class FString& CallFunc_GetOfferId_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_1, enum class ESlateVisibility Temp_byte_Variable, bool CallFunc_IsPriceInMTX_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, const class FString& CallFunc_GetOfferId_ReturnValue_1, enum class ESlateVisibility Temp_byte_Variable_1, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue_1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_3, bool Temp_bool_Variable, const class FString& CallFunc_GetOfferId_ReturnValue_2, class UFortMcpContext* CallFunc_GetContext_ReturnValue_3, enum class EOfferPurchaseError CallFunc_CanPurchaseOffer_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_2, bool CallFunc_HandleBack_Passthrough, class UCommonButton* K2Node_ComponentBoundEvent_Button_1, bool CallFunc_IsMobileGame_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_4, bool CallFunc_IsGiftable_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, const class FString& CallFunc_GetOfferId_ReturnValue_3, class UCommonButton* K2Node_ComponentBoundEvent_Button, enum class EOfferPurchaseError CallFunc_CanGiftOffer_ReturnValue, class UFortStoreContext* CallFunc_GetContext_ReturnValue_4, bool K2Node_SwitchEnum_CmpSuccess, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue_1, class UGiftingScreen_C* CallFunc_Create_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_5, class UFortMcpContext* CallFunc_GetContext_ReturnValue_5, enum class EOfferPurchaseError CallFunc_PurchaseOffer_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, bool K2Node_CustomEvent_bSuccess, TArray<struct FPurchasedItemInfo>& K2Node_CustomEvent_Purchases, class UFortStoreContext* CallFunc_GetContext_ReturnValue_6)
{
	...
	Parms.K2Node_CustomEvent_Purchases = K2Node_CustomEvent_Purchases;

...
{
	static auto Func = Class->GetFunction("Ostrich_Driver_AnimBP_C", "AnimGraph");
...
{
	static auto Func = Class->GetFunction("Ostrich_Driver_AnimBP_C", "ExecuteUbergraph_Ostrich_Driver_AnimBP");

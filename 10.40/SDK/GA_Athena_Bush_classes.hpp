...
public:
	...
	struct FFortGameplayAbilityMontageInfo       AnimMontageInfo;                                   // 0x968(0x58)(Edit, BlueprintVisible, DisableEditOnInstance)
	...
	struct FDataTableRowHandle                   UseBushObjectiveStat;                              // 0x9D0(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	class AAthena_Player_Bush_C*                 PlayerBush;                                        // 0x9E0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTagContainer                 BushTag;                                           // 0x9E8(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FName                                  BushHolsterSelf;                                   // 0xA08(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                          EquippingCue;                                      // 0xA10(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

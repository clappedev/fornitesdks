...
{
	static auto Func = Class->GetFunction("TeamMemberManage_C", "OnActivated");

	Params::UTeamMemberManage_C_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("TeamMemberManage_C", "OnDeactivated");

	Params::UTeamMemberManage_C_OnDeactivated_Params Parms;

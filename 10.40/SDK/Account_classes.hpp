...
{
public:
	uint8                                        Pad_1633[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1637[0x29B];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1639[0x308];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_163A[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_163B[0x34];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_163C[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]

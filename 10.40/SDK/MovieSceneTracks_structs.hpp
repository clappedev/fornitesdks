...
public:
	...
	uint8                                        Pad_104D[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1050[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1051[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1052[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FVector                               Location;                                          // 0x8(0xC)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1053[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1054[0x140];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               RotationCurve;                                     // 0x1E0(0xA0)(NativeAccessSpecifierPublic)
	uint8                                        Pad_1055[0x140];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               ScaleCurve;                                        // 0x3C0(0xA0)(NativeAccessSpecifierPublic)
	uint8                                        Pad_1056[0x140];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1063[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1064[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1065[0x1E0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1067[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_106F[0x1E0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1071[0x67];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1077[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

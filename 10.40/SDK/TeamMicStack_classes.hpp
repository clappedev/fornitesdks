...
public:
	...
	class UVerticalBox*                          _Vertical_Box__Team_Members;                       // 0x278(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	TArray<class UCinematic_TeamMics_C*>         TeamMembers;                                       // 0x288(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)

...
public:
	...
	UInterfaceProperty_                          CallFunc_GetVehicleUInterface_ReturnValue;         // 0x98(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_4A3C[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	UInterfaceProperty_                          CallFunc_GetVehicleUInterface_ReturnValue_1;       // 0x138(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	UInterfaceProperty_                          CallFunc_GetVehicleUInterface_ReturnValue_2;       // 0x198(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)

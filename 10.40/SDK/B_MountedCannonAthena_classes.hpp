...
public:
	...
	class UParticleSystemComponent*              P_FiringDelay;                                     // 0xE60(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

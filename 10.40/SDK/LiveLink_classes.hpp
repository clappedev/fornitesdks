...
{
public:
	struct FLiveLinkSubjectName                  SubjectName;                                       // 0xB0(0x8)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_FB9[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FBC[0xA8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FBD[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]

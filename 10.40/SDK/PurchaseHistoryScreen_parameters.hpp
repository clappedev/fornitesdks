...
public:
	...
	TArray<class UCommonTextBlock*>              K2Node_Event_ItemsToReturn;                        // 0x178(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
	...
	class UFortUINavigationManager*              CallFunc_GetUINavigationManager_ReturnValue;       // 0x1F0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class ECommonInputType                  K2Node_CustomEvent_bNewInputType;                  // 0x201(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5873[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         K2Node_Event_bIsSelectionTokenlessRefundable;      // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         Temp_bool_Variable_1;                              // 0x211(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5874[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UWidget*                               K2Node_Select_Default;                             // 0x218(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  K2Node_Select_Default_1;                           // 0x220(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

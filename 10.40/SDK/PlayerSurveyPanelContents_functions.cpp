...
void UPlayerSurveyPanelContents_C::UpdateQuestionText(class FText QuestionText, UInterfaceProperty_ CallFunc_GetQuestion_self_CastInput, class UFortPlayerSurveyQuestion* CallFunc_GetQuestion_ReturnValue, class UFortPlayerSurveyQuestionStandardBase* K2Node_DynamicCast_AsFort_Player_Survey_Question_Standard_Base, bool K2Node_DynamicCast_bSuccess)
{
...
// UInterfaceProperty_                CallFunc_IsAnswerValid_self_CastInput                            (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UPlayerSurveyPanelContents_C::UpdateNextButtonState(class UCommonButton* ActiveNextButton, bool HasMoreQuestions, bool HasAnsweredCurrentQuestion, bool Temp_bool_Variable, UInterfaceProperty_ CallFunc_IsAnswerValid_self_CastInput, bool CallFunc_IsAnswerValid_ReturnValue, UInterfaceProperty_ CallFunc_CanMoveDelta_self_CastInput, enum class EIndexNavigationResult CallFunc_CanMoveDelta_ReturnValue, class UCommonButton* K2Node_Select_Default, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{

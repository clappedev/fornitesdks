...
struct ABGA_Athena_SuperDingo_Box_C_UserConstructionScript_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_Box_C_Spawn_Items_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_Box_C_HideAndKill_Params
{
public:
};
...
public:
	...
	struct FVector                               CallFunc_GetActorForwardVector_ReturnValue;        // 0xBC(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFortItemEntry                        CallFunc_Array_Get_Item;                           // 0xD0(0x120)()
	...
	class AFortPickup*                           CallFunc_K2_SpawnPickupInWorld_ReturnValue;        // 0x200(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

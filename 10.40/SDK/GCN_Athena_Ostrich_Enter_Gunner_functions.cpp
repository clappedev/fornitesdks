...
{
	static auto Func = Class->GetFunction("GCN_Athena_Ostrich_Enter_Gunner_C", "OnExecute");
...
{
	static auto Func = Class->GetFunction("GCN_Athena_Ostrich_Enter_Gunner_C", "OnBurst");

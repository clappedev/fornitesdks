...
{
	static auto Func = Class->GetFunction("GA_Athena_Slurp_Granted_C", "K2_ActivateAbility");

	Params::UGA_Athena_Slurp_Granted_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Athena_Slurp_Granted_C", "K2_OnEndAbility");

	Params::UGA_Athena_Slurp_Granted_C_K2_OnEndAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Athena_Slurp_Granted_C", "ApplyHealthOrShield");

	Params::UGA_Athena_Slurp_Granted_C_ApplyHealthOrShield_Params Parms;

...
{
	static auto Func = Class->GetFunction("VaultCharacterPlacementHelper_C", "Timeline_Zoom__FinishedFunc");

	Params::AVaultCharacterPlacementHelper_C_Timeline_Zoom__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("VaultCharacterPlacementHelper_C", "Timeline_Zoom__UpdateFunc");

	Params::AVaultCharacterPlacementHelper_C_Timeline_Zoom__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("VaultCharacterPlacementHelper_C", "BattlePassZoom");

	Params::AVaultCharacterPlacementHelper_C_BattlePassZoom_Params Parms;
...
{
	static auto Func = Class->GetFunction("VaultCharacterPlacementHelper_C", "BattlePassZoomOut");

	Params::AVaultCharacterPlacementHelper_C_BattlePassZoomOut_Params Parms;

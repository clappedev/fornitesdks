...
public:
	...
	class AFortPlayerControllerGameplay*         K2Node_DynamicCast_AsFort_Player_Controller_Gameplay; // 0x28(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4E26[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AFortMinigameSettingsBuilding*         K2Node_DynamicCast_AsFort_Minigame_Settings_Building; // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UFortTrapItemDefinition> CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue; // 0x58(0x28)(HasGetValueTypeHash)
	...
	TSoftClassPtr<class UObject>                 K2Node_Select_Default;                             // 0x88(0x28)(HasGetValueTypeHash)
};
...
public:
	...
	UInterfaceProperty_                          K2Node_DynamicCast_AsFort_Initialize_from_Object_Interface; // 0x88(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)

...
{
	static auto Func = Class->GetFunction("Athena_Player_Bush_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("Athena_Player_Bush_C", "OnDamageServer");
...
{
	static auto Func = Class->GetFunction("Athena_Player_Bush_C", "ReceiveBeginPlay");

	Params::AAthena_Player_Bush_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("Athena_Player_Bush_C", "OnDeathServer");
...
{
	static auto Func = Class->GetFunction("Athena_Player_Bush_C", "RemoveBush");

	Params::AAthena_Player_Bush_C_RemoveBush_Params Parms;

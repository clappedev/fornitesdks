...
{
	static auto Func = Class->GetFunction("GC_Athena_Feedback_ExplosionSmall_SmallRadius_C", "OnBurst");

	Params::UGC_Athena_Feedback_ExplosionSmall_SmallRadius_C_OnBurst_Params Parms;

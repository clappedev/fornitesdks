...
{
public:
	struct FMovieSceneFloatChannel               VectorChannels;                                    // 0x50(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1611[0x1E0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1614[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<class UObject*>                       UObjects;                                          // 0x80(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
public:
	...
	TArray<struct FNiagaraDataInterfaceGPUParamInfo> DIParamInfo;                                       // 0xF0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	enum class ENiagaraScriptCompileStatus       LastCompileStatus;                                 // 0x100(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_1629[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	int32                                        ParameterSize;                                     // 0xF8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                       PaddedParameterSize;                               // 0xFC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraScriptExecutionPaddingInfo> PaddingInfo;                                       // 0x100(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        bInitialized : 1;                                  // Mask : 0x1 0x110(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_162B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UObject*>                       RootObjects;                                       // 0x8(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_162C[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_162D[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1631[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1632[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TMap<struct FNiagaraVariable, struct FNiagaraVariable> UserParameterRedirects;                            // 0xF8(0x50)(ZeroConstructor, NativeAccessSpecifierPrivate)
};

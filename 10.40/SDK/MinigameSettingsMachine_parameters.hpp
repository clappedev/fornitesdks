...
public:
	...
	struct FSolarisPrototype                     K2Node_MakeStruct_SolarisPrototype;                // 0x30(0x60)()
};
...
public:
	...
	uint8                                        Pad_5732[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5748[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class UCommonActivatablePanel*               K2Node_DynamicCast_AsCommon_Activatable_Panel;     // 0x38(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_574B[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_NotEqual_IntInt_ReturnValue;              // 0x99(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         Temp_bool_Variable;                                // 0x9A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_574E[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        K2Node_Select_Default;                             // 0x9C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_NotEqual_IntInt_ReturnValue_1;            // 0xA0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TMap<class FString, class FString>           K2Node_MakeMap_Map;                                // 0xD8(0x50)(ConstParm, ZeroConstructor)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_1;            // 0x128(0x10)(ZeroConstructor, NoDestructor)
	bool                                         CallFunc_SetPropertyOverrides_ReturnValue;         // 0x138(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5750[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class AFortPlayerController*>         CallFunc_GetLocalFortPlayerControllers_ReturnValue_2; // 0x140(0x10)(ZeroConstructor, ReferenceParm)
	...
	class AFortVolumeManager*                    CallFunc_GetVolumeManager_OutVolumeManager;        // 0x158(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EVolumeValidityResult             CallFunc_GetVolumeManager_OutIsValid;              // 0x160(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5751[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UFortAsyncAction_CreateWidgetAsync*    CallFunc_CreateWidgetAsync_ReturnValue;            // 0x168(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_5752[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         K2Node_Event_bShouldUse;                           // 0x181(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

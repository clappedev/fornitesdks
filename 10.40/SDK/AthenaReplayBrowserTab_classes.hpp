...
public:
	...
	void OnViewStreamingReplay(bool* PassThrough, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UAthenaViewStreamingReplayModal_C* CallFunc_Create_ReturnValue);

...
// bool                               CallFunc_IsLiveSpectateButtonEnabled_ReturnValue                 (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UAthenaMatchmakingOptionsDisplay_v2_C::OnSpectateMatch(bool* PassThrough, bool CallFunc_IsLiveSpectateButtonEnabled_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UAthenaSpectateMatchModal_C* CallFunc_Create_ReturnValue)
{
	...
	Parms.CallFunc_IsLiveSpectateButtonEnabled_ReturnValue = CallFunc_IsLiveSpectateButtonEnabled_ReturnValue;
...
// enum class EInputActionState       Temp_byte_Variable_17                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class EInputActionState       Temp_byte_Variable_18                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFillDisableReason      Temp_byte_Variable_19                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortMatchmakingTileStyleTemp_byte_Variable_20                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_IsLiveSpectateButtonEnabled_ReturnValue                 (ZeroConstructor, IsPlainOldData, NoDestructor)
// enum class EInputActionState       K2Node_Select_Default_21                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaMatchmakingOptionsDisplay_v2_C::ExecuteUbergraph_AthenaMatchmakingOptionsDisplay_v2(int32 EntryPoint, class FText Temp_text_Variable, class FText Temp_text_Variable_1, class FText Temp_text_Variable_2, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, bool Temp_bool_Variable_1, class UClass* Temp_class_Variable, class UClass* Temp_class_Variable_1, bool Temp_bool_Variable_2, class UClass* Temp_class_Variable_2, class UClass* Temp_class_Variable_3, bool Temp_bool_Variable_3, const struct FLinearColor& Temp_struct_Variable, const struct FLinearColor& Temp_struct_Variable_1, bool Temp_bool_Variable_4, const struct FLinearColor& Temp_struct_Variable_2, const struct FLinearColor& Temp_struct_Variable_3, bool Temp_bool_Variable_5, enum class EInputActionState Temp_byte_Variable_2, enum class EInputActionState Temp_byte_Variable_3, class UFortMatchmakingContext* CallFunc_GetContext_ReturnValue, bool Temp_bool_Variable_6, bool CallFunc_IsCustomMatchmakingKeyEnabled_ReturnValue, enum class ESlateVisibility Temp_byte_Variable_4, enum class EInputActionState K2Node_Select_Default, enum class ESlateVisibility Temp_byte_Variable_5, enum class ESquadFillSetting Temp_byte_Variable_6, bool Temp_bool_Variable_7, bool Temp_bool_Variable_8, bool Temp_bool_Variable_9, bool Temp_bool_Variable_10, class FText Temp_text_Variable_3, class FText Temp_text_Variable_4, enum class EServerAccessSetting Temp_byte_Variable_7, bool Temp_bool_Variable_11, bool Temp_bool_Variable_12, bool Temp_bool_Variable_13, enum class ESpectatorQueueType Temp_byte_Variable_8, class FText Temp_text_Variable_5, class FText Temp_text_Variable_6, class FText Temp_text_Variable_7, bool Temp_bool_Variable_14, enum class ESlateVisibility Temp_byte_Variable_9, enum class ESlateVisibility Temp_byte_Variable_10, bool Temp_bool_Variable_15, enum class EInputActionState Temp_byte_Variable_11, enum class EInputActionState Temp_byte_Variable_12, class UFortMatchmakingContext* CallFunc_GetContext_ReturnValue_1, bool Temp_bool_Variable_16, bool CallFunc_IsLiveSpectatingEnabled_ReturnValue, enum class ESlateVisibility Temp_byte_Variable_13, enum class EInputActionState K2Node_Select_Default_1, enum class ESlateVisibility Temp_byte_Variable_14, bool Temp_bool_Variable_17, enum class ESlateVisibility Temp_byte_Variable_15, enum class ESlateVisibility Temp_byte_Variable_16, class UFortMcpContext* CallFunc_GetContext_ReturnValue_2, const class FString& CallFunc_GetAffiliateName_ReturnValue, enum class ESlateVisibility K2Node_Select_Default_2, int32 CallFunc_Len_ReturnValue, bool Temp_bool_Variable_18, bool CallFunc_EqualEqual_IntInt_ReturnValue, enum class EInputActionState Temp_byte_Variable_17, enum class EInputActionState Temp_byte_Variable_18, enum class ESquadFillSetting K2Node_Event_InSquadFillSetting, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool K2Node_Select_Default_3, class FText Temp_text_Variable_8, class FText Temp_text_Variable_9, class FText Temp_text_Variable_10, class UCommonButton* K2Node_ComponentBoundEvent_Button_3, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue_1, const struct FPlaylistFrontEndData& K2Node_Event_NewRepresentedPlaylist, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1, bool CallFunc_IsValid_ReturnValue, const struct FSlateBrush& CallFunc_MakeBrushFromTexture_ReturnValue, const struct FSlateBrush& CallFunc_MakeBrushFromTexture_ReturnValue_1, class FText CallFunc_TextToUpper_ReturnValue, bool CallFunc_TextIsEmpty_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue_1, class UCommonButton* K2Node_Event_ButtonClicked, int32 CallFunc_Array_Length_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, int32 CallFunc_Len_ReturnValue_1, bool CallFunc_Greater_IntInt_ReturnValue_1, enum class ESlateVisibility K2Node_Select_Default_4, int32 CallFunc_Len_ReturnValue_2, class FText CallFunc_Conv_StringToText_ReturnValue_1, bool CallFunc_Greater_IntInt_ReturnValue_2, int32 CallFunc_Len_ReturnValue_3, class FText CallFunc_Conv_StringToText_ReturnValue_2, bool CallFunc_Greater_IntInt_ReturnValue_3, class FText CallFunc_TextToUpper_ReturnValue_2, class FText Temp_text_Variable_11, class FText Temp_text_Variable_12, bool CallFunc_IsValid_ReturnValue_1, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button, bool K2Node_DynamicCast_bSuccess, bool K2Node_Event_bPlaylistIsEnabled, enum class EFillDisableReason K2Node_Event_FillDisableReason, bool CallFunc_NotEqual_ByteByte_ReturnValue, enum class ESlateVisibility K2Node_Select_Default_5, class UClass* K2Node_Select_Default_6, class UClass* K2Node_Select_Default_7, const struct FLinearColor& K2Node_Select_Default_8, bool CallFunc_Not_PreBool_ReturnValue, const struct FLinearColor& K2Node_Select_Default_9, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_NotEqual_ByteByte_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue_1, enum class EFillDisableReason Temp_byte_Variable_19, enum class ESlateVisibility K2Node_Select_Default_10, class FText K2Node_Select_Default_11, class UWidget* Temp_object_Variable, enum class EFortMatchmakingTileStyle Temp_byte_Variable_20, class UWidget* K2Node_Select_Default_12, enum class ESlateVisibility Temp_byte_Variable_21, enum class ESlateVisibility Temp_byte_Variable_22, bool Temp_bool_Variable_19, enum class ESlateVisibility K2Node_Select_Default_13, enum class ESlateVisibility Temp_byte_Variable_23, enum class ESlateVisibility Temp_byte_Variable_24, enum class EServerAccessSetting K2Node_Event_InServerAccessSetting, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, bool K2Node_Select_Default_14, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button_1, bool K2Node_DynamicCast_bSuccess_1, class FText K2Node_Select_Default_15, bool Temp_bool_Variable_20, enum class ESlateVisibility K2Node_Select_Default_16, enum class ESlateVisibility Temp_byte_Variable_25, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button_2, bool K2Node_DynamicCast_bSuccess_2, enum class ESpectatorQueueType K2Node_Event_InSpectatorQueueType, bool CallFunc_EqualEqual_ByteByte_ReturnValue_2, class FText K2Node_Select_Default_17, enum class ESlateVisibility Temp_byte_Variable_26, class UCommonButton* K2Node_ComponentBoundEvent_Button_2, bool CallFunc_Handle_InputAction_Cancel_PassThrough, bool CallFunc_IsMobileGame_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_1, enum class ESlateVisibility K2Node_Select_Default_18, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, int32 CallFunc_Len_ReturnValue_4, class UAffiliateKeyModal_C* CallFunc_Create_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue_4, bool CallFunc_NotEqual_StrStr_ReturnValue, const class FString& K2Node_Event_AffiliateName, bool CallFunc_BooleanOR_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_1, bool Temp_bool_Variable_21, bool CallFunc_EqualEqual_StrStr_ReturnValue, enum class ESlateVisibility K2Node_Select_Default_19, bool CallFunc_BooleanAND_ReturnValue_2, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_2, bool K2Node_Event_bIsCreativeLTM, bool CallFunc_BooleanAND_ReturnValue_3, bool CallFunc_BooleanAND_ReturnValue_4, bool CallFunc_IsMobileGame_ReturnValue_1, class FText Temp_text_Variable_13, bool Temp_bool_Variable_22, bool CallFunc_Is_Performing_Transition_Performing_Transition, class FText K2Node_Select_Default_20, bool CallFunc_IsLiveSpectateButtonEnabled_ReturnValue, enum class EInputActionState K2Node_Select_Default_21)
{

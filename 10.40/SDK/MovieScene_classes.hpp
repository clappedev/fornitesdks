...
public:
	...
	uint8                                        Pad_FDE[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FE2[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FE4[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FE8[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FF4[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FF6[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FF7[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]

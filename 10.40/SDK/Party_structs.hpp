...
public:
	...
	uint8                                        Pad_13E3[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_13E4[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class USocialChatChannel*>            ListenChannels;                                    // 0x18(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_13E5[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_13E7[0x35];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13E8[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

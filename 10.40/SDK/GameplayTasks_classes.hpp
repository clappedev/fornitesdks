...
{
public:
	uint8                                        Pad_1418[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        : 1;                                               // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        bIsNetDirty : 1;                                   // Mask : 0x2 0xBC(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_141A[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_141D[0x25];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1424[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1425[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]

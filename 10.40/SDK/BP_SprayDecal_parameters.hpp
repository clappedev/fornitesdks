...
public:
	...
	UInterfaceProperty_                          CallFunc_GetOwnedGameplayTags_self_CastInput;      // 0xA8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                        Pad_ED5[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]

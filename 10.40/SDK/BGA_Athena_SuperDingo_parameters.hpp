...
public:
	...
	UInterfaceProperty_                          K2Node_DynamicCast_AsFort_Vehicle_Interface;       // 0x8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                        Pad_4F92[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ABGA_Athena_SuperDingo_C_HitTurn__FinishedFunc_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_HitTurn__UpdateFunc_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SpawnIn__FinishedFunc_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SpawnIn__UpdateFunc_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_ReceiveBeginPlay_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SpawnBox_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_OnSpawn_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SetupRandomTurns_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_TurnTrigger_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SetupHeightCheck_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_HeightCheck_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SetupHeightPicker_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SelectHeight_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_Despawn_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SetupLeashCheck_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_LeashCheck_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_SpawnMaterialVFX_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_DeSpawnMaterialVFX_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_OutOfCircleDespawn_Params
{
public:
};
...
struct ABGA_Athena_SuperDingo_C_ResumeMovement_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_4F9F[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4FAB[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4FB3[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]

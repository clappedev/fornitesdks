...
public:
	...
	class UCommonInputSubsystem*                 CallFunc_GetContext_ReturnValue;                   // 0xA8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AFortPlayerController*                 K2Node_DynamicCast_AsFort_Player_Controller_4;     // 0xC0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_GetText_ReturnValue;                      // 0xD8(0x18)()
	bool                                         CallFunc_IsPlayerNameValid_OutIsValid;             // 0xF0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_1F7[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_IsPlayerNameValid_OutErrorText;           // 0xF8(0x18)()

...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingSpinnerButton_C", "OnFocusReceived");

	Params::UAthenaMatchmakingSpinnerButton_C_OnFocusReceived_Params Parms;

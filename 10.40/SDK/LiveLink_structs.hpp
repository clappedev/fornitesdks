...
{
public:
	uint8                                        Pad_FC0[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_FC1[0x140];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_FC3[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_FC4[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]

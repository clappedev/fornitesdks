...
public:
	...
	uint8                                        Pad_E75[0xD8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E76[0xE];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E77[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E7B[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E7C[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E7D[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E80[0xE];                                      // Fixing Size After Last Property  [ Dumper-7 ]

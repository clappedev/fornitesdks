...
void AB_Prj_Athena_SilverBlazer_V2_C::OnStop(struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SilverBlazer_V2_C", "OnStop");

	Params::AB_Prj_Athena_SilverBlazer_V2_C_OnStop_Params Parms;
	Parms.Hit = Hit;
...
void AB_Prj_Athena_SilverBlazer_V2_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SilverBlazer_V2_C", "ReceiveHit");

	Params::AB_Prj_Athena_SilverBlazer_V2_C_ReceiveHit_Params Parms;
	Parms.MyComp = MyComp;
	Parms.Other = Other;
...
void AB_Prj_Athena_SilverBlazer_V2_C::SpawnBGA(struct FHitResult& HitResult, class UPrimitiveComponent* HitComp, const struct FVector& Pos)
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SilverBlazer_V2_C", "SpawnBGA");

	Params::AB_Prj_Athena_SilverBlazer_V2_C_SpawnBGA_Params Parms;

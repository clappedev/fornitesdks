...
{
	static auto Func = Class->GetFunction("B_SneakySnowman_Athena_C", "K2_OnUnEquip");

	Params::AB_SneakySnowman_Athena_C_K2_OnUnEquip_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_SneakySnowman_Athena_C", "ExecuteUbergraph_B_SneakySnowman_Athena");

...
void UAthenaDirectAcquisitionScreen_C::Handle_AffiliateButton(bool* PassThrough, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UAffiliateKeyModal_C* CallFunc_Create_ReturnValue)
{
...
// class UFortStoreFrontOfferInfo*    LocalOfferData                                                   (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               bIsLargeTile                                                     (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
// class UAthenaDirectAcquisitionOfferWidget_C*OfferWidget                                                      (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FString                      Category                                                         (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
// TArray<class FString>              CallFunc_GetStorefrontNames_ReturnValue                          (ZeroConstructor, ReferenceParm)
...
void UAthenaDirectAcquisitionScreen_C::GenerateOfferWidget(class UFortStoreFrontOfferInfo* OfferData, class UFortStoreFrontOfferInfo* LocalOfferData, bool bIsLargeTile, class UAthenaDirectAcquisitionOfferWidget_C* OfferWidget, const class FString& Category, TArray<class FString>& CallFunc_GetStorefrontNames_ReturnValue, bool CallFunc_EqualEqual_StrStr_ReturnValue, const class FString& CallFunc_Array_Get_Item, class FName CallFunc_Conv_StringToName_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UAthenaDirectAcquisitionOfferWidget_C* CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, const class FString& CallFunc_GetFortStoreOfferCategory_ReturnValue, class FName CallFunc_GetStorefrontName_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue, int32 CallFunc_GetChildrenCount_ReturnValue, class UGridSlot* CallFunc_AddChildToGrid_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Percent_IntInt_ReturnValue, int32 CallFunc_Divide_IntInt_ReturnValue, int32 CallFunc_SelectInt_ReturnValue, int32 CallFunc_SelectInt_ReturnValue_1, bool CallFunc_LessEqual_IntInt_ReturnValue_1, class UHorizontalBoxSlot* CallFunc_AddChildToHorizontalBox_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UAthenaDirectAcquisitionOfferWidget_C* CallFunc_Create_ReturnValue)
{
	...
	Parms.LocalOfferData = LocalOfferData;
	Parms.bIsLargeTile = bIsLargeTile;
	Parms.OfferWidget = OfferWidget;
	Parms.Category = Category;
	Parms.CallFunc_GetStorefrontNames_ReturnValue = CallFunc_GetStorefrontNames_ReturnValue;
...
{
	static auto Func = Class->GetFunction("AthenaDirectAcquisitionScreen_C", "IsCommunityVotingLayout");

	Params::UAthenaDirectAcquisitionScreen_C_IsCommunityVotingLayout_Params Parms;
...
void UAthenaDirectAcquisitionScreen_C::ExecuteUbergraph_AthenaDirectAcquisitionScreen(int32 EntryPoint, enum class ESlateVisibility Temp_byte_Variable, bool CallFunc_IsActivated_ReturnValue, const struct FDateTime& CallFunc_GetWeeklyStoreEndDate_ReturnValue, const struct FDateTime& CallFunc_GetDailyStoreEndDate_ReturnValue, enum class ESlateVisibility Temp_byte_Variable_1, bool K2Node_Event_HasOtherPlatformCurrency, class FText K2Node_Event_CurrencyMessageLocText, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, bool CallFunc_GetEnableSplitWalletTextNotice_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_1, const class FString& K2Node_Event_AffiliateName, class FText CallFunc_Conv_StringToText_ReturnValue, int32 CallFunc_Len_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool Temp_bool_Variable, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_2, class UFortMcpContext* CallFunc_GetContext_ReturnValue, bool K2Node_Event_bIsVotingLayout, const class FString& CallFunc_GetAffiliateName_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
	...
	Parms.K2Node_Event_bIsVotingLayout = K2Node_Event_bIsVotingLayout;

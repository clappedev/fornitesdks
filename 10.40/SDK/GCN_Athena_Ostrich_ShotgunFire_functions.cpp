...
{
	static auto Func = Class->GetFunction("GCN_Athena_Ostrich_ShotgunFire_C", "MeterFlare");
...
{
	static auto Func = Class->GetFunction("GCN_Athena_Ostrich_ShotgunFire_C", "OnBurst");

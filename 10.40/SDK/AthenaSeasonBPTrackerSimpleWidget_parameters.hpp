...
struct UAthenaSeasonBPTrackerSimpleWidget_C_SetStyleFree_Params
{
public:
};
...
struct UAthenaSeasonBPTrackerSimpleWidget_C_SetStylePremium_Params
{
public:
};
...
struct UAthenaSeasonBPTrackerSimpleWidget_C_PreConstruct_Params
{
public:
...
struct UAthenaSeasonBPTrackerSimpleWidget_C_Construct_Params
{
public:
};
...
public:
	...
	struct FFortPublicAccountInfo                K2Node_Event_Result;                               // 0x38(0x34)(ConstParm, NoDestructor)
	...
	bool                                         CallFunc_GreaterEqual_IntInt_ReturnValue_1;        // 0x8D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3F3F[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        Temp_float_Variable_2;                             // 0x90(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        Temp_float_Variable_3;                             // 0xAC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        K2Node_Select_Default_3;                           // 0xB8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3F42[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateFontInfo                        K2Node_MakeStruct_SlateFontInfo;                   // 0xC0(0x50)(HasGetValueTypeHash)
};

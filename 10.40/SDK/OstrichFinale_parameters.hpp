...
struct UOstrichFinale_C_PreConstruct_Params
{
public:
...
struct UOstrichFinale_C_Construct_Params
{
public:
};
...
struct UOstrichFinale_C_OnSelfDestructStart_Params
{
public:
	//float                                      WarningDuration;                                   // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x4 (0x4 - 0x0)
// Function OstrichFinale.OstrichFinale_C.OnUpdateSelfDestruct
struct UOstrichFinale_C_OnUpdateSelfDestruct_Params
{
public:
...
struct UOstrichFinale_C_OnSelfDestructFinish_Params
{
public:
};
...
struct UOstrichFinale_C_OnSetupComplete_Params
{
public:
};
...
struct UOstrichFinale_C_OnStartSelfDestructPrime_Params
{
public:
...
struct UOstrichFinale_C_OnCancelSelfDestructPrime_Params
{
public:
};
...
struct UOstrichFinale_C_ExecuteUbergraph_OstrichFinale_Params
{
public:
	...
	float                                        K2Node_Event_WarningDuration;                      // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_FTrunc_ReturnValue_2;                     // 0x1C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        K2Node_Event_Duration;                             // 0x2C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

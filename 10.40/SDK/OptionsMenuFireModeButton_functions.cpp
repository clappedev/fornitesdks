...
void UOptionsMenuFireModeButton_C::HandleFireModeButtonClicked(class UCommonButton* Common_Button, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue, class UHUDLayoutToolFireModePanel_C* K2Node_DynamicCast_AsHUDLayout_Tool_Fire_Mode_Panel, bool K2Node_DynamicCast_bSuccess)
{
	static auto Func = Class->GetFunction("OptionsMenuFireModeButton_C", "HandleFireModeButtonClicked");

	Params::UOptionsMenuFireModeButton_C_HandleFireModeButtonClicked_Params Parms;
...
{
	static auto Func = Class->GetFunction("OptionsMenuFireModeButton_C", "Destruct");

	Params::UOptionsMenuFireModeButton_C_Destruct_Params Parms;

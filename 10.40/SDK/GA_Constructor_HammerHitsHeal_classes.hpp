...
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0xA98(0x8)(ZeroConstructor, Transient, DuplicateTransient)
	struct FGameplayTagContainer                 TC_RequiredTags;                                   // 0xAA0(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)

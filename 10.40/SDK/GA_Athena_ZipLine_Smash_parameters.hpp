...
public:
	...
	uint8                                        Pad_4352[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_3;            // 0x260(0x10)(ZeroConstructor, NoDestructor)
	class ABP_Athena_Environmental_ZipLine_C*    K2Node_DynamicCast_AsBP_Athena_Environmental_Zip_Line; // 0x270(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_2;                     // 0x278(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         GameplayTagsK2Node_SwitchGameplayTag_CmpSuccess;   // 0x279(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)

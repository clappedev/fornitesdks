...
{
	static auto Func = Class->GetFunction("GCN_Athena_Ostrich_Enter_Driver_C", "OnExecute");
...
{
	static auto Func = Class->GetFunction("GCN_Athena_Ostrich_Enter_Driver_C", "OnBurst");

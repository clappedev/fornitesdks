...
{
	static auto Func = Class->GetFunction("Tiered_Chest_Athena_C", "OnRep_IsGlitched");
...
{
	static auto Func = Class->GetFunction("Tiered_Chest_Athena_C", "HandleGlitch");

	Params::ATiered_Chest_Athena_C_HandleGlitch_Params Parms;

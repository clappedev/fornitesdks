...
// Parameters:
// UInterfaceProperty_                UserListEntry                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UUserListEntryLibrary::IsListItemSelected(UInterfaceProperty_ UserListEntry)
{
...
bool UUserListEntryLibrary::IsListItemExpanded(UInterfaceProperty_ UserListEntry)
{
...
class UListViewBase* UUserListEntryLibrary::GetOwningListView(UInterfaceProperty_ UserListEntry)
{
...
// (Final, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// UInterfaceProperty_                UserObjectListEntry                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
// class UObject*                     ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UObject* UUserObjectListEntryLibrary::GetListItemObject(UInterfaceProperty_ UserObjectListEntry)
{

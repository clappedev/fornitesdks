...
class UGCN_Athena_Item_JollyRascal_Main_Spawn_C : public UFortGameplayCueNotify_Burst
{
public:
	TMap<int32, class USoundBase*>               MapSound;                                          // 0x1A0(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("GCN_Athena_Item_JollyRascal_Main_Spawn_C");
		return Clss;
	}

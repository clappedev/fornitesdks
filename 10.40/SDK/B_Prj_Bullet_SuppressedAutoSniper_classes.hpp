...
public:
	...
	class UStaticMeshComponent*                  TracerMesh;                                        // 0x830(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("B_Prj_Bullet_SuppressedAutoSniper_C");
		return Clss;
	}

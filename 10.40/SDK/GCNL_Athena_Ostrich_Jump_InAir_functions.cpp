...
{
	static auto Func = Class->GetFunction("GCNL_Athena_Ostrich_Jump_InAir_C", "OnApplication");
...
{
	static auto Func = Class->GetFunction("GCNL_Athena_Ostrich_Jump_InAir_C", "ExecuteUbergraph_GCNL_Athena_Ostrich_Jump_InAir");

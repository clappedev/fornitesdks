...
{
	unsigned char                                      UnknownData00[0x6C8];                                     // 0x0008(0x06C8) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x368];                                     // 0x0000(0x0368) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x2C8];                                     // 0x0000(0x02C8) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x338];                                     // 0x0000(0x0338) MISSED OFFSET
};
...
struct FFortBasicMissionInfo
{
	...
	unsigned char                                      UnknownData00[0x3A0];                                     // 0x0018(0x03A0) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x210];                                     // 0x0008(0x0210) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x370];                                     // 0x0000(0x0370) MISSED OFFSET
};
...
{
	struct FText                                       DisplayName;                                              // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData00[0x6F8];                                     // 0x0018(0x06F8) MISSED OFFSET
};

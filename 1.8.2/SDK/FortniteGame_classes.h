...
{
public:
	unsigned char                                      UnknownData00[0x7B0];                                     // 0x0EE0(0x07B0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x250];                                     // 0x0388(0x0250) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x23B8];                                    // 0x0028(0x23B8) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x560];                                     // 0x1690(0x0560) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x1E0];                                     // 0x03B0(0x01E0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x1C38];                                    // 0x06C8(0x1C38) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x250];                                     // 0x0028(0x0250) MISSED OFFSET
...
public:
	...
	void STATIC_GetPlayerUtcNowMcpOffset(class UFortLocalPlayer* LocalPlayer);
	void STATIC_GetPlayerControllerUtcNowMcpOffset();
};
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class FortniteGame.FortDownloadingScreen");
		return ptr;
	}
...
// 0x0610 (0x0700 - 0x00F0)
class UFortGameInstance : public UGameInstance
{
public:
	unsigned char                                      UnknownData00[0x610];                                     // 0x00F0(0x0610) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xA0];                                      // 0x0790(0x00A0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x70];                                      // 0x0830(0x0070) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x4A0];                                     // 0x2390(0x04A0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x9C0];                                     // 0x2830(0x09C0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x290];                                     // 0x08A0(0x0290) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xB0];                                      // 0x0790(0x00B0) MISSED OFFSET

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class FortniteGame.FortLoadingMode");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData00[0x40];                                      // 0x0A40(0x0040) MISSED OFFSET
...
public:
	...
	float                                              IdleResetShortTimer;                                      // 0x05C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x80];                                      // 0x05C8(0x0080) MISSED OFFSET
	float                                              ReconnectToMMSDelay;                                      // 0x0648(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxReconnectToMMSDelay;                                   // 0x064C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0650(0x0008) MISSED OFFSET
	struct FString                                     MMSVersionCompatability;                                  // 0x0658(0x0010) (ZeroConstructor, Config)
	struct FString                                     MMSTicketURLServer;                                       // 0x0668(0x0010) (ZeroConstructor, Config)
	float                                              MMSPingInterval;                                          // 0x0678(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC4];                                      // 0x067C(0x00C4) MISSED OFFSET
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class FortniteGame.FortGameStateChunkDownloader");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x1220(0x0020) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x140];                                     // 0x1220(0x0140) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x190];                                     // 0x1360(0x0190) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xF0];                                      // 0x1360(0x00F0) MISSED OFFSET
...
public:
	...
	bool                                               RememberMeCheckbox;                                       // 0x0180(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0181(0x0007) MISSED OFFSET
	struct FString                                     RememberMeToken;                                          // 0x0188(0x0010) (ZeroConstructor, Config)
	struct FString                                     LastLoginEmail;                                           // 0x0198(0x0010) (ZeroConstructor, Config)
	bool                                               bMotionBlur;                                              // 0x01A8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bShowGrass;                                               // 0x01A9(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bShowFPS;                                                 // 0x01AA(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x01AB(0x0001) MISSED OFFSET
	int                                                InitialBenchmarkState;                                    // 0x01AC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bDisableMouseAcceleration;                                // 0x01B0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x01B1(0x0003) MISSED OFFSET
	int                                                DiscreteResolutionQuality;                                // 0x01B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x8];                                       // 0x01B8(0x0008) MISSED OFFSET
...
public:
	...
	void STATIC_ClientRequestSetTimeOfDay();
...
public:
	...
	unsigned char                                      UnknownData01[0x3E0];                                     // 0x01E0(0x03E0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xA0];                                      // 0x2390(0x00A0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x6B0];                                     // 0x0420(0x06B0) MISSED OFFSET
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class FortniteGame.FortPlayerControllerChunkDownloader");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData00[0x170];                                     // 0x2830(0x0170) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x2830(0x0020) MISSED OFFSET
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class FortniteGame.FortPlayerStateChunkDownloader");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData00[0x250];                                     // 0x0AD0(0x0250) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x80];                                      // 0x2830(0x0080) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x80];                                      // 0x0D20(0x0080) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x520];                                     // 0x00F0(0x0520) MISSED OFFSET

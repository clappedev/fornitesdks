...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_FragGrenade_C", "UserConstructionScript");

	Params::AB_Prj_Athena_FragGrenade_C_UserConstructionScript_Params Parms;

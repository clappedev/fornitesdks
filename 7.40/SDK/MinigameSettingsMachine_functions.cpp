...
void AMinigameSettingsMachine_C::TryAddEndCondition_Kills(TArray<struct FFortMinigameStatQuery>& EndConditions, bool* bResult, bool bAdded, const struct FFortMinigameStatQuery& K2Node_MakeStruct_FortMinigameStatQuery, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("MinigameSettingsMachine_C", "TryAddEndCondition_Kills");

	Params::AMinigameSettingsMachine_C_TryAddEndCondition_Kills_Params Parms;
	Parms.EndConditions = EndConditions;
	Parms.bAdded = bAdded;
	Parms.K2Node_MakeStruct_FortMinigameStatQuery = K2Node_MakeStruct_FortMinigameStatQuery;
	Parms.CallFunc_Array_Add_ReturnValue = CallFunc_Array_Add_ReturnValue;
...
// bool                               CallFunc_TryAddEndCondition_Kills_bResult                        (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_HasAuthority_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor)
// class AFortMinigame*               CallFunc_GetCurrentMinigame_Minigame                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void AMinigameSettingsMachine_C::UpdateEndConditions(const TArray<struct FFortMinigameStatQuery>& EndConditions, class AFortMinigame* Minigame, bool CallFunc_TryAddEndCondition_CollectItems_bResult, bool CallFunc_TryAddEndCondition_Kills_bResult, bool CallFunc_HasAuthority_ReturnValue, class AFortMinigame* CallFunc_GetCurrentMinigame_Minigame, bool CallFunc_IsValid_ReturnValue)
{
	...
	Parms.CallFunc_TryAddEndCondition_Kills_bResult = CallFunc_TryAddEndCondition_Kills_bResult;
	Parms.CallFunc_HasAuthority_ReturnValue = CallFunc_HasAuthority_ReturnValue;
	Parms.CallFunc_GetCurrentMinigame_Minigame = CallFunc_GetCurrentMinigame_Minigame;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
...
void AMinigameSettingsMachine_C::UpdateTeamSetting(class AFortMinigame* CurrentMinigame, bool CallFunc_HasAuthority_ReturnValue, class AFortMinigame* CallFunc_GetCurrentMinigame_Minigame, bool CallFunc_IsValid_ReturnValue)
{
...
void AMinigameSettingsMachine_C::UpdateGameMode(class AFortMinigame* CurrentMinigame, bool CallFunc_Array_IsValidIndex_ReturnValue, bool CallFunc_IsValid_ReturnValue, class AFortMinigame* CallFunc_GetCurrentMinigame_Minigame, bool CallFunc_NotEqual_IntInt_ReturnValue)
{

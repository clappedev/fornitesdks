...
// bool                               CallFunc_HasAnyUserFocus_ReturnValue1                            (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_HasAnyUserFocus_ReturnValue2                            (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_HasAnyUserFocus_ReturnValue3                            (ZeroConstructor, IsPlainOldData, NoDestructor)

class UWidget* UGamepadMappingInfo_v3_C::DoCustomNavigation_0(enum class EUINavigation Navigation, class UWidget* NextWidget_Local, bool K2Node_SwitchEnum_CmpSuccess, bool CallFunc_HasAnyUserFocus_ReturnValue, bool CallFunc_HasAnyUserFocus_ReturnValue1, bool CallFunc_HasAnyUserFocus_ReturnValue2, bool CallFunc_HasAnyUserFocus_ReturnValue3)
{
	...
	Parms.CallFunc_HasAnyUserFocus_ReturnValue1 = CallFunc_HasAnyUserFocus_ReturnValue1;
	Parms.CallFunc_HasAnyUserFocus_ReturnValue2 = CallFunc_HasAnyUserFocus_ReturnValue2;
	Parms.CallFunc_HasAnyUserFocus_ReturnValue3 = CallFunc_HasAnyUserFocus_ReturnValue3;
...
void UGamepadMappingInfo_v3_C::Update_Displayed_Mapping(int32 Platform, enum class EFortInputActionGroup Mode, int32 Configuration, enum class ESlateVisibility Temp_byte_Variable, bool K2Node_SwitchInteger_CmpSuccess, enum class ESlateVisibility Temp_byte_Variable1, enum class ESlateVisibility Temp_byte_Variable2, enum class ESlateVisibility Temp_byte_Variable3, int32 Temp_int_Variable, enum class ESlateVisibility Temp_byte_Variable4, enum class ESlateVisibility K2Node_Select_Default, enum class ESlateVisibility Temp_byte_Variable5, enum class ESlateVisibility Temp_byte_Variable6, enum class ESlateVisibility Temp_byte_Variable7, int32 Temp_int_Variable1, enum class ESlateVisibility K2Node_Select1_Default, int32 Temp_int_Variable2, TArray<TSoftObjectPtr<class UTexture2D>>& K2Node_Select2_Default)
{
...
// class FName                        CallFunc_GetTabIdAtIndex_ReturnValue3                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// float                              CallFunc_ConvertSliderValueToSettingsValue_SettingsValue1        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UGamepadMappingInfo_v3_C::ExecuteUbergraph_GamepadMappingInfo_v3(int32 EntryPoint, class UObject* Temp_object_Variable, class UTexture2D* K2Node_DynamicCast_AsTexture_2D, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, TSoftObjectPtr<class UTexture2D> CallFunc_GetControllerImage_Texture, bool CallFunc_IsAssetNull_ReturnValue, int32 Temp_int_Array_Index_Variable, class UCommonButton* K2Node_CustomEvent_Button2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UGamepadKeyTextButton_C* K2Node_DynamicCast_AsGamepad_Key_Text_Button, bool K2Node_DynamicCast_bSuccess1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, int32 CallFunc_Array_Length_ReturnValue, TArray<class UGamepadKeyTextButton_C*>& K2Node_MakeArray_Array, class FName CallFunc_GetTabIdAtIndex_ReturnValue, class FName CallFunc_GetTabIdAtIndex_ReturnValue1, class FName CallFunc_GetTabIdAtIndex_ReturnValue2, class FName CallFunc_GetTabIdAtIndex_ReturnValue3, int32 CallFunc_GetTabCount_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable1, int32 Temp_int_Loop_Counter_Variable, class UGamepadKeyTextButton_C* CallFunc_Array_Get_Item, class FName CallFunc_GetCustomButtonDataForKey_ActionName, class FText CallFunc_GetCustomButtonDataForKey_DescText, class FName CallFunc_GetCustomButtonDataForKey_ActionName1, class FText CallFunc_GetCustomButtonDataForKey_DescText1, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class UObject* K2Node_CustomEvent_Loaded, class UCommonButton* K2Node_CustomEvent_Button1, class UCommonButton* K2Node_CustomEvent_Button, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, int32 Temp_int_Loop_Counter_Variable1, int32 CallFunc_Add_IntInt_ReturnValue1, class UFortSettingsContext* CallFunc_GetContext_ReturnValue, float CallFunc_GetValue_ReturnValue, float CallFunc_ConvertSliderValueToSettingsValue_SettingsValue, class UFortSettingsContext* CallFunc_GetContext_ReturnValue1, float CallFunc_GetValue_ReturnValue1, float CallFunc_ConvertSliderValueToSettingsValue_SettingsValue1, class FName CallFunc_GetCustomButtonDataForKey_ActionName2, class FText CallFunc_GetCustomButtonDataForKey_DescText2, class UGamepadKeyTextButton_C* CallFunc_Array_Get_Item1, int32 CallFunc_Array_Length_ReturnValue1, bool CallFunc_Less_IntInt_ReturnValue1)
{
	...
	Parms.CallFunc_GetTabIdAtIndex_ReturnValue3 = CallFunc_GetTabIdAtIndex_ReturnValue3;
	...
	Parms.CallFunc_ConvertSliderValueToSettingsValue_SettingsValue1 = CallFunc_ConvertSliderValueToSettingsValue_SettingsValue1;

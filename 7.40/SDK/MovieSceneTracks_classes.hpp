...
public:
	...
	uint8                                        Pad_1103[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1107[0x140];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Rotation;                                          // 0x2C8(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1108[0x140];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Scale;                                             // 0x4A8(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1109[0x140];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_110C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_111A[0x1E0];                                   // Fixing Size After Last Property  [ Dumper-7 ]

...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_DemonHunter_Crossbow_Athena_C", "UserConstructionScript");

	Params::AB_Prj_Arrow_DemonHunter_Crossbow_Athena_C_UserConstructionScript_Params Parms;

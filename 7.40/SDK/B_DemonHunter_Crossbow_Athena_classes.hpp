...
public:
	...
	class UParticleSystemComponent*              P_DemonHunter_Crossbow_FireTipFlare;               // 0xDF0(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

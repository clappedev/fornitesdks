...
public:
	...
	uint8                                        Temp_byte_Variable;                                // 0x50(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        CallFunc_GetActorPvPTeamIndex_TeamIndex;           // 0x51(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_GetActorPvPTeamIndex_ReturnValue;         // 0x52(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_10F2[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTagQuery                     Temp_struct_Variable;                              // 0x58(0x48)()
	struct FGameplayTagQuery                     Temp_struct_Variable1;                             // 0xA0(0x48)()
	struct FGameplayTagQuery                     Temp_struct_Variable2;                             // 0xE8(0x48)()
	struct FGameplayTagQuery                     Temp_struct_Variable3;                             // 0x130(0x48)()
	struct FGameplayTagQuery                     K2Node_Select_Default;                             // 0x178(0x48)()
};

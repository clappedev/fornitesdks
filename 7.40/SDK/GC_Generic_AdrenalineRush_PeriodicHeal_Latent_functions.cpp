...
{
	static auto Func = Class->GetFunction("GC_Generic_AdrenalineRush_PeriodicHeal_Latent_C", "UserConstructionScript");

	Params::AGC_Generic_AdrenalineRush_PeriodicHeal_Latent_C_UserConstructionScript_Params Parms;

...
void AB_Perk_C_Constructor_BASE_C::SetupHostileEffects(class UAbilitySystemComponent* AbilitySystemComponent, TArray<struct FBASEGameplayEffect>* HostileEffects, UInterfaceProperty_ CallFunc_HasAllMatchingGameplayTags_TagContainerInterface_CastInput, bool CallFunc_HasAllMatchingGameplayTags_ReturnValue, const struct FBASEGameplayEffect& K2Node_MakeStruct_BASEGameplayEffect, int32 CallFunc_Array_Add_ReturnValue, UInterfaceProperty_ CallFunc_HasAllMatchingGameplayTags_TagContainerInterface1_CastInput, bool CallFunc_HasAllMatchingGameplayTags_ReturnValue1, const struct FBASEGameplayEffect& K2Node_MakeStruct_BASEGameplayEffect1, int32 CallFunc_Array_Add_ReturnValue1, const struct FBASEGameplayEffect& K2Node_MakeStruct_BASEGameplayEffect2, int32 CallFunc_Array_Add_ReturnValue2, UInterfaceProperty_ CallFunc_HasAllMatchingGameplayTags_TagContainerInterface2_CastInput, bool CallFunc_HasAllMatchingGameplayTags_ReturnValue2)
{
...
void AB_Perk_C_Constructor_BASE_C::SetupBaseDefaultValues(class UAbilitySystemComponent* Ability_System_Component, int32* NodesToAffect, bool Temp_bool_Variable, float CallFunc_GetValueAtLevel_ReturnValue, int32 CallFunc_FTrunc_ReturnValue, UInterfaceProperty_ CallFunc_HasAllMatchingGameplayTags_TagContainerInterface_CastInput, bool CallFunc_HasAllMatchingGameplayTags_ReturnValue, bool Temp_bool_Variable1, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue1, int32 CallFunc_FTrunc_ReturnValue1, UInterfaceProperty_ CallFunc_HasAllMatchingGameplayTags_TagContainerInterface1_CastInput, bool CallFunc_HasAllMatchingGameplayTags_ReturnValue1, UInterfaceProperty_ CallFunc_HasAllMatchingGameplayTags_TagContainerInterface2_CastInput, bool CallFunc_HasAllMatchingGameplayTags_ReturnValue2, int32 K2Node_Select_Default, int32 CallFunc_Add_IntInt_ReturnValue, int32 K2Node_Select1_Default, int32 CallFunc_Add_IntInt_ReturnValue1)
{
...
{
	static auto Func = Class->GetFunction("B_Perk_C_Constructor_BASE_C", "UserConstructionScript");

	Params::AB_Perk_C_Constructor_BASE_C_UserConstructionScript_Params Parms;

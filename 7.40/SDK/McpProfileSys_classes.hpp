...
public:
	...
	uint8                                        Pad_285D[0x57];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_285E[0x1D];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2860[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2861[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2864[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2868[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	bool                                         bSendProfileCommandRevisions;                      // 0x1E0(0x1)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                         bAsyncParseProfileUpdates;                         // 0x1E1(0x1)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2869[0x2E];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_286A[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]

...
public:
	...
	uint8                                        Pad_1059[0x15];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_105D[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1063[0x348];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1066[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1067[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	UInterfaceProperty_                          PlaybackClient;                                    // 0x778(0x10)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_1068[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]

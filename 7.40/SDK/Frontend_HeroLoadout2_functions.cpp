...
{
	static auto Func = Class->GetFunction("Frontend_HeroLoadout2_C", "UserConstructionScript");

	Params::AFrontend_HeroLoadout2_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("Frontend_HeroLoadout2_C", "OnActivated");

	Params::AFrontend_HeroLoadout2_C_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("Frontend_HeroLoadout2_C", "OnDeactivated");

	Params::AFrontend_HeroLoadout2_C_OnDeactivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("Frontend_HeroLoadout2_C", "ExecuteUbergraph_Frontend_HeroLoadout2");

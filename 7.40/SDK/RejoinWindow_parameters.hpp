...
public:
	...
	uint8                                        Pad_557C[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FMcpBanInfo                           CallFunc_GetBanInfo_ReturnValue;                   // 0x10(0x40)(ConstParm)
	bool                                         CallFunc_IsUserCurrentlyBanned_ReturnValue;        // 0x50(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

...
{
public:
	uint8                                        Pad_28F2[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_28F6[0x29B];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_28F8[0x2F0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_28F9[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_28FA[0x34];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_28FB[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]

...
public:
	...
	uint8                                        Pad_3AAF[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FScalableFloat                        CallFunc_EvaluatePerkTierBalanceValue_Balance_Value; // 0x128(0x20)()
	...
	struct FFortGameplayEffectContainer          CallFunc_BP_GetGameplayEffectContainer_ReturnValue; // 0x150(0x90)()
	...
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue1; // 0x2A0(0x80)()
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue2; // 0x320(0x80)()
};

...
{
	static auto Func = Class->GetFunction("GA_DanceGrenade_ALSyne_C", "InvalidHandle_B5171FC24972C9187F9F1CA732D2527C");
...
{
	static auto Func = Class->GetFunction("GA_DanceGrenade_ALSyne_C", "OnRemoved_B5171FC24972C9187F9F1CA732D2527C");
...
{
	static auto Func = Class->GetFunction("GA_DanceGrenade_ALSyne_C", "K2_ActivateAbility");

	Params::UGA_DanceGrenade_ALSyne_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_DanceGrenade_ALSyne_C", "K2_OnEndAbility");
...
{
	static auto Func = Class->GetFunction("GA_DanceGrenade_ALSyne_C", "ExecuteUbergraph_GA_DanceGrenade_ALSyne");

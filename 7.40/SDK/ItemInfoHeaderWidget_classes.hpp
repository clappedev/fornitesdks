...
public:
	...
	class UCommonTextBlock*                      RarityTextBlock;                                   // 0x308(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	void OverrideHeaderAndDiscription(class FText Hearder, class FText Desciption, class FText ItemType, bool bUseAlternateHeaderBG, enum class ESlateVisibility Temp_byte_Variable, class FText CallFunc_TextToUpper_ReturnValue, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UWidget* K2Node_Select_Default, const struct FFortRarityItemData& CallFunc_BPGetRarityData_ReturnValue, bool Temp_bool_Variable1, enum class ESlateVisibility K2Node_Select1_Default);

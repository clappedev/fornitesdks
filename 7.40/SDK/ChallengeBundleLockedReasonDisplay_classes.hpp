...
public:
	...
	class UCommonTextBlock*                      LockedText;                                        // 0x238(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	UInterfaceProperty_                          TimeSpanSource;                                    // 0x240(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	struct FFortChallengeBundleInfoLockedReason  ReasonForLock;                                     // 0x250(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)

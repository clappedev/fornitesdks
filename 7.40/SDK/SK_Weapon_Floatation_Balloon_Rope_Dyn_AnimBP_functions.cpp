...
{
	static auto Func = Class->GetFunction("SK_Weapon_Floatation_Balloon_Rope_Dyn_AnimBP_C", "BlueprintUpdateAnimation");
...
{
	static auto Func = Class->GetFunction("SK_Weapon_Floatation_Balloon_Rope_Dyn_AnimBP_C", "BlueprintInitializeAnimation");

	Params::USK_Weapon_Floatation_Balloon_Rope_Dyn_AnimBP_C_BlueprintInitializeAnimation_Params Parms;

...
{
public:
	uint8                                        Pad_F76[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_F77[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F7A[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F7B[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Shear;                                             // 0x368(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_F7C[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]

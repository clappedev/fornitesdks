...
{
	static auto Func = Class->GetFunction("B_Prj_Commando_FragGrenade_Cluster_C", "UserConstructionScript");

	Params::AB_Prj_Commando_FragGrenade_Cluster_C_UserConstructionScript_Params Parms;

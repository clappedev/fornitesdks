...
void UFrontEnd_C::QueueSurvivorSquadsAutoSlottedNotification(class FText Temp_text_Variable, class FText Temp_text_Variable1, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class UBasicNotification_C* CallFunc_CreateNotification_ReturnValue)
{

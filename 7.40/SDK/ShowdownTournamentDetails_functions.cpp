...
{
	static auto Func = Class->GetFunction("ShowdownTournamentDetails_C", "BndEvt__BackButton2_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("ShowdownTournamentDetails_C", "BndEvt__DetailsPanelButton2_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("ShowdownTournamentDetails_C", "BndEvt__OverviewPanelButton2_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("ShowdownTournamentDetails_C", "BndEvt__Button_ViewLeaderboard_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("ShowdownTournamentDetails_C", "EventViewFullLeaderboard");
...
{
	static auto Func = Class->GetFunction("ShowdownTournamentDetails_C", "EventToggleFullScreenContent");
...
{
	static auto Func = Class->GetFunction("ShowdownTournamentDetails_C", "EventCloseLeaderboard");

	Params::UShowdownTournamentDetails_C_EventCloseLeaderboard_Params Parms;

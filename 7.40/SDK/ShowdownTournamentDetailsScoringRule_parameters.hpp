...
public:
	...
	class FText                                  Temp_text_Variable;                                // 0x280(0x18)()
	...
	struct FFortShowdownScoringRuleDisplayInfo   CallFunc_GetDataTableRowFromName_OutRow;           // 0x2B0(0x48)()
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x300(0x18)()
	class FText                                  K2Node_Select1_Default;                            // 0x318(0x18)()
};

...
{
public:
	uint8                                        Pad_2C0C[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2C0D[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2C0F[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C10[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2C11[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C12[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]

...
public:
	...
	enum class EPlayerBanReasons                 Temp_byte_Variable;                                // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_48D4[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_Len_ReturnValue;                          // 0x34(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  Temp_text_Variable2;                               // 0xD8(0x18)()
...
public:
	...
	struct FTimespan                             CallFunc_GetBanDuration_ReturnValue;               // 0x200(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetTotalSeconds_ReturnValue;              // 0x208(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_LessEqual_FloatFloat_ReturnValue;         // 0x20C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EPlayerBanReasons                 CallFunc_Array_Get_Item;                           // 0x20D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_48DF[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_BanEnumToText_ReturnValue;                // 0x210(0x18)()
	...
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData2;             // 0x230(0x40)(HasGetValueTypeHash)
	...
	struct FTimespan                             CallFunc_GetBanDuration_ReturnValue1;              // 0x2A8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_GetTimespanAsText_ReturnValue;            // 0x2B0(0x18)()
	class FText                                  K2Node_Select2_Default;                            // 0x2C8(0x18)()
};

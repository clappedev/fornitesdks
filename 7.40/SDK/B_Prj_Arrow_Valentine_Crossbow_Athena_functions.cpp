...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_Valentine_Crossbow_Athena_C", "UserConstructionScript");

	Params::AB_Prj_Arrow_Valentine_Crossbow_Athena_C_UserConstructionScript_Params Parms;
...
void AB_Prj_Arrow_Valentine_Crossbow_Athena_C::OnTouched(class AActor* OtherActor, class UPrimitiveComponent* OtherComp, struct FHitResult& HitResult, bool bIsOverlap)
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_Valentine_Crossbow_Athena_C", "OnTouched");

	Params::AB_Prj_Arrow_Valentine_Crossbow_Athena_C_OnTouched_Params Parms;

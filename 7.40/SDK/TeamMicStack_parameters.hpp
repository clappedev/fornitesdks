...
public:
	...
	TArray<class UHUD_TeamMemberInfo_C*>         K2Node_MakeArray_Array;                            // 0x210(0x10)(ZeroConstructor, ReferenceParm)
	...
	class UHUD_TeamMemberInfo_C*                 CallFunc_Array_Get_Item;                           // 0x228(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UCinematic_TeamMics_C*                 CallFunc_Create_ReturnValue;                       // 0x240(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

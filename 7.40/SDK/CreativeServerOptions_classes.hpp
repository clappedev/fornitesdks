...
public:
	...
	UMulticastDelegateProperty_                  OnSelectedServerChanged;                           // 0x2D8(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

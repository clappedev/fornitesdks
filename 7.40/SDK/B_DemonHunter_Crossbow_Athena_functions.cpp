...
{
	static auto Func = Class->GetFunction("B_DemonHunter_Crossbow_Athena_C", "UserConstructionScript");

	Params::AB_DemonHunter_Crossbow_Athena_C_UserConstructionScript_Params Parms;

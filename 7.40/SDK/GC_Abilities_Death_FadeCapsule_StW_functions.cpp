...
{
	static auto Func = Class->GetFunction("GC_Abilities_Death_FadeCapsule_StW_C", "UserConstructionScript");

	Params::AGC_Abilities_Death_FadeCapsule_StW_C_UserConstructionScript_Params Parms;

...
public:
	...
	class UItemCraftingIngredientList_C*         ItemCraftingIngredientList;                        // 0x288(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

...
{
	static auto Func = Class->GetFunction("GC_Abilities_Death_FadeCapsule_Athena_C", "UserConstructionScript");

	Params::AGC_Abilities_Death_FadeCapsule_Athena_C_UserConstructionScript_Params Parms;

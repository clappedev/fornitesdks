...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_C", "UserConstructionScript");

	Params::ABP_ZipLine_Athena_Harness_C_UserConstructionScript_Params Parms;

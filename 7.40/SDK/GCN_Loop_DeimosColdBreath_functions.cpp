...
{
	static auto Func = Class->GetFunction("GCN_Loop_DeimosColdBreath_C", "UserConstructionScript");

	Params::AGCN_Loop_DeimosColdBreath_C_UserConstructionScript_Params Parms;

...
{
	static auto Func = Class->GetFunction("B_Assault_InfantryRifle_Athena_C", "UserConstructionScript");

	Params::AB_Assault_InfantryRifle_Athena_C_UserConstructionScript_Params Parms;

...
public:
	...
	UMulticastDelegateProperty_                  Entry_Selected;                                    // 0xB40(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

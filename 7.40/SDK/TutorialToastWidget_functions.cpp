...
{
	static auto Func = Class->GetFunction("TutorialToastWidget_C", "CompleteToast");

	Params::UTutorialToastWidget_C_CompleteToast_Params Parms;
...
{
	static auto Func = Class->GetFunction("TutorialToastWidget_C", "WidgetAnimationEvt_Intro_K2Node_WidgetAnimationEvent_1");

	Params::UTutorialToastWidget_C_WidgetAnimationEvt_Intro_K2Node_WidgetAnimationEvent_1_Params Parms;

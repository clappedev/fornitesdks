...
{
public:
	uint8                                        Pad_2B4A[0x80];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FGameplayTagSource>            TagSources;                                        // 0xA8(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2B4B[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B4C[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]

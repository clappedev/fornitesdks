...
{
	static auto Func = Class->GetFunction("Announce_Gen_Conversation_C", "UserConstructionScript");

	Params::AAnnounce_Gen_Conversation_C_UserConstructionScript_Params Parms;

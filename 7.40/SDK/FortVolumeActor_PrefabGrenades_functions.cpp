...
{
	static auto Func = Class->GetFunction("FortVolumeActor_PrefabGrenades_C", "UserConstructionScript");

	Params::AFortVolumeActor_PrefabGrenades_C_UserConstructionScript_Params Parms;

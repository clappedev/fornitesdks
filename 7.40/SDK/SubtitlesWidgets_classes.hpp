...
{
public:
	uint8                                        Pad_25ED[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_25EE[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_25EF[0x294];                                   // Fixing Size Of Struct [ Dumper-7 ]

...
// bool                               CallFunc_UpdateQuestList_HasClaimableQuests9                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_UpdateQuestList_HasClaimableQuests10                    (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UChallengeBundlePage_C::UpdateQuests(bool bHasQuestsToClaim, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable, bool CallFunc_UpdateQuestList_HasClaimableQuests, bool CallFunc_UpdateQuestList_HasClaimableQuests1, bool CallFunc_UpdateQuestList_HasClaimableQuests2, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_UpdateQuestList_HasClaimableQuests3, bool CallFunc_BooleanOR_ReturnValue1, bool CallFunc_UpdateQuestList_HasClaimableQuests4, bool CallFunc_BooleanOR_ReturnValue2, bool CallFunc_UpdateQuestList_HasClaimableQuests5, bool CallFunc_BooleanOR_ReturnValue3, bool CallFunc_UpdateQuestList_HasClaimableQuests6, bool CallFunc_BooleanOR_ReturnValue4, bool CallFunc_UpdateQuestList_HasClaimableQuests7, bool CallFunc_BooleanOR_ReturnValue5, bool CallFunc_UpdateQuestList_HasClaimableQuests8, bool CallFunc_BooleanOR_ReturnValue6, bool CallFunc_UpdateQuestList_HasClaimableQuests9, bool CallFunc_UpdateQuestList_HasClaimableQuests10, bool CallFunc_BooleanOR_ReturnValue7, bool CallFunc_BooleanOR_ReturnValue8, bool CallFunc_BooleanOR_ReturnValue9, enum class ESlateVisibility K2Node_Select_Default)
{
	...
	Parms.CallFunc_UpdateQuestList_HasClaimableQuests9 = CallFunc_UpdateQuestList_HasClaimableQuests9;
	Parms.CallFunc_UpdateQuestList_HasClaimableQuests10 = CallFunc_UpdateQuestList_HasClaimableQuests10;
...
// class UFortItem*                   CallFunc_GetVaultedItemToPreview_ReturnValue                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UChallengeBundlePage_C::UpdateBundle(bool HideHeader, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, enum class ESlateVisibility Temp_byte_Variable2, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue1, bool CallFunc_IsInZone_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, enum class ESlateVisibility Temp_byte_Variable3, bool Temp_bool_Variable1, bool Temp_bool_Variable2, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable4, bool CallFunc_IsInZone_ReturnValue1, enum class ESlateVisibility Temp_byte_Variable5, class UFortChallengeBundleInfo* CallFunc_GetChallengeBundleInfo_ReturnValue, int32 CallFunc_GetAchievedCount_OutTotalAchievedCount, int32 CallFunc_GetAchievedCount_OutTotalRequiredCount, float CallFunc_GetAchievedCount_OutAchievedPercent, float CallFunc_GetAchievedCount_OutThresholdPercent, bool CallFunc_IsRewardThresholdAchieved_ReturnValue, int32 CallFunc_Conv_BoolToInt_ReturnValue, bool CallFunc_HasSiblingBundles_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, bool Temp_bool_Variable3, class UFortChallengeBundleInfo* CallFunc_GetChallengeBundleInfo_ReturnValue1, class UFortItem* CallFunc_GetVaultedItemToPreview_ReturnValue, enum class ESlateVisibility K2Node_Select1_Default, const struct FFortChallengeBundleInfoLockedReason& CallFunc_IsUnlocked_LockedReason, bool CallFunc_IsUnlocked_ReturnValue, bool CallFunc_OwnsBattlePass_ReturnValue, enum class ESlateVisibility K2Node_Select2_Default, class UFortChallengeBundleItemDefinition* CallFunc_GetBundleDefinition_ReturnValue, int32 CallFunc_GetNumVisibleQuests_ReturnValue, int32 CallFunc_GetRewardCompletionThreshold_ReturnValue, class FText CallFunc_GetDisplayName_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, class FText CallFunc_TextToUpper_ReturnValue, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData1, class FText CallFunc_Format_ReturnValue, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array1, bool CallFunc_EqualEqual_IntInt_ReturnValue, class FText CallFunc_Format_ReturnValue1, class FText K2Node_Select3_Default, class UFortItem* CallFunc_GetRewardItem_ReturnValue, int32 CallFunc_GetNumInStack_ReturnValue, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, const struct FFortItemQuantityPair& CallFunc_MakeItemQuantityPair_ReturnValue, bool CallFunc_SetItemQuantityPairToRepresent_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue)
{
	...
	Parms.CallFunc_GetVaultedItemToPreview_ReturnValue = CallFunc_GetVaultedItemToPreview_ReturnValue;

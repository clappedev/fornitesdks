...
{
	static auto Func = Class->GetFunction("B_FerretWeapon_C", "UserConstructionScript");

	Params::AB_FerretWeapon_C_UserConstructionScript_Params Parms;

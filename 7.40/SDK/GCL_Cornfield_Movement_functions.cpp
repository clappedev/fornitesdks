...
{
	static auto Func = Class->GetFunction("GCL_Cornfield_Movement_C", "UserConstructionScript");

	Params::AGCL_Cornfield_Movement_C_UserConstructionScript_Params Parms;

...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Sweep_Beam_C", "UserConstructionScript");

	Params::AGC_DUDEBRO_Sweep_Beam_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Sweep_Beam_C", "Overtime__FinishedFunc");

	Params::AGC_DUDEBRO_Sweep_Beam_C_Overtime__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Sweep_Beam_C", "Overtime__UpdateFunc");

	Params::AGC_DUDEBRO_Sweep_Beam_C_Overtime__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Sweep_Beam_C", "K2_HandleGameplayCue");
...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Sweep_Beam_C", "Reset");

	Params::AGC_DUDEBRO_Sweep_Beam_C_Reset_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Sweep_Beam_C", "ExecuteUbergraph_GC_DUDEBRO_Sweep_Beam");

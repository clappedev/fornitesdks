...
public:
	...
	class UFortHero*                             Host_Hero;                                         // 0x2F8(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	void UpdateLockedImage(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable1, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsPerkUnlocked_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const struct FSlateBrush& K2Node_Select_Default, enum class ESlateVisibility K2Node_Select1_Default);
	...
	void UpdateFromState(const struct FSlateBrush& CallFunc_NoResourceBrush_ReturnValue, class UFortAbilityKit* CallFunc_GetPerkAbilityKit_ReturnValue, const struct FSlateBrush& CallFunc_ResizeBrush_ResizedBrush, bool CallFunc_IsValid_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue, class UFortAbilityKit* CallFunc_GetPerkAbilityKit_ReturnValue1, class UFortAbilityKit* CallFunc_GetPerkAbilityKit_ReturnValue2, bool CallFunc_IsValid_ReturnValue1, const struct FSlateBrush& CallFunc_ResizeBrush_ResizedBrush1, bool CallFunc_IsValid_ReturnValue2, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UFortTooltipContext* CallFunc_SpawnTooltipContextWithSource_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue, bool Temp_bool_Variable, class UFortTooltipUIContext* CallFunc_GetContext_ReturnValue, class FText CallFunc_GetCombinedDescription_OutDescription, bool CallFunc_GetCombinedDescription_ReturnValue, class FText K2Node_Select_Default);

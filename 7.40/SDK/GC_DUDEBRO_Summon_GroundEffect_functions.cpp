...
{
	static auto Func = Class->GetFunction("GC_DUDEBRO_Summon_GroundEffect_C", "UserConstructionScript");

	Params::AGC_DUDEBRO_Summon_GroundEffect_C_UserConstructionScript_Params Parms;

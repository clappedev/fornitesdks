...
{
	static auto Func = Class->GetFunction("PlayerReportingCategoryDropdown_C", "OnActivated");

	Params::UPlayerReportingCategoryDropdown_C_OnActivated_Params Parms;
...
void UPlayerReportingCategoryDropdown_C::ExecuteUbergraph_PlayerReportingCategoryDropdown(int32 EntryPoint, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class FText>& CallFunc_GetPlayerReportingCategoryLabels_ReturnValue, class FText CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, class UIconTextButton_C* CallFunc_Create_ReturnValue, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue)
{

...
{
	static auto Func = Class->GetFunction("GCNL_Perk_H_CorruptedAura_C", "UserConstructionScript");

	Params::AGCNL_Perk_H_CorruptedAura_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Perk_H_CorruptedAura_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCNL_Perk_H_CorruptedAura_C", "ExecuteUbergraph_GCNL_Perk_H_CorruptedAura");

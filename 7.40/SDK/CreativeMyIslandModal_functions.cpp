...
void UCreativeMyIslandModal_C::PassInputModeToActivePanel(bool bUsingGamepad, bool CallFunc_EqualEqual_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("CreativeMyIslandModal_C", "PassInputModeToActivePanel");

	Params::UCreativeMyIslandModal_C_PassInputModeToActivePanel_Params Parms;
...
{
	static auto Func = Class->GetFunction("CreativeMyIslandModal_C", "BndEvt__Description_K2Node_ComponentBoundEvent_7_CommonButtonClicked__DelegateSignature");

	Params::UCreativeMyIslandModal_C_BndEvt__Description_K2Node_ComponentBoundEvent_7_CommonButtonClicked__DelegateSignature_Params Parms;
	Parms.Button = Button;
...
{
	static auto Func = Class->GetFunction("CreativeMyIslandModal_C", "SetUpOnClosedDelegates");

	Params::UCreativeMyIslandModal_C_SetUpOnClosedDelegates_Params Parms;

...
{
public:
	uint8                                        Pad_1152[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	struct FLevelSequencePlayerSnapshot          FrameInformation;                                  // 0x230(0x88)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class ALevelSequenceActor*                   LevelSequenceActor;                                // 0x2B8(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_1154[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]

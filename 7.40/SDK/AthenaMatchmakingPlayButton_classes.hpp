...
public:
	...
	class UMatchmakingInputIndicator_C*          MatchmakingInputIndicator;                         // 0xB40(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

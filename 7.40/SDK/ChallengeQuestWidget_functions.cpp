...
{
	static auto Func = Class->GetFunction("ChallengeQuestWidget_C", "GetTimeSpanValue");
...
// struct FFortChallengeBundleInfoLockedReasonCallFunc_IsQuestUnlocked_LockedReason                            ()

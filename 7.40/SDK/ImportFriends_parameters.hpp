...
public:
	...
	uint8                                        Pad_5C64[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5C65[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_Select1_Default;                            // 0x58(0x18)()
	...
	class FText                                  K2Node_Select4_Default;                            // 0xF0(0x18)()
};

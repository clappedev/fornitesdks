...
{
	static auto Func = Class->GetFunction("B_BGA_FireworksMortar_Holder_C", "UserConstructionScript");

	Params::AB_BGA_FireworksMortar_Holder_C_UserConstructionScript_Params Parms;

...
struct AB_Prj_Arrow_Valentine_Crossbow_Athena_C_UserConstructionScript_Params
{
public:
};
...
struct AB_Prj_Arrow_Valentine_Crossbow_Athena_C_OnTouched_Params
{
public:
...
struct AB_Prj_Arrow_Valentine_Crossbow_Athena_C_ExecuteUbergraph_B_Prj_Arrow_Valentine_Crossbow_Athena_Params
{
public:
	...
	class AAthena_Prop_SneakySnowman_C*          K2Node_DynamicCast_AsAthena_Prop_Sneaky_Snowman;   // 0x130(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AAthena_Player_SneakySnowman_C*        K2Node_DynamicCast_AsAthena_Player_Sneaky_Snowman; // 0x150(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AAthena_Player_Bush_C*                 K2Node_DynamicCast_AsAthena_Player_Bush;           // 0x160(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess2;                      // 0x168(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Not_PreBool_ReturnValue1;                 // 0x169(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Not_PreBool_ReturnValue2;                 // 0x16A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_64F4[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AAthena_Enemy_Player_SneakySnowman_C*  K2Node_DynamicCast_AsAthena_Enemy_Player_Sneaky_Snowman; // 0x170(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_Not_PreBool_ReturnValue3;                 // 0x17A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         CallFunc_BooleanAND_ReturnValue1;                  // 0x17D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanAND_ReturnValue2;                  // 0x17E(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanAND_ReturnValue3;                  // 0x17F(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

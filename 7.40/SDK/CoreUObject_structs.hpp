...
{
public:
	uint8                                        Pad_C3[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	float                                        InVal;                                             // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_CC[0xC];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D8[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};

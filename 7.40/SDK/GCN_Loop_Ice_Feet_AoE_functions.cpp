...
{
	static auto Func = Class->GetFunction("GCN_Loop_Ice_Feet_AoE_C", "UserConstructionScript");

	Params::AGCN_Loop_Ice_Feet_AoE_C_UserConstructionScript_Params Parms;

...
{
	static auto Func = Class->GetFunction("GC_Perk_FourOnTheFloor_MainDrums_C", "UserConstructionScript");

	Params::AGC_Perk_FourOnTheFloor_MainDrums_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_Perk_FourOnTheFloor_MainDrums_C", "OnLoopingStart");

	Params::AGC_Perk_FourOnTheFloor_MainDrums_C_OnLoopingStart_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_Perk_FourOnTheFloor_MainDrums_C", "OnRemoval");

	Params::AGC_Perk_FourOnTheFloor_MainDrums_C_OnRemoval_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;
...
void AGC_Perk_FourOnTheFloor_MainDrums_C::ExecuteUbergraph_GC_Perk_FourOnTheFloor_MainDrums(int32 EntryPoint, class AActor* K2Node_Event_MyTarget1, const struct FGameplayCueParameters& K2Node_Event_Parameters1, TArray<class UParticleSystemComponent*>& K2Node_Event_ParticleComponents1, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents1, class AActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UParticleSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents, class UCameraShake* K2Node_Event_BurstCameraShakeInstance, class ADecalActor* K2Node_Event_BurstDecalInstance, const struct FRotator& CallFunc_MakeRotator_ReturnValue, const struct FVector& CallFunc_MakeVector_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAtLocation_ReturnValue)
{
	static auto Func = Class->GetFunction("GC_Perk_FourOnTheFloor_MainDrums_C", "ExecuteUbergraph_GC_Perk_FourOnTheFloor_MainDrums");

	Params::AGC_Perk_FourOnTheFloor_MainDrums_C_ExecuteUbergraph_GC_Perk_FourOnTheFloor_MainDrums_Params Parms;

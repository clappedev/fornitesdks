...
{
	static auto Func = Class->GetFunction("GC_Outlander_Phaseshift_PhaseSiphon_Dash_C", "UserConstructionScript");

	Params::AGC_Outlander_Phaseshift_PhaseSiphon_Dash_C_UserConstructionScript_Params Parms;

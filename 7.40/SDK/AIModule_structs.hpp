...
public:
	...
	uint8                                        Pad_DF0[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DFD[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_DFF[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E01[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E07[0x170];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E08[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_E0C[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E0D[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E0E[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E12[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};

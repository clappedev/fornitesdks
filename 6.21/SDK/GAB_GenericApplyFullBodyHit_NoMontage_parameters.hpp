...
public:
	...
	struct FVector                               K2Node_CustomEvent_NormalImpulse;                  // 0x48(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromHitResult_ReturnValue; // 0x188(0x20)()

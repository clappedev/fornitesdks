...
public:
	...
	uint8                                        Pad_271E[0x57];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_271F[0x1D];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         bShouldCreateInstances;                            // 0xD4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                         bProfileWriteLocked;                               // 0xD5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2720[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FDateTime                             ProfileWriteLockExpireTime;                        // 0xD8(0x8)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_2721[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2722[0xC0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2725[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2728[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2729[0x26];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_272A[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]

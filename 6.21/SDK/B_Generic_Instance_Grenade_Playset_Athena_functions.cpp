...
{
	static auto Func = Class->GetFunction("B_Generic_Instance_Grenade_Playset_Athena_C", "UserConstructionScript");

	Params::AB_Generic_Instance_Grenade_Playset_Athena_C_UserConstructionScript_Params Parms;

...
{
	static auto Func = Class->GetFunction("GC_Perk_NightStalker_Active_Looping_C", "UserConstructionScript");

	Params::AGC_Perk_NightStalker_Active_Looping_C_UserConstructionScript_Params Parms;

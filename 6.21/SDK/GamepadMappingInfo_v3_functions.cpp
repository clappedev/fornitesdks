...
void UGamepadMappingInfo_v3_C::ExecuteUbergraph_GamepadMappingInfo_v3(int32 EntryPoint, int32 Temp_int_Loop_Counter_Variable, class UObject* K2Node_CustomEvent_Loaded, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Loop_Counter_Variable1, int32 CallFunc_Add_IntInt_ReturnValue1, TSoftObjectPtr<class UTexture2D> CallFunc_GetControllerImage_Texture, bool CallFunc_IsAssetNull_ReturnValue, class UCommonButton* K2Node_CustomEvent_Button, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UGamepadKeyTextButton_C* K2Node_DynamicCast_AsGamepad_Key_Text_Button, bool K2Node_DynamicCast_bSuccess, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, TArray<class UGamepadKeyTextButton_C*>& K2Node_MakeArray_Array, class UGamepadKeyTextButton_C* CallFunc_Array_Get_Item, class FName CallFunc_GetCustomButtonDataForKey_ActionName, class FText CallFunc_GetCustomButtonDataForKey_DescText, class FName CallFunc_GetCustomButtonDataForKey_ActionName1, class FText CallFunc_GetCustomButtonDataForKey_DescText1, int32 Temp_int_Array_Index_Variable1, class FName CallFunc_GetTabIdAtIndex_ReturnValue, class FName CallFunc_GetTabIdAtIndex_ReturnValue1, class FName CallFunc_GetTabIdAtIndex_ReturnValue2, int32 CallFunc_GetTabCount_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, class UGamepadKeyTextButton_C* CallFunc_Array_Get_Item1, class FName CallFunc_GetCustomButtonDataForKey_ActionName2, class FText CallFunc_GetCustomButtonDataForKey_DescText2, int32 CallFunc_Array_Length_ReturnValue1, bool CallFunc_Less_IntInt_ReturnValue1, class UObject* Temp_object_Variable, class UTexture2D* K2Node_DynamicCast_AsTexture_2D, bool K2Node_DynamicCast_bSuccess1, bool CallFunc_IsValid_ReturnValue)
{

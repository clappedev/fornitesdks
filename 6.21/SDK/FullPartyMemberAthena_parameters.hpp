...
public:
	...
	class FString                                K2Node_Event_IconId;                               // 0x88(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                K2Node_Event_ColorId;                              // 0x98(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	class UUserWidget*                           CallFunc_GetCachedWidget_ReturnValue;              // 0xC0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EFortFriendRequestStatus          Temp_byte_Variable1;                               // 0xC8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5656[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class USocialPanel_C*                        K2Node_DynamicCast_AsSocial_Panel;                 // 0xD0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xD8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EFortFriendRequestStatus          K2Node_Event_RequestStatus;                        // 0xD9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_Select1_Default;                            // 0x108(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

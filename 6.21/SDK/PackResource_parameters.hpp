...
public:
	...
	struct FDateTime                             CallFunc_Now_ReturnValue;                          // 0x220(0x8)(NoDestructor, HasGetValueTypeHash)
	struct FEventReply                           CallFunc_Handled_ReturnValue;                      // 0x228(0xB8)()
	struct FTimespan                             CallFunc_Subtract_DateTimeDateTime_ReturnValue;    // 0x2E0(0x8)(NoDestructor, HasGetValueTypeHash)
...
{
public:
	struct FSlateColor                           CallFunc_GetCountOpacity_SlateColor;               // 0x0(0x28)()
...
public:
	...
	//struct FPointerEvent                       InTouchEvent;                                      // 0x38(0x70)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	//struct FEventReply                         ReturnValue;                                       // 0xA8(0xB8)(Parm, OutParm, ReturnParm)
	struct FDateTime                             CallFunc_Now_ReturnValue;                          // 0x160(0x8)(NoDestructor, HasGetValueTypeHash)

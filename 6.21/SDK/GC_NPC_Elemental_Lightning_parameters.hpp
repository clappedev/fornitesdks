...
public:
	...
	uint8                                        Pad_3200[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3204[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FVector                               CallFunc_Conv_LinearColorToVector_ReturnValue;     // 0x4(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_GetComponentBounds_Origin;                // 0x10C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_GetComponentBounds_BoxExtent;             // 0x118(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetComponentBounds_SphereRadius;          // 0x124(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Divide_VectorFloat_ReturnValue;           // 0x128(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Subtract_VectorVector_ReturnValue;        // 0x134(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)

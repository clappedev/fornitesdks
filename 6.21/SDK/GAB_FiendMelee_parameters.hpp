...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable2;                             // 0x1B8(0x20)()
	...
	struct FRotator                              CallFunc_MakeRotator_ReturnValue;                  // 0x258(0xC)(IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_4004[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayAbilityTargetDataHandle      K2Node_CustomEvent_Target_Data;                    // 0x2A8(0x20)()
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate10;            // 0x370(0x10)(ZeroConstructor, NoDestructor)
	bool                                         CallFunc_AnimSharingEnabled_ReturnValue;           // 0x380(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

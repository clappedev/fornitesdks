...
{
	static auto Func = Class->GetFunction("BP_FortExpeditionOverviewWidget_C", "RefreshActiveInputAction");
...
{
	static auto Func = Class->GetFunction("BP_FortExpeditionOverviewWidget_C", "BndEvt__HeaderWithNav_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature");

	Params::UBP_FortExpeditionOverviewWidget_C_BndEvt__HeaderWithNav_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature_Params Parms;

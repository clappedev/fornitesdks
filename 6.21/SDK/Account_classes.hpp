...
{
public:
	uint8                                        Pad_2652[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2655[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2656[0x29B];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2658[0x2F0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2659[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_265A[0x34];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_265B[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]

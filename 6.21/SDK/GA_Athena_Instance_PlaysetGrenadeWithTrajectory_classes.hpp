...
public:
	...
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0xC10(0x8)(Transient, DuplicateTransient)
	class UFortPlaysetItemDefinition*            PlaysetData;                                       // 0xC18(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
{
	static auto Func = Class->GetFunction("B_Grenade_Playset_Athena_C", "UserConstructionScript");

	Params::AB_Grenade_Playset_Athena_C_UserConstructionScript_Params Parms;

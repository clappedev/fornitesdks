...
void UAthenaFrontEndRadialPicker_C::SetInputMode(bool WasUsingGamepad, bool CallFunc_IsMobileGame_ReturnValue, class UFortPickerContext* CallFunc_GetContext_ReturnValue, class UCommonInputSubsystem* CallFunc_GetContext_ReturnValue1, bool CallFunc_UseLeftThumbstick_ReturnValue, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue)
{
...
void UAthenaFrontEndRadialPicker_C::ExecuteUbergraph_AthenaFrontEndRadialPicker(int32 EntryPoint, bool CallFunc_IsMobileGame_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 CallFunc_Array_Add_ReturnValue, int32 CallFunc_Array_Add_ReturnValue1, int32 CallFunc_Array_Add_ReturnValue2, int32 CallFunc_Array_Add_ReturnValue3, int32 CallFunc_Array_Add_ReturnValue4, int32 CallFunc_Array_Add_ReturnValue5, int32 CallFunc_Array_Add_ReturnValue6, int32 CallFunc_Array_Add_ReturnValue7, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, int32 Temp_int_Loop_Counter_Variable1, int32 CallFunc_Add_IntInt_ReturnValue1, class UFortPickerContext* CallFunc_GetContext_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, const struct FGeometry& K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, bool Temp_bool_Variable, bool CallFunc_CanConfirm_CanAccept, bool Temp_bool_Variable1, int32 K2Node_CustomEvent_PickerOption, enum class ESlateVisibility Temp_byte_Variable, bool Temp_bool_True_if_break_was_hit_Variable, bool CallFunc_Not_PreBool_ReturnValue1, bool CallFunc_BooleanAND_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue1, float CallFunc_GetInputAnalogStickState_StickX, float CallFunc_GetInputAnalogStickState_StickY, float CallFunc_GetMousePosition_LocationX, float CallFunc_GetMousePosition_LocationY, bool CallFunc_GetMousePosition_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, const struct FVector2D& CallFunc_GetViewportSize_ReturnValue, float CallFunc_DegAtan2_ReturnValue, const struct FVector2D& CallFunc_Divide_Vector2DFloat_ReturnValue, float CallFunc_BreakVector2D_X, float CallFunc_BreakVector2D_Y, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue1, float CallFunc_Multiply_FloatFloat_ReturnValue1, enum class ESlateVisibility Temp_byte_Variable1, float CallFunc_DegAtan2_ReturnValue1, bool Temp_bool_Variable2, enum class ESlateVisibility K2Node_Select_Default, bool CallFunc_EqualEqual_IntInt_ReturnValue, enum class ESlateVisibility CallFunc_GetVisibility_ReturnValue, bool CallFunc_NotEqual_ByteByte_ReturnValue, class UFortPickerContext* CallFunc_GetContext_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class URadialPickerItem_C* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue1, bool CallFunc_Less_IntInt_ReturnValue1, bool CallFunc_IsGamepadInPickerDeadZone_bIsInDeadZone, bool CallFunc_Not_PreBool_ReturnValue2, bool CallFunc_BooleanOR_ReturnValue, class UFortPickerContext* CallFunc_GetContext_ReturnValue2, enum class ESlateVisibility CallFunc_GetVisibility_ReturnValue1, bool CallFunc_NotEqual_ByteByte_ReturnValue1, class UCommonInputSubsystem* CallFunc_GetContext_ReturnValue3, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, bool CallFunc_NotEqual_BoolBool_ReturnValue, class URadialPickerItem_C* K2Node_ComponentBoundEvent_Picked_Option7, class URadialPickerItem_C* K2Node_ComponentBoundEvent_Picked_Option6, class URadialPickerItem_C* K2Node_ComponentBoundEvent_Picked_Option5, class URadialPickerItem_C* K2Node_ComponentBoundEvent_Picked_Option4, class URadialPickerItem_C* K2Node_ComponentBoundEvent_Picked_Option3, class URadialPickerItem_C* K2Node_ComponentBoundEvent_Picked_Option2, class URadialPickerItem_C* K2Node_ComponentBoundEvent_Picked_Option1, class URadialPickerItem_C* K2Node_ComponentBoundEvent_Picked_Option, int32 Temp_int_Array_Index_Variable1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, float CallFunc_GetOptionAngle_Angle, bool CallFunc_Less_IntInt_ReturnValue2, float CallFunc_GetAngleDifference_Difference, bool CallFunc_LessEqual_FloatFloat_ReturnValue, bool CallFunc_NotEqual_IntInt_ReturnValue, bool Temp_bool_Variable3, class UCommonButton* K2Node_ComponentBoundEvent_Button1, class UCommonButton* K2Node_ComponentBoundEvent_Button, float K2Node_Select1_Default, bool CallFunc_IsMobileGame_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate4, class UWidget* K2Node_Select2_Default, class UFortPickerContext* CallFunc_GetContext_ReturnValue4, class UWidget* K2Node_Select3_Default)
{

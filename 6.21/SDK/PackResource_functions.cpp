...
// struct FDateTime                   CallFunc_Now_ReturnValue                                         (NoDestructor, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("PackResource_C", "OnTouchEnded");
...
{
	static auto Func = Class->GetFunction("PackResource_C", "OnTouchMoved");
...
void UPackResource_C::RefreshSmallerCountLayout(const struct FSlateColor& CallFunc_GetCountOpacity_SlateColor, bool CallFunc_LessEqual_IntInt_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue)
{

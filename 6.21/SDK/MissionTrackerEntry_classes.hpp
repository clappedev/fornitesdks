...
public:
	...
	UMulticastDelegateProperty_                  WidgetVisibilityChanged;                           // 0x2D0(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

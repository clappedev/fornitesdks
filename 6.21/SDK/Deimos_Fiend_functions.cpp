...
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "UserConstructionScript");

	Params::ADeimos_Fiend_C_UserConstructionScript_Params Parms;
...
void ADeimos_Fiend_C::FlingerSpawnedAnEnemy(class AFortAIPawn* EnemySpawned, class AFortProjectileBase* ProjectileThatSpawnedThisEnemy)
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "FlingerSpawnedAnEnemy");

	Params::ADeimos_Fiend_C_FlingerSpawnedAnEnemy_Params Parms;
...
void ADeimos_Fiend_C::CanFlingerSpawnAnEnemy(class AActor* ActorWhoAsked)
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "CanFlingerSpawnAnEnemy");

	Params::ADeimos_Fiend_C_CanFlingerSpawnAnEnemy_Params Parms;
...
void ADeimos_Fiend_C::FlingerCanSpawnAnEnemy()
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "FlingerCanSpawnAnEnemy");

	Params::ADeimos_Fiend_C_FlingerCanSpawnAnEnemy_Params Parms;
...
void ADeimos_Fiend_C::FlingerCan_tSpawnAnEnemy()
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "FlingerCan'tSpawnAnEnemy");

	Params::ADeimos_Fiend_C_FlingerCan_tSpawnAnEnemy_Params Parms;
...
void ADeimos_Fiend_C::FlingerThrewAProjectileContainingAnEnemy(class AFortProjectileBase* Projectile)
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "FlingerThrewAProjectileContainingAnEnemy");

	Params::ADeimos_Fiend_C_FlingerThrewAProjectileContainingAnEnemy_Params Parms;
...
void ADeimos_Fiend_C::FlingerEnemyFailedToSpawn(class AFortProjectileBase* FailedProjectile)
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "FlingerEnemyFailedToSpawn");

	Params::ADeimos_Fiend_C_FlingerEnemyFailedToSpawn_Params Parms;
...
void ADeimos_Fiend_C::AlertEnemySpawnedByFlinger(const struct FVector& PushMomentum, float PushDuration, class APawn* OwningFlinger)
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "AlertEnemySpawnedByFlinger");

	Params::ADeimos_Fiend_C_AlertEnemySpawnedByFlinger_Params Parms;
...
void ADeimos_Fiend_C::FlingerEnemyDied(class APawn* PawnThatDied)
{
	static auto Func = Class->GetFunction("Deimos_Fiend_C", "FlingerEnemyDied");

	Params::ADeimos_Fiend_C_FlingerEnemyDied_Params Parms;

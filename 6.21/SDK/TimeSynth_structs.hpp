...
public:
	...
	uint8                                        Pad_2702[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FVector2D                             DistanceRange;                                     // 0xC(0x8)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

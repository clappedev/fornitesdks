...
{
	static auto Func = Class->GetFunction("GC_Perk_Assassination_Active_C", "HandleFX");
...
{
	static auto Func = Class->GetFunction("GC_Perk_Assassination_Active_C", "UserConstructionScript");

	Params::AGC_Perk_Assassination_Active_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GC_Perk_Assassination_Active_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GC_Perk_Assassination_Active_C", "OnApplication");
...
{
	static auto Func = Class->GetFunction("GC_Perk_Assassination_Active_C", "ExecuteUbergraph_GC_Perk_Assassination_Active");

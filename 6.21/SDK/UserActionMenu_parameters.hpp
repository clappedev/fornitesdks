...
public:
	...
	struct FLinearColor                          K2Node_Select1_Default;                            // 0x30(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class UFortUINavigationManager*              CallFunc_GetNavigationManager_ReturnValue;         // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_bIsVisible;                           // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EOnlineStatus                     K2Node_Event_OnlineStatus;                         // 0x21(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3569[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UWidget*                               CallFunc_GetFirstEntryToCenter_ReturnValue1;       // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

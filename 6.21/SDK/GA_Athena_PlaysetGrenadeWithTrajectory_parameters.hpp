...
public:
	...
	struct FRotator                              Rotation;                                          // 0x8(0xC)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	struct FRotator                              NewRotation;                                       // 0x14(0xC)(Parm, OutParm, IsPlainOldData, NoDestructor)
	struct FRotator                              PlaysetRotation;                                   // 0x20(0xC)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor)
	struct FRotator                              YawOffset;                                         // 0x2C(0xC)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor)
	...
	struct FRotator                              CallFunc_ComposeRotators_ReturnValue;              // 0x58(0xC)(IsPlainOldData, NoDestructor)
};
...
public:
	...
	struct FHitResult                            CallFunc_CalculateProjectileTrajectorySplineWithHit_OutHitResult; // 0x50(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                               K2Node_Event_Location;                             // 0x20C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              K2Node_Event_Direction;                            // 0x218(0xC)(IsPlainOldData, NoDestructor)
	...
	class AFortGameStateAthena*                  K2Node_DynamicCast_AsFort_Game_State_Athena;       // 0x230(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayTagContainer                 CallFunc_GetAthenaPlaylistContextTags_ReturnValue; // 0x240(0x20)()
	bool                                         CallFunc_HasTag_ReturnValue;                       // 0x260(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3D90[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AFortProjectileBase*                   K2Node_Event_ProjectileReference;                  // 0x268(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortPlaysetItemDefinition*            CallFunc_GetActivePlaysetData_OutData;             // 0x270(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                              CallFunc_CalculateRotation_NewRotation;            // 0x27C(0xC)(IsPlainOldData, NoDestructor)
	bool                                         CallFunc_CheckForOverlappingPlayspaces_ReturnValue; // 0x288(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanOR_ReturnValue4;                   // 0x289(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3D92[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ABP_ProjectileTrajectory_C*            K2Node_Select_Default;                             // 0x290(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABP_ProjectileTrajectory_C*            K2Node_Select1_Default;                            // 0x298(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

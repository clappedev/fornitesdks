...
public:
	...
	uint8                                        Pad_5B85[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               CallFunc_BreakTransform_Location;                  // 0x230(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_BreakTransform_Rotation;                  // 0x23C(0xC)(IsPlainOldData, NoDestructor)
	struct FVector                               CallFunc_BreakTransform_Scale;                     // 0x248(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5B87[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]

...
struct USocialInteractionMenu_HandleMenuOpenChanged_Params
{
public:
	bool                                         bInIsOpen;                                         // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

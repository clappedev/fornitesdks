...
public:
	...
	class UBP_FortMaterialProgressBar_C*         BP_FortMaterialProgressBar;                        // 0x288(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

...
public:
	...
	struct FSoftObjectPath                       GameDefaultMap;                                    // 0x98(0x18)(Edit, Config, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftObjectPath                       ServerDefaultMap;                                  // 0xB0(0x18)(Edit, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                        GlobalDefaultGameMode;                             // 0xC8(0x18)(Edit, Config, NoClear, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                        GlobalDefaultServerGameMode;                       // 0xE0(0x18)(Edit, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)

...
public:
	...
	uint8                                        Pad_4B82[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               K2Node_CustomEvent_Location;                       // 0x144(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_MakeVector_ReturnValue;                   // 0x174(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_GetLocationInCircleXY_LocationLocalSpace; // 0x190(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Add_VectorVector_ReturnValue1;            // 0x19C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)

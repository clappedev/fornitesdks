...
{
	static auto Func = Class->GetFunction("Announce_LowDurability_C", "UserConstructionScript");

	Params::AAnnounce_LowDurability_C_UserConstructionScript_Params Parms;

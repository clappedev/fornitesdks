...
// Parameters:
// class FText                        UnlockingSoon                                                    (Edit, BlueprintVisible)
...
void UChallengeBundleLockedReasonDisplay_C::UpdateLockReasonDisplay(class FText UnlockingSoon, const struct FTimespan& CallFunc_GetTimespanValue_Result, class FText CallFunc_FormatLockedReason_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue)
{
	...
	Parms.UnlockingSoon = UnlockingSoon;

...
{
public:
	class USceneComponent*                       DefaultSceneRoot;                                  // 0xF98(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

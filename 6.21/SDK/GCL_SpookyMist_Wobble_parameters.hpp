...
public:
	...
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue2;         // 0x84(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_FindLookAtRotation_ReturnValue;           // 0x90(0xC)(IsPlainOldData, NoDestructor)
	struct FVector                               CallFunc_Conv_RotatorToVector_ReturnValue;         // 0x9C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

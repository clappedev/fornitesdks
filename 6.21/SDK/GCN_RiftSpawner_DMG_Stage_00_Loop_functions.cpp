...
{
	static auto Func = Class->GetFunction("GCN_RiftSpawner_DMG_Stage_00_Loop_C", "UserConstructionScript");

	Params::AGCN_RiftSpawner_DMG_Stage_00_Loop_C_UserConstructionScript_Params Parms;

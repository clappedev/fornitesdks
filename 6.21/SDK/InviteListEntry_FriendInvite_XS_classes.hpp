...
public:
	...
	void ExecuteUbergraph_InviteListEntry_FriendInvite_XS(int32 EntryPoint, bool K2Node_ComponentBoundEvent_bIsOpen, bool CallFunc_IsAnimationPlaying_ReturnValue);
};

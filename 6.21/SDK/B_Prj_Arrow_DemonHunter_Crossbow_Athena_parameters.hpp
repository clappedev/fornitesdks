...
public:
	...
	struct FHitResult                            K2Node_Event_HitResult;                            // 0x78(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                         K2Node_Event_bIsOverlap;                           // 0x100(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EPhysicalSurface                  CallFunc_GetSurfaceType_ReturnValue;               // 0x101(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BreakHitResult_bBlockingHit;              // 0x102(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BreakHitResult_bInitialOverlap;           // 0x103(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class ADeimos_Fiend_C*                       K2Node_DynamicCast_AsDeimos_Fiend;                 // 0x180(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        Temp_int_Variable22;                               // 0x1AC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EFortTeamAffiliation              CallFunc_GetTeamAffiliation_ReturnValue;           // 0x1B0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_59FE[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue1;         // 0x1B4(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_FindClosestBone_K2_BoneLocation;          // 0x1C4(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FName                                  CallFunc_FindClosestBone_K2_ReturnValue;           // 0x1D0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EPhysicalSurface                  Temp_byte_Variable;                                // 0x1D8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                  Temp_name_Variable;                                // 0x1E0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_GetActorForwardVector_ReturnValue;        // 0x1F0(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_GetActorForwardVector_ReturnValue1;       // 0x220(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue1;        // 0x250(0xC)(IsPlainOldData, NoDestructor)

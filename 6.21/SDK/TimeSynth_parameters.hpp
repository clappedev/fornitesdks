...
{
public:
	struct FTimeSynthClipHandle                  InClipHandle;                                      // 0x0(0x10)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	enum class ETimeSynthEventClipQuantization   EventQuantization;                                 // 0x10(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_26F8[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTimeSynthTimeDef                     FadeTime;                                          // 0x14(0x8)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	struct FTimeSynthClipHandle                  InClipHandle;                                      // 0x0(0x10)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	enum class ETimeSynthEventClipQuantization   EventQuantization;                                 // 0x10(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_26FA[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FTimeSynthFilterSettings              InSettings;                                        // 0x4(0xC)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FTimeSynthEnvelopeFollowerSettings    InSettings;                                        // 0x0(0xC)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FTimeSynthClipHandle                  ReturnValue;                                       // 0x10(0x10)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	UDelegateProperty_                           OnQuantizationEvent;                               // 0x8(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};

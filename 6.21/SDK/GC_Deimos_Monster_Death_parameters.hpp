...
public:
	...
	class ADeimos_Brute_C*                       K2Node_DynamicCast_AsDeimos_Brute;                 // 0xF8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_Conv_BoolToFloat_ReturnValue;             // 0x190(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4ABC[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ADeimos_Fiend_C*                       K2Node_DynamicCast_AsDeimos_Fiend;                 // 0x198(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_Conv_LinearColorToVector_ReturnValue;     // 0x1A4(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

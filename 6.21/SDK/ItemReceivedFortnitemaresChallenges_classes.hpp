...
{
public:
	uint8                                        Pad_2651[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UCommonTextBlock*                      SubHeader;                                         // 0x268(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("ItemReceivedFortnitemaresChallenges_C");
		return Clss;
	}

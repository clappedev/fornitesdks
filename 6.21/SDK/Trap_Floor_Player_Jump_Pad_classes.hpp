...
public:
	...
	class UParticleSystemComponent*              JumpParticleEffect;                                // 0xD98(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

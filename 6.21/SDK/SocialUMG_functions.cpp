...
// Function SocialUMG.SocialInteractionMenu.HandleMenuOpenChanged
// (Final, Native, Private)
// Parameters:
// bool                               bInIsOpen                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USocialInteractionMenu::HandleMenuOpenChanged(bool bInIsOpen)
{
	static auto Func = Class->GetFunction("SocialInteractionMenu", "HandleMenuOpenChanged");

	Params::USocialInteractionMenu_HandleMenuOpenChanged_Params Parms;

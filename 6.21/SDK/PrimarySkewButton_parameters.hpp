...
public:
	...
	bool                                         Temp_bool_5E56992142F23F8FF0DE5B8B6DE7BBD4_Variable; // 0x165(0x1)(ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor)
	...
	float                                        CallFunc_GetEndTime_ReturnValue;                   // 0x234(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	float                                        Temp_float_Variable;                               // 0x160(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable;                                // 0x164(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         Temp_bool_679417744C164854843C9586E9C47A75_Variable; // 0x165(0x1)(ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor)
...
public:
	...
	bool                                         Temp_bool_C3995742480E3DB79FB9909AC28CB9B9_Variable; // 0x4(0x1)(ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor)
	...
	bool                                         Temp_bool_A88C031B40471C7E4A13B79CE7FAEEF9_Variable; // 0xD(0x1)(ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor)
	...
	struct FSlateFontInfo                        K2Node_MakeStruct_SlateFontInfo1;                  // 0x60(0x50)(HasGetValueTypeHash)
	float                                        Temp_float_Variable1;                              // 0xB0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_GetStartTime_ReturnValue1;                // 0x110(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetEndTime_ReturnValue1;                  // 0x114(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_PauseAnimation_ReturnValue2;              // 0x12C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_Select1_Default;                            // 0x130(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_LessEqual_FloatFloat_ReturnValue1;        // 0x134(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                        CallFunc_PauseAnimation_ReturnValue3;              // 0x13C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_Select2_Default;                            // 0x140(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_Add_FloatFloat_ReturnValue1;              // 0x144(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_ComponentBoundEvent_bUsingGamepad;          // 0x148(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5504[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_TextToUpper_ReturnValue;                  // 0x150(0x18)()
	class FText                                  K2Node_Select3_Default;                            // 0x168(0x18)()
};

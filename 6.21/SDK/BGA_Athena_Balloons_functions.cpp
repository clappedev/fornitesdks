...
void ABGA_Athena_Balloons_C::SwapToAnimBp()
{
	static auto Func = Class->GetFunction("BGA_Athena_Balloons_C", "SwapToAnimBp");

	Params::ABGA_Athena_Balloons_C_SwapToAnimBp_Params Parms;

...
public:
	...
	uint8                                        Pad_EAA[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Scale;                                             // 0x4A8(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_EAB[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EBB[0x1E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]

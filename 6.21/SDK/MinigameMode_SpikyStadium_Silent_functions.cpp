...
void AMinigameMode_SpikyStadium_Silent_C::GiveStartingWeapon(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class AFortPlayspaceManager* CallFunc_GetPlayspaceManager_OutPlayspaceManager, enum class EValidityResult CallFunc_GetPlayspaceManager_OutIsValid, bool K2Node_SwitchEnum_CmpSuccess, TArray<class AController*>& CallFunc_GetAllPlayersInPlayspace_ReturnValue, class AController* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess, bool CallFunc_Less_IntInt_ReturnValue, UInterfaceProperty_ CallFunc_GiveItemToInventoryOwner_InventoryOwner_CastInput, UInterfaceProperty_ CallFunc_GiveItemToInventoryOwner_InventoryOwner1_CastInput)
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "GiveStartingWeapon");

	Params::AMinigameMode_SpikyStadium_Silent_C_GiveStartingWeapon_Params Parms;
...
void AMinigameMode_SpikyStadium_Silent_C::SetSinglePlayerToStart(class AFortPlayerController* Player, class APawn* CallFunc_K2_GetPawn_ReturnValue, class AActor* CallFunc_ChoosePlayerStart_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct FTransform& CallFunc_GetTransform_ReturnValue, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, bool CallFunc_K2_TeleportTo_ReturnValue)
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "SetSinglePlayerToStart");

	Params::AMinigameMode_SpikyStadium_Silent_C_SetSinglePlayerToStart_Params Parms;
	Parms.Player = Player;
...
void AMinigameMode_SpikyStadium_Silent_C::RemoveStasis(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class AFortPlayspaceManager* CallFunc_GetPlayspaceManager_OutPlayspaceManager, enum class EValidityResult CallFunc_GetPlayspaceManager_OutIsValid, bool K2Node_SwitchEnum_CmpSuccess, TArray<class AController*>& CallFunc_GetAllPlayersInPlayspace_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class AController* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess, class APawn* CallFunc_K2_GetPawn_ReturnValue, class AFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess1)
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "RemoveStasis");

	Params::AMinigameMode_SpikyStadium_Silent_C_RemoveStasis_Params Parms;
	Parms.Temp_int_Array_Index_Variable = Temp_int_Array_Index_Variable;
	Parms.Temp_int_Loop_Counter_Variable = Temp_int_Loop_Counter_Variable;
	Parms.CallFunc_Add_IntInt_ReturnValue = CallFunc_Add_IntInt_ReturnValue;
	Parms.CallFunc_GetPlayspaceManager_OutPlayspaceManager = CallFunc_GetPlayspaceManager_OutPlayspaceManager;
...
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "SetPlayerPositionToStart");

	Params::AMinigameMode_SpikyStadium_Silent_C_SetPlayerPositionToStart_Params Parms;
	Parms.Temp_int_Array_Index_Variable = Temp_int_Array_Index_Variable;
	Parms.Temp_int_Loop_Counter_Variable = Temp_int_Loop_Counter_Variable;
	Parms.CallFunc_Add_IntInt_ReturnValue = CallFunc_Add_IntInt_ReturnValue;
	Parms.CallFunc_GetPlayspaceManager_OutPlayspaceManager = CallFunc_GetPlayspaceManager_OutPlayspaceManager;
...
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "HandleMinigameAborted");

	Params::AMinigameMode_SpikyStadium_Silent_C_HandleMinigameAborted_Params Parms;
...
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "HandleMinigameStateSetup");

	Params::AMinigameMode_SpikyStadium_Silent_C_HandleMinigameStateSetup_Params Parms;
...
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "K2_PreGameTransitionEvent");

	Params::AMinigameMode_SpikyStadium_Silent_C_K2_PreGameTransitionEvent_Params Parms;
...
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "K2_LeavingPlayspaceEvent");

	Params::AMinigameMode_SpikyStadium_Silent_C_K2_LeavingPlayspaceEvent_Params Parms;
...
{
	static auto Func = Class->GetFunction("MinigameMode_SpikyStadium_Silent_C", "K2_ExitedPlayspaceEvent");

	Params::AMinigameMode_SpikyStadium_Silent_C_K2_ExitedPlayspaceEvent_Params Parms;
	Parms.LeftPlayerState = LeftPlayerState;
...
// class APlayerState*                K2Node_Event_LeftPlayerState                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class APlayerState*                K2Node_Event_LeftPlayerState1                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AMinigameMode_SpikyStadium_Silent_C::ExecuteUbergraph_MinigameMode_SpikyStadium_Silent(int32 EntryPoint, class APlayerState* K2Node_Event_LeftPlayerState, class APlayerState* K2Node_Event_LeftPlayerState1)
{
	...
	Parms.K2Node_Event_LeftPlayerState = K2Node_Event_LeftPlayerState;
	Parms.K2Node_Event_LeftPlayerState1 = K2Node_Event_LeftPlayerState1;

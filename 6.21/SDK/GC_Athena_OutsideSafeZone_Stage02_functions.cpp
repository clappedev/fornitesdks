...
{
	static auto Func = Class->GetFunction("GC_Athena_OutsideSafeZone_Stage02_C", "UserConstructionScript");

	Params::AGC_Athena_OutsideSafeZone_Stage02_C_UserConstructionScript_Params Parms;

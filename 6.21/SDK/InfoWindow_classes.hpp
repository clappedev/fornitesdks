...
public:
	...
	UMulticastDelegateProperty_                  OnInfoIndowClosed;                                 // 0x378(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

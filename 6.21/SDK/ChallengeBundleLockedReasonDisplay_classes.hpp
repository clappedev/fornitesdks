...
public:
	...
	class UCommonTextBlock*                      LockedText;                                        // 0x220(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FFortChallengeBundleInfoLockedReason  LockReason;                                        // 0x228(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	...
	void UpdateLockReasonDisplay(class FText UnlockingSoon, const struct FTimespan& CallFunc_GetTimespanValue_Result, class FText CallFunc_FormatLockedReason_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue);

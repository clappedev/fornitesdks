...
void UMainMenu_C::UpdateRespawnWidgetVisibility(enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class AFortGameStateAthena* K2Node_DynamicCast_AsFort_Game_State_Athena, bool K2Node_DynamicCast_bSuccess, class APawn* CallFunc_GetOwningPlayerPawn_ReturnValue, bool CallFunc_IsPlayerTriggeredRespawnAllowed_ReturnValue, class AFortRemoteControlledPawnAthena* K2Node_DynamicCast_AsFort_Remote_Controlled_Pawn_Athena, bool K2Node_DynamicCast_bSuccess1, bool CallFunc_BooleanAND_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
...
// Function MainMenu.MainMenu_C.OpenRespawnPrompt
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UFortUIManagerWidget_NUI*    CallFunc_GetUIManagerWidget_ReturnValue                          (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UMainMenu_C::OpenRespawnPrompt(class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue)
{
	static auto Func = Class->GetFunction("MainMenu_C", "OpenRespawnPrompt");

	Params::UMainMenu_C_OpenRespawnPrompt_Params Parms;
...
void UMainMenu_C::PushDailyRewards(class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class UFortHUDContext* CallFunc_GetContext_ReturnValue, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue, class UDailyRewards_C* K2Node_DynamicCast_AsDaily_Rewards, bool K2Node_DynamicCast_bSuccess, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue1, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_IsInZone_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue3)
{
...
// class URespawnPromptWidget_C*      CallFunc_Create_ReturnValue2                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UPrivacyWidget_C*            CallFunc_Create_ReturnValue3                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UShowFriendCodesSelection_C* CallFunc_Create_ReturnValue4                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               Temp_bool_Variable2                                              (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_IsOutpostOwner_OutpostOwner                             (ZeroConstructor, IsPlainOldData, NoDestructor)
// class UFortGlobalUIContext*        CallFunc_GetContext_ReturnValue2                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UMessageCenterWidget_C*      CallFunc_Create_ReturnValue5                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UNews_C*                     CallFunc_Create_ReturnValue6                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UPermissionsRoot_C*          CallFunc_Create_ReturnValue7                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ULegalInfo_C*                CallFunc_Create_ReturnValue8                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UOptionsMenu_C*              CallFunc_Create_ReturnValue9                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UMainMenu_C::InitializeMainMenu(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UAthenaChallengesTab_C* CallFunc_Create_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue1, bool CallFunc_AllowLogout_ReturnValue, enum class ESlateVisibility Temp_byte_Variable2, enum class ESlateVisibility Temp_byte_Variable3, bool CallFunc_IsInAthena_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, enum class ESlateVisibility Temp_byte_Variable4, class UTeamSelectWidget_C* CallFunc_Create_ReturnValue1, bool Temp_bool_Variable1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, enum class ESlateVisibility K2Node_Select1_Default, class URespawnPromptWidget_C* CallFunc_Create_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable5, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue3, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue4, class UPrivacyWidget_C* CallFunc_Create_ReturnValue3, class UShowFriendCodesSelection_C* CallFunc_Create_ReturnValue4, bool Temp_bool_Variable2, bool CallFunc_IsOutpostOwner_OutpostOwner, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_IsInZone_ReturnValue1, class UFortUIDataConfigurationContext* CallFunc_GetContext_ReturnValue3, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_ArePartyFeaturesEnabled_ReturnValue, enum class ESlateVisibility K2Node_Select2_Default, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue4, bool CallFunc_AllowQuit_ReturnValue, bool CallFunc_IsInZone_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable6, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, enum class ESlateVisibility Temp_byte_Variable7, bool Temp_bool_Variable3, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue5, bool CallFunc_IsInZone_ReturnValue3, enum class ESlateVisibility K2Node_Select3_Default, bool CallFunc_BooleanAND_ReturnValue1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue5, class UMessageCenterWidget_C* CallFunc_Create_ReturnValue5, class UNews_C* CallFunc_Create_ReturnValue6, class UPermissionsRoot_C* CallFunc_Create_ReturnValue7, class ULegalInfo_C* CallFunc_Create_ReturnValue8, class UOptionsMenu_C* CallFunc_Create_ReturnValue9)
{
	...
	Parms.CallFunc_Create_ReturnValue9 = CallFunc_Create_ReturnValue9;
...
// class UCommonInputManager*         CallFunc_GetInputManager_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortGlobalUIContext*        CallFunc_GetContext_ReturnValue5                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UCommonUISubsystem*          CallFunc_GetContext_ReturnValue6                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UCommonUISubsystem*          CallFunc_GetContext_ReturnValue16                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UCommonUISubsystem*          CallFunc_GetContext_ReturnValue18                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UCommonUISubsystem*          CallFunc_GetContext_ReturnValue19                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortHUDContext*             CallFunc_GetContext_ReturnValue20                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortFrontEndContext*        CallFunc_GetContext_ReturnValue22                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortHUDContext*             CallFunc_GetContext_ReturnValue25                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UMainMenu_C::ExecuteUbergraph_MainMenu(int32 EntryPoint, enum class ESubGame Temp_byte_Variable, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, enum class ESlateVisibility Temp_byte_Variable1, enum class ESlateVisibility Temp_byte_Variable2, enum class ESlateVisibility Temp_byte_Variable3, class UHUDLayoutToolContext* CallFunc_GetContext_ReturnValue, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable4, enum class ESlateVisibility Temp_byte_Variable5, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue1, class UFortHUDContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_IsInZone_ReturnValue, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue3, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue4, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue5, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue6, class UFortHUDContext* CallFunc_GetContext_ReturnValue7, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue1, bool Temp_bool_Variable1, enum class ESlateVisibility Temp_byte_Variable6, enum class ESlateVisibility Temp_byte_Variable7, class UCommonInputSubsystem* CallFunc_GetContext_ReturnValue8, class UCommonButton* K2Node_ComponentBoundEvent_Button62, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button61, class UCommonButton* K2Node_ComponentBoundEvent_Button60, class UCommonButton* K2Node_ComponentBoundEvent_Button59, class UCommonButton* K2Node_ComponentBoundEvent_Button58, class UCommonButton* K2Node_ComponentBoundEvent_Button57, class FText CallFunc_GetEmptyText_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button56, class UCommonButton* K2Node_ComponentBoundEvent_Button55, class UCommonButton* K2Node_ComponentBoundEvent_Button54, class UCommonButton* K2Node_ComponentBoundEvent_Button53, class UCommonButton* K2Node_ComponentBoundEvent_Button52, class UCommonButton* K2Node_ComponentBoundEvent_Button51, class UCommonButton* K2Node_ComponentBoundEvent_Button50, class UCommonButton* K2Node_ComponentBoundEvent_Button49, class UCommonButton* K2Node_CustomEvent_Button3, class UIconTextButton_C* CallFunc_GetButton_Leave, class UCommonButton* K2Node_CustomEvent_Button2, class UIconTextButton_C* CallFunc_GetButton_Leave1, class UCommonButton* K2Node_ComponentBoundEvent_Button48, class UFortPartyContext* CallFunc_GetContext_ReturnValue9, class FText CallFunc_GetLeaveActionText_Text, bool CallFunc_ShouldShowCrossplayWarningDialog_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button47, class UCommonButton* K2Node_ComponentBoundEvent_Button46, class UCommonButton* K2Node_ComponentBoundEvent_Button45, class UCommonButton* K2Node_ComponentBoundEvent_Button44, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue10, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue11, bool CallFunc_IsInZone_ReturnValue1, enum class ESubGame CallFunc_GetSubGame_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button43, class UClass* Temp_class_Variable, class UClass* K2Node_CustomEvent_Loaded, class UClass* K2Node_ClassDynamicCast_AsUser_Widget, bool K2Node_ClassDynamicCast_bSuccess, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue12, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue13, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue14, class UCommonButton* K2Node_ComponentBoundEvent_Button42, bool CallFunc_IsInZone_ReturnValue2, class UCommonButton* K2Node_ComponentBoundEvent_Button41, class UCommonButton* K2Node_ComponentBoundEvent_Button40, class UCommonButton* K2Node_ComponentBoundEvent_Button39, class UCommonButton* K2Node_ComponentBoundEvent_Button38, class UCommonButton* K2Node_ComponentBoundEvent_Button37, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue1, class UCommonButton* K2Node_ComponentBoundEvent_Button36, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue2, class UCommonButton* K2Node_ComponentBoundEvent_Button35, class UFortHUDContext* CallFunc_GetContext_ReturnValue15, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UBoostsRoot_C* CallFunc_Create_ReturnValue, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue16, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue2, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue17, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue18, class UClass* CallFunc_GetUITestingClass_ReturnValue, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue3, bool CallFunc_IsValidClass_ReturnValue, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue19, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue4, class UFortHUDContext* CallFunc_GetContext_ReturnValue20, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue21, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue22, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue23, class UCommonButton* K2Node_ComponentBoundEvent_Button34, class UCommonButton* K2Node_ComponentBoundEvent_Button33, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue24, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, class UCommonButton* K2Node_ComponentBoundEvent_Button32, class UCommonButton* K2Node_ComponentBoundEvent_Button31, class UCommonButton* K2Node_ComponentBoundEvent_Button30, class UCommonButton* K2Node_ComponentBoundEvent_Button29, class UCommonButton* K2Node_ComponentBoundEvent_Button28, class UCommonButton* K2Node_ComponentBoundEvent_Button27, class UCommonButton* K2Node_ComponentBoundEvent_Button26, class FText CallFunc_GetEmptyText_ReturnValue1, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue3, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button25, class UCommonButton* K2Node_ComponentBoundEvent_Button24, class UCommonButton* K2Node_ComponentBoundEvent_Button23, class UCommonButton* K2Node_CustomEvent_Button1, class UCommonButton* K2Node_CustomEvent_Button, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, bool K2Node_ComponentBoundEvent_Visibility1, class UCommonButton* K2Node_ComponentBoundEvent_Button22, class UCommonButton* K2Node_ComponentBoundEvent_Button21, class UCommonButton* K2Node_ComponentBoundEvent_Button20, class UCommonButton* K2Node_ComponentBoundEvent_Button19, enum class EFortDialogResult Temp_byte_Variable8, class UCommonButton* K2Node_ComponentBoundEvent_Button18, bool K2Node_SwitchEnum_CmpSuccess, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, class UUserWidget* CallFunc_Create_ReturnValue1, bool K2Node_ComponentBoundEvent_Visibility, class FName Temp_name_Variable, class UCommonButton* K2Node_ComponentBoundEvent_Button17, class UCommonButton* K2Node_ComponentBoundEvent_Button16, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue4, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue5, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue1, class UBacchusControlsHelp_C* K2Node_DynamicCast_AsBacchus_Controls_Help, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue1, class UCommonButton* K2Node_ComponentBoundEvent_Button15, enum class ESlateVisibility CallFunc_GetVisibility_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button14, enum class ESlateVisibility K2Node_Select_Default, class UCommonButton* K2Node_ComponentBoundEvent_Button13, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, enum class EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, class UCommonButton* K2Node_ComponentBoundEvent_Button12, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue6, bool CallFunc_IsValid_ReturnValue2, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue2, class UHUDLayoutTool_C* K2Node_DynamicCast_AsHUDLayout_Tool, bool K2Node_DynamicCast_bSuccess1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate4, class UCommonButton* K2Node_ComponentBoundEvent_Button11, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate5, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate6, bool CallFunc_IsMobileGame_ReturnValue, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue1, bool CallFunc_IsValid_ReturnValue3, class UCommonButton* K2Node_ComponentBoundEvent_Button10, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue1, enum class EFortDialogResult Temp_byte_Variable9, bool CallFunc_GetIsPlayerReportingFlowEnabled_ReturnValue, bool K2Node_SwitchEnum1_CmpSuccess, enum class ESlateVisibility K2Node_Select1_Default, class FName Temp_name_Variable1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, enum class EFortDialogResult K2Node_CustomEvent_Result1, class FName K2Node_CustomEvent_ResultName1, class UReportPlayer_C* CallFunc_Create_ReturnValue2, class UFortHUDContext* CallFunc_GetContext_ReturnValue25, class UCommonButton* K2Node_ComponentBoundEvent_Button9, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate7, class UCommonButton* K2Node_ComponentBoundEvent_Button8, class UCommonButton* K2Node_ComponentBoundEvent_Button7, class UCommonButton* K2Node_ComponentBoundEvent_Button6, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue2, bool CallFunc_ShowWebURL_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button5, class UCommonButton* K2Node_ComponentBoundEvent_Button4, class UCommonButton* K2Node_ComponentBoundEvent_Button3, bool CallFunc_IsTencentBuild_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button2, class UCommonButton* K2Node_ComponentBoundEvent_Button1, class UCommonButton* K2Node_ComponentBoundEvent_Button, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue3, bool CallFunc_IsMobileGame_ReturnValue1, enum class ESlateVisibility K2Node_Select2_Default)
{

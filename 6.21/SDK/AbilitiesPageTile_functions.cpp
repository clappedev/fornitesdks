...
void UAbilitiesPageTile_C::Destruct()
{
	static auto Func = Class->GetFunction("AbilitiesPageTile_C", "Destruct");

	Params::UAbilitiesPageTile_C_Destruct_Params Parms;
...
void UAbilitiesPageTile_C::ExecuteUbergraph_AbilitiesPageTile(int32 EntryPoint, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue, bool K2Node_CustomEvent_bUsingGamepad)
{

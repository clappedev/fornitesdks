...
void AMusicManager_C::ExecuteUbergraph_MusicManager(int32 EntryPoint, float CallFunc_GetGameTimeInSeconds_ReturnValue, class UFortMusicManagerBank* CallFunc_GetMusicBank_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, float CallFunc_GetGameTimeInSeconds_ReturnValue1, float CallFunc_GetGameTimeInSeconds_ReturnValue2, float CallFunc_GetGameTimeInSeconds_ReturnValue3, float Temp_float_Variable, float CallFunc_Subtract_FloatFloat_ReturnValue1, bool CallFunc_Greater_FloatFloat_ReturnValue1, float CallFunc_GetGameTimeInSeconds_ReturnValue4, float CallFunc_Subtract_FloatFloat_ReturnValue2, bool CallFunc_Greater_FloatFloat_ReturnValue2, bool Temp_bool_Variable, bool CallFunc_NotEqual_IntInt_ReturnValue, float CallFunc_GetGameTimeInSeconds_ReturnValue5, float CallFunc_GetGameTimeInSeconds_ReturnValue6, bool CallFunc_NotEqual_IntInt_ReturnValue1, float Temp_float_Variable1, float Temp_float_Variable2, float CallFunc_Subtract_FloatFloat_ReturnValue3, bool CallFunc_Greater_FloatFloat_ReturnValue3, bool CallFunc_EqualEqual_NameName_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue1, bool CallFunc_EqualEqual_NameName_ReturnValue2, bool CallFunc_EqualEqual_NameName_ReturnValue3, float Temp_float_Variable3, bool CallFunc_EqualEqual_NameName_ReturnValue4, bool CallFunc_EqualEqual_NameName_ReturnValue5, class UFortMusicManagerBank* CallFunc_GetMusicBank_ReturnValue1, float CallFunc_GetWorldDeltaSeconds_ReturnValue, bool Temp_bool_Variable1, float CallFunc_GetWorldDeltaSeconds_ReturnValue1, float CallFunc_GetWorldDeltaSeconds_ReturnValue2, float Temp_float_Variable4, float CallFunc_GetWorldDeltaSeconds_ReturnValue3, float CallFunc_GetGameTimeInSeconds_ReturnValue7, bool CallFunc_EqualEqual_NameName_ReturnValue6, bool CallFunc_EqualEqual_NameName_ReturnValue7, float Temp_float_Variable5, float CallFunc_Subtract_FloatFloat_ReturnValue4, bool Temp_bool_IsClosed_Variable, bool CallFunc_Greater_FloatFloat_ReturnValue4, bool Temp_bool_Has_Been_Initd_Variable, class UFortMusicManagerBank* CallFunc_GetMusicBank_ReturnValue2, bool Temp_bool_Variable2, bool Temp_bool_IsClosed_Variable1, bool Temp_bool_Has_Been_Initd_Variable1, enum class EFortDayPhase K2Node_Event_CurrentDayPhase, enum class EFortDayPhase K2Node_Event_PreviousDayPhase, bool K2Node_Event_bAtCreation, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsNearActiveEncounters_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue1, bool CallFunc_NotEqual_IntInt_ReturnValue2, float CallFunc_GetGameTimeInSeconds_ReturnValue8, float CallFunc_GetGameTimeInSeconds_ReturnValue9, float CallFunc_Subtract_FloatFloat_ReturnValue5, bool CallFunc_Greater_FloatFloat_ReturnValue5, bool CallFunc_NotEqual_IntInt_ReturnValue3, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, class UFortMusicManagerBank* CallFunc_GetMusicBank_ReturnValue3, class UFortMusicAsset* CallFunc_GetAssetFromDayPhase_ReturnValue, class UFortMusicVoice* CallFunc_ChangePrimaryMusic_ReturnValue, class UFortMusicAsset* K2Node_Event_NewMusicAsset, class UFortMusicVoice* CallFunc_PlayMusicVoice_ReturnValue, float K2Node_CustomEvent_Time1, float K2Node_CustomEvent_Time, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue1, class UFortMusicVoice* K2Node_CustomEvent_Voice, uint8 CallFunc_MakeLiteralByte_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue1, int32 CallFunc_Conv_ByteToInt_ReturnValue, int32 CallFunc_Conv_ByteToInt_ReturnValue1, int32 CallFunc_MakeLiteralInt_ReturnValue, int32 CallFunc_MakeLiteralInt_ReturnValue1, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue1, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue1, class UFortMusicAsset* CallFunc_GetAssetFromCombatIntensity_ReturnValue, class UFortMusicAsset* CallFunc_GetAssetFromCombatIntensity_ReturnValue1, class UFortMusicVoice* CallFunc_ChangePrimaryMusic_ReturnValue1, class UFortMusicVoice* CallFunc_ChangePrimaryMusic_ReturnValue2, uint8 CallFunc_MakeLiteralByte_ReturnValue2, int32 CallFunc_Conv_ByteToInt_ReturnValue2, class UFortMusicAsset* CallFunc_GetAssetFromCombatIntensity_ReturnValue2, int32 CallFunc_MakeLiteralInt_ReturnValue2, class UFortMusicVoice* CallFunc_ChangePrimaryMusic_ReturnValue3, bool CallFunc_Greater_IntInt_ReturnValue2, bool CallFunc_BooleanAND_ReturnValue2, class UFortMusicManagerBank* CallFunc_GetMusicBank_ReturnValue4, bool CallFunc_Less_FloatFloat_ReturnValue, bool CallFunc_Less_FloatFloat_ReturnValue1, bool CallFunc_Greater_FloatFloat_ReturnValue6, bool CallFunc_Greater_FloatFloat_ReturnValue7, bool CallFunc_Less_FloatFloat_ReturnValue2, bool CallFunc_Less_FloatFloat_ReturnValue3, bool CallFunc_Greater_FloatFloat_ReturnValue8, bool CallFunc_Greater_FloatFloat_ReturnValue9, float CallFunc_GetGameTimeInSeconds_ReturnValue10, class UFortMusicManagerBank* K2Node_Event_NewBank, float CallFunc_Subtract_FloatFloat_ReturnValue6, bool CallFunc_Greater_FloatFloat_ReturnValue10, const struct FFortPlayerDeathReport& K2Node_Event_DeathReport, class UFortMusicVoice* CallFunc_ChangePrimaryMusic_ReturnValue4, float CallFunc_GetGameTimeInSeconds_ReturnValue11, float K2Node_CustomEvent_Counter, bool CallFunc_LessEqual_FloatFloat_ReturnValue, class UAudioComponent* CallFunc_SpawnSound2D_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue3, int32 CallFunc_Conv_ByteToInt_ReturnValue3, float CallFunc_Subtract_FloatFloat_ReturnValue7, int32 CallFunc_MakeLiteralInt_ReturnValue3, bool CallFunc_Greater_FloatFloat_ReturnValue11, bool CallFunc_Greater_IntInt_ReturnValue3, class UFortMusicAsset* CallFunc_GetAssetFromCombatIntensity_ReturnValue3, bool CallFunc_BooleanAND_ReturnValue3, class UFortMusicVoice* CallFunc_ChangePrimaryMusic_ReturnValue5, bool CallFunc_IsValid_ReturnValue, class AFortPlayerPawn* CallFunc_GetPlayerPawn_ReturnValue, class USoundBase* K2Node_CustomEvent_Sound, bool CallFunc_IsValid_ReturnValue1, class UAudioComponent* CallFunc_SpawnSound2D_ReturnValue1, bool CallFunc_IsDead_ReturnValue, class UAudioComponent* K2Node_CustomEvent_Mission_Music, float Temp_float_Variable6, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, float CallFunc_GetEventHeatPercent_ReturnValue, float CallFunc_GetEventHeatPercent_ReturnValue1, bool CallFunc_Greater_FloatFloat_ReturnValue12, bool CallFunc_Greater_FloatFloat_ReturnValue13, float CallFunc_GetEventHeatPercent_ReturnValue2, float CallFunc_GetEventHeatPercent_ReturnValue3, bool CallFunc_Greater_FloatFloat_ReturnValue14, bool CallFunc_Greater_FloatFloat_ReturnValue15, bool CallFunc_BooleanOR_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue2, bool CallFunc_BooleanOR_ReturnValue3, float CallFunc_Conv_BoolToFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_GetEventHeatPercent_ReturnValue4, bool CallFunc_Less_FloatFloat_ReturnValue4, bool CallFunc_Greater_FloatFloat_ReturnValue16, float CallFunc_GetEventHeatPercent_ReturnValue5, float K2Node_Select_Default, bool CallFunc_Greater_FloatFloat_ReturnValue17, float CallFunc_FInterpTo_ReturnValue, bool CallFunc_BooleanOR_ReturnValue4, float CallFunc_Conv_BoolToFloat_ReturnValue1, float Temp_float_Variable7, float CallFunc_GetEventHeatPercent_ReturnValue6, float CallFunc_GetEventHeatPercent_ReturnValue7, float CallFunc_GetEventHeatPercent_ReturnValue8, float CallFunc_GetEventHeatPercent_ReturnValue9, float CallFunc_Add_FloatFloat_ReturnValue, bool Temp_bool_Variable3, float CallFunc_Add_FloatFloat_ReturnValue1, float CallFunc_GetEventHeatPercent_ReturnValue10, float CallFunc_Multiply_FloatFloat_ReturnValue1, float CallFunc_GetEventHeatPercent_ReturnValue11, bool CallFunc_Less_FloatFloat_ReturnValue5, float CallFunc_Add_FloatFloat_ReturnValue2, float CallFunc_Add_FloatFloat_ReturnValue3, float K2Node_Select1_Default, bool CallFunc_Less_FloatFloat_ReturnValue6, float CallFunc_FInterpTo_ReturnValue1, float K2Node_Select2_Default, float CallFunc_GetEventHeatPercent_ReturnValue12, float CallFunc_FInterpTo_ReturnValue2, float CallFunc_GetEventHeatPercent_ReturnValue13, float CallFunc_Add_FloatFloat_ReturnValue4, bool CallFunc_Less_FloatFloat_ReturnValue7, float K2Node_Select3_Default, float CallFunc_FInterpTo_ReturnValue3)
{

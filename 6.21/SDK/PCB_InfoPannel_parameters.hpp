...
struct UPCB_InfoPannel_C_Construct_Params
{
public:
};
...
public:
	...
	class FText                                  CallFunc_GetPCBDescription_ReturnValue;            // 0x8(0x18)()
	class FText                                  CallFunc_GetPCBHeader_ReturnValue;                 // 0x20(0x18)()
};

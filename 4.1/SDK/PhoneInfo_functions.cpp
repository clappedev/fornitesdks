...
// UInterfaceProperty_                CallFunc_SetBrushFromAtlasInterface_AtlasRegion12_CastInput      (ZeroConstructor, IsPlainOldData, NoDestructor)
// UInterfaceProperty_                CallFunc_SetBrushFromAtlasInterface_AtlasRegion123_CastInput     (ZeroConstructor, IsPlainOldData, NoDestructor)
// class UAthenaHUDContext*           CallFunc_GetContext_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// UInterfaceProperty_                CallFunc_SetBrushFromAtlasInterface_AtlasRegion1234_CastInput    (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UPhoneInfo_C::BatteryTimerUpdate(float Float, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion_CastInput, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion1_CastInput, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion12_CastInput, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion123_CastInput, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue, UInterfaceProperty_ CallFunc_SetBrushFromAtlasInterface_AtlasRegion1234_CastInput, float CallFunc_GetBatteryLevel_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue1, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue12)
{
	...
	Parms.CallFunc_SetBrushFromAtlasInterface_AtlasRegion12_CastInput = CallFunc_SetBrushFromAtlasInterface_AtlasRegion12_CastInput;
	Parms.CallFunc_SetBrushFromAtlasInterface_AtlasRegion123_CastInput = CallFunc_SetBrushFromAtlasInterface_AtlasRegion123_CastInput;
	Parms.CallFunc_GetContext_ReturnValue = CallFunc_GetContext_ReturnValue;
	Parms.CallFunc_SetBrushFromAtlasInterface_AtlasRegion1234_CastInput = CallFunc_SetBrushFromAtlasInterface_AtlasRegion1234_CastInput;

...
public:
	...
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array12;                          // 0x160(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue12;                     // 0x170(0x18)()
};

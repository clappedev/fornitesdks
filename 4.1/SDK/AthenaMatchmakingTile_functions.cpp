...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingTile_C", "OnSelected");

	Params::UAthenaMatchmakingTile_C_OnSelected_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingTile_C", "OnDeselected");

	Params::UAthenaMatchmakingTile_C_OnDeselected_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingTile_C", "OnHovered");

	Params::UAthenaMatchmakingTile_C_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingTile_C", "OnClicked");

	Params::UAthenaMatchmakingTile_C_OnClicked_Params Parms;
...
void UAthenaMatchmakingTile_C::ExecuteUbergraph_AthenaMatchmakingTile(int32 EntryPoint, bool Temp_bool_Variable, float Temp_float_Variable, float Temp_float_Variable1, bool Temp_bool_Variable1, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable12, enum class ESlateVisibility Temp_byte_Variable12, enum class ESlateVisibility Temp_byte_Variable123, bool Temp_bool_Variable123, enum class ESlateVisibility Temp_byte_Variable1234, enum class ESlateVisibility Temp_byte_Variable12345, bool K2Node_Event_Available, enum class ESlateVisibility K2Node_Select_Default, bool K2Node_Event_UseLargeSize, class UFortPlaylistAthena* K2Node_Event_PlaylistToRepresent, float K2Node_Select1_Default, const struct FSlateBrush& CallFunc_MakeBrushFromTexture_ReturnValue, const struct FSlateBrush& CallFunc_MakeBrushFromTexture_ReturnValue1, class FText CallFunc_TextToUpper_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue1, bool CallFunc_TextIsEmpty_ReturnValue, enum class ESlateVisibility K2Node_Select12_Default, enum class ESlateVisibility K2Node_Select123_Default, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, float Temp_float_Variable12, float Temp_float_Variable123, bool Temp_bool_Variable1234, float K2Node_Select1234_Default, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate)
{

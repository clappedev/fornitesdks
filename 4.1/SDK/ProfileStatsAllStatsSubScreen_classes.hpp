...
public:
	...
	class UWrapBox*                              StatWrapBox;                                       // 0x3C8(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FDataTableRowHandle                   BackAction;                                        // 0x3D0(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FGameplayTagContainer                 StatsToDisplay;                                    // 0x3E0(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)

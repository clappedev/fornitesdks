...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SmokeGrenade_C", "UserConstructionScript");

	Params::AB_Prj_Athena_SmokeGrenade_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SmokeGrenade_C", "OnBounce");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SmokeGrenade_C", "OnExploded");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SmokeGrenade_C", "BndEvt__OverlapCapsule_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SmokeGrenade_C", "FuseEnded");

	Params::AB_Prj_Athena_SmokeGrenade_C_FuseEnded_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SmokeGrenade_C", "ExecuteUbergraph_B_Prj_Athena_SmokeGrenade");

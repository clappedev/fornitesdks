...
void AB_BGA_BotTurret_Parent_C::Fired()
{
	static auto Func = Class->GetFunction("B_BGA_BotTurret_Parent_C", "Fired");

	Params::AB_BGA_BotTurret_Parent_C_Fired_Params Parms;

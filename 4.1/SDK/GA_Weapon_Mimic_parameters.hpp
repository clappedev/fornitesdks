...
public:
	...
	struct FProjectileEventData                  K2Node_CustomEvent_ProjectileData1234;             // 0x8(0x28)(ConstParm, ContainsInstancedReference)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0x30(0x10)(ZeroConstructor, NoDestructor)
	struct FProjectileEventData                  K2Node_CustomEvent_ProjectileData123;              // 0x40(0x28)(ConstParm, ContainsInstancedReference)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1;             // 0x68(0x10)(ZeroConstructor, NoDestructor)
	struct FProjectileEventData                  K2Node_CustomEvent_ProjectileData12;               // 0x78(0x28)(ConstParm, ContainsInstancedReference)
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1234567;       // 0x1E0(0x10)(ZeroConstructor, NoDestructor)
	struct FGameplayTag                          Temp_struct_Variable1;                             // 0x1F0(0x8)(NoDestructor, HasGetValueTypeHash)
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable12;                            // 0x1F8(0x20)()
	...
	struct FProjectileEventData                  K2Node_CustomEvent_ProjectileData12345;            // 0x330(0x28)(ConstParm, ContainsInstancedReference)

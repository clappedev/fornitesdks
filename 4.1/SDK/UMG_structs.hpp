...
{
public:
	uint8                                        Pad_11F[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_120[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_122[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_123[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRichCurve                            Shear;                                             // 0x278(0x70)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_124[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]

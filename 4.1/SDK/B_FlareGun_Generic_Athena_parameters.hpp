...
struct AB_FlareGun_Generic_Athena_C_UserConstructionScript_Params
{
public:
};
...
struct AB_FlareGun_Generic_Athena_C_Muzzle_Flash_FX_Params
{
public:
...
struct AB_FlareGun_Generic_Athena_C_ExecuteUbergraph_B_FlareGun_Generic_Athena_Params
{
public:

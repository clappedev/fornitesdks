...
// enum class EFortBrushSize          Temp_byte_Variable123                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class EFortBrushSize          Temp_byte_Variable1234                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class EFortBrushSize          K2Node_Select_Default                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void USkillTreeBPLibrary_C::GetSkillTreeNodeIconSizeByMagnitude(enum class EFortHomebaseNodeMagnitude Node_Magnitude, class UObject* __WorldContext, enum class EFortBrushSize* Icon_Size, enum class EFortHomebaseNodeMagnitude Temp_byte_Variable, enum class EFortBrushSize Temp_byte_Variable1, enum class EFortBrushSize Temp_byte_Variable12, enum class EFortBrushSize Temp_byte_Variable123, enum class EFortBrushSize Temp_byte_Variable1234, enum class EFortBrushSize K2Node_Select_Default)
{

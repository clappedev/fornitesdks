...
public:
	...
	struct FSlateBrush                           Temp_struct_Variable12;                            // 0x120(0x88)()
	struct FSlateBrush                           Temp_struct_Variable123;                           // 0x1A8(0x88)()
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush12;                    // 0x350(0x88)()
	struct FSlateBrush                           K2Node_Select_Default;                             // 0x3D8(0x88)()
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush123;                   // 0x460(0x88)()
...
public:
	...
	uint8                                        Pad_4922[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]

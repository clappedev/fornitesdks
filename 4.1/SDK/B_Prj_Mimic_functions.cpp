...
void AB_Prj_Mimic_C::UserConstructionScript(class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Prj_Mimic_C", "UserConstructionScript");

	Params::AB_Prj_Mimic_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Mimic_C", "ReceiveBeginPlay");

	Params::AB_Prj_Mimic_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Mimic_C", "OnBounce");

	Params::AB_Prj_Mimic_C_OnBounce_Params Parms;
	Parms.Hit = Hit;
...
{
	static auto Func = Class->GetFunction("B_Prj_Mimic_C", "OnExploded");

	Params::AB_Prj_Mimic_C_OnExploded_Params Parms;

...
public:
	...
	enum class ECommonInputType                  CallFunc_GetCurrentInputType_ReturnValue;          // 0x9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0xA(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2E3A[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]

...
public:
	...
	class FText                                  Temp_text_Variable123;                             // 0x150(0x18)()
	class FText                                  Temp_text_Variable1234;                            // 0x168(0x18)()
	class FText                                  Temp_text_Variable12345;                           // 0x180(0x18)()
	...
	bool                                         Temp_bool_Variable12;                              // 0x1D0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_51FA[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_Select12_Default;                           // 0x1D8(0x18)()
};

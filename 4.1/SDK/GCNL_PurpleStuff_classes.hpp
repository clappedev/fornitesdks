...
public:
	...
	class APlayerPawn_Athena_Generic_C*          PlayerActor;                                       // 0x448(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

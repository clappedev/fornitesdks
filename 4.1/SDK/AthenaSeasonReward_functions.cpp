...
void UAthenaSeasonReward_C::SetState(bool Claimed, bool Locked, bool LevelAchieved, float Temp_float_Variable, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable1, enum class ESlateVisibility K2Node_Select_Default, enum class ESlateVisibility Temp_byte_Variable12, enum class ESlateVisibility Temp_byte_Variable123, enum class ESlateVisibility K2Node_Select1_Default, float Temp_float_Variable1, bool Temp_bool_Variable12, float K2Node_Select12_Default)
{
...
{
	static auto Func = Class->GetFunction("AthenaSeasonReward_C", "OnClicked");

	Params::UAthenaSeasonReward_C_OnClicked_Params Parms;

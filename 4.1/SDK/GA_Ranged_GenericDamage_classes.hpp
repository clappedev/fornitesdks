...
{
public:
	struct FGameplayTag                          GT_EventWeaponFire;                                // 0xB00(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

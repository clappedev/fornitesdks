...
public:
	...
	uint8                                        Pad_238E[0xA7];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_238F[0x1D];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2391[0x18C];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2392[0xF0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2395[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2398[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2399[0x87];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_239A[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]

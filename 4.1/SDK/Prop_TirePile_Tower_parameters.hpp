...
public:
	...
	float                                        CallFunc_Add_FloatFloat_ReturnValue12;             // 0x214(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_MakeVector_ReturnValue12;                 // 0x218(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

...
{
	static auto Func = Class->GetFunction("B_Glider_SpaceShuttleA_C", "UserConstructionScript");

	Params::AB_Glider_SpaceShuttleA_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Glider_SpaceShuttleA_C", "ReceiveBeginPlay");

	Params::AB_Glider_SpaceShuttleA_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Glider_SpaceShuttleA_C", "OnParachuteTrailUpdated");

	Params::AB_Glider_SpaceShuttleA_C_OnParachuteTrailUpdated_Params Parms;
...
void AB_Glider_SpaceShuttleA_C::ReceiveEndPlay(enum class EEndPlayReason EndPlayReason)
{
	static auto Func = Class->GetFunction("B_Glider_SpaceShuttleA_C", "ReceiveEndPlay");

	Params::AB_Glider_SpaceShuttleA_C_ReceiveEndPlay_Params Parms;
...
void AB_Glider_SpaceShuttleA_C::ExecuteUbergraph_B_Glider_SpaceShuttleA(int32 EntryPoint, enum class EEndPlayReason K2Node_Event_EndPlayReason, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, bool Temp_bool_Has_Been_Initd_Variable1, float K2Node_Event_MovementLengthSquared, float K2Node_Event_ForwardDot, float K2Node_Event_RightDot, float K2Node_Event_RotationalMovementAcceleration, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool Temp_bool_IsClosed_Variable1, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Glider_SpaceShuttleA_C", "ExecuteUbergraph_B_Glider_SpaceShuttleA");

	Params::AB_Glider_SpaceShuttleA_C_ExecuteUbergraph_B_Glider_SpaceShuttleA_Params Parms;

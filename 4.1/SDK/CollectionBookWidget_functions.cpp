...
// class UFortCollectionBookManager*  CallFunc_GetCollectionBookManager_ReturnValue12                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UCollectionBookWidget_C::ExecuteUbergraph_CollectionBookWidget(int32 EntryPoint, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue1, class UFortAccountItem* K2Node_CustomEvent_ItemSlotted, class FName K2Node_CustomEvent_SlotId, class UFortCollectionBookManager* CallFunc_GetCollectionBookManager_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_CalculateBookXp_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue12, bool CallFunc_BooleanAND_ReturnValue, class UFortCollectionBookManager* CallFunc_GetCollectionBookManager_ReturnValue1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue123, class UFortCollectionBookManager* CallFunc_GetCollectionBookManager_ReturnValue12, class UCollectionBookPrimaryPanel_C* K2Node_DynamicCast_AsCollection_Book_Primary_Panel, bool K2Node_DynamicCast_bSuccess, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate)
{
	...
	Parms.CallFunc_GetCollectionBookManager_ReturnValue12 = CallFunc_GetCollectionBookManager_ReturnValue12;

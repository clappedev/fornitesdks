...
{
	static auto Func = Class->GetFunction("IconTextButtonReplay_C", "OnHovered");

	Params::UIconTextButtonReplay_C_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("IconTextButtonReplay_C", "OnUnhovered");

	Params::UIconTextButtonReplay_C_OnUnhovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("IconTextButtonReplay_C", "OnSelected");

	Params::UIconTextButtonReplay_C_OnSelected_Params Parms;
...
{
	static auto Func = Class->GetFunction("IconTextButtonReplay_C", "OnDeselected");

	Params::UIconTextButtonReplay_C_OnDeselected_Params Parms;

...
public:
	...
	struct FVector                               CallFunc_Add_VectorVector_ReturnValue12;           // 0x80(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_GetControlRotation_ReturnValue;           // 0x8C(0xC)(IsPlainOldData, NoDestructor)
	uint8                                        Pad_52C2[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]

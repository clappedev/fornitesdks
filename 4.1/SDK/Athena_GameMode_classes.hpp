...
{
public:
	class USceneComponent*                       DefaultSceneRoot;                                  // 0xE80(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

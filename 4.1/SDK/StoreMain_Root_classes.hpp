...
public:
	...
	void OnBeginIntro();
	void OnBeginOutro();
	void ExecuteUbergraph_StoreMain_Root(int32 EntryPoint, bool CallFunc_IsActivated_ReturnValue, enum class ESlateVisibility Temp_byte_Variable, bool Temp_bool_Variable, enum class EFrontEndCamera Temp_byte_Variable1, enum class EFrontEndCamera Temp_byte_Variable12, class UFortStoreContext* CallFunc_GetContext_ReturnValue, class UFortMtxStoreOfferBase* K2Node_Event_MtxOffer, enum class ESlateVisibility Temp_byte_Variable123, bool Temp_bool_Variable1, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortUIStateWidget_NUI* CallFunc_GetCurrentUIStateWidget_ReturnValue, class UFrontEnd_C* K2Node_DynamicCast_AsFront_End, bool K2Node_DynamicCast_bSuccess, class UFortStoreContext* CallFunc_GetContext_ReturnValue1, enum class ESlateVisibility K2Node_Select_Default, enum class EFrontEndCamera K2Node_Select1_Default, class UFortStoreContext* CallFunc_GetContext_ReturnValue12, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UFortUIStateWidget_NUI* CallFunc_GetCurrentUIStateWidget_ReturnValue1, class UFrontEnd_C* K2Node_DynamicCast_AsFront_End1, bool K2Node_DynamicCast_bSuccess1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue123, bool CallFunc_BooleanOR_ReturnValue);
};

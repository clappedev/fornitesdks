...
public:
	...
	struct FDataTableRowHandle                   K2Node_MakeStruct_DataTableRowHandle12;            // 0x80(0x10)(NoDestructor)
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1234;          // 0xB8(0x10)(ZeroConstructor, NoDestructor)
};

...
public:
	...
	uint8                                        Pad_239C[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_239E[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_239F[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]

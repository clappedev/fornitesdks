...
{
	static auto Func = Class->GetFunction("B_Glider_Satellite_C", "UserConstructionScript");

	Params::AB_Glider_Satellite_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Glider_Satellite_C", "ReceiveBeginPlay");

	Params::AB_Glider_Satellite_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Glider_Satellite_C", "OnParachuteTrailUpdated");

	Params::AB_Glider_Satellite_C_OnParachuteTrailUpdated_Params Parms;
...
void AB_Glider_Satellite_C::ExecuteUbergraph_B_Glider_Satellite(int32 EntryPoint, float K2Node_Event_MovementLengthSquared, float K2Node_Event_ForwardDot, float K2Node_Event_RightDot, float K2Node_Event_RotationalMovementAcceleration, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Glider_Satellite_C", "ExecuteUbergraph_B_Glider_Satellite");

	Params::AB_Glider_Satellite_C_ExecuteUbergraph_B_Glider_Satellite_Params Parms;

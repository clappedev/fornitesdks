...
void UAlterationWidget_C::SetEvolutionDetails(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortAlterationInfo* CallFunc_GetAlterationInfo_ReturnValue, bool CallFunc_IsAlterationHighlighted_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
...
void UAlterationWidget_C::UpdateRaritySwitcherVisiblity(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortAlterationInfo* CallFunc_GetAlterationInfo_ReturnValue, class UFortAlterationInfo* CallFunc_GetAlterationInfo_ReturnValue1, enum class EFortRarity CallFunc_GetRarity_ReturnValue, bool CallFunc_IsAlterationUnlocked_ReturnValue, int32 CallFunc_Conv_ByteToInt_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, bool Temp_bool_Variable1, class UWidget* K2Node_Select1_Default)
{

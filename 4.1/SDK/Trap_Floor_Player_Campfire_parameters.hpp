...
public:
	...
	uint8                                        Pad_4CC2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               CallFunc_K2_GetComponentLocation_ReturnValue12;    // 0xEC(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_4CC5[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4CC6[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               CallFunc_Multiply_VectorVector_ReturnValue12;      // 0x1E0(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Multiply_VectorVector_ReturnValue123;     // 0x1EC(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4CC8[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FParticleSysParam                     K2Node_MakeStruct_ParticleSysParam123;             // 0x200(0x80)(IsPlainOldData, NoDestructor)
	struct FParticleSysParam                     K2Node_MakeStruct_ParticleSysParam1234;            // 0x280(0x80)(IsPlainOldData, NoDestructor)
	struct FParticleSysParam                     K2Node_MakeStruct_ParticleSysParam12345;           // 0x300(0x80)(IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_4CCA[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue123;       // 0x448(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue1234;      // 0x464(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_IsValid_ReturnValue12;                    // 0x611(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4CCF[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               CallFunc_K2_GetComponentLocation_ReturnValue12;    // 0x614(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_K2_GetComponentLocation_ReturnValue123;   // 0x628(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_SwitchEnum12_CmpSuccess;                    // 0x65C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4CD2[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTimerHandle                          CallFunc_K2_SetTimer_ReturnValue;                  // 0x660(0x8)(NoDestructor)
};

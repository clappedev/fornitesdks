...
{
public:
	class UParticleSystemComponent*              P_PotofGold_Pickaxe;                               // 0xBB8(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

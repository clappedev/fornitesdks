...
{
public:
	uint8                                        Pad_17C[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_17F[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_180[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Shear;                                             // 0x318(0x90)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_181[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]

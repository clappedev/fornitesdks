...
{
public:
	class USceneComponent*                       DefaultSceneRoot;                                  // 0x1560(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

...
struct UTopRightContainer_Proto_1_C_BndEvt__Button_Map_K2Node_ComponentBoundEvent_17_OnButtonClickedEvent__DelegateSignature_Params
{
public:
};
...
struct UTopRightContainer_Proto_1_C_CustomEvent_0_Params
{
public:
};
...
struct UTopRightContainer_Proto_1_C_Construct_Params
{
public:
};
...
struct UTopRightContainer_Proto_1_C_Destruct_Params
{
public:
};
...
struct UTopRightContainer_Proto_1_C_ExecuteUbergraph_TopRightContainer_Proto_1_Params
{
public:
	...
	class AFortPlayerControllerAthena*           K2Node_DynamicCast_AsFort_Player_Controller_Athena2; // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess2;                      // 0x68(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsInAircraft_ReturnValue;                 // 0x69(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)

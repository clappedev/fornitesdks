...
public:
	...
	uint8                                        bAllowClientSideNavigation : 1;                    // Mask : 0x2 0x40(0x1)(Edit, Config, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        bTickWhilePaused : 1;                              // Mask : 0x4 0x40(0x1)(Edit, Config, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        bSupportRebuilding : 1;                            // Mask : 0x8 0x40(0x1)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        bInitialBuildingLocked : 1;                        // Mask : 0x10 0x40(0x1)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        : 1;                                               // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        bSkipAgentHeightCheckWhenPickingNavData : 1;       // Mask : 0x40 0x40(0x1)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_F72[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F73[0xCC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F74[0x23B];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F76[0x24];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F7C[0x3F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F7E[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F84[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F87[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F88[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F89[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F8D[0x3F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F9A[0x13];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F9C[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]

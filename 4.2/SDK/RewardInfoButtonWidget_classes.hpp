...
public:
	...
	class UHorizontalBox*                        ItemDetails;                                       // 0x8B0(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      ItemInfo;                                          // 0x8B8(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class FText                                  DisplayNameText;                                   // 0x8C0(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  DisplayQuantity;                                   // 0x8D8(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)

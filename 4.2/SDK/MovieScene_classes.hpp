...
public:
	...
	uint8                                        Pad_2041[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2045[0x15];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2047[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2049[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_204D[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_204F[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2050[0x348];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2052[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2053[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneSequencePlaybackSettings   PlaybackSettings;                                  // 0x3F8(0x40)(Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_2054[0x3A8];                                   // Fixing Size Of Struct [ Dumper-7 ]

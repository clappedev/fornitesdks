...
public:
	...
	uint8                                        Pad_21B9[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_21BB[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_21BC[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_21C1[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

...
void ATrap_Floor_BouncePad_C::OnOutOfDurability()
{
	static auto Func = Class->GetFunction("Trap_Floor_BouncePad_C", "OnOutOfDurability");

	Params::ATrap_Floor_BouncePad_C_OnOutOfDurability_Params Parms;
...
void ATrap_Floor_BouncePad_C::OnWorldReady()
{
	static auto Func = Class->GetFunction("Trap_Floor_BouncePad_C", "OnWorldReady");

	Params::ATrap_Floor_BouncePad_C_OnWorldReady_Params Parms;

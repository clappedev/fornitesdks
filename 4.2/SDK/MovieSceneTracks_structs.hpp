...
public:
	...
	uint8                                        Pad_20A8[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20AB[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20AC[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_20AD[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FVector                               Location;                                          // 0x8(0xC)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_20AE[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20AF[0x120];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               RotationCurve;                                     // 0x1B0(0x90)(NativeAccessSpecifierPublic)
	uint8                                        Pad_20B0[0x120];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               ScaleCurve;                                        // 0x360(0x90)(NativeAccessSpecifierPublic)
	uint8                                        Pad_20B1[0x120];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_20B3[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FMovieSceneActorReferenceKey>  KeyValues;                                         // 0x28(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_20B4[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20BD[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20BE[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20BF[0x1B0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_20C1[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20C2[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20C7[0x1B0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_20C8[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20C9[0x67];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_20CD[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};

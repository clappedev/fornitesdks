...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_AthenaRed_C", "UserConstructionScript");

	Params::ABP_ProjectileTrajectory_AthenaRed_C_UserConstructionScript_Params Parms;

...
public:
	...
	void On_Widget_Activated(int32 CallFunc_GetNumItemsSelected_ReturnValue, class UObject* CallFunc_BP_GetSelectedItem_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue);

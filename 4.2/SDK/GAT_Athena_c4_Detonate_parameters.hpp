...
public:
	...
	uint8                                        Pad_39B4[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate2;             // 0x1A0(0x10)(ZeroConstructor, NoDestructor)

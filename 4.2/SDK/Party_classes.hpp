...
{
public:
	uint8                                        Pad_20F9[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_20FA[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_20FB[0x17F];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_20FD[0x58];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_20FE[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2100[0x108];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2101[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2102[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]

...
public:
	...
	struct FNiagaraVMExecutableData                    CachedScriptVM;                                           // 0x0560(0x0178)
	TArray<class UNiagaraParameterCollection*>         CachedParameterCollectionReferences;                      // 0x06D8(0x0010) (ZeroConstructor)
	TArray<struct FNiagaraScriptDataInterfaceInfo>     CachedDefaultDataInterfaces;                              // 0x06E8(0x0010) (ZeroConstructor)

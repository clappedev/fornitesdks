...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Athena_ButtonStyle_AngledBlueMenuButton_Small.Athena_ButtonStyle_AngledBlueMenuButton_Small_C");
		return ptr;
	}

...
public:
	...
	void STATIC_AddModularSynthPresetToBankAsset(class UModularSynthPresetBank* InBank, struct FModularSynthPreset Preset, struct FString PresetName);
};
...
{
public:
	int                                                VoiceCount;                                               // 0x0640(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x67C];                                     // 0x0644(0x067C) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x00D8(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.EnvelopeFollowerListener.OnEnvelopeFollowerUpdate
...
public:
	...
	unsigned char                                      UnknownData00[0x10];                                      // 0x0110(0x0010) UNKNOWN PROPERTY: DelegateProperty Synthesis.Synth2DSlider.ValueXDelegate
	unsigned char                                      UnknownData01[0x10];                                      // 0x0120(0x0010) UNKNOWN PROPERTY: DelegateProperty Synthesis.Synth2DSlider.ValueYDelegate
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x0401(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.Synth2DSlider.OnMouseCaptureBegin
	unsigned char                                      UnknownData05[0x10];                                      // 0x0418(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.Synth2DSlider.OnMouseCaptureEnd
	unsigned char                                      UnknownData06[0x10];                                      // 0x0428(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.Synth2DSlider.OnControllerCaptureBegin
	unsigned char                                      UnknownData07[0x10];                                      // 0x0438(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.Synth2DSlider.OnControllerCaptureEnd
	unsigned char                                      UnknownData08[0x10];                                      // 0x0448(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.Synth2DSlider.OnValueChangedX
	unsigned char                                      UnknownData09[0x10];                                      // 0x0458(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.Synth2DSlider.OnValueChangedY
...
{
public:
	class USoundWave*                                  GranulatedSoundWave;                                      // 0x0640(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x348];                                     // 0x0648(0x0348) MISSED OFFSET
...
{
public:
	class USoundWave*                                  SoundWave;                                                // 0x0640(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0648(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.SynthSamplePlayer.OnSampleLoaded
	unsigned char                                      UnknownData01[0x10];                                      // 0x0658(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.SynthSamplePlayer.OnSamplePlaybackProgress
	unsigned char                                      UnknownData02[0x108];                                     // 0x0668(0x0108) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0150(0x0010) UNKNOWN PROPERTY: DelegateProperty Synthesis.SynthKnob.ValueDelegate
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x039A(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.SynthKnob.OnMouseCaptureBegin
	unsigned char                                      UnknownData04[0x10];                                      // 0x03B0(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.SynthKnob.OnMouseCaptureEnd
	unsigned char                                      UnknownData05[0x10];                                      // 0x03C0(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.SynthKnob.OnControllerCaptureBegin
	unsigned char                                      UnknownData06[0x10];                                      // 0x03D0(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.SynthKnob.OnControllerCaptureEnd
	unsigned char                                      UnknownData07[0x10];                                      // 0x03E0(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Synthesis.SynthKnob.OnValueChanged

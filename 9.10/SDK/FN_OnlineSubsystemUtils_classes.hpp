...
{
public:
	unsigned char                                      UnknownData00[0x60];                                      // 0x1980(0x0060) MISSED OFFSET
	float                                              SocketErrorDisconnectDelay;                               // 0x19E0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x19E4(0x000C) MISSED OFFSET
...
public:
	...
	double                                             MaxSecondsInReceive;                                      // 0x0768(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	int                                                NbPacketsBetweenReceiveTimeTest;                          // 0x0770(0x0004) (ZeroConstructor, Config, IsPlainOldData)

...
{
	static auto fn = UObject::FindObject<UFunction>("Function MinimalSquadMember.MinimalSquadMember_C.BP_OnTeamMemberEstablished");

	UMinimalSquadMember_C_BP_OnTeamMemberEstablished_Params params;

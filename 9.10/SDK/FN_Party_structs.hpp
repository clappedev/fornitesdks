...
struct FPartyMemberRepData : public FOnlinePartyRepDataBase
{
	...
	struct FUniqueNetIdRepl                            PlatformUniqueId;                                         // 0x0060(0x0028)
	unsigned char                                      UnknownData02[0x30];                                      // 0x0088(0x0030) MISSED OFFSET
	struct FString                                     PlatformSessionId;                                        // 0x00B8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x30];                                      // 0x00C8(0x0030) MISSED OFFSET
	ECrossplayPreference                               CrossplayPreference;                                      // 0x00F8(0x0001) (ZeroConstructor, IsPlainOldData)

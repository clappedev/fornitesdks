...
public:
	...
	struct FVector                                     LastVelocity;                                             // 0x078C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector                                     OtherVelocity;                                            // 0x07A8(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     OtherLocation;                                            // 0x07B4(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector                                     Debug_LastPosition;                                       // 0x07C8(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     InitialSpawnPosition;                                     // 0x07D4(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FVector                                     DustSize;                                                 // 0x07FC(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

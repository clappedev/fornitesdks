...
public:
	...
	class UTexture2D*                                  PreviewImage;                                             // 0x00C0(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	bool IsRecording();
	class UScreenCaptureContext* STATIC_CreateScreenCaptureContext(class UObject* WorldContextObject);
};

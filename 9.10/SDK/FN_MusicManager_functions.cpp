...
{
	static auto fn = UObject::FindObject<UFunction>("Function MusicManager.MusicManager_C.Get Valid Mission Timer Update");

	AMusicManager_C_Get_Valid_Mission_Timer_Update_Params params;
	params.Is_Valid_Mission_Timer = Is_Valid_Mission_Timer;

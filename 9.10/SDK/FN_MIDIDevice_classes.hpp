...
public:
	...
	void STATIC_GetMIDIOutputDeviceIDByName(struct FString DeviceName, int* DeviceID);
	void STATIC_GetMIDIInputDeviceIDByName(struct FString DeviceName, int* DeviceID);

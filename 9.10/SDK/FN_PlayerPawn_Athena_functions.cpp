...
void APlayerPawn_Athena_C::WhiteoutAndTeleport(struct FVector DestLocation, struct FRotator DestRotation, bool Instant, float Gravity)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Athena.PlayerPawn_Athena_C.MeleeSwingLeft_End");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Athena.PlayerPawn_Athena_C.MeleeSwingRight_End");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Athena.PlayerPawn_Athena_C.AddSafeZoneGameplayCue");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Athena.PlayerPawn_Athena_C.RemoveSafeZoneGameplayCueServerToClient");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Athena.PlayerPawn_Athena_C.OnSuccessfulBuildingEdit");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Athena.PlayerPawn_Athena_C.SwingLeftEnd__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Athena.PlayerPawn_Athena_C.SwingRightEnd__DelegateSignature");

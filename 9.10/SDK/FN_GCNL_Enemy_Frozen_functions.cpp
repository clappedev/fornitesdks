...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Enemy_Frozen.GCNL_Enemy_Frozen_C.OnLoopingStart");

	AGCNL_Enemy_Frozen_C_OnLoopingStart_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Enemy_Frozen.GCNL_Enemy_Frozen_C.OnRemoval");

	AGCNL_Enemy_Frozen_C_OnRemoval_Params params;
	params.MyTarget = MyTarget;
	params.Parameters = Parameters;
	params.ParticleComponents = ParticleComponents;
	params.AudioComponents = AudioComponents;
...
void AGCNL_Enemy_Frozen_C::ExecuteUbergraph_GCNL_Enemy_Frozen(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Enemy_Frozen.GCNL_Enemy_Frozen_C.ExecuteUbergraph_GCNL_Enemy_Frozen");

	AGCNL_Enemy_Frozen_C_ExecuteUbergraph_GCNL_Enemy_Frozen_Params params;

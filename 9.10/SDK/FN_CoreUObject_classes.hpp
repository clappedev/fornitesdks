...
namespace SDK
{
	...
	public:
		...
		static T_Fast* FindObjectFast(std::string name)
		{
			...
			auto StaticFindObject = (T_Fast * (*)(UClass*, UObject * Package, const wchar_t* OrigInName, bool ExactClass))(reinterpret_cast<uintptr_t>(GetModuleHandle(0)) + 0x2001E30);
		...
		template <typename T>
		static T* LoadObject(std::string Path, UClass* InClass = T::StaticClass(), UObject* Outer = nullptr)
		{
			auto StaticLoadObject_ = (T * (*)(UClass * Class, UObject * InOuter, const TCHAR * Name, const TCHAR * Filename, uint32_t LoadFlags, UObject * Sandbox, bool bAllowObjectReconciliation))(reinterpret_cast<uintptr_t>(GetModuleHandle(0)) + 0x2003110);

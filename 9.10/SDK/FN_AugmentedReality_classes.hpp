...
{
public:
	int                                                BufferSizePerChunk;                                       // 0x0328(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	TArray<unsigned char>                              PreviewImageData;                                         // 0x02A0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<unsigned char>                              ARWorldData;                                              // 0x02B0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	int                                                PreviewImageBytesTotal;                                   // 0x02C0(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                ARWorldBytesTotal;                                        // 0x02C4(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                PreviewImageBytesDelivered;                               // 0x02C8(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                ARWorldBytesDelivered;                                    // 0x02CC(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UAREnvironmentCaptureProbe*                  CaptureProbe;                                             // 0x0250(0x0008) (ZeroConstructor, IsPlainOldData)

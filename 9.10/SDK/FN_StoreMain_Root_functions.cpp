...
{
	static auto fn = UObject::FindObject<UFunction>("Function StoreMain_Root.StoreMain_Root_C.ShouldUserSeeNewVBuckOffer");

	UStoreMain_Root_C_ShouldUserSeeNewVBuckOffer_Params params;
	...
	if (ShowNewStyle != nullptr)
		*ShowNewStyle = params.ShowNewStyle;
}

...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaReplayBrowserTab.AthenaReplayBrowserTab_C.OnViewStreamingReplay");

	UAthenaReplayBrowserTab_C_OnViewStreamingReplay_Params params;

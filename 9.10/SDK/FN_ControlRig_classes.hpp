...
public:
	...
	TArray<struct FControlRigOperator>                 Operators;                                                // 0x0100(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData02[0x68];                                      // 0x0110(0x0068) MISSED OFFSET
	...
	void SetGlobalTransform(struct FName BoneName, struct FTransform InTransform);
	struct FTransform GetGlobalTransform(struct FName BoneName);
	float GetDeltaTime();
};
...
{
public:
	TArray<struct FControlRigOperator>                 Operators;                                                // 0x02E0(0x0010) (Edit, ZeroConstructor, EditConst)

...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0294(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Rewards_ItemCard.Rewards_ItemCard_C.OnSlideAnimationFinished
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x02FC(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Rewards_ItemCard.Rewards_ItemCard_C.OnInspectClicked
	unsigned char                                      UnknownData04[0x10];                                      // 0x0310(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Rewards_ItemCard.Rewards_ItemCard_C.OnResizeAnimationFinished
	...
	unsigned char                                      UnknownData05[0x10];                                      // 0x0330(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty Rewards_ItemCard.Rewards_ItemCard_C.OnPopInAnimationFinished

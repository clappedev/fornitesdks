...
{
	static auto fn = UObject::FindObject<UFunction>("Function ShowdownEventTileViolator.ShowdownEventTileViolator_C.RefreshViolatorData");

	UShowdownEventTileViolator_C_RefreshViolatorData_Params params;

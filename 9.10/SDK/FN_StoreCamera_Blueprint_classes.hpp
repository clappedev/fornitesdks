...
public:
	...
	float                                              ChoicePack_NewTrack;                                      // 0x07F8(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	float                                              Timeline;                                                 // 0x0808(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    Timeline02;                                               // 0x080C(0x0001) (ZeroConstructor, IsPlainOldData)

...
{
public:
	unsigned char                                      UnknownData00[0xC0];                                      // 0x0208(0x00C0) MISSED OFFSET
	bool                                               bIsFocusable;                                             // 0x02C8(0x0001) (Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x02C9(0x0007) MISSED OFFSET
	class USocialChatChannel*                          ActiveChannel;                                            // 0x02D0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x20];                                      // 0x02D8(0x0020) MISSED OFFSET
...
{
public:
	class UClass*                                      GroupEntryWidgetClass;                                    // 0x03B0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UClass*                                      UserEntryWidgetClass;                                     // 0x03B8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UClass*                                      ActionMenuClass;                                          // 0x03C0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialInteractionMenu*                      ActionMenu;                                               // 0x03C8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
{
public:
	class UClass*                                      UserEntryWidgetClass;                                     // 0x03B0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UClass*                                      InviteEntryWidgetClass;                                   // 0x03B8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UClass*                                      ActionMenuClass;                                          // 0x03C0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class USocialInteractionMenu*                      ActionMenu;                                               // 0x03C8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)

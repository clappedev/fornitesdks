...
public:
	...
	struct FString                                     McpDispatchUrl;                                           // 0x00C8(0x0010) (ZeroConstructor)
	struct FString                                     McpDispatchBatchUrl;                                      // 0x00D8(0x0010) (ZeroConstructor)
	struct FString                                     McpProxyUrl;                                              // 0x00E8(0x0010) (ZeroConstructor)

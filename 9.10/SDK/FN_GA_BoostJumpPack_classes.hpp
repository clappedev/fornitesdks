...
public:
	...
	struct FGameplayTag                                BoostCue;                                                 // 0x0AC4(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTag                                BoostJumpPackCue;                                         // 0x0ACC(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)

...
// Parameters:
// EFrontEndCamera                CameraMode                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_Hex_PARENT_C::UpdateFromFrontendCamera(EFrontEndCamera CameraMode)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.UpdateFromFrontendCamera");

	ABP_Hex_PARENT_C_UpdateFromFrontendCamera_Params params;

...
public:
	...
	unsigned char                                      UnknownData01 : 1;                                        // 0x00E4(0x0001)
	unsigned char                                      bIsNetDirty : 1;                                          // 0x00E4(0x0001)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00E5(0x0003) MISSED OFFSET
	TArray<class UGameplayTask*>                       SimulatedTasks;                                           // 0x00E8(0x0010) (Net, ZeroConstructor)
	TArray<class UGameplayTask*>                       TaskPriorityQueue;                                        // 0x00F8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0108(0x0010) MISSED OFFSET
	TArray<class UGameplayTask*>                       TickingTasks;                                             // 0x0118(0x0010) (ZeroConstructor)
	TArray<class UGameplayTask*>                       KnownTasks;                                               // 0x0128(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData04[0x10];                                      // 0x0138(0x0010) UNKNOWN PROPERTY: MulticastInlineDelegateProperty GameplayTasks.GameplayTasksComponent.OnClaimedResourcesChange

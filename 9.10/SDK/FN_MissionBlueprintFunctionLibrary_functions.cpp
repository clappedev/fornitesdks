...
void UMissionBlueprintFunctionLibrary_C::STATIC_NPC_CanBeElemental(struct FGameplayTag PawnTag, class UObject* __WorldContext, bool* Value)
{
	static auto fn = UObject::FindObject<UFunction>("Function MissionBlueprintFunctionLibrary.MissionBlueprintFunctionLibrary_C.NPC_CanBeElemental");

...
{
	static auto fn = UObject::FindObject<UFunction>("Function MTXButton.MTXButton_C.HandleInputActionChanged");

	UMTXButton_C_HandleInputActionChanged_Params params;

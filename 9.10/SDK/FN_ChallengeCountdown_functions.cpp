...
{
	static auto fn = UObject::FindObject<UFunction>("Function ChallengeCountdown.ChallengeCountdown_C.OnChallengeSet");

	UChallengeCountdown_C_OnChallengeSet_Params params;

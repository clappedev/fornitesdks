...
public:
	...
	bool                                               AllowLootDrop;                                            // 0x0B18(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0B19(0x0003) MISSED OFFSET
	struct FVector                                     StartLoc;                                                 // 0x0B1C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

...
void UControlRig::SetGlobalTransform(struct FName BoneName, struct FTransform InTransform)
{
...
struct FTransform UControlRig::GetGlobalTransform(struct FName BoneName)
{

...
// bool                           bIsRewardClaimed               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UMissionAlertIndicator_C::Config(struct FGameplayTagContainer AlertVisualTags, bool bIsRewardClaimed)
{
	...
	params.bIsRewardClaimed = bIsRewardClaimed;
